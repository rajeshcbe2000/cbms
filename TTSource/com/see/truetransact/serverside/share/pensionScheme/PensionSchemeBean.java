 ...
 * @author Balachandar
 */
public class PensionSchemeBean implements SessionBean, TTDAOImpl {

    PensionSchemeDAO daoPensionScheme = null;

    public void ejbCreate() throws CreateException, ServiceLocatorException {
        daoPensionScheme = new PensionSchemeDAO();
    }

    public void ejbRemove() {
        daoPensionScheme = null;
    }
    ...
    public HashMap execute(HashMap obj) throws Exception {
        return daoPensionScheme.execute(obj);
    }

    public HashMap executeQuery(HashMap obj) throws Exception {
        return daoPensionScheme.executeQuery(obj);
    }
}
