 ...
 */
package com.see.truetransact.serverside.indend.depo;
 ...
 *
 */
public class DepoDAO extends TTDAO {

    private static SqlMap sqlMap = null;
    private DepoTO objTO;
     ...
     */
    public DepoDAO() throws ServiceLocatorException {
    ...
    private HashMap getData(HashMap map) throws Exception {
        ...
        List list = (List) sqlMap.executeQueryForList("Depo.getSelectDepo", where);
        returnMap.put("DepoTO", list);
        return returnMap;
    }

    private String getDepoId() throws Exception {
        //  final IDGenerateDAO dao = new IDGenerateDAO();
        final HashMap where = new HashMap();
        where.put(CommonConstants.MAP_WHERE, "DEPID");
        // return "";
    ...
    public HashMap generateID() {
        ...
        try {
            ...
            where.put("ID_KEY", "DEPID"); //Here u have to pass BORROW_ID or something else
            List list = null;
    ...
    private void insertData() throws Exception {
        try {
            ...
            sqlMap.executeUpdate("insertDepoTO", objTO);
    ...
    private void updateData() throws Exception {
        try {
            ...
            //  logTO.setPrimaryKey(objTO.getKeyData());
            // logTO.setStatus(objTO.getCommand());
            sqlMap.executeUpdate("updateDepoTO", objTO);
            //  logDAO.addToLog(logTO);
            sqlMap.commitTransaction();
        } catch (Exception e) {
            sqlMap.rollbackTransaction();
    ...
    private void deleteData() throws Exception {
        try {
            ...
            // logTO.setPrimaryKey(objTO.getKeyData());
            // logTO.setStatus(objTO.getCommand());
            sqlMap.executeUpdate("deleteDepoTO", objTO);
            //   logDAO.addToLog(logTO);
            sqlMap.commitTransaction();
        } catch (Exception e) {
            sqlMap.rollbackTransaction();
    ...
    public HashMap execute(HashMap map) throws Exception {
        ...
        if (command.equals(CommonConstants.TOSTATUS_INSERT)) {
            ...
            returnMap.put("DEPID", objTO.getDepId());
