 ...
 */
package com.see.truetransact.serverside.indend.sale;
 ...
 *
 */
public class SaleDAO extends TTDAO {

    private static SqlMap sqlMap = null;
    private SaleTO objTO;
     ...
     */
    public SaleDAO() throws ServiceLocatorException {
    ...
    private HashMap getData(HashMap map) throws Exception {
        ...
        List list = (List) sqlMap.executeQueryForList("Sale.getSelectSale", where);
        returnMap.put("SaleTO", list);
        return returnMap;
    }

    private String getSmId() throws Exception {
        //  final IDGenerateDAO dao = new IDGenerateDAO();
        final HashMap where = new HashMap();
        where.put(CommonConstants.MAP_WHERE, "SMID");
        // return "";
    ...
    public HashMap generateID() {
        ...
        try {
            ...
            where.put("ID_KEY", "SMID"); //Here u have to pass BORROW_ID or something else
            List list = null;
    ...
    private void insertData() throws Exception {
        try {
            ...
            sqlMap.executeUpdate("insertSaleTO", objTO);
    ...
    private void updateData() throws Exception {
        try {
            ...
            //  logTO.setPrimaryKey(objTO.getKeyData());
            // logTO.setStatus(objTO.getCommand());
            sqlMap.executeUpdate("updateSaleTO", objTO);
            //  logDAO.addToLog(logTO);
            sqlMap.commitTransaction();
        } catch (Exception e) {
            sqlMap.rollbackTransaction();
    ...
    private void deleteData() throws Exception {
        try {
            ...
            // logTO.setPrimaryKey(objTO.getKeyData());
            // logTO.setStatus(objTO.getCommand());
            sqlMap.executeUpdate("deleteSaleTO", objTO);
            //   logDAO.addToLog(logTO);
            sqlMap.commitTransaction();
        } catch (Exception e) {
            sqlMap.rollbackTransaction();
    ...
    public HashMap execute(HashMap map) throws Exception {
        ...
        if (command.equals(CommonConstants.TOSTATUS_INSERT)) {
            ...
            returnMap.put("SMID", objTO.getSmId());
