 ...
 *
 */
public class StoreDAO extends TTDAO {

    private static SqlMap sqlMap = null;
    private StoreTO objTO;
     ...
     */
    public StoreDAO() throws ServiceLocatorException {
    ...
    private HashMap getData(HashMap map) throws Exception {
        ...
        List list = (List) sqlMap.executeQueryForList("Store.getSelectStore", where);
        returnMap.put("StoreTO", list);
        return returnMap;
    }

    private String getSTNo() throws Exception {
        //  final IDGenerateDAO dao = new IDGenerateDAO();
        final HashMap where = new HashMap();
        where.put(CommonConstants.MAP_WHERE, "STNUMBER");
        // return "";
    ...
    public HashMap generateID() {
        ...
        try {
            ...
            where.put("ID_KEY", "STNUMBER"); //Here u have to pass BORROW_ID or something else
            List list = null;
    ...
    private void insertData() throws Exception {
        try {
            ...
            sqlMap.executeUpdate("insertStoreTO", objTO);
    ...
    private void updateData() throws Exception {
        try {
            ...
            //  logTO.setPrimaryKey(objTO.getKeyData());
            // logTO.setStatus(objTO.getCommand());
            sqlMap.executeUpdate("updateStoreTO", objTO);
            //  logDAO.addToLog(logTO);
            sqlMap.commitTransaction();
        } catch (Exception e) {
            sqlMap.rollbackTransaction();
    ...
    private void deleteData() throws Exception {
        try {
            ...
            // logTO.setPrimaryKey(objTO.getKeyData());
            // logTO.setStatus(objTO.getCommand());
            sqlMap.executeUpdate("deleteStoreTO", objTO);
            //   logDAO.addToLog(logTO);
            sqlMap.commitTransaction();
        } catch (Exception e) {
            sqlMap.rollbackTransaction();
    ...
    public HashMap execute(HashMap map) throws Exception {
        ...
        if (command.equals(CommonConstants.TOSTATUS_INSERT)) {
            ...
            returnMap.put("STNUMBER", objTO.getStNo());
