 ...
 * @author shanmugavel
 */
public class DataCorrectionBean implements SessionBean, TTDAOImpl {
    ...
    public HashMap execute(HashMap obj) throws Exception {
        DataCorrectionDAO daoDataCorrectionDAO = new DataCorrectionDAO();
        return daoDataCorrectionDAO.execute(obj);
        //daoTermLoan = null;
    }

    public HashMap executeQuery(HashMap obj) throws Exception {
        DataCorrectionDAO daoDataCorrectionDAO = new DataCorrectionDAO();
        return daoDataCorrectionDAO.executeQuery(obj);
    }
}
