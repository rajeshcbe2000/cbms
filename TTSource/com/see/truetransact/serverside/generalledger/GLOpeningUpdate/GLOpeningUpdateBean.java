 ...
 *
 */
public class GLOpeningUpdateBean implements SessionBean, TTDAOImpl {

    GLOpeningUpdateDAO daoGLOpeningUpdate = null;

    public void ejbCreate() throws CreateException, ServiceLocatorException {
        daoGLOpeningUpdate = new GLOpeningUpdateDAO();
    }

    public void ejbRemove() {
        daoGLOpeningUpdate = null;
    }
    ...
    public HashMap execute(HashMap obj) throws Exception {
        return daoGLOpeningUpdate.execute(obj);
    }

    public HashMap executeQuery(HashMap obj) throws Exception {
        return daoGLOpeningUpdate.executeQuery(obj);
    }
}
