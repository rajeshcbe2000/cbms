 ...
 */
package com.see.truetransact.serverside.supporting.generateseries;
...
public class GenerateSeries {
     ...
     */
    public GenerateSeries(String itemType, String branchID, String userID, String authStatus) throws ServiceLocatorException {
    ...
    //__ Controling method... Decoration of the data ...
        ...
        if (resultMap.containsKey("BOOK_SLNO_FROM")) {
            ...
            if (chequeBooks > 0) {
                if (difference >= chequeBooks) {
                    ...
                    //__ if the current Series is finished...
                    ...
                    final HashMap inventoryMap = setInventoryDetailsData(resultMap);
//                    final String transID = setInventoryDetailsData(resultMap);
                    ...
                    resultMap.put(CommonConstants.USER_ID, getUserID());
                    resultMap.put(CommonConstants.AUTHORIZEDT, ServerUtil.getCurrentDate(getBranchCode()));
                ...
                } else { // __ if unable to generate the required book(s)..
                    resultMap.put("ORDERED_BOOKS", String.valueOf(getBooks()));
    ...
    //__ To set the TO Obj for the Inventory Details...
    private HashMap setInventoryDetailsData(HashMap dataMap) throws Exception {
