 ...
 * @author swaroop
 */
public class EmpTransferBean implements SessionBean, TTDAOImpl {

    private EmpTransferDAO empTransferDAO;

    public void ejbCreate() throws CreateException, ServiceLocatorException {
        empTransferDAO = new EmpTransferDAO();
    }
    ...
    public HashMap execute(HashMap obj) throws Exception {
        return empTransferDAO.execute(obj);
    }

    public HashMap executeQuery(HashMap obj) throws Exception {
        return empTransferDAO.executeQuery(obj);
    }
}
