 ...
 */
package com.see.truetransact.serverside.inwardregister;
 ...
 *
 */
public class InwardDAO extends TTDAO {

    private static SqlMap sqlMap = null;
    private InwardRegisterTO objTO;
    private LogDAO logDAO;
    private LogTO logTO;
    private final static Logger log = Logger.getLogger(InwardDAO.class);
    private Date currDt = null;
    /**
     * Creates a new instance of TokenConfigDAO
     */
    public InwardDAO() throws ServiceLocatorException {
    ...
    private HashMap getData(HashMap map) throws Exception {
        ...
        List list = (List) sqlMap.executeQueryForList("getSelectInwardTO", map);
        System.out.println("#########" + list);
        returnMap.put("InwardTO", list);
        return returnMap;
    }
    ...
    private void insertData(HashMap map) throws Exception {
        try {
            ...
            objTO.setInwardNo(getInwardNo());
            sqlMap.executeUpdate("insertInwardTO", objTO);
...
//            logDAO.addToLog(logTO);
    ...
    private String getInwardNo() throws Exception {
        final IDGenerateDAO dao = new IDGenerateDAO();
        final HashMap where = new HashMap();
        where.put(CommonConstants.MAP_WHERE, "INWARD_NO");  
    ...
    private void updateData(HashMap map) throws Exception {
        try {
            sqlMap.startTransaction();
            sqlMap.executeUpdate("updateInwardTO", objTO);
//            logTO.setData(objTO.toString());
//            logTO.setPrimaryKey(objTO.getKeyData());
//            logTO.setStatus(objTO.getStatus());
//            logDAO.addToLog(logTO);
    ...
    private void deleteData() throws Exception {
        try {
            ...
            sqlMap.executeUpdate("deleteInwardTO", objTO);
//            logTO.setData(objTO.toString());
//            logTO.setPrimaryKey(objTO.getKeyData());
//            logTO.setStatus(objTO.getStatus());
//            logDAO.addToLog(logTO);
    ...
    public HashMap execute(HashMap map) throws Exception {
        ...
        logDAO = new LogDAO();
        logTO = new LogTO();
        objTO = (InwardRegisterTO) map.get("InwardRegister");
        //objTO.setBranCode(_branchCode);
        final String command = CommonUtil.convertObjToStr(map.get("COMMAND"));
        if (command.equals(CommonConstants.TOSTATUS_INSERT)) {
            insertData(map);
            returnMap.put("INWARD_NO", objTO.getInwardNo());
