...
/**
 * PaddyLocalityMaster DAO.
 *
 */
public class PaddyLocalityMasterDAO extends TTDAO {

    private static SqlMap sqlMap = null;
    private PaddyLocalityMasterTO objTO;
    ...
    /**
     * Creates a new instance of PaddyLocalityMasterDAO
     */
    public PaddyLocalityMasterDAO() throws ServiceLocatorException {
    ...
    private HashMap getData(HashMap map) throws Exception {
        ...
        List list = (List) sqlMap.executeQueryForList("getSelectPaddyLocalityMasterTO", where);
        returnMap.put("PaddyLocalityMasterTO", list);
        return returnMap;
    }
    ...
    private void insertData() throws Exception {
        try {
            ...
            sqlMap.executeUpdate("insertPaddyLocalityMasterTO", objTO);
    ...
    private void updateData() throws Exception {
        try {
            ...
            objTO.setStatusBy(userID);
            objTO.setStatusDt(currDt);
            sqlMap.executeUpdate("updatePaddyLocalityMasterTO", objTO);
            sqlMap.commitTransaction();
        } catch (SQLException e) {
            sqlMap.rollbackTransaction();
            e.printStackTrace();
    ...
    private void deleteData() throws Exception {
        try {
            ...
            objTO.setStatusBy(userID);
            objTO.setStatusDt(currDt);
            sqlMap.executeUpdate("deletePaddyLocalityMasterTO", objTO);
            sqlMap.commitTransaction();
        } catch (SQLException e) {
            sqlMap.rollbackTransaction();
            e.printStackTrace();
    ...
    public static void main(String str[]) {
        try {
            PaddyLocalityMasterDAO dao = new PaddyLocalityMasterDAO();
        } catch (Exception ex) {
            ex.printStackTrace();
        }
    }
    ...
    public HashMap execute(HashMap map) throws Exception {
        objTO = (PaddyLocalityMasterTO) map.get("PaddyLocalityMasterTO");
    ...
    public HashMap executeQuery(HashMap condition) throws Exception {
        ...
        if (!condition.containsKey("AUTH_DATA")) {
            ...
            getLocalityMasterData();
            makeNull();
        } else if (condition.containsKey("AUTH_DATA")) {
            System.out.println("@#$@#$@#$condition:" + condition);
            sqlMap.executeUpdate("authorizeLocalityMaster", condition);
        }
        return data;
    ...
    private void getLocalityMasterData() throws Exception {
        ...
        System.out.println("#@$@#$whereConditions:" + whereConditions);
        List list = (List) sqlMap.executeQueryForList("getSelectPaddyLocalityMasterTO", whereConditions);
        System.out.println("@#$@#$@#4list :" + list);
        PaddyLocalityMasterTO objPaddyLocalityMasterTO = new PaddyLocalityMasterTO();
        if (list.size() > 0) {
            objPaddyLocalityMasterTO = (PaddyLocalityMasterTO) list.get(0);
            data.put("PaddyLocalityMasterTO", objPaddyLocalityMasterTO);
        }
