 ...
 */
package com.see.truetransact.serverside.visitorsdiary;
 ...
 *
 */
public class VisitorsDAO extends TTDAO {

    private static SqlMap sqlMap = null;
    private VisitorsDiaryTO objTO;
    private LogDAO logDAO;
    private LogTO logTO;
    private final static Logger log = Logger.getLogger(VisitorsDAO.class);
    private Date currDt = null;
    /**
     * Creates a new instance of TokenConfigDAO
     */
    public VisitorsDAO() throws ServiceLocatorException {
    ...
    private void insertData(HashMap map) throws Exception {
        try {
            ...
            objTO.setVisitorsid(getVisitorsID());
            sqlMap.executeUpdate("insertVisitorsTO", objTO);
...
//            logDAO.addToLog(logTO);
    ...
    private String getVisitorsID() throws Exception {
        ...
        where.put(CommonConstants.MAP_WHERE, "VISIT_ID");
...
//            logDAO.addToLog(logTO);
    ...
    public HashMap execute(HashMap map) throws Exception {
        ...
        logDAO = new LogDAO();
        logTO = new LogTO();
        objTO = (VisitorsDiaryTO) map.get("VisitorsDiary");
        objTO.setBranCode(_branchCode);
        final String command = CommonUtil.convertObjToStr(map.get("COMMAND"));
        if (command.equals(CommonConstants.TOSTATUS_INSERT)) {
            insertData(map);
            returnMap.put("VISIT_ID", objTO.getVisitorsid());
