 ...
 */
package com.see.truetransact.serverside.termloan.personalSuretyConfiguration.servicewise;
 ...
 *
 */
public class ServiceWiseLoanAmountDAO extends TTDAO {

    private static SqlMap sqlMap = null;
    private ServiceWiseLoanAmountTO objTO;
     ...
     */
    public ServiceWiseLoanAmountDAO() throws ServiceLocatorException {
    ...
    private HashMap getData(HashMap map) throws Exception {
        ...
        List list = (List) sqlMap.executeQueryForList("getSelectServicePersonal", where);
        returnMap.put("ServiceWiseLoanAmountTO", list);

        List prodList = (List) sqlMap.executeQueryForList("getSelectServiceProdIdDesc", where);
    ...
    private String getIMBPID() throws Exception {
        ...
        System.out.println("MAP IN DAOOOOOO!!!11111==========" + map);
        //   System.out.println("MAP IN DAOOOOOO222222222=========="+map.get(CommonConstants.DATA));
        return (String) map.get(CommonConstants.DATA);
        //  return (String) (dao.executeQuery(where)).get(CommonConstants.DATA);
    }
    /*
     * private String getGeneralBoadyID() throws Exception{ // final
     * IDGenerateDAO dao = new IDGenerateDAO(); final HashMap where = new
     * HashMap(); where.put(CommonConstants.MAP_WHERE, "PSCID"); // return "";
     * HashMap map=generateID(); //System.out.println("MAP IN
     * DAOOOOOO=========="+map); return (String) map.get(CommonConstants.DATA);
     * // return (String) (dao.executeQuery(where)).get(CommonConstants.DATA); }
     */

    public HashMap generateIMBPID() {

        System.out.println("jkkjbjddsdsaaaaeeee");
        HashMap hash = null, result = null;
        try {
            System.out.println("jkkjbjddsdsaaaaeeee222222");
            ...
            if (list.size() > 0) {
                ...
                System.out.println("resultmappppp>>>>>>!!!!!1111>>>>>>>" + genID);
    ...
    private void insertData() throws Exception {
        try {
            sqlMap.startTransaction();
            /*
             * if(objTO.getPan()==1){ System.out.println("MYYYY
             * IIIDDDD"+getGeneralBoadyID());
            ...
            //  {
            objTO.setStatus(CommonConstants.STATUS_CREATED);
            //    System.out.println("mapppppp!!!!!3333333>>>>@@"+map);
            objTO.setGbid(getIMBPID());
            sqlMap.executeUpdate("insertEmpServiceWiseLoanElg", objTO);
            ...
            for (int i = 0; i < Selected.size(); i++) {
                ...
                ServiceWiseLoanAmountTO personalTO = new ServiceWiseLoanAmountTO();
                ...
                sqlMap.executeUpdate("insertEmpServiceWiseLoanElgProd", personalTO);
    ...
    private void updateData() throws Exception {
        try {
            ...
            //  logTO.setPrimaryKey(objTO.getKeyData());
            // logTO.setStatus(objTO.getCommand());
            System.out.println("in daoo" + objTO.getGbid());
            sqlMap.executeUpdate("updateServicePersonalTO", objTO);
            sqlMap.executeUpdate("deleteServicePersonalTO", objTO);
            List Selected = objTO.getSelectedList();
            System.out.println("selected list in DAO..." + Selected.size());
            for (int i = 0; i < Selected.size(); i++) {
                HashMap getMap = new HashMap();
    ...
    public static void main(String str[]) {
        try {
            ServiceWiseLoanAmountDAO dao = new ServiceWiseLoanAmountDAO();
        } catch (Exception ex) {
            ex.printStackTrace();
        }
    }
    ...
    public HashMap execute(HashMap map) throws Exception {
        ...
        objTO = (ServiceWiseLoanAmountTO) map.get("ServiceWiseLoanAmountTO");
        final String command = objTO.getCommand();
        HashMap returnMap = null;
        System.out.println("mapppppp!!!!!1111>>>>@@" + map);
        ////  logDAO = new LogDAO();
        //  logTO = new LogTO();
        ...
        if (command.equals(CommonConstants.TOSTATUS_INSERT)) {
            System.out.println("mapppppp!!!!!222222>>>>@@" + map);
            insertData();
            returnMap = new HashMap();
            System.out.println("objTO.getGbid()>>>>@@" + objTO.getGbid());
            returnMap.put("ID_NO", objTO.getGbid());
