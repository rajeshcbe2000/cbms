 ...
 */
package com.see.truetransact.serverside.termloan.kcc;
 ...
 *
 */
public class KCCRenewalDAO extends TTDAO {
...
//    private LinkedHashMap deletedCaseDetailMap = null;
     ...
     */
    public KCCRenewalDAO() throws ServiceLocatorException {
    ...
    private void executeSalaryDetailsQuery() throws Exception {
       ...
       if (termLoanSecuritySalaryTODeletedMap != null && termLoanSecuritySalaryTODeletedMap.size() > 0) {
            ...
            for (int i = 0; i < keyset.size(); i++) {
                ...
                getActNoMap.put("ACCT_NUM", objTermLoanSecuritySalaryTO.getAcctNum());
        ...
        if (termLoanSecuritySalaryTOMap != null && termLoanSecuritySalaryTOMap.size() > 0) {
            ...
            for (int i = 0; i < keyset.size(); i++) {
                ...
                executeUpdate("insertTermLoanSecuritySalaryTO", objTermLoanSecuritySalaryTO);
                     ...
                     objTermLoanSecuritySalaryTO.setStatus("MODIFIED");  
                     objTermLoanSecuritySalaryTO.setStatusBy(userId);
                     objTermLoanSecuritySalaryTO.setStatusDt(curr_dt);
...
//        List lst = (List) sqlMap.executeQueryForList("getNextActNumForLoan", where);
    ...
    private void updateData(HashMap map) throws Exception {
        try {
            ...
            String loanNo = CommonUtil.convertObjToStr(map.get("ACCT_NUM"));
...
//            updateVehicleTableDetails();
            ...
            if (map.containsKey("CUST_GOLD_SECURITY_STOCK") && map.get("CUST_GOLD_SECURITY_STOCK") != null && objCustomerGoldStockSecurityTO != null && objCustomerGoldStockSecurityTO.getPledgeAmount() > 0) { // Added by nithya on 07-03-2020 for KD-1379
                ...
                objCustomerGoldStockSecurityTO.setAuthorizedStatus("AUTHORIZED");
                objCustomerGoldStockSecurityTO.setAuthorizedBy(userId);
                objCustomerGoldStockSecurityTO.setAuthorizedDt(curr_dt);
                sqlMap.executeUpdate("insertLoansSecurityGoldStockTO", objCustomerGoldStockSecurityTO);
                HashMap goldUpdateMap = (HashMap)map.get("GOLD_UPDATE_MAP");
                goldUpdateMap.put("ACCT_NUM",objCustomerGoldStockSecurityTO.getAcctNum());
                goldUpdateMap.put("VALUE_OF_GOLD", CommonUtil.convertObjToDouble(goldUpdateMap.get("VALUE_OF_GOLD")));
                sqlMap.executeUpdate("updateTermLoanGoldSecurityForKCC", goldUpdateMap);
            }else if (map.containsKey("GOLD_LOAN_SECURITY") && map.get("GOLD_LOAN_SECURITY") != null) {
                GoldLoanSecurityTO objGoldLoanSecurityTO = (GoldLoanSecurityTO) (map.get("GOLD_LOAN_SECURITY"));
                HashMap updatemap = new HashMap();                  
                updatemap.put("IS_RELEASE","Y");
                updatemap.put("RELEASE_DT",curr_dt.clone());
                updatemap.put("ACCT_NUM",objGoldLoanSecurityTO.getAcctNum());
                sqlMap.executeUpdate("updateGoldReleaseStatusForKCC", updatemap);
                objGoldLoanSecurityTO.setStatus("CREATED");
                objGoldLoanSecurityTO.setStatusBy(userId);
                objGoldLoanSecurityTO.setStatusDt(curr_dt);
                objGoldLoanSecurityTO.setAuthorizeStatus("AUTHORIZED");
                objGoldLoanSecurityTO.setAuthorizeBy(userId);
                objGoldLoanSecurityTO.setAuthorizeDt(curr_dt);
                sqlMap.executeUpdate("insertGoldLoanSecurityTO", objGoldLoanSecurityTO);               
                updatemap.put("GOLD_REMARKS", map.get("GOLD_REMARKS"));
                updatemap.put("GROSS_WEIGHT", objGoldLoanSecurityTO.getGrossWeight());
                updatemap.put("NET_WEIGHT", objGoldLoanSecurityTO.getNetWeight());
                updatemap.put("VALUE_OF_GOLD", CommonUtil.convertObjToDouble(objGoldLoanSecurityTO.getSecurityValue()));
                updatemap.put("JEWELLERY_DETAILS", objGoldLoanSecurityTO.getParticulars());
                sqlMap.executeUpdate("updateTermLoanGoldSecurityForKCC", updatemap);
            }
           updateCollateralTableDetails();
           updateDepositTypeDetails(loanNo);
           executeSalaryDetailsQuery();
//            updateLosTypeDetails();
//            editTransaction(transMap);
//             //kcc details insertion
//            System.out.println("kccTo####"+kccTo);
            if (map.containsKey("RENEWAL_OD_KCC") && map.get("RENEWAL_OD_KCC") != null && CommonUtil.convertObjToStr(map.get("RENEWAL_OD_KCC")).equalsIgnoreCase("RENEWAL_OD_KCC")) {
                if (kccTo != null && kccTo.getActNum().length() > 0) {
                    HashMap updatemap = new HashMap();
                    updatemap.put("BORROW_NO", map.get("BORROWER_NO"));
                    updatemap.put("ACCT_NUM", map.get("ACCT_NUM"));
                    updatemap.put("FROM_DT", kccTo.getFromDt());
                    updatemap.put("TO_DT", kccTo.getToDt());
                    updatemap.put("LIMIT", kccTo.getLimit());
                    sqlMap.executeUpdate("insertLoansRenewalSanctionDetails", updatemap);
                    sqlMap.executeUpdate("insertLoansRenewalFacilityDetails", updatemap);
                    sqlMap.executeUpdate("updateTermLoanSanctionDataForKCC", updatemap);
                    sqlMap.executeUpdate("updateAcctAvailableBalForKCCRenewal", updatemap);      // Added by nithya on 31-08-2018 for KD 219 - Need kcc renewal sanction amount changing facility  
...
//        cashAuthMap.put("DAILY", "DAILY");
    ...
    public HashMap execute(HashMap map) throws Exception {
        ...
        System.out.print("inside KCCRenewalDAO termloandao#######" + map);
        ...
        if(map.containsKey("CUST_GOLD_SECURITY_STOCK") && map.get("CUST_GOLD_SECURITY_STOCK") != null && map.get("CUST_GOLD_SECURITY_STOCK").equals("CUST_GOLD_SECURITY_STOCK")){ // Added by nithya on 07-03-2020 for KD-1379
        ...
        try{
        List acctLst = sqlMap.executeQueryForList("getKCCAccountNoDetails", map);
        if(acctLst != null && acctLst.size() > 0){
            HashMap acctMap = (HashMap)acctLst.get(0);
            String kccRenewalTrans = CommonUtil.convertObjToStr(acctMap.get("KCC_RENEWAL_TRANSACTION"));
            double acctBal = CommonUtil.convertObjToDouble(acctMap.get("BAL"));
            double limit = CommonUtil.convertObjToDouble(acctMap.get("LIMIT"));
            if(kccRenewalTrans.equals("Y") && acctBal == 0 && limit == kccTo.getLimit()){
                renewalTransactionPart(map);
            }
        }
        }catch(Exception e){
        ...
        updateData(map);
        if (map.containsKey("CHARGE_LIST_DATA")) { //Added By Kannan AR
            chargeLst = (List) map.get("CHARGE_LIST_DATA");
            System.out.println("@##$#$% CHARGE_LIST_DATA #### :" + chargeLst);
            if (chargeLst != null && chargeLst.size() > 0) {
                chargesTransactionPart(map);
            }
        }
        destroyObjects();
        if (returnMap.size() > 0) {
    ...
    private void renewalTransactionPart(HashMap dataMap) throws Exception {
        ...
        String screenName = CommonUtil.convertObjToStr(dataMap.get(CommonConstants.SCREEN));
        int count = 0;
           try {
            TxTransferTO transferTo = new TxTransferTO();
            ...
            String narration = "";
                ...
                List acctHeadList = null;
                acctHeadMap.put("PROD_ID", CommonUtil.convertObjToStr(dataMap.get("PROD_ID")));              
                acctHeadList = sqlMap.executeQueryForList("getKoleFieldKCCChargesHead", acctHeadMap);                
                if (acctHeadList != null && acctHeadList.size() > 0) {
                        acctHeadMap = (HashMap) acctHeadList.get(0);
                        accHead =  CommonUtil.convertObjToStr(acctHeadMap.get("ACCT_HEAD"));
                }
                transAmt = CommonUtil.convertObjToDouble(kccTo.getLimit());      
                txMap = new HashMap();
                txMap.put(TransferTrans.CR_AC_HD, accHead);
                txMap.put(TransferTrans.CR_PROD_TYPE, TransactionFactory.ADVANCES); 
                txMap.put("TRANS_MOD_TYPE",  TransactionFactory.ADVANCES);             
                txMap.put(TransferTrans.CR_PROD_ID, kccTo.getProductId());
                txMap.put(TransferTrans.CR_ACT_NUM, kccTo.getActNum());                                
                txMap.put("SCREEN_NAME" ,screenName);
                txMap.put(TransferTrans.CR_BRANCH, _branchCode);
                txMap.put("INITIATED_BRANCH", _branchCode);
                txMap.put(TransferTrans.CURRENCY, "INR");
                txMap.put(CommonConstants.USER_ID, CommonUtil.convertObjToStr(dataMap.get("USER_ID")));
                txMap.put("LINK_BATCH_ID", kccTo.getActNum());
                txMap.put(TransferTrans.PARTICULARS, kccTo.getActNum());
                ...
                txMap.put(TransferTrans.DR_PROD_TYPE, TransactionFactory.ADVANCES); 
                txMap.put("TRANS_MOD_TYPE",  TransactionFactory.ADVANCES);             
                txMap.put(TransferTrans.DR_PROD_ID, kccTo.getProductId());
                txMap.put(TransferTrans.DR_ACT_NUM, kccTo.getActNum());                                
                txMap.put("SCREEN_NAME" ,screenName);
                txMap.put(TransferTrans.DR_BRANCH, _branchCode);
                txMap.put("INITIATED_BRANCH", _branchCode);
                txMap.put(TransferTrans.CURRENCY, "INR");
                ...
                System.out.println("transferList in kcc renewal dao :: " + transferList);
               ...
               if (transferList != null && transferList.size() > 0) {
                   ...
                   data.put(CommonConstants.SCREEN, screenName);
  ...
  private String getServiceTaxNo() throws Exception {
    ...
    public static void main(String[] arg) {
        try {
            ...
            new KCCRenewalDAO().executeQuery(data);
            data = null;
        } catch (Exception e) {
