 ...
 */
package com.see.truetransact.serverside.termloan.kcc.multiplerenewal;
 ...
 *
 */
public class KCCMultipleRenewalDAO extends TTDAO {
...
//    private LinkedHashMap deletedCaseDetailMap = null;
     ...
     */
    public KCCMultipleRenewalDAO() throws ServiceLocatorException {
...
//        cashAuthMap.put("DAILY", "DAILY");
    ...
    public HashMap execute(HashMap map) throws Exception {
        ...
        System.out.print("inside KCCmultipleRenewalDAO termloandao#######" + map);
        ...
        if (map.containsKey("KccRenewalTO")) {
            kccToList = (List) map.get("KccRenewalTO");
        }   
        if(map.containsKey("KCC_MULTIPLE_RENEWAL")){
            updateData(map);
        }
        
        if(map.containsKey("KCC_RENEWAL_RISKFUND_PROCESS")){
         if(map.containsKey("KCC_RISK_FUND_LIST") && map.get("KCC_RISK_FUND_LIST") != null){
             riskFundList = (List)map.get("KCC_RISK_FUND_LIST");
             if(riskFundList != null && riskFundList.size() > 0){
                 HashMap transReturnMap = riskFundTransactionPart(map);
             }
         }   
        }
        destroyObjects();
