 ...
 * @author shanmugavel
 */
public class FileManagementBean implements SessionBean, TTDAOImpl {
    ...
    public HashMap execute(HashMap obj) throws Exception {
        FileManagementDAO daoFileManagement = new FileManagementDAO();
        return daoFileManagement.execute(obj);
        //daoTermLoan = null;
    }

    public HashMap executeQuery(HashMap obj) throws Exception {
        FileManagementDAO daoFileManagement = new FileManagementDAO();
        return daoFileManagement.executeQuery(obj);
    }
}
