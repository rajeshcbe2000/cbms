 ...
 * @author Sunil (152691)
 */
public class ContraHeadCheckTask extends Task {
    ...
    /**
     * Creates a new instance of ContraHeadChechTask
     */
    public ContraHeadCheckTask(TaskHeader header) throws Exception {
        setHeader(header);
    ...
    public TaskStatus executeTask() throws Exception {
        ...
        if (sqlMap.executeQueryForList("getContraDiff", paramMap).size() > 0) {
    ...
    public static void main(String args[]) {
        try {
            ...
            header.setTaskClass("ContraHeadChechTask");
            HashMap paramMap = new HashMap();
            header.setBranchID("BRAN");
            header.setTaskParam(paramMap);
            ContraHeadCheckTask ft = new ContraHeadCheckTask(header);
