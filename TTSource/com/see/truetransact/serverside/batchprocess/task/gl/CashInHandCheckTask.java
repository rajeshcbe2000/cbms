 ...
 * @author Sunil (152691)
 */
public class CashInHandCheckTask extends Task {
    ...
    /**
     * Creates a new instance of CashInHandCheckTask
     */
    public CashInHandCheckTask(TaskHeader header) throws Exception {
        setHeader(header);
    ...
    public TaskStatus executeTask() throws Exception {
        ...
        if (sqlMap.executeQueryForList("getCashInHand", paramMap).size() > 0) {
    ...
    public static void main(String args[]) {
        try {
            ...
            header.setTaskClass("CashInHandCheckTask");
            HashMap paramMap = new HashMap();
            header.setBranchID("BRAN");
            header.setTaskParam(paramMap);
            CashInHandCheckTask ft = new CashInHandCheckTask(header);
