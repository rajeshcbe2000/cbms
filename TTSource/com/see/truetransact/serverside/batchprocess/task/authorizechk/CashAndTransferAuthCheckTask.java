 ...
 * @author Sunil (152691)
 */
public class CashAndTransferAuthCheckTask extends Task {
     ...
     */
    public CashAndTransferAuthCheckTask(TaskHeader header) throws Exception {
        setHeader(header);
    ...
    public TaskStatus executeTask() throws Exception {
        ...
        if (sqlMap.executeQueryForList("CashAndTransferAuth_view", map).size() > 0) {
