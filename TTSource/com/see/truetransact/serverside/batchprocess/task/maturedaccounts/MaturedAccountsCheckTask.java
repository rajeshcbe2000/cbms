 ...
 * 
 * MaturedAccountsCheckTask.java
 *
 * Created on February 28, 2005, 12:23 PM
 */
package com.see.truetransact.serverside.batchprocess.task.maturedaccounts;
 ...
 */
public class MaturedAccountsCheckTask extends Task {
    ...
    public MaturedAccountsCheckTask(TaskHeader header) throws Exception {
        setHeader(header);
    ...
    public TaskStatus executeTask() throws Exception {
        ...
        System.out.println("paramMap@@" + paramMap);
        lst = sqlMap.executeQueryForList("getMaturedAccounts", paramMap);
