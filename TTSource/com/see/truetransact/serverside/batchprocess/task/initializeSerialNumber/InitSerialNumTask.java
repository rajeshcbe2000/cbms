 ...
 * 
 * InitSerialNumTask.java
 *
 * Created on November 30, 2009, 5:23 PM
 */
package com.see.truetransact.serverside.batchprocess.task.initializeSerialNumber;
 ...
 */
public class InitSerialNumTask extends Task {

//    /** Creates a new instance of InitSerialNumTask */
//    public InitSerialNumTask() {
//    }
//    
//    /**
...
//    }
     ...
     * Creates a new instance of InitSerialNumTask
     */
    public InitSerialNumTask(TaskHeader header) throws Exception {
        setHeader(header);
        ...
        if (paramMap != null && paramMap.containsKey("CHK_INIT_SERIAL_NUM")) {
            taskLable = CommonUtil.convertObjToStr(paramMap.get("CHK_INIT_SERIAL_NUM"));
        }
    }
            ...
            for (int b = 0; b < branchList.size(); b++) {
                ...
                if (compLst.size() <= 0 || compStatus.equals("ERROR")) {
                    ...
                    try {
                        ...
                        presentTasks.append("'" + "TRANSFER.BATCH_ID" + "'"
                                + "," + "'" + "TRANSFER_TRANS_ID" + "'"
                                + "," + "'" + "INWARD_CLEARING" + "'"
                                + "," + "'" + "OUTWARD.BATCH_ID" + "'"
                                + "," + "'" + "CASH_TRANS_ID" + "'");
                        mapData.put("ID_KEY", presentTasks);
                        mapData.put("BRANCH_CODE", branch);
                        sqlMap.executeUpdate("updateIdGenerationDayBegin", mapData);
