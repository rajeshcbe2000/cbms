 ...
 */
package com.see.truetransact.serverside.transaction.token.tokenissue;
 ...
 *
 */
public class TokenIssueDAO extends TTDAO {

    private static SqlMap sqlMap = null;
    private TokenIssueTO objTO;
     ...
     */
    public TokenIssueDAO() throws ServiceLocatorException {
    ...
    private HashMap getData(HashMap map) throws Exception {
        ...
        List list = (List) sqlMap.executeQueryForList("getSelectTokenIssueTO", where);
        returnMap.put("TokenIssueTO", list);
        return returnMap;
    }
    ...
    private String getTokenIssueId() throws Exception {
        ...
        where.put(CommonConstants.MAP_WHERE, "TOKEN_ISSUE_ID");
    ...
    private void insertData() throws Exception {
        try {
            ...
            sqlMap.executeUpdate("insertTokenIssueTO", objTO);
    ...
    private void updateData() throws Exception {
        try {
            ...
            logTO.setPrimaryKey(objTO.getKeyData());
            logTO.setStatus(objTO.getCommand());
            sqlMap.executeUpdate("updateTokenIssueTO", objTO);
            logDAO.addToLog(logTO);
            sqlMap.commitTransaction();
        } catch (Exception e) {
            sqlMap.rollbackTransaction();
    ...
    private void deleteData() throws Exception {
        try {
            ...
            logTO.setPrimaryKey(objTO.getKeyData());
            logTO.setStatus(objTO.getCommand());
            sqlMap.executeUpdate("deleteTokenIssueTO", objTO);
            logDAO.addToLog(logTO);
            sqlMap.commitTransaction();
        } catch (Exception e) {
            sqlMap.rollbackTransaction();
    ...
    public static void main(String str[]) {
        try {
            TokenIssueDAO dao = new TokenIssueDAO();
        } catch (Exception ex) {
            ex.printStackTrace();
        }
    }
    ...
    public HashMap execute(HashMap map) throws Exception {
        ...
        objTO = (TokenIssueTO) map.get("TokenIssueTO");
