 ...
 */
package com.see.truetransact.serverside.transaction.balance;

import com.see.truetransact.serverside.termloan.personalSuretyConfiguration.*;
...
import com.see.truetransact.transferobject.transaction.balance.BalanceTO;
 ...
 *
 */
public class BalanceDAO extends TTDAO {

    private static SqlMap sqlMap = null;
    private BalanceTO objTO;
     ...
     */
    public BalanceDAO() throws ServiceLocatorException {
        ...
        try {
            ...
            if (objTO.getPan() == 2) {
                ...
                for (int i = 0; i < Selected.size(); i++) {
                    ...
                    BalanceTO personalTO = new BalanceTO();
...
//        objTO = (BalanceTO) map.get("PersonalSuretyConfigurationTO");
