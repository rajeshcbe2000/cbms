 ...
 */
package com.see.truetransact.serverside.staffworkdiary;
 ...
 *
 */
public class StaffWorkDiaryDAO extends TTDAO {

    private static SqlMap sqlMap = null;
    private StaffWorkDiaryTO objTO;
     ...
     */
    public StaffWorkDiaryDAO() throws ServiceLocatorException {
    ...
    private HashMap getData(HashMap map) throws Exception {
        ...
        List list = (List) sqlMap.executeQueryForList("StaffWorkDiary.getSelectStaffWorkDiary", where);
        returnMap.put("StaffWorkDiaryTO", list);
        return returnMap;
    }
    ...
    public HashMap generateID() {
        ...
        try {
            ...
            where.put("ID_KEY", "SWDID"); //Here u have to pass BORROW_ID or something else
            List list = null;
    ...
    private void insertData() throws Exception {
        try {
            ...
            sqlMap.executeUpdate("insertStaffWorkTO", objTO);
    ...
    private void updateData() throws Exception {
        try {
            ...
            //  logTO.setPrimaryKey(objTO.getKeyData());
            // logTO.setStatus(objTO.getCommand());
            sqlMap.executeUpdate("updateStaffWorkTO", objTO);
            //  logDAO.addToLog(logTO);
            sqlMap.commitTransaction();
        } catch (Exception e) {
            sqlMap.rollbackTransaction();
    ...
    private void deleteData() throws Exception {
        try {
            ...
            // logTO.setPrimaryKey(objTO.getKeyData());
            // logTO.setStatus(objTO.getCommand());
            sqlMap.executeUpdate("deleteStaffWorkTO", objTO);
            //   logDAO.addToLog(logTO);
            sqlMap.commitTransaction();
        } catch (Exception e) {
            sqlMap.rollbackTransaction();
    ...
    public static void main(String str[]) {
        try {
            StaffWorkDiaryDAO dao = new StaffWorkDiaryDAO();
        } catch (Exception ex) {
            ex.printStackTrace();
        }
    }
    ...
    public HashMap execute(HashMap map) throws Exception {
        ...
        objTO = (StaffWorkDiaryTO) map.get("StaffWorkDiaryTO");
