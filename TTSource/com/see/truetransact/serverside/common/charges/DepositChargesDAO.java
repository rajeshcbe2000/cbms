 ...
 * @modified
 */
public class DepositChargesDAO extends TTDAO {
    ...
    private LogTO logTO;
    private final static Logger log = Logger.getLogger(DepositChargesDAO.class);
     ...
     */
    public DepositChargesDAO() throws ServiceLocatorException {
    ...
    public HashMap execute(HashMap map) throws Exception {
        ...
        System.out.println("Map in DAO: Depositscharges in " + map);
    ...
    public static void main(String str[]) {
        try {
            DepositChargesDAO dao = new DepositChargesDAO();
