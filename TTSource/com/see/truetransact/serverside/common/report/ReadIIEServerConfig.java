 ...
 * @author 152684
 */
public class ReadIIEServerConfig {

    private com.see.iie.ui.IIEServerConfig iieServerConfig;

    /**
     * Creates a new instance of ReadIIEServerConfig
     */
    public ReadIIEServerConfig(com.see.iie.ui.IIEServerConfig iieServerConfig) {
...
//                    }
        ...
        strInputBuff.append(strTmpQuery);
        // top given number of rows will be returned
        strNoOfRows = dataSource.rowCount(noOfRows, "ORACLE", "END");
