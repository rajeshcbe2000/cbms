 ...
 */
package com.see.truetransact.serverside.generalbodydetails;
 ...
 *
 */
public class GeneralBodydetailsDAO extends TTDAO {

    private static SqlMap sqlMap = null;
    private GeneralBodyDetailsTO objTO;
     ...
     */
    public GeneralBodydetailsDAO() throws ServiceLocatorException {
    ...
    private HashMap getData(HashMap map) throws Exception {
        ...
        List list = (List) sqlMap.executeQueryForList("GeneralBody.getSelectGeneralBody", where);
        returnMap.put("GeneralBodyDetailsTO", list);
        return returnMap;
    }
    ...
    public HashMap generateID() {
        ...
        try {
            ...
            where.put("ID_KEY", "GBID"); //Here u have to pass BORROW_ID or something else
            List list = null;
            ...
            if (list.size() > 0) {
                ...
                if (hash.containsKey("ID_LENGTH")) {
                    ...
                    strLen = CommonUtil.convertObjToStr(hash.get("ID_LENGTH"));
    ...
    private void insertData() throws Exception {
        try {
            ...
            sqlMap.executeUpdate("insertGeneralBodyTO", objTO);
    ...
    private void updateData() throws Exception {
        try {
            ...
            //  logTO.setPrimaryKey(objTO.getKeyData());
            // logTO.setStatus(objTO.getCommand());
            sqlMap.executeUpdate("updateGeneralBodyTO", objTO);
            //  logDAO.addToLog(logTO);
            sqlMap.commitTransaction();
        } catch (Exception e) {
            sqlMap.rollbackTransaction();
    ...
    public static void main(String str[]) {
        try {
            GeneralBodydetailsDAO dao = new GeneralBodydetailsDAO();
        } catch (Exception ex) {
            ex.printStackTrace();
        }
    }
    ...
    public HashMap execute(HashMap map) throws Exception {
        ...
        objTO = (GeneralBodyDetailsTO) map.get("GeneralBodyDetailsTO");
