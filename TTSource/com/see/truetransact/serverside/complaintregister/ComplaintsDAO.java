 ...
 */
package com.see.truetransact.serverside.complaintregister;
 ...
 *
 */
public class ComplaintsDAO extends TTDAO {

    private static SqlMap sqlMap = null;
    private ComplaintsTO objTO;
    private LogDAO logDAO;
    private LogTO logTO;
    private final static Logger log = Logger.getLogger(ComplaintsDAO.class);

    /**
     * Creates a new instance of TokenConfigDAO
     */
    public ComplaintsDAO() throws ServiceLocatorException {
    ...
    private HashMap getData(HashMap map) throws Exception {
        ...
        List list = (List) sqlMap.executeQueryForList("getSelectVisitorsTO", map);
        returnMap.put("VisitorsTO", list);
        return returnMap;
    }
    ...
    private void insertData(HashMap map) throws Exception {
        try {
            ...
            objTO.setComplaintid(getVisitorsID());
            sqlMap.executeUpdate("insertComplaintTO", objTO);
...
//            logDAO.addToLog(logTO);
    ...
    private String getVisitorsID() throws Exception {
        final IDGenerateDAO dao = new IDGenerateDAO();
        final HashMap where = new HashMap();
        where.put(CommonConstants.MAP_WHERE, "COMPL_REG");
...
//        try{
//            sqlMap.startTransaction();
//            sqlMap.executeUpdate("updateVisitorsTO",objTO);
////            logTO.setData(objTO.toString());
////            logTO.setPrimaryKey(objTO.getKeyData());
////            logTO.setStatus(objTO.getStatus());
////            logDAO.addToLog(logTO);
...
//            sqlMap.executeUpdate("deleteVisitorsTO",objTO);
////            logTO.setData(objTO.toString());
////            logTO.setPrimaryKey(objTO.getKeyData());
////            logTO.setStatus(objTO.getStatus());
////            logDAO.addToLog(logTO);
...
//    }
    ...
    public HashMap execute(HashMap map) throws Exception {
        ...
        logDAO = new LogDAO();
        logTO = new LogTO();
        objTO = (ComplaintsTO) map.get("ComplaintRegister");
        objTO.setBranCode(_branchCode);
        final String command = CommonUtil.convertObjToStr(map.get("COMMAND"));
        if (command.equals(CommonConstants.TOSTATUS_INSERT)) {
            insertData(map);
            returnMap.put("COMPLAIN_ID", objTO.getComplaintid());
