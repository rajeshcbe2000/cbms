 ...
 * @author swaroop
 */
public class EmployeeTrainingBean implements SessionBean, TTDAOImpl {

    private EmployeeTrainingDAO empTrainingDAO;

    public void ejbCreate() throws CreateException, ServiceLocatorException {
        empTrainingDAO = new EmployeeTrainingDAO();
    }
