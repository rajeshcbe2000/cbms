 ...
 * @author swaroop
 */
public class LeaveSurrenderBean implements SessionBean, TTDAOImpl {

    private LeaveSurrenderDAO pfInterestApplicationDAO;

    public void ejbCreate() throws CreateException, ServiceLocatorException {
        pfInterestApplicationDAO = new LeaveSurrenderDAO();
    }
