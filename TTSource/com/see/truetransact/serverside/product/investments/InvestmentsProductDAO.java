 ...
 */
package com.see.truetransact.serverside.product.investments;
 ...
 *
 */
public class InvestmentsProductDAO extends TTDAO {

    private static SqlMap sqlMap = null;
    private InvestmentsProductTO objTO;
     ...
     */
    public InvestmentsProductDAO() throws ServiceLocatorException {
    ...
    private HashMap getInvestmentProductData() throws Exception {
        ...
        List list = (List) sqlMap.executeQueryForList("getSelectInvestmentProductTO", where);
        returnMap.put("InvestmentsProductTO", list);
        list = null;
        return returnMap;
    }
...
//    }
    ...
    private void insertData() throws Exception {
        ...
        sqlMap.executeUpdate("insertInvestmentProductTO", objTO);
//        addLoanData();
    }
    ...
    private void updateData() throws Exception {
        ...
        logTO.setStatus(objTO.getCommand());
        logDAO.addToLog(logTO);
        sqlMap.executeUpdate("updateInvestmentProductTO", objTO);
//        addLoanData();
    }
    ...
    private void deleteData() throws Exception {
        ...
        logTO.setStatus(objTO.getCommand());
        logDAO.addToLog(logTO);
        sqlMap.executeUpdate("deleteInvestmentProductTO", objTO);
//        addLoanData();
    }

    public static void main(String str[]) {
        try {
            InvestmentsProductDAO dao = new InvestmentsProductDAO();
        } catch (Exception ex) {
        }
    }
    ...
    public HashMap execute(HashMap map) throws Exception {
        ...
        try {
            ...
            objTO = (InvestmentsProductTO) map.get("InvestmentsProductTO");
...
//        HashMap shareLoanMap = getShareProductLoanData();
        ...
        data.put("InvestmentProductTO", investmentMap);
