 ...
 * @author Balachandar
 */
public class MDSTypeBean implements SessionBean, TTDAOImpl {

    MDSTypeDAO mdsTypeDAO = null;

    public void ejbCreate() throws CreateException, ServiceLocatorException {
        mdsTypeDAO = new MDSTypeDAO();
    }
    ...
    public HashMap execute(HashMap obj) throws Exception {
        return mdsTypeDAO.execute(obj);
    }

    public HashMap executeQuery(HashMap obj) throws Exception {
        return mdsTypeDAO.executeQuery(obj);
    }
}
