...
public class CButtonBeanInfo extends java.beans.SimpleBeanInfo {
     private Image icon;
     /** Creates a new instance of CButtonBeanInfo & load the Icon to display */
    public CButtonBeanInfo() {
        icon = loadImage("/com/see/truetransact/uicomponent/images/CButtonColor16.gif");
    }
