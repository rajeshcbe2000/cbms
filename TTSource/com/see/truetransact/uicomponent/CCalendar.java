 ...
 */
public class CCalendar extends JDialog {
    ...
    private Color dateColor = new Color(255, 255, 255);
...
//    private boolean backDatedAllowed = false;
    ...
    /**
     * CCalendar constructor comment.
     * @param title java.lang.String
     */
    public CCalendar(String title) {
        super();
    }
     ...
     * CCalendar constructor comment.
     */
    public CCalendar(JTextField dateFld) {
        this(dateFld, true);
    }
     ...
     * CCalendar constructor comment.
     */
    public CCalendar(JTextField dateFld, boolean isBranchDate) {
...
//            JMenuItem btns = new JMenuItem(sk);
            JLabel btns = new JLabel(sk);
//            JButton btns = new JButton(sk);
//            btns.setMargin(new Insets(0, 0, 0, 0));
            ...
            btns.setOpaque(true);
//            btns.setBackground(dateColor);
//            btns.setForeground(selectedBorder);
            btns.setFont(new java.awt.Font("Arial", 0, 11));
//            btns.setBorder(null);
...
//            }
            ...
            btns.addMouseListener(new ButtonEventHandler());
...
//    }
    ...
    public void getDate(java.awt.event.MouseEvent actionEvent) {
        this.dispose();
        String strDt = "";
        strDt = (getMonth().getSelectedIndex() + 1) + "/" + ((JLabel)actionEvent.getSource()).getText() + "/" + getYear().getText();
    ...
    private javax.swing.JPanel getJFrameContentPane() {
        if (ivjJFrameContentPane == null) {
            try {
                ...
                getJFrameContentPane().add(getCCalendarPane(), "Center");
    ...
    private javax.swing.JLabel getJLabel11() {
        if (ivjJLabel11 == null) {
            try {
                ...
                ivjJLabel11.setFont(new java.awt.Font("Arial", 0, 11));
    ...
    private javax.swing.JLabel getStatusMsg1() {
        if (ivjStatusMsg1 == null) {
            try {
                ...
                ivjStatusMsg1.setFont(new java.awt.Font("Arial", 0, 11));
            } catch (java.lang.Throwable ivjExc) {
                handleException(ivjExc);
            }
        }
    ...
    /**
     * Return the CCalendarPane property value.
     * @return javax.swing.JPanel
     */
    /* WARNING: THIS METHOD WILL BE REGENERATED. */
    private javax.swing.JPanel getCCalendarPane() {
        if (ivjCCalendarPane == null) {
            try {
                ivjCCalendarPane = new javax.swing.JPanel();
                ivjCCalendarPane.setName("CCalendarPane");
                ivjCCalendarPane.setLayout(new java.awt.BorderLayout());
                getCCalendarPane().add(getCalParam(), "North");
                getCCalendarPane().add(getCalendarPane(), "Center");
...
//        };
//    }
      class ButtonEventHandler implements java.awt.event.MouseListener {

        @Override
        public void mouseClicked(MouseEvent e) {
//            System.out.println("#$#$ inside mouseclicked:"+e);
            getDate(e);
        }
...
//        };
    ...
    class IvjEventHandler implements java.awt.event.ActionListener, java.awt.event.AdjustmentListener, java.awt.event.MouseListener {
        public void actionPerformed(java.awt.event.ActionEvent e) {
            if (e.getSource() == CCalendar.this.getPrevious())
                connEtoC1(e);
            if (e.getSource() == CCalendar.this.getNext())
                connEtoC2(e);
            if (e.getSource() == CCalendar.this.getMonth())
                connEtoC3(e);
            if (e.getSource() == CCalendar.this.getYear())
                connEtoC4(e);
            if (e.getSource() == CCalendar.this.getbtnPrevYear())
                connEtoC6(e);
            if (e.getSource() == CCalendar.this.getbtnNextYear())
                connEtoC7(e);
            if (e.getSource() == CCalendar.this.getJButtonClear())
                connEtoC8(e);
        };
        public void adjustmentValueChanged(java.awt.event.AdjustmentEvent e) {
            if (e.getSource() == CCalendar.this.getyearincrease())
                connEtoC5(e);
        };
        public void mouseClicked(java.awt.event.MouseEvent e) {
            if (e.getSource() == CCalendar.this.getJLabelTodayColor())
                connEtoC9(e);
            if (e.getSource() == CCalendar.this.getStatusMsg1())
                connEtoC10(e);
        };
    ...
    /**
     * connEtoC1:  (Previous.action.actionPerformed(java.awt.event.ActionEvent) --> CCalendar.previous_ActionPerformed(Ljava.awt.event.ActionEvent;)V)
    ...
    /**
     * connEtoC10:  (StatusMsg1.mouse.mouseClicked(java.awt.event.MouseEvent) --> CCalendar.statusMsg1_MouseClicked(Ljava.awt.event.MouseEvent;)V)
    ...
    /**
     * connEtoC2:  (Next.action.actionPerformed(java.awt.event.ActionEvent) --> CCalendar.next_ActionPerformed(Ljava.awt.event.ActionEvent;)V)
     * @param arg1 java.awt.event.ActionEvent
     */
    /* WARNING: THIS METHOD WILL BE REGENERATED. */
    ...
    /**
     * connEtoC3:  (Month.action.actionPerformed(java.awt.event.ActionEvent) --> CCalendar.month_ActionPerformed(Ljava.awt.event.ActionEvent;)V)
     * @param arg1 java.awt.event.ActionEvent
     */
    /* WARNING: THIS METHOD WILL BE REGENERATED. */
    ...
    /**
     * connEtoC4:  (Year.action.actionPerformed(java.awt.event.ActionEvent) --> CCalendar.year_ActionPerformed(Ljava.awt.event.ActionEvent;)V)
     * @param arg1 java.awt.event.ActionEvent
     */
    /* WARNING: THIS METHOD WILL BE REGENERATED. */
    ...
    /**
     * connEtoC5:  (yearincrease.adjustment.adjustmentValueChanged(java.awt.event.AdjustmentEvent) --> CCalendar.yearincrease_AdjustmentValueChanged(Ljava.awt.event.AdjustmentEvent;)V)
    ...
    /**
     * connEtoC6:  (btnPrevYear.action.actionPerformed(java.awt.event.ActionEvent) --> CCalendar.btnPrevYear_ActionPerformed(Ljava.awt.event.ActionEvent;)V)
     * @param arg1 java.awt.event.ActionEvent
     */
    /* WARNING: THIS METHOD WILL BE REGENERATED. */
    ...
    /**
     * connEtoC7:  (btnNextYear.action.actionPerformed(java.awt.event.ActionEvent) --> CCalendar.btnNextYear_ActionPerformed(Ljava.awt.event.ActionEvent;)V)
     * @param arg1 java.awt.event.ActionEvent
     */
    /* WARNING: THIS METHOD WILL BE REGENERATED. */
    ...
    /**
     * connEtoC8:  (JButtonClear.action.actionPerformed(java.awt.event.ActionEvent) --> CCalendar.jButtonClear_ActionPerformed(Ljava.awt.event.ActionEvent;)V)
     * @param arg1 java.awt.event.ActionEvent
     */
    /* WARNING: THIS METHOD WILL BE REGENERATED. */
    ...
    /**
     * connEtoC9:  (JLabelTodayColor.mouse.mouseClicked(java.awt.event.MouseEvent) --> CCalendar.statusMsg1_MouseClicked(Ljava.awt.event.MouseEvent;)V)
     * @param arg1 java.awt.event.MouseEvent
     */
    /* WARNING: THIS METHOD WILL BE REGENERATED. */
    ...
    private JPanel ivjCCalendarPane = null;
    ...
    public static void main(String st[]) {
        try {
            ...
            new CCalendar(new JTextField()).show();
        } catch (Exception e){}
