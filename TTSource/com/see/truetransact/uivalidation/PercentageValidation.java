 ...
 * @author karthik, Bala
 */
public class PercentageValidation extends UIComponentValidation{
    ...
    /** Creates a new instance of NumericValidation
     *
    public PercentageValidation(int nums, int decimals) {
        _nums = nums;
        _decimals = decimals;
    }*/
    ...
    public boolean validate() {
        ...
        if (content.length() != 0) {
            try {
                ...
                double percent = Double.parseDouble(textValue);
                if (percent <= 100) {
