 ...
 * 
 * AgriLoanDocumentValidationRule.java
 *
 ...
 * @author  152713
 */
public class AgriLoanDocumentValidationRule extends ValidationRule{
    ...
    public AgriLoanDocumentValidationRule() throws Exception{
    ...
    private void getTarget(HashMap inputMap) throws Exception{
        List keyList = sqlMap.executeQueryForList("getDocumentStatusATL", inputMap);
    ...
    public static void main(String[] args) throws Exception{
        ...
        AgriLoanDocumentValidationRule rule = new AgriLoanDocumentValidationRule();
        rule.validate(map);
    }
