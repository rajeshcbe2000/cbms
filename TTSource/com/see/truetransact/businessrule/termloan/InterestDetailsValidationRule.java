 ...
 * 
 * InterestDetailsValidationRule.java
 *
 ...
 * @author  152713
 */
public class InterestDetailsValidationRule extends ValidationRule{
    ...
    public InterestDetailsValidationRule() throws Exception{
    ...
    private void getTarget(HashMap inputMap) throws Exception{
        ...
        if (strIntGetFrom.length() <= 0){
            ...
            if(inputMap.containsKey("PROD_TYPE") && inputMap.get("PROD_TYPE").equals("ATL"))
                ...
                String acct_num=CommonUtil.convertObjToStr(inputMap.get("ACCT_NUM"));
                no_records = CommonUtil.convertObjToInt(sqlMap.executeQueryForObject("getAcctInterestDetailsCount", acct_num));
                System.out.println("no_records   ###"+no_records);
            }
//            if (no_records > 0){
//                HashMap retrieveMap = (HashMap) list.get(0);
//                int no_records = CommonUtil.convertObjToInt(list.get(0));
...
//            }
            ...
            if (list.size() > 0){
                ...
                retrieveMap.put(CommonConstants.DEBIT, CommonConstants.DEBIT);
