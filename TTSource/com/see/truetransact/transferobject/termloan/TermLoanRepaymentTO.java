 ...
 */
public class TermLoanRepaymentTO extends TransferObject implements Serializable {
    ...
    private Double repayMorotorium = null;
    private String emi_uniform = null;

    public String getEmi_uniform() {
        return emi_uniform;
    }

    public void setEmi_uniform(String emi_uniform) {
        this.emi_uniform = emi_uniform;
    }
    ...
    public String toString() {
        ...
        strB.append(getTOString("repayMorotorium", repayMorotorium));
        strB.append(getTOString("emi_uniform", emi_uniform));
    ...
    public String toXML() {
        ...
        strB.append(getTOXml("repayMorotorium", repayMorotorium));
        strB.append(getTOXml("emi_uniform", emi_uniform));
    ...
    /**
     * Getter for property repayMorotorium.
     *
     * @return Value of property repayMorotorium.
     */
    public java.lang.Double getRepayMorotorium() {
        return repayMorotorium;
    }

    /**
     * Setter for property repayMorotorium.
     *
     * @param repayMorotorium New value of property repayMorotorium.
     */
    public void setRepayMorotorium(java.lang.Double repayMorotorium) {
        this.repayMorotorium = repayMorotorium;
    }
}