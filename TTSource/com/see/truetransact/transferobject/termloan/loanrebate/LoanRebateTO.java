 ...
 */
package com.see.truetransact.transferobject.termloan.loanrebate;
...
public class LoanRebateTO extends TransferObject implements Serializable {
    ...
    public String toString() {
        ...
        strB.append(getTOString("rebateInt", rebateInt));
        strB.append(getTOString("intAmount", intAmount));
        strB.append(getTOString("rebateId", rebateId));
        strB.append(getTOString("normalInt", normalInt));
        strB.append(getTOString("prodType", prodType));
        strB.append(getTOString("rebateUpto", rebateUpto));
    ...
    public String toXML() {
        ...
        strB.append(getTOXml("rebateInt", rebateInt));
        strB.append(getTOXml("intAmount", intAmount));
        strB.append(getTOXml("rebateId", rebateId));
        strB.append(getTOXml("normalInt", normalInt));
        strB.append(getTOXml("prodType", prodType));
        strB.append(getTOXml("rebateUpto", rebateUpto));
    ...
    public void setNormalInterest(String normalInt) {
    ...
    /**
     * Getter for property rebateId.
     *
     * @return Value of property rebateId.
     */
    ...
    /**
     * Setter for property rebateId.
     *
     * @param rebateId New value of property rebateId.
     */
    public void setRebateId(java.lang.String rebateId) {
        this.rebateId = rebateId;
    }

    public Date getRebateUpto() {
        return rebateUpto;
    }
     ...
     * @param rebateId New value of property rebateId.
     */
    public void setRebateUpto(Date rebateUpto) {
