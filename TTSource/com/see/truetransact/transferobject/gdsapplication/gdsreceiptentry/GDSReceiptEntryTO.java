 ...
 */
package com.see.truetransact.transferobject.gdsapplication.gdsreceiptentry;

import com.see.truetransact.transferobject.gdsapplication.gdsreceiptentry.*;
 ...
 */
public class GDSReceiptEntryTO extends TransferObject implements Serializable {
    ...
    public String toString() {
        ...
        strB.append(getTOString("gdsName", gdsName));
        ...
        strB.append(getTOString("group_no", gds_no));
    ...
    public String toXML() {
        ...
        strB.append(getTOXml("GDSName", gdsName));
        strB.append(getTOXml("schemeName", schemeName));
        strB.append(getTOXml("gds_no", gds_no));
        strB.append(getTOXml("group_no", group_no));
