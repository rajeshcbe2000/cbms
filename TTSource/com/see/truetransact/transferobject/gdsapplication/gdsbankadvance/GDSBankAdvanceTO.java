 ...
 */
package com.see.truetransact.transferobject.gdsapplication.gdsbankadvance;

import com.see.truetransact.transferobject.mdsapplication.mdsbankadvance.*;
 ...
 */
public class GDSBankAdvanceTO extends TransferObject implements Serializable {
    ...
    public String toString() {
        ...
        strB.append(getTOString("forfeitAmt", forfeitAmt));
    ...
    public String toXML() {
        ...
        strB.append(getTOXml("forfeitAmt", forfeitAmt));
    ...
    public Double getForfeitAmt() {
        return forfeitAmt;
    }

    public void setForfeitAmt(Double forfeitAmt) {
