 ...
 */
package com.see.truetransact.transferobject.gdsapplication.gdsprizedmoneydetailsentry;

import com.see.truetransact.transferobject.mdsapplication.mdsprizedmoneydetailsentry.*;
 ...
 */
public class GDSPrizedMoneyDetailsEntryTO extends TransferObject implements Serializable {
    ...
    private Integer appNo = 0;
    private String chittalNo = "";
    private String oldChittalNo = "";
    private Integer oldSubNo = null;
    ...
    public String getNoOfMemberPerDiv() {
        return noOfMemberPerDiv;
    }

    public void setNoOfMemberPerDiv(String noOfMemberPerDiv) {
