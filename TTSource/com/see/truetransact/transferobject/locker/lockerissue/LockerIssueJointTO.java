 ...
 */
public class LockerIssueJointTO extends TransferObject implements Serializable {
    ...
    public String getKeyData() {
        setKeyColumns("locNum" + KEY_VAL_SEPARATOR + "custId" + KEY_VAL_SEPARATOR + "status");
        return locNum + KEY_VAL_SEPARATOR + custId + KEY_VAL_SEPARATOR + status;
    }
