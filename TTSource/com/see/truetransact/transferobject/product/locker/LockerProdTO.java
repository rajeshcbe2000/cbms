 ...
 */
public class LockerProdTO extends TransferObject implements Serializable {
    ...
    private String rentAdvAcHd = "";
    private String rdoRefund = "";
    private Integer dimLen = new Integer(0);
    private Integer dimBre = new Integer(0);
    private Integer dimHei = new Integer(0);
    private String dimMet = "";
    private String rdoPenal = "";
    private Double penalRate = null;
    private String penalAcHd = "";
...
//                strB.append(getTOString("rateForDelay", rateForDelay));
        ...
        strB.append(getTOString("rentAdvAcHd", rentAdvAcHd));
//                strB.append(getTOString("intIcc", intIcc));
        strB.append(getTOString("dimLen", dimLen));
        strB.append(getTOString("dimBre", dimBre));
        strB.append(getTOString("dimHei", dimHei));
        strB.append(getTOString("dimMet", dimMet));
        strB.append(getTOString("rdoRefund", rdoRefund));
        strB.append(getTOString("rdoPenal", rdoPenal));
        strB.append(getTOString("penalRate", penalRate));
        strB.append(getTOString("penalAcHd", penalAcHd));
...
//                strB.append(getTOXml("rateForDelay", rateForDelay));
        ...
        strB.append(getTOXml("rentAdvAcHd", rentAdvAcHd));
//                strB.append(getTOXml("intIcc", intIcc));
        strB.append(getTOXml("dimLen", dimLen));
        strB.append(getTOXml("dimBre", dimBre));
        strB.append(getTOXml("dimHei", dimHei));
        strB.append(getTOXml("dimMet", dimMet));
        strB.append(getTOXml("rdoRefund", rdoRefund));

        strB.append(getTOXml("rdoPenal", rdoPenal));
        strB.append(getTOXml("penalRate", penalRate));
        strB.append(getTOXml("penalAcHd", penalAcHd));
    ...
    public Integer getDimLen() {
        return dimLen;
    }

    public void setDimLen(Integer dimLen) {
        this.dimLen = dimLen;
    }

    /**
     * Getter for property dimBre.
     *
     * @return Value of property dimBre.
     */
    public Integer getDimBre() {
        return dimBre;
    }

    public void setDimBre(Integer dimBre) {
        this.dimBre = dimBre;
    }

    public Integer getDimHei() {
        return dimHei;
    }

    public void setDimHei(Integer dimHei) {
        this.dimHei = dimHei;
    }
    ...
    public void setRdoRefund(String rdoRefund) {
        this.rdoRefund = rdoRefund;
    }

    /**
     * Getter for property dimHei.
     *
     * @return Value of property dimHei.
     */
    public java.lang.String getRdoRefund() {
        return rdoRefund;
    }

    /**
     * Getter for property dimMet.
     *
     * @return Value of property dimMet.
     */
    public java.lang.String getDimMet() {
        return dimMet;
    }

    /**
     * Setter for property dimMet.
     *
     * @param dimMet New value of property dimMet.
     */
    public void setDimMet(java.lang.String dimMet) {
        this.dimMet = dimMet;
    }

    /**
     * Getter for property rentAdvAcHd.
     *
     * @return Value of property rentAdvAcHd.
     */
    public java.lang.String getRentAdvAcHd() {
        return rentAdvAcHd;
    }

    /**
     * Setter for property rentAdvAcHd.
     *
     * @param rentAdvAcHd New value of property rentAdvAcHd.
     */
    public void setRentAdvAcHd(java.lang.String rentAdvAcHd) {
        this.rentAdvAcHd = rentAdvAcHd;
    }

    /**
     * Getter for property rdoPenal.
     *
     * @return Value of property rdoPenal.
     */
    public java.lang.String getRdoPenal() {
        return rdoPenal;
    }

    /**
     * Setter for property rdoPenal.
     *
     * @param rdoPenal New value of property rdoPenal.
     */
    public void setRdoPenal(java.lang.String rdoPenal) {
        this.rdoPenal = rdoPenal;
    }

    /**
     * Getter for property penalRate.
     *
     * @return Value of property penalRate.
     */
//        public int getPenalRate() {
//            return penalRate;
//        }
    /**
     * Setter for property penalRate.
     *
     * @param penalRate New value of property penalRate.
     */
//        public void setPenalRate(int penalRate) {
//            this.penalRate = penalRate;
//        }
    /**
     * Getter for property penalAcHd.
     *
     * @return Value of property penalAcHd.
     */
    public java.lang.String getPenalAcHd() {
        return penalAcHd;
    }

    /**
     * Setter for property penalAcHd.
     *
     * @param penalAcHd New value of property penalAcHd.
     */
    public void setPenalAcHd(java.lang.String penalAcHd) {
        this.penalAcHd = penalAcHd;
    }
