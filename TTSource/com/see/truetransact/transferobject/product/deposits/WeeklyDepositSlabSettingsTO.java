 ...
 */
public class WeeklyDepositSlabSettingsTO extends TransferObject implements Serializable {

    private String prodId = "";
    private String prodType = "";
    private Integer instFrom = 0;
    private Integer instTo = 0;
    private Integer penal = 0;
    ...
    public String toString() {
        ...
        strB.append(getTOString("instFrom", instFrom));
        strB.append(getTOString("instTo", instTo));
    ...
    public String toXML() {
        ...
        strB.append(getTOXml("instFrom", instFrom));
        strB.append(getTOXml("instTo", instTo));
