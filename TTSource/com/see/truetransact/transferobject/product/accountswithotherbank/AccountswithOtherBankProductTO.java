 ...
 */
package com.see.truetransact.transferobject.product.accountswithotherbank;
 ...
 */
public class AccountswithOtherBankProductTO extends TransferObject implements Serializable {
    ...
    public String toString() {
        ...
        strB.append(getTOString("cboOtherbankacntsBehaves", cboOtherbankacntsBehaves));
        ...
        strB.append(getTOString("txtPenalAcHead", txtPenalAcHead));
    ...
    public String toXML() {
        ...
        strB.append(getTOXml("cboOtherbankacntsBehaves", cboOtherbankacntsBehaves));
        ...
        strB.append(getTOXml("txtPenalAcHead", txtPenalAcHead));
