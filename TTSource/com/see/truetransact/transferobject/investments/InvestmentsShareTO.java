 ...
 * 
 *
 * InvestmentsShareTO.java
 * 
 * Created on Tue Feb 21 10:50:45 IST 2012
 */
...
/**
 * Table name for this TO is INVESTMENT_SHARE.
 */
public class InvestmentsShareTO extends TransferObject implements Serializable {
    ...
    private String investmentRefNo = ""; //Member No
    private String agencyName = "";
    private Date investmentIssueDt = null;
    private Double noOfShares = null;
    ...
    /**
     * Setter/Getter for NO_OF_SHARES - table Field
     */
    ...
    /**
     * Setter/Getter for SHARE_VALUE - table Field
     */
    ...
    /**
     * Setter/Getter for FEES_PAID - table Field
     */
    ...
    public String toString() {
        ...
        strB.append(getTOString("shareValue", shareValue));
        strB.append(getTOString("faceValue", faceValue));
        strB.append(getTOString("feesPaid", feesPaid));
    ...
    public String toXML() {
        ...
        strB.append(getTOXml("shareValue", shareValue));
        strB.append(getTOXml("faceValue", faceValue));
        strB.append(getTOXml("feesPaid", feesPaid));
    ...
    /**
     * Getter for property investmentRefNo.
     *
     * @return Value of property investmentRefNo.
     */
    public java.lang.String getInvestmentRefNo() {
        return investmentRefNo;
    }

    /**
     * Setter for property investmentRefNo.
     *
     * @param investmentRefNo New value of property investmentRefNo.
     */
    public void setInvestmentRefNo(java.lang.String investmentRefNo) {
