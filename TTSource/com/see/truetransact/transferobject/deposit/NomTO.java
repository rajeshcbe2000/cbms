 ...
 * NomTO.java
 *
 * Created on Wed Aug 18 11:22:09 GMT+05:30 2004
 */
...
/**
 * Table name for this TO is DEPOSIT_NOMINEE.
 */
public class NomTO extends TransferObject implements Serializable {
    ...
    /**
     * Setter/Getter for G_ADDR_TYPE - table Field
     */
    public void setGAddrType(String gAddrType) {
        this.gAddrType = gAddrType;
    }

    public String getGAddrType() {
        return gAddrType;
    }

    /**
     * Setter/Getter for G_TYPE - table Field
     */
    ...
    /**
     * Setter/Getter for NOMINATED_BY - table Field
     */
    ...
    public String getKeyData() {
        setKeyColumns("depositNo" + KEY_VAL_SEPARATOR + "nomineeId");
        return depositNo + KEY_VAL_SEPARATOR + nomineeId;
    }
    ...
    public String toString() {
        ...
        strB.append(getTOString("gAddrType", gAddrType));
        strB.append(getTOString("gType", gType));
        strB.append(getTOString("status", status));
        strB.append(getTOString("statusBy", statusBy));
        strB.append(getTOString("statusDt", statusDt));
        strB.append(getTOString("nominatedBy", nominatedBy));
    ...
    public String toXML() {
        ...
        strB.append(getTOXml("gAddrType", gAddrType));
        strB.append(getTOXml("gType", gType));
        strB.append(getTOXml("status", status));
        strB.append(getTOXml("statusBy", statusBy));
        strB.append(getTOXml("statusDt", statusDt));
        strB.append(getTOXml("nominatedBy", nominatedBy));
