 ...
 * AccountParamTO.java
 * 
 * Created on Mon Aug 22 16:04:41 IST 2005
 */
...
/**
 * Table name for this TO is ACT_PARAM_DETAIL.
 */
public class AccountParamTO extends TransferObject implements Serializable {
    ...
    private Double minBal1Flexi = null;
    private Double minBal2Flexi = null;
    ...
    /**
     * Setter/Getter for FLEXI - table Field
     */
    ...
    /**
     * Setter/Getter for MIN_BAL1_FLEXI - table Field
     */
    public void setMinBal1Flexi(Double minBal1Flexi) {
        this.minBal1Flexi = minBal1Flexi;
    }

    public Double getMinBal1Flexi() {
        return minBal1Flexi;
    }

    /**
     * Setter/Getter for MIN_BAL2_FLEXI - table Field
     */
    public void setMinBal2Flexi(Double minBal2Flexi) {
        this.minBal2Flexi = minBal2Flexi;
    }

    public Double getMinBal2Flexi() {
        return minBal2Flexi;
    }
    ...
    /**
     * Setter/Getter for HIDE_BALANCE - table Field
     */
    public void setHideBalance(String hideBalance) {
        this.hideBalance = hideBalance;
    }

    public String getHideBalance() {
        return hideBalance;
    }

    /**
     * Setter/Getter for SHOW_BALANCE_TO - table Field
     */
    public void setShowBalanceTo(String showBalanceTo) {
        this.showBalanceTo = showBalanceTo;
    }

    public String getShowBalanceTo() {
        return showBalanceTo;
    }
    ...
    public String toString() {
        ...
        strB.append(getTOString("flexi", flexi));
        strB.append(getTOString("minBal1Flexi", minBal1Flexi));
        strB.append(getTOString("minBal2Flexi", minBal2Flexi));
        ...
        strB.append(getTOString("passBook", passBook));
        ...
        strB.append(getTOString("hideBalance", hideBalance));
        strB.append(getTOString("showBalanceTo", showBalanceTo));
    ...
    public String toXML() {
        ...
        strB.append(getTOXml("flexi", flexi));
        strB.append(getTOXml("minBal1Flexi", minBal1Flexi));
        strB.append(getTOXml("minBal2Flexi", minBal2Flexi));
        ...
        strB.append(getTOXml("passBook", passBook));
        ...
        strB.append(getTOXml("hideBalance", hideBalance));
        strB.append(getTOXml("showBalanceTo", showBalanceTo));
        strB.append(getTOXmlEnd());
        return strB.toString();
    }

    /**
     * Getter for property passBook.
     *
     * @return Value of property passBook.
     */
    ...
    /**
     * Setter for property passBook.
     *
     * @param passBook New value of property passBook.
     */
    public void setPassBook(java.lang.String passBook) {
