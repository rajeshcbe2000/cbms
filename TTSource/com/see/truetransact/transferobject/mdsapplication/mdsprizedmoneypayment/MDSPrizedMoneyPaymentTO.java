 ...
 */
package com.see.truetransact.transferobject.mdsapplication.mdsprizedmoneypayment;
 ...
 */
public class MDSPrizedMoneyPaymentTO extends TransferObject implements Serializable {

    private Integer divisionNo = 0; //AJITH
    private Integer subNo = 0; //AJITH
    private Integer totalInstallments = 0; //AJITH
    private Integer noOfInstPaid = 0; //AJITH
    private Integer noOfOverdueInst = 0; //AJITH
    private Double overdueAmount = 0.0; //AJITH
    private Integer prizedInstNo = 0; //AJITH
    private Double bonusAmount = 0.0; //AJITH
    private Double commisionAmount = 0.0; //AJITH
    private Double refundAmount = 0.0; //AJITH
    private Double discountAmount = 0.0; //AJITH
    private Double noticeAmount = 0.0; //AJITH
    private Double chargeAmount = 0.0; //AJITH
    private Double aribitrationAmount = 0.0; //AJITH
    private Double prizedAmount = 0.0; //AJITH
    private Double netAmount = 0.0; //AJITH
    ...
    private Double penalAmount = 0.0;   //AJITH
    private Double bonusRecovered = 0.0;   //AJITH
    private Double defaulter_bonus_recoverd = 0.0;   //AJITH
    private Double chitalBonusAmt = 0.0;   //AJITH
    private Double paymentTaxAmt = 0.0;
    private Double defaulterReceiptTaxAmt = 0.0;
    private Double defaulter_interst = 0.0;   //AJITH
    private Double defaulter_comm = 0.0;   //AJITH
    ...
    public Double getChitalBonusAmt() {
        return chitalBonusAmt;
    }

    public void setChitalBonusAmt(Double chitalBonusAmt) {
        this.chitalBonusAmt = chitalBonusAmt;
    }
    ...
    public String toString() {
        ...
        strB.append(getTOString("chitalBonusAmt", chitalBonusAmt));
        strB.append(getTOString("paymentTaxAmt", paymentTaxAmt));
        strB.append(getTOString("defaulterReceiptTaxAmt", defaulterReceiptTaxAmt));
    ...
    public String toXML() {
        ...
        strB.append(getTOXml("chitalBonusAmt", chitalBonusAmt));
        strB.append(getTOXml("paymentTaxAmt", paymentTaxAmt));
        strB.append(getTOXml("defaulterReceiptTaxAmt", defaulterReceiptTaxAmt));
