...
public class AccountswithOtherBanksOB extends CObservable{
    
    Date curDate = null;
    private final static ClientParseException parseException = ClientParseException.getInstance();
    private final static Logger _log = Logger.getLogger(AccountswithOtherBanksOB.class);
    ...
    private static AccountswithOtherBanksOB objInvestmentsMasterOB;//Singleton Object
    ...
    private String txtSanctnNo="";
    private boolean acctClosed=false;

    public boolean getAcctClosed() {
        return acctClosed;
    }

    public void setAcctClosed(boolean acctClosed) {
        this.acctClosed = acctClosed;
    }
    ...
    public String getTxtPenalrate() {
        return txtPenalrate;
    }

    public void setTxtPenalrate(String txtPenalrate) {
        this.txtPenalrate = txtPenalrate;
    }

    public String getTxtSanctnNo() {
        return txtSanctnNo;
    }

    public void setTxtSanctnNo(String txtSanctnNo) {
        this.txtSanctnNo = txtSanctnNo;
    }
    ...
    private AccountswithOtherBanksOB() {
        map = new HashMap();
        map.put(CommonConstants.JNDI, "AccountswithOtherBankMasterJNDI");
        map.put(CommonConstants.HOME, "serverside.accountswithotherbank.AccountswithOtherBanksHome");
        map.put(CommonConstants.REMOTE, "serverside.accountswithotherbank.AccountswithOtherBanks");
        try {
...
//            cbmRenewalInvestmentBehaves.removeKeyAndElement("SHARE_OTHER_INSTITUTIONS");
    ...
    public static AccountswithOtherBanksOB getInstance()throws Exception{
         try {
            objInvestmentsMasterOB = new AccountswithOtherBanksOB();
        } catch(Exception e) {
            parseException.logException(e,true);
        }
    ...
    public InvestmentsTransTO getInvestmentsTransTO(String command){
        ...
        objgetInvestmentsTransTO.setTransDT(curDate);
    ...
    //Added By Suresh
    /** Returns an Instance of InvestmentMaster */
    public AccountswithOtherBanksOperativeTO getInvestmentsOperativeTO(String command){
        AccountswithOtherBanksOperativeTO objgetInvestmentsOperativeTO= new AccountswithOtherBanksOperativeTO();
        ...
        objgetInvestmentsOperativeTO.setInvestmentIssueDt(getTdtSBAccOpenDt());
        ...
        if(CommonUtil.convertObjToStr(cbmInvestmentBehaves.getKeyForSelected()).equals("OD") || CommonUtil.convertObjToStr(cbmInvestmentBehaves.getKeyForSelected()).equals("CC") || CommonUtil.convertObjToStr(cbmInvestmentBehaves.getKeyForSelected()).equals("BR")){
        objgetInvestmentsOperativeTO.setSanctnAmt(CommonUtil.convertObjToDouble(getTxtDepositAmt()).doubleValue());
        objgetInvestmentsOperativeTO.setDepositAmt(CommonUtil.convertObjToDouble(getTxtDepositAmt()).doubleValue());
        }else{
            objgetInvestmentsOperativeTO.setDepositAmt(CommonUtil.convertObjToDouble(getTxtDepositAmt()).doubleValue());
             objgetInvestmentsOperativeTO.setSanctnAmt(0.0);
        }
        objgetInvestmentsOperativeTO.setSanctnNo(CommonUtil.convertObjToStr(getTxtSanctnNo()));
        objgetInvestmentsOperativeTO.setExpDt(getMaturityDate());
        objgetInvestmentsOperativeTO.setIntRate(CommonUtil.convertObjToDouble(getTxtIntrate()));
        objgetInvestmentsOperativeTO.setPenalRate(CommonUtil.convertObjToDouble(getTxtPenalrate()));        
        System.out.println("san amt"+objgetInvestmentsOperativeTO);
    ...
    public InvestmentsDepositTO getInvestmentsDepositTO(String command){
        ...
        objgetInvestmentsDepositTO.setInvestmentIssueDt(getTdtFDAccOpenDt());
        objgetInvestmentsDepositTO.setInvestmentEffectiveDt(getTdtFDEffectiveDt());
        ...
        objgetInvestmentsDepositTO.setMaturityDt(getTdtFDMaturityDt());
        ...
        objgetInvestmentsDepositTO.setIntRecTillDt(getTdtFDIntReceivedTillDt());
    ...
    public InvestmentsDepositTO getRenewalInvestmentsDepositTO(String command){
        ...
        objgetInvestmentsDepositTO.setInvestmentIssueDt(getTdtRenewalFDAccOpenDt());
        objgetInvestmentsDepositTO.setInvestmentEffectiveDt(getTdtRenewalFDEffectiveDt());
        ...
        objgetInvestmentsDepositTO.setMaturityDt(getTdtRenewalFDMaturityDt());
...
//            term.put("InvestmentsMasterTO", getInvestmentsMasterTO(command));
            String accounttype = "";
            accounttype = CommonUtil.convertObjToStr(cbmInvestmentBehaves.getKeyForSelected());
            System.out.println("#### Investment Type : "+accounttype);
            term.put("COMMAND",command);
            term.put("ACCOUNT_TYPE",accounttype);
            if(accounttype.equals("OTHER_BANK_SB") || accounttype.equals("OTHER_BANK_CA") || accounttype.equals("OD") || accounttype.equals("CC") || accounttype.equals("BR")){
                ...
                System.out.println("getAcctClosed@$!@$!$!$"+getAcctClosed());
                 if(command.equalsIgnoreCase(CommonConstants.TOSTATUS_UPDATE)){
                    if(getAcctClosed()){
                        term.put("ACCT_STATUS","CLOSED");
                    }
                 }
            }else if(accounttype.equals("OTHER_BANK_CCD") || accounttype.equals("OTHER_BANK_FD") 
            || accounttype.equals("OTHER_BANK_SSD") || accounttype.equals("OTHER_BANK_RD")){
                ...
                if(renewal.length()>0  && renewal.equals("Y")){
                    ...
                    if(CommonUtil.convertObjToDouble(getTxtFDPricipalAmt()).doubleValue()>0){
            ...
            }else if(accounttype.equals("SHARES_DCB") || accounttype.equals("SHARE_OTHER_INSTITUTIONS")){
                term.put("InvestmentsShareTO", getInvestmentsShareTO(command));
            }else if(accounttype.equals("RESERVE_FUND_DCB")){
            ...
            }else if(command.equalsIgnoreCase(CommonConstants.TOSTATUS_UPDATE) && getAcctClosed()){
                transactionDetailsTO=new LinkedHashMap();
                transactionDetailsTO.put(NOT_DELETED_TRANS_TOs,allowedTransactionDetailsTO);
                term.put("TransactionTO",transactionDetailsTO);
            }
            if(command.equals("AUTHORIZE")){
                ...
                //Renewal
                if(accounttype.equals("OTHER_BANK_CCD") || accounttype.equals("OTHER_BANK_FD")
                || accounttype.equals("OTHER_BANK_SSD")){
                    term.put("InvestmentsDepositTO", getInvestmentsDepositTO(command));
                    String renewal = CommonUtil.convertObjToStr(getRdoRenewal());
                    if(renewal.length()>0  && renewal.equals("Y")){
                        term.put("RENEWAL","RENEWAL");
    ...
    public void populateData(HashMap whereMap) {
        ...
        try {
            ...
            if(mapData.containsKey("InvestmentsOperativeTO")){
                objInvestmentsOperativeTO = (AccountswithOtherBanksOperativeTO) ((List) mapData.get("InvestmentsOperativeTO")).get(0);
...
//                setInvestmentsTransTO(objInvestmentsTransTO);
                ...
                if (!list.isEmpty()) {
                    transactionOB.setActionType(getActionType());
    ...
    /** Sets all the InvsetmentMaster values to the OB varibles  there by populatin the UI fields */
    private void setInvestmentsOperativeTO(AccountswithOtherBanksOperativeTO objInvestmentsOperativeTO){
        ...
        if(objInvestmentsOperativeTO.getAmt()>0)
        setTxtDepositAmt(CommonUtil.convertObjToStr(objInvestmentsOperativeTO.getDepositAmt()+objInvestmentsOperativeTO.getAmt()));
        else if(objInvestmentsOperativeTO.getAmtC()>0)
             setTxtDepositAmt(CommonUtil.convertObjToStr(objInvestmentsOperativeTO.getDepositAmt()+objInvestmentsOperativeTO.getAmtC()));
        else
            setTxtDepositAmt(CommonUtil.convertObjToStr(objInvestmentsOperativeTO.getDepositAmt()));
        
        setTxtSanctnNo(CommonUtil.convertObjToStr(objInvestmentsOperativeTO.getSanctnNo()));
        setTxtPenalrate(CommonUtil.convertObjToStr(objInvestmentsOperativeTO.getPenalRate()));
        setTxtIntrate(CommonUtil.convertObjToStr(objInvestmentsOperativeTO.getIntRate()));
        setMaturityDate(objInvestmentsOperativeTO.getExpDt());
    }
