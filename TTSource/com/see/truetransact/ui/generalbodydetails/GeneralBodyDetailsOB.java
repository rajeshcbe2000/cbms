...
import com.see.truetransact.transferobject.generalbodydetails.GeneralBodyDetailsTO;
 ...
 *
 */
public class GeneralBodyDetailsOB extends CObservable {

    private String txtvenu = "";
    private String txttotalAttendance = "";
  ...
  private ProxyFactory proxy;
    ...
    private int _result;
     private static GeneralBodyDetailsOB objGeneralBodyDetailsOB;
 private HashMap map;
...
//    private int actionType;
  private GeneralBodyDetailsOB generalBodyDetailsOB;
    GeneralBodyDetailsRB objGeneralBodyDetailsRB = new GeneralBodyDetailsRB();
    private static final CommonRB objCommonRB = new CommonRB();
    private GeneralBodyDetailsTO objGeneralBodyDetailsTO;
    
    /** Creates a new instance of TDS MiantenanceOB */
    public GeneralBodyDetailsOB() {
        try {
            proxy = ProxyFactory.createProxy();
            
            map = new HashMap();
            map.put(CommonConstants.JNDI, "GeneralBodyDetailsJNDI");
            map.put(CommonConstants.HOME, "generalbodydetails.GeneralBodyDetailsHome");
            map.put(CommonConstants.REMOTE, "generalbodydetails.GeneralBodyDetails");
//            setTableTile();
...
//            fillDropdown();
     ...
     static {
        try {
            ...
            objGeneralBodyDetailsOB = new GeneralBodyDetailsOB();
        } catch(Exception e) {
           // parseException.logException(e,true);
  ...
  public void setTxtGeneralBoadyID(java.lang.String txtGeneralBoadyID) {
    ...
    public void settdtDate(java.lang.String tdtDate) {
     ...
     public java.lang.String getTxtVenu() {
        return txtvenu;
    }
    
   
    public void setTxtVenu(java.lang.String txtvenu) {
        this.txtvenu = txtvenu;
    }
    
    
     public java.lang.String getTxttotalAttendance() {
        return txttotalAttendance;
    }
    
   
    public void setTxttotalAttendance(java.lang.String txttotalAttendance) {
        this.txttotalAttendance = txttotalAttendance;
    }
     ...
     public void execute(String command) {
        try {
         //   System.out.println("GET BOPRRR NO IN EDIT :="+geBorrowingTO(command));
            ...
            term.put("GeneralBodyDetailsTO", getGeneralTO(command));
...
//            setProxyReturnMap(proxyReturnMap);
     ...
     private GeneralBodyDetailsTO getGeneralTO(String command){
        GeneralBodyDetailsTO objTO = new GeneralBodyDetailsTO();
        objTO.setCommand(command);
        objTO.setGbid(getTxtGeneralBoadyID());
        objTO.setgDate(DateUtil.getDateMMDDYYYY(gettdtDate()));
        objTO.setVenu(getTxtVenu());
        objTO.setTotalAttendance(Integer.parseInt(getTxttotalAttendance()));
...
//                objTO.setAuthorizeDte(null);
     ...
     public void setGeneralBodyDetailsTO(GeneralBodyDetailsTO objTO) {
        setTxtGeneralBoadyID(objTO.getGbid());
        settdtDate(objTO.getgDate().toString());
        setTxtVenu(objTO.getVenu());
...
//            }
   ...
   public void resetForm(){
     ...
     public static GeneralBodyDetailsOB getInstance()throws Exception{
        return objGeneralBodyDetailsOB;
    }
      ...
      /** To update the Status based on result performed by doAction() method */
       ...
       public int getResult(){
        ...
        try {
            ...
            System.out.println("objmapData=="+((List) mapData.get("GeneralBodyDetailsTO")).get(0));
            GeneralBodyDetailsTO objTO =(GeneralBodyDetailsTO) ((List) mapData.get("GeneralBodyDetailsTO")).get(0);
           System.out.println("objTOobjTOobjTOobjTO=="+objTO);
            setGeneralBodyDetailsTO(objTO);
        } catch( Exception e ) {
            setResult(ClientConstants.ACTIONTYPE_FAILED);
           // parseException.logException(e,true);
