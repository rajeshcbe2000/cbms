 ...
 */
package com.see.truetransact.ui.transaction.denominationConfiguration;
    ...
    public void initTableData() {
        ...
        tblData.setModel(new javax.swing.table.DefaultTableModel(
                new Object[][]{
                    ...
                    {"COIN", "0.05", null, null},
                    {"COIN", "0.01", null, null},
                    {null,"Total Coins",  null, null},
                    {"STAMP", "1", null, null, "1"},
                    {null, "Total Stamps", null, null},
                    {null, "Grand Total", null, null}
                    },
                new String[]{
                    
                    "Type", "Denomination", "No", "Amount"
                    }) {
        ...
        public void tableChanged(TableModelEvent e) {
             if (e.getType() == TableModelEvent.UPDATE) {
                       System.out.println("Cell " + e.getFirstRow() + ", "
                        ...
                        if (row != 11 && row != 22 && row != 25 && row != 24) {
                        ...
                        String quantity = model.getValueAt(row, 1).toString();
                            ...
                            if (model.getValueAt(row, 1) != null) {
                                ...
                                model.setValueAt(formatCrore(String.valueOf(Double.valueOf(totalPay))), 25, 3);//formatCrore(
                                model.setValueAt(CommonUtil.convertObjToInt(totalCount), 25, 2);
...
//setOpBalanceAmount();
    ...
    private void initComponents() {
        ...
        DmBal.setFont(new java.awt.Font("MS Sans Serif", 1, 13));
        ...
        lblCrBal.setFont(new java.awt.Font("MS Sans Serif", 1, 13));
        ...
        lblTotalStamp.setFont(new java.awt.Font("MS Sans Serif", 1, 12));
        ...
        DmBal1.setFont(new java.awt.Font("MS Sans Serif", 1, 13));
        ...
        lblCrBal1.setFont(new java.awt.Font("MS Sans Serif", 1, 13));
...
//    }
    ...
    public void insertData(String transId, String amount, String noOfNotes, String trans_type, String deno_type, String dnomType) {
        ...
        singleAuthorizeMap.put("DENOMINATION_VALUE", CommonUtil.convertObjToDouble(amount)); //amount
        singleAuthorizeMap.put("DENOMINATION_COUNT", CommonUtil.convertObjToDouble(noOfNotes));//no of notes
