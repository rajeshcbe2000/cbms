...
public class ReprintOB extends CObservable{
  ...
  private HashMap dataHash;
    ...
    private final static Logger log = Logger.getLogger(ReprintOB.class);//Creating Instace of Log
    private ProxyFactory proxy;
    private int _actionType;//This vairable is used to type of action 1-New 2-Edit 3-Delete
    private int _result;
    private static ReprintOB objCashierApprovalOB;//Singleton Object Reference
    ...
    private boolean rdoTransfer=false;
    ...
    public ReprintOB() {
     ...
     static {
        try {
            ...
            objCashierApprovalOB = new ReprintOB();
        } catch(Exception e) {
           // parseException.logException(e,true);
    ...
    public void setTableTitle() {
        ...
        tableTitle.add("Module");
        tableTitle.add("Single TransID");
        if(rdoTransfer){
            tableTitle.add("Agent Name");
        }else {
            tableTitle.remove("Agent Name");
        }
        tblReciept = new EnhancedTableModel((ArrayList) null, tableTitle);
    }
...
//        _isAvailable = ClientUtil.setTableModel(mapID, tblData);
     ...
     public static ReprintOB getInstance()throws Exception{
    ...
    public boolean isRdoTransfer() {
        return rdoTransfer;
    }

    public void setRdoTransfer(boolean rdoTransfer) {
        this.rdoTransfer = rdoTransfer;
    }
