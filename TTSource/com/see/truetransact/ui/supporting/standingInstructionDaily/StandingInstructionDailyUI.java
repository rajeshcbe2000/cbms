 ...
 * 
 * StandingInstructionDailyUI.java
 * STANDING_INSTRUCTON
 * Created on February 2, 2004, 2:38 PM
 */
package com.see.truetransact.ui.supporting.standingInstructionDaily;
 ...
 * Added Edit locking
 */
//import com.see.truetransact.ui.supporting.standinginstruction.*;
...
public class StandingInstructionDailyUI extends com.see.truetransact.uicomponent.CInternalFrame implements Observer, UIMandatoryField {
    ...
    private StandingInstructionDailyOB observable;
    private StandingInstructionDailyMRB objMandatoryRB = new StandingInstructionDailyMRB();
    ;
     ...
     */
    public StandingInstructionDailyUI() {
...
//        new MandatoryCheck().putMandatoryMarks(getClass().getName(),panCharges);
        ...
        tabDCDayBegin.remove(panMainSI);
        btnCancel.setEnabled(true);
        lblIntCalcDt.setVisible(false);
        tdtIntCalcDt.setVisible(false);
        panCheckBoxes1.setEnabled(false);
    ...
    private void setObservable() {
        observable = StandingInstructionDailyOB.getInstance();
        observable.addObserver(this);
    }

    public static void main(String[] arg) {
        javax.swing.JFrame jf = new javax.swing.JFrame();
        StandingInstructionDailyUI siUI = new StandingInstructionDailyUI();
...
//                    }
    ...
    private void initComponents() {
        ...
        RadioButtonTL = new javax.swing.JRadioButton();
        RadioButtonRD = new javax.swing.JRadioButton();
        RadioButtonADVariable = new javax.swing.JRadioButton();
        RadioButtonDeposit = new javax.swing.JRadioButton();
        lblIntCalcDt = new com.see.truetransact.uicomponent.CLabel();
        tdtIntCalcDt = new com.see.truetransact.uicomponent.CDateField();
        RadioButtonRDVariable = new javax.swing.JRadioButton();
        btnCancel1 = new com.see.truetransact.uicomponent.CButton();
        RadioButtonAD = new javax.swing.JRadioButton();
        scrOutputMsg1 = new com.see.truetransact.uicomponent.CScrollPane();
        tblData = new com.see.truetransact.uicomponent.CTable();
        panStandingTotal = new com.see.truetransact.uicomponent.CPanel();
        ...
        lblSelectCount = new com.see.truetransact.uicomponent.CLabel();
        ...
        lblTotal.setPreferredSize(new java.awt.Dimension(200, 18));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 3;
        gridBagConstraints.gridy = 0;
        panStatus.add(lblTotal, gridBagConstraints);
        ...
        panDebitSI.setMinimumSize(new java.awt.Dimension(816, 180));
        panDebitSI.setPreferredSize(new java.awt.Dimension(816, 180));
        ...
        srpDebitSI.setMinimumSize(new java.awt.Dimension(400, 100));
        srpDebitSI.setPreferredSize(new java.awt.Dimension(400, 100));
        ...
        panDebitActDetails.setMinimumSize(new java.awt.Dimension(400, 141));
        panDebitActDetails.setPreferredSize(new java.awt.Dimension(400, 141));
        ...
        gridBagConstraints.fill = java.awt.GridBagConstraints.BOTH;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        gridBagConstraints.insets = new java.awt.Insets(0, 0, 16, 4);
        ...
        srpCrebitSI.setMinimumSize(new java.awt.Dimension(454, 100));
        ...
        panCheckBoxes1.setMinimumSize(new java.awt.Dimension(536, 200));
        panCheckBoxes1.setPreferredSize(new java.awt.Dimension(536, 200));
        panCheckBoxes1.setLayout(new java.awt.GridBagLayout());

        panMultiSearch.setBorder(javax.swing.BorderFactory.createEtchedBorder());
        panMultiSearch.setMinimumSize(new java.awt.Dimension(875, 160));
        panMultiSearch.setPreferredSize(new java.awt.Dimension(875, 160));
        panMultiSearch.setLayout(new java.awt.GridBagLayout());

        btnSearchSI.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/see/truetransact/ui/images/TT_FIND.gif"))); // NOI18N
        btnSearchSI.setText("Search");
        btnSearchSI.setFont(new java.awt.Font("MS Sans Serif", 1, 13)); // NOI18N
        btnSearchSI.setMaximumSize(new java.awt.Dimension(120, 27));
        btnSearchSI.setMinimumSize(new java.awt.Dimension(120, 27));
        btnSearchSI.setPreferredSize(new java.awt.Dimension(120, 27));
        ...
        lblExecDateProc.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        ...
        btnSearchSI1.setForeground(new java.awt.Color(0, 0, 204));
        btnSearchSI1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/see/truetransact/ui/images/TT_AUTHORIZE.gif"))); // NOI18N
        btnSearchSI1.setText("PROCESS");
        btnSearchSI1.setFont(new java.awt.Font("MS Sans Serif", 1, 13)); // NOI18N
        btnSearchSI1.setMaximumSize(new java.awt.Dimension(120, 27));
        btnSearchSI1.setMinimumSize(new java.awt.Dimension(120, 27));
        btnSearchSI1.setPreferredSize(new java.awt.Dimension(120, 27));
        ...
        RadioButtonTL.setText("Loans (Fixed)");
        RadioButtonTL.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                RadioButtonTLActionPerformed(evt);
            }
        });
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        ...
        panMultiSearch.add(RadioButtonTL, gridBagConstraints);

        RadioButtonRD.setText("Reccuring Deposit (Fixed)");
        RadioButtonRD.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                RadioButtonRDActionPerformed(evt);
            }
        });
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 3;
        ...
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
        gridBagConstraints.insets = new java.awt.Insets(4, 4, 4, 4);
        panMultiSearch.add(RadioButtonRD, gridBagConstraints);

        RadioButtonADVariable.setText("Advances(Variable)");
        RadioButtonADVariable.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                RadioButtonADVariableActionPerformed(evt);
            }
        });
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 2;
        gridBagConstraints.gridy = 1;
        panMultiSearch.add(RadioButtonADVariable, gridBagConstraints);

        RadioButtonDeposit.setText("Loan Against Deposit");
        RadioButtonDeposit.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                RadioButtonDepositActionPerformed(evt);
            }
        });
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 5;
        ...
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
        gridBagConstraints.insets = new java.awt.Insets(4, 4, 4, 4);
        panMultiSearch.add(RadioButtonDeposit, gridBagConstraints);

        lblIntCalcDt.setText("Int Calc Dt");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 3;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.EAST;
        gridBagConstraints.insets = new java.awt.Insets(4, 4, 4, 4);
        panMultiSearch.add(lblIntCalcDt, gridBagConstraints);

        tdtIntCalcDt.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusLost(java.awt.event.FocusEvent evt) {
                tdtIntCalcDtFocusLost(evt);
            }
        });
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        ...
        gridBagConstraints.insets = new java.awt.Insets(4, 4, 4, 4);
        panMultiSearch.add(tdtIntCalcDt, gridBagConstraints);

        RadioButtonRDVariable.setText("Reccuring Deposit (Variable)");
        RadioButtonRDVariable.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                RadioButtonRDVariableActionPerformed(evt);
            }
        });
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 4;
        ...
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
        gridBagConstraints.insets = new java.awt.Insets(4, 4, 4, 4);
        panMultiSearch.add(RadioButtonRDVariable, gridBagConstraints);

        btnCancel1.setForeground(new java.awt.Color(0, 51, 51));
        ...
        btnCancel1.setFont(new java.awt.Font("MS Sans Serif", 1, 13)); // NOI18N
        btnCancel1.setMaximumSize(new java.awt.Dimension(120, 27));
        btnCancel1.setMinimumSize(new java.awt.Dimension(120, 27));
        btnCancel1.setPreferredSize(new java.awt.Dimension(120, 27));
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        gridBagConstraints.insets = new java.awt.Insets(4, 4, 4, 4);
        panMultiSearch.add(btnCancel1, gridBagConstraints);

        RadioButtonAD.setText("Advances(Fixed)");
        RadioButtonAD.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                RadioButtonADActionPerformed(evt);
            }
        });
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        ...
        panMultiSearch.add(RadioButtonAD, gridBagConstraints);
        ...
        tblData.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "SELECT", "SI ID", "LODGE DT", "SI START DT", "SI END DT", "DEBIT ACT", "DEBIT ACT BAL", "CREDIT ACT", "DEBIT AMT", "LAST RUN DT", "NEXT RUN_ T"
            }
        ));
        tblData.setSelectionBackground(new java.awt.Color(102, 255, 102));
        tblData.setSelectionForeground(new java.awt.Color(0, 0, 153));
        ...
        panStandingTotal.setMaximumSize(new java.awt.Dimension(925, 60));
        panStandingTotal.setMinimumSize(new java.awt.Dimension(925, 60));
        panStandingTotal.setPreferredSize(new java.awt.Dimension(925, 60));
        panStandingTotal.setLayout(new java.awt.GridBagLayout());
        ...
        panStandingTotal.add(lblTotalTransactionAmt, gridBagConstraints);
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.EAST;
        gridBagConstraints.insets = new java.awt.Insets(4, 0, 4, 4);
        panStandingTotal.add(lblTotalTransactionAmtVal, gridBagConstraints);

        lblSelectCount.setForeground(new java.awt.Color(51, 0, 255));
        lblSelectCount.setText("Selected Record :");
        lblSelectCount.setFont(new java.awt.Font("MS Sans Serif", 1, 12)); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 0;
        panStandingTotal.add(lblSelectCount, gridBagConstraints);

        lblCount.setForeground(new java.awt.Color(0, 0, 255));
        lblCount.setFont(new java.awt.Font("MS Sans Serif", 1, 12)); // NOI18N
        lblCount.setMaximumSize(new java.awt.Dimension(100, 21));
        lblCount.setMinimumSize(new java.awt.Dimension(100, 21));
        lblCount.setPreferredSize(new java.awt.Dimension(100, 21));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 2;
        gridBagConstraints.gridy = 0;
        panStandingTotal.add(lblCount, gridBagConstraints);

        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 4;
        panBatchProcess1.add(panStandingTotal, gridBagConstraints);
    ...
    private void cboProductTypeDSIItemStateChanged() {
        String prodType = ((ComboBoxModel) cboProductTypeDSI.getModel()).getKeyForSelected().toString();
        if ((!prodType.equals("")) && (prodType != null)) {
            if ((prodType.equals("OA")) || (prodType.equals("AD")) || (prodType.equals("GL")) || (prodType.equals("SA"))) {
                //do nothing
            } else {
                ClientUtil.showAlertWindow("ProdType can only be OA,GL,SA or AD");
                cboProductTypeDSI.setSelectedItem("");
...
//                }
    ...
    private void chkSelectAll1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_chkSelectAll1ActionPerformed
        // TODO add your handling code here:
        //observable.setSelectAll(new Boolean(chkSelectAll1.isSelected()),dataCount);
        // System.out.println("count####"+dataCount);
        boolean flag;
        if (chkSelectAll1.isSelected() == true) {
            flag = true;
        } else {
            flag = false;
        }
        for (int i = 0; i < tblData.getRowCount(); i++) {
           //added by rishad for mantis 6859.6860
            // tblData.setValueAt(new Boolean(flag), i, 0);
            double availbalnce = CommonUtil.convertObjToDouble(tblData.getValueAt(i, 6));
            double netamt = CommonUtil.convertObjToDouble(tblData.getValueAt(i, 8));
 ...
 //added by rishad for calculating total amount in table grid   
 private void setTotalAmount() {
        double totAmount = 0;
        String st = "";
        int count=0;
        for (int i = 0; i < tblData.getRowCount(); i++) {
            st = CommonUtil.convertObjToStr(tblData.getValueAt(i, 0));
            if (st.equals("true")) {
                totAmount = totAmount + CommonUtil.convertObjToDouble((CommonUtil.convertObjToStr(tblData.getValueAt(i, 8))).replaceAll(",", "")).doubleValue();
              count++;
            }
        }
        lblTotalTransactionAmtVal.setText(CurrencyValidation.formatCrore(String.valueOf(totAmount)));
        lblCount.setText(String.valueOf(count));
    }    public void populateData(String type) {
        //System.out.println("type####" + type);
        HashMap whereMap = new HashMap();
        HashMap viewMap = new HashMap();
        whereMap.put("NEXT_RUN_DT", dtdExecDateProc.getDateValue());
        whereMap.put("TYPE", type);
//        if(RadioButtonRD.isSelected()){
//            whereMap.put("SI_TYPE", "FIXED");
//        }else if(RadioButtonRDVariable.isSelected()){
//            whereMap.put("SI_TYPE", "VARIABLE");
//        }
            if (observable.getCboSIType().equalsIgnoreCase("Fixed")) {
                whereMap.put("SI_TYPE", "FIXED");
            } else if (observable.getCboSIType().equalsIgnoreCase("Variable")) {
                whereMap.put("SI_TYPE", "VARIABLE");
            }
        //Added By Suresh R
            String typeOfSI = "";
            if (RadioButtonTL.isSelected()) {
                typeOfSI = "LOAN";
            } else if (RadioButtonADVariable.isSelected()) {
                typeOfSI = "ADVANCE";
            } else if (RadioButtonAD.isSelected()) {
                typeOfSI = "ADVANCE";
            } else if (RadioButtonRD.isSelected()) {
                typeOfSI = "RECURRING_FIXED";
            } else if (RadioButtonRDVariable.isSelected()) {
                typeOfSI = "RECURRING_VARIABLE";
        ...
        if (type.equals("TLD")) {
            ...
            whereMap.put("TYPE", "TL");
            viewMap.put(CommonConstants.MAP_NAME, "getNormalSiForDepositExecution");
        } else {
            whereMap.put("BRANCH_CODE", TrueTransactMain.BRANCH_ID);
            whereMap.put("SAL_REC_MODULE", CommonUtil.convertObjToStr(CommonConstants.SAL_REC_MODULE));
            viewMap.put(CommonConstants.MAP_NAME, "getNormalSiForReExecution");
...
//            }
        ...
        if (CommonUtil.convertObjToStr(CommonConstants.SAL_REC_MODULE).equals("Y")) {
            if (type.equalsIgnoreCase("TL")) {
                whereMap.put("ASONDATE", DateUtil.getDateMMDDYYYY(tdtIntCalcDt.getDateValue()));
            } else {
                whereMap.put("ASONDATE", currDt.clone());
            }
        } else {
            whereMap.put("ASONDATE", currDt.clone());
        }
        ...
        try {
            ArrayList heading = observable.populateData(viewMap, tblData, typeOfSI);
        } catch (Exception e) {
    ...
    public void clearData() {
        ...
        colourList.clear();
	//Added By Suresh R
        btnSearchSI.setEnabled(true);
        btnSearchSI1.setEnabled(true);
        ClientUtil.enableDisable(panMultiSearch, true);
        dtdExecDateProc.setEnabled(false);
        tdtIntCalcDt.setEnabled(true);
    }

    private void setSizeTableData() {
        tblData.getColumnModel().getColumn(0).setPreferredWidth(30);
        tblData.getColumnModel().getColumn(1).setPreferredWidth(60);
        tblData.getColumnModel().getColumn(2).setPreferredWidth(65);
        tblData.getColumnModel().getColumn(3).setPreferredWidth(65);
        tblData.getColumnModel().getColumn(4).setPreferredWidth(65);
        tblData.getColumnModel().getColumn(5).setPreferredWidth(75);
        tblData.getColumnModel().getColumn(6).setPreferredWidth(70);
        tblData.getColumnModel().getColumn(7).setPreferredWidth(75);
        tblData.getColumnModel().getColumn(8).setPreferredWidth(60);
        tblData.getColumnModel().getColumn(9).setPreferredWidth(65);
        tblData.getColumnModel().getColumn(10).setPreferredWidth(65);
...
//                txtAccNoCSI.setText(String.valueOf(ACCOUNTNO));
    ...
    private void BalanceCheck() {
        for (int i = 0; i < tblData.getRowCount(); i++) {
            ...
            demandAmt = CommonUtil.convertObjToDouble(tblData.getValueAt(i, 6).toString()).doubleValue();
            recoveredAmt = CommonUtil.convertObjToDouble(tblData.getValueAt(i, 8).toString()).doubleValue();
...
//        }
    ...
    private void btnNewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNewActionPerformed
        ...
        enabledUI();
        chkSuspendUser.setEnabled(false);
        txtSiDt.setText(DateUtil.getStringDate((Date) currDt.clone()));
...
// TODO add your handling code here:
    ...
    if (count > 0) {
        ...
        if (st.equals("true")) {
            double availbalnce = CommonUtil.convertObjToDouble(tblData.getValueAt(tblData.getSelectedRow(), 6));
            double netamt = CommonUtil.convertObjToDouble(tblData.getValueAt(tblData.getSelectedRow(), 8));
            if (availbalnce < netamt) {
                tblData.setValueAt(false, tblData.getSelectedRow(), 0);
            } else {
...
private void RadioButtonTLActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_RadioButtonTLActionPerformed

    RadioButtonADVariable.setSelected(false);
    RadioButtonRD.setSelected(false);
    RadioButtonDeposit.setSelected(false);
    RadioButtonRDVariable.setSelected(false);
    observable.setStandType("TL");
    if (CommonUtil.convertObjToStr(CommonConstants.SAL_REC_MODULE).equals("Y")) {// Added by nithya on 03-03-2017 for 5763 [ RBI ]
        lblIntCalcDt.setVisible(true);
        tdtIntCalcDt.setVisible(true);
        tdtIntCalcDt.setEnabled(true);
    } else {
        lblIntCalcDt.setVisible(false);
        tdtIntCalcDt.setVisible(false);
...
}//GEN-LAST:event_RadioButtonTLActionPerformed

private void RadioButtonADVariableActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_RadioButtonADVariableActionPerformed
    RadioButtonTL.setSelected(false);
    RadioButtonRD.setSelected(false);
    RadioButtonDeposit.setSelected(false);
    RadioButtonRDVariable.setSelected(false);
    RadioButtonAD.setSelected(false);
    observable.setStandType("AD");
}//GEN-LAST:event_RadioButtonADVariableActionPerformed

private void RadioButtonRDActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_RadioButtonRDActionPerformed
    RadioButtonADVariable.setSelected(false);
    RadioButtonTL.setSelected(false);
    RadioButtonDeposit.setSelected(false);
    RadioButtonRDVariable.setSelected(false);
    observable.setStandType("TD");
}//GEN-LAST:event_RadioButtonRDActionPerformed

    private void RadioButtonDepositActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_RadioButtonDepositActionPerformed
        // TODO add your handling code here:
        RadioButtonADVariable.setSelected(false);
        RadioButtonTL.setSelected(false);
        RadioButtonRD.setSelected(false);
        RadioButtonRDVariable.setSelected(false);
        observable.setStandType("TLD");
    }//GEN-LAST:event_RadioButtonDepositActionPerformed

    private void tdtIntCalcDtFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_tdtIntCalcDtFocusLost
        // TODO add your handling code here:
        dtdExecDateProc.setDateValue(tdtIntCalcDt.getDateValue()); // Added by nithya on 14-02-2017
    }//GEN-LAST:event_tdtIntCalcDtFocusLost

    private void RadioButtonRDVariableActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_RadioButtonRDVariableActionPerformed
        // TODO add your handling code here:
        RadioButtonADVariable.setSelected(false);
        RadioButtonTL.setSelected(false);
        RadioButtonDeposit.setSelected(false);
        RadioButtonRD.setSelected(false);
        observable.setStandType("TD");
    }//GEN-LAST:event_RadioButtonRDVariableActionPerformed
...
//         if(isCheck){
        ...
        //System.out.println("count" + rowscnt);
...
//                                    newBranMap.put("BRANCH_CODE", CommonUtil.convertObjToStr(tblData.getValueAt(i,2)));
                    ...
                    //System.out.println("newBranMappppppp" + newBranMap);
                    branAryLst.add(newBranMap);
                    // branAryLst.add("status");
//                                    branMap.put("BRANCH_LST", branAryLst);
//                  System.out.println("count"+rowscnt);                  dayEndPrev = "DAY_END_PREV";
//                                    isCheck = false;
                    //System.out.println("listt" + branAryLst);
                }
            }

            // Added by nithya on 14-02-2017
            //observable.setStandType("TL");
            if (CommonUtil.convertObjToStr(CommonConstants.SAL_REC_MODULE).equals("Y")) {
                if (observable.getStandType().equalsIgnoreCase("TL")) {
                    observable.setTdtIntCalcDt(tdtIntCalcDt.getDateValue().toString());
                    //System.out.println("tdtIntCalcDt.getDateValue() :: " + tdtIntCalcDt.getDateValue());
                }
            }
            // End
        ...
        if (branAryLst != null && branAryLst.size() > 0) { //Added By Suresh R  13-Jul-2017
            btnSearchSI1.setEnabled(false);
            observable.doExecute(branAryLst, typeOfSI);
            if (observable.getProxyReturnMap() == null || observable.getProxyReturnMap().size() == 0) {
                ClientUtil.showMessageWindow("Process completed, but no transactions created !!! ");//Message Changed by kannan AR
            } else {
                returnMap = observable.getProxyReturnMap();
                System.out.println("returnMap@@@@@@@@" + returnMap);
                if (returnMap.get("SINGLE_TRANS_ID") != null) {
            ...
            clearData();
        } else {//Added By Suresh R
            ClientUtil.showMessageWindow("No Record to Process !!!");
            return;
        }
    ...
    private void btnSearchSIActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearchSIActionPerformed
        // TODO add your handling code here:
        if (CommonUtil.convertObjToStr(CommonConstants.SAL_REC_MODULE).equals("Y") && RadioButtonTL.isSelected()) { // Added by nithya on 03-03-2017 for 5763 [ RBI ]
            if (tdtIntCalcDt.getDateValue().length() == 0) {
                ClientUtil.showAlertWindow("Please select Last interest calc date");
                return;
            }
        }
        if (RadioButtonADVariable.isSelected() == false && RadioButtonAD.isSelected()==false&& RadioButtonTL.isSelected() == false && RadioButtonRD.isSelected() == false
                && RadioButtonRDVariable.isSelected() == false && RadioButtonDeposit.isSelected() == false) {
            ClientUtil.showAlertWindow("Please Select any Standing Instruction Type");
        } else {
            tblData.setEnabled(true);
            String type = ""; 
            boolean RecurDep = RadioButtonRD.isSelected();
            boolean RecurDepVariable = RadioButtonRDVariable.isSelected();  //Added By Suresh R
//        reciept radio button
            boolean Loan = RadioButtonTL.isSelected();
            boolean Advance = RadioButtonADVariable.isSelected();
            boolean AdvanceFixed = RadioButtonAD.isSelected();
            boolean Loan1 = RadioButtonDeposit.isSelected();
            if (RecurDep) {
                type = observable.getStandType();
                observable.setCboSIType("Fixed");
            } else if (Loan) {
                observable.setCboSIType("Fixed");
                type = observable.getStandType();
            } else if (Advance) {
                observable.setCboSIType("Variable");
                type = observable.getStandType();
            } else if (Loan1) {
                observable.setCboSIType("Variable");
                type = observable.getStandType();
            } else if (RecurDepVariable) {
                observable.setCboSIType("Variable");
                type = observable.getStandType();
            } else if (AdvanceFixed) {
                observable.setCboSIType("Fixed");
                type = observable.getStandType();
            }
            populateData(type);
            ...
            setColour();
            btnCancel.setEnabled(true);
            dataCount = tblData.getRowCount();
            if (dataCount > 0) {//Added By Suresh R
                ClientUtil.enableDisable(panMultiSearch, false);
                chkSelectAll1.setEnabled(true);
                btnSearchSI.setEnabled(false);
            }
            System.out.println("#### Table Record Count : " + dataCount);
        }
    }//GEN-LAST:event_btnSearchSIActionPerformed

    private void RadioButtonADActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_RadioButtonADActionPerformed
        // TODO add your handling code here:
    RadioButtonTL.setSelected(false);
    RadioButtonRD.setSelected(false);
    RadioButtonDeposit.setSelected(false);
    ...
    RadioButtonADVariable.setSelected(false);
    observable.setStandType("AD");
    }//GEN-LAST:event_RadioButtonADActionPerformed
    ...
    private javax.swing.JRadioButton RadioButtonAD;
    private javax.swing.JRadioButton RadioButtonADVariable;
    private javax.swing.JRadioButton RadioButtonDeposit;
    private javax.swing.JRadioButton RadioButtonRD;
    private javax.swing.JRadioButton RadioButtonRDVariable;
    private javax.swing.JRadioButton RadioButtonTL;
    ...
    private com.see.truetransact.uicomponent.CLabel lblIntCalcDt;
    ...
    private com.see.truetransact.uicomponent.CLabel lblSelectCount;
    ...
    private com.see.truetransact.uicomponent.CPanel panStandingTotal;
    ...
    private com.see.truetransact.uicomponent.CDateField tdtIntCalcDt;
