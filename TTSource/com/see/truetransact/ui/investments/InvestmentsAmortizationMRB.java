...
public class InvestmentsAmortizationMRB extends ListResourceBundle {
    public InvestmentsAmortizationMRB(){
    }
    ...
    static final String[][] contents = {
        ...
        {"txtInvestmentAmount", "Investment Amount be a proper value!!!"},
