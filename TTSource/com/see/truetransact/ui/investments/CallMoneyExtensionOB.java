...
public class CallMoneyExtensionOB extends CObservable{
    ...
    private static CallMoneyExtensionOB objCallMoneyExtensionOB;//Singleton Object
    ...
    static {
        try {
            ...
            objCallMoneyExtensionOB= new CallMoneyExtensionOB();
        } catch(Exception e) {
            parseException.logException(e,true);
        }
    }
    ...
    public static CallMoneyExtensionOB getInstance()throws Exception{
        return objCallMoneyExtensionOB;
    }
    ...
    public void execute(String command) {
        try {
            ...
            term.put("CALLMONEYEXTENSION","CALLMONEYEXTENSION");
    ...
    public  void resetForm(){
        ...
        setChanged();
        setTransDate(null);
        setNoOfDayExtension(null);
        setExtensioninterestRate(null);
        setCallMoneyType("");
        notifyObservers();
    }
    ...
    public void setCallMoneyTo(CallMoneyTO objCallMoneyTO ){
        ...
        setTransDate(objCallMoneyTO.getTransDT());
        setExtensioninterestRate(objCallMoneyTO.getExtensioninterestRate());
        setNoOfDayExtension(objCallMoneyTO.getNoOfDayExtension());
    ...
    public CallMoneyTO getCallMoneyTO(String command){
        ...
        objgetCallMoneyTO.setExtensioninterestRate(getExtensioninterestRate());
        objgetCallMoneyTO.setNoOfDayExtension(getNoOfDayExtension());
    ...
    public void populateData(HashMap whereMap) {
        ...
        try {
            if(getActionType()!=ClientConstants.ACTIONTYPE_NEW){
                whereMap.put("OTHERTHANINSERT","OTHERTHANINSERT");
            }
    ...
    private void setCallMoneyTransDetTable(ArrayList transList){
        ...
        for(int i=0 ;i<transList.size();i++){
            ...
            invAmrDetRow.add(9,String.valueOf(objCallMoneyTO.getCallMoneyAmount()));
