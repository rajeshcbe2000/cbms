 ...
 *
 */
public class EmpTrainingOB extends CObservable {
    ...
    private final static Logger log = Logger.getLogger(EmpTrainingOB.class);
   ...
   public EmpTrainingOB() {
    ...
    public EmpTrainingTO setEmpTranferData() {
        
        final EmpTrainingTO objEmpTrainingTO = new EmpTrainingTO();
        try{
           objEmpTrainingTO.setBranCode(TrueTransactMain.BRANCH_ID);
           objEmpTrainingTO.setDestination(CommonUtil.convertObjToStr(getCbmTrainingDest().getKeyForSelected()));
           ...
           objEmpTrainingTO.setTeamSize(getTeamSize());
           objEmpTrainingTO.setNoOfEmp(getNoOfTrainees());
    ...
    private void populateEmpTrainingData(EmpTrainingTO objEmpTrainingTO) throws Exception{
