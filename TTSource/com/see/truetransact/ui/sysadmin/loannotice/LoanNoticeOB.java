...
public class LoanNoticeOB extends CObservable {
    ...
    private ComboBoxModel cbmNotType;
    private String cboNotType = "";
    private static Date currDt = null;

    private static LoanNoticeOB loanNoticeOB;
    static {
        try {
            currDt = ClientUtil.getCurrentDate();
            loanNoticeOB = new LoanNoticeOB();
        } catch(Exception e) {
        }
    }
    
    public static LoanNoticeOB getInstance() {
        return loanNoticeOB;
    }
    
    /** Creates a new instance of LoanNoticeOB */
    public LoanNoticeOB() throws Exception {
        initiate();
    }
    ...
    private void fillDropDown() throws Exception{
        ...
        lookupKey.add("NOTICE_PERIOD_PRODUCTTYPE");
        ...
        fillData((HashMap)lookupValues.get("NOTICE_PERIOD_PRODUCTTYPE"));
        cbmProdType=new ComboBoxModel(key,value);
        
        param.put(CommonConstants.MAP_NAME,"getNoticeType");
        ...
        cbmNotType = new ComboBoxModel(key,value);
    ...
    public void setAccountName(){
        try {
            ...
            if(this.prodType.equals("OA")){
             resultList = ClientUtil.executeQuery("getAccountNumberNamePassBook"+this.getProdType(),accountNameMap);
            }else{
...
//                    Date currDt = DateUtil.getDateMMDDYYYY(CommonUtil.convertObjToStr(currDt.clone()));
                    int transMonth = 0;
                    int transYear = 0;
                    if(tranDt==null){
    ...
    public void setCbmProdId(String prodType) {
        if (CommonUtil.convertObjToStr(prodType).length()>1) {
            if (prodType.equals("GL")) {
                ...
                try {
                    HashMap lookupMap = new HashMap();
                    lookupMap.put(CommonConstants.MAP_NAME,"Cash.getAccProduct" + prodType);
    ...
    /**
     * Getter for property cbmNotType.
     * @return Value of property cbmNotType.
     */
    public com.see.truetransact.clientutil.ComboBoxModel getCbmNotType() {
        return cbmNotType;
    }
    
    /**
     * Setter for property cbmNotType.
     * @param cbmNotType New value of property cbmNotType.
     */
    public void setCbmNotType(com.see.truetransact.clientutil.ComboBoxModel cbmNotType) {
        this.cbmNotType = cbmNotType;
    }
    
    /**
     * Getter for property cboNotType.
     * @return Value of property cboNotType.
     */
    public java.lang.String getCboNotType() {
        return cboNotType;
    }
    
    /**
     * Setter for property cboNotType.
     * @param cboNotType New value of property cboNotType.
     */
    public void setCboNotType(java.lang.String cboNotType) {
        this.cboNotType = cboNotType;
    }
