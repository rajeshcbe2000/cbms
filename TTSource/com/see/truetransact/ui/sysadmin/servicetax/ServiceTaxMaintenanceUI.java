 ...
 * @author  rahul
 */
public class ServiceTaxMaintenanceUI extends CInternalFrame implements java.util.Observer, UIMandatoryField {
    private HashMap mandatoryMap;
    ServiceTaxMaintenanceOB observable;
    
    final int EDIT=0, DELETE=1, ACCNUMBER=2,AUTHORIZE=3, VIEW=4,Cess1=5,Cess2=6,StHd=7;
    ...
    boolean flag =false;
    //    final ServiceTaxMaintenanceRB resourceBundle = new ServiceTaxMaintenanceRB();
    java.util.ResourceBundle resourceBundle = java.util.ResourceBundle.getBundle("com.see.truetransact.ui.sysadmin.servicetax.ServiceTaxMaintenanceRB", ProxyParameters.LANGUAGE);
    
    //Logger
    private final static Logger log = Logger.getLogger(ServiceTaxMaintenanceUI.class);
    
    /** Creates new form ServiceTaxMaintenanceUI */
    public ServiceTaxMaintenanceUI() {
        initComponents();
        initSetup();
    }
    ...
    private void initSetup(){
        ...
        resetUI();
        txtTotTaxRate.setEditable(false);
        txtTotTaxRate.setEnabled(false);
        setHelpMessage();
        txtServiceTaxAchd.setEditable(false);
        txtCess1AcHd.setEditable(false);
        txtCess2AcHd.setEditable(false);
        
        //__ To reset the value of the visited tabs...
        tabServiceTaxMaintenance.resetVisits();
    }
    ...
    private void setObservable() {
        observable = ServiceTaxMaintenanceOB.getInstance();
...
//        lblProdType.setName("lblProdType");
        ...
        panServiceTaxMaintenance.setName("panServiceTaxMaintenance");
...
//        srpProduct.setName("srpProduct");
        tabServiceTaxMaintenance.setName("tabServiceTaxMaintenance");
...
//        txtAgainstInterest.setName("txtAgainstInterest");
        txtTotTaxRate.setName("txtStatementPenal");
...
//        txtLimitAmt.setName("txtLimitAmt");
        txtCess1Rate.setName("txtODI");
        txtCess2Rate.setName("txtPenalInterest");
        txtServiceTaxRate.setName("txtRateInterest");
        txtToPeriod.setName("txtToPeriod");
        lblServiceTaxHd.setName("lblServiceTaxHd");
        lblCess1Achd.setName("lblCess1Achd");
        lblCess2AcHd.setName("lblCess2AcHd");
        panTaxAcHd.setName("panTaxAcHd");
        panInterestCalculation.setName("panInterestCalculation");
        panInterestGroup.setName("panInterestGroup");
    }
...
//        lblInterExpiry.setText(resourceBundle.getString("lblInterExpiry"));
        ...
        lblServiceTaxHd.setText(resourceBundle.getString("lblServiceTaxHd"));
        lblCess1Achd.setText(resourceBundle.getString("lblCess1Achd"));
        lblCess2AcHd.setText(resourceBundle.getString("lblCess2AcHd"));
        panTaxAcHd.setName(resourceBundle.getString("panTaxAcHd"));
        panInterestCalculation.setName(resourceBundle.getString("panInterestCalculation"));
//        panInterestGroup.setName(resourceBundle.getString("panInterestGroup"));
        tabServiceTaxMaintenance.setTitleAt(0, resourceBundle.getString("panInterestGroup"));
         tabServiceTaxMaintenance.setTitleAt(2, resourceBundle.getString("panInterestCalculation"));
         tabServiceTaxMaintenance.setTitleAt(1,resourceBundle.getString("panTaxAcHd"));
...
//        cboProdType.setSelectedItem(observable.getCboProdType());
        ...
        txtServiceTaxRate.setText(observable.getTxtServiceTax());
        txtCess1Rate.setText(observable.getTxtCess1Tax());
...
//        txtInterExpiry.setText(observable.getTxtInterExpiry());
        txtCess2Rate.setText(observable.getTxtCess2Tax());
        txtTotTaxRate.setText(observable.getTxtTotTax());
...
//        observable.setCboProdType((String) cboProdType.getSelectedItem());
        ...
        observable.setTxtServiceTax(txtServiceTaxRate.getText());
        observable.setTxtCess1Tax(txtCess1Rate.getText());
...
//        observable.setTxtInterExpiry(txtInterExpiry.getText());
        observable.setTxtCess2Tax(txtCess2Rate.getText());
        observable.setTxtTotTax(txtTotTaxRate.getText());
        observable.setStAcHdId(txtServiceTaxAchd.getText());
        observable.setCess1HdId(txtCess1AcHd.getText());
        observable.setCess2HdId(txtCess2AcHd.getText());
...
//        observable.setTblProduct((com.see.truetransact.clientutil.EnhancedTableModel)tblProduct.getModel());
   ...
   object. Help display Label name should be lblMsg. */
    public void setHelpMessage() {
        ServiceTaxMaintenanceMRB objMandatoryRB = new ServiceTaxMaintenanceMRB();
        ...
        txtServiceTaxRate.setHelpMessage(lblMsg, objMandatoryRB.getString("txtRateInterest"));
        txtCess1Rate.setHelpMessage(lblMsg, objMandatoryRB.getString("txtPenalInterest"));
...
//        cboProdType.setModel(observable.getCbmProdType());
    ...
    private void setMaxLenths() {
        ...
        txtToPeriod.setMaxLength(3);
        txtToPeriod.setValidation(new NumericValidation());
        
        txtServiceTaxRate.setMaxLength(6);
        txtServiceTaxRate.setValidation(new NumericValidation(4,2));
        
        txtCess1Rate.setMaxLength(6);
        txtCess1Rate.setValidation(new NumericValidation(4,2));
        
//        txtAgainstInterest.setMaxLength(16);
//        txtAgainstInterest.setValidation(new NumericValidation(14,2));
        
//        txtLimitAmt.setMaxLength(16);
//        txtLimitAmt.setValidation(new CurrencyValidation(14,2));
        
//        txtInterExpiry.setMaxLength(16);
//        txtInterExpiry.setValidation(new NumericValidation(14,2));
        
        txtTotTaxRate.setMaxLength(6);
        txtTotTaxRate.setValidation(new NumericValidation(4,2));
        
        txtCess2Rate.setMaxLength(6);
        txtCess2Rate.setValidation(new NumericValidation(4,2));
    }
    ...
    private void setButtonEnableDisable() {
        ...
        btnView.setEnabled(!btnView.isEnabled());
         btnCess1Help.setEnabled(!btnNew.isEnabled());
        btnServiceTax.setEnabled(!btnNew.isEnabled());
        btnSess2Help.setEnabled(!btnNew.isEnabled());
    }
    ...
    private void initComponents() {
        ...
        panServiceTaxMaintenance = new com.see.truetransact.uicomponent.CPanel();
        lblSpaces = new com.see.truetransact.uicomponent.CLabel();
        tabServiceTaxMaintenance = new com.see.truetransact.uicomponent.CTabbedPane();
        ...
        panTaxAcHd = new com.see.truetransact.uicomponent.CPanel();
        panGroupnfo1 = new com.see.truetransact.uicomponent.CPanel();
        lblGroupIdDesc1 = new com.see.truetransact.uicomponent.CLabel();
        btnServiceTax = new com.see.truetransact.uicomponent.CButton();
        txtServiceTaxAchd = new com.see.truetransact.uicomponent.CTextField();
        lblServiceTaxHd = new com.see.truetransact.uicomponent.CLabel();
        btnCess1Help = new com.see.truetransact.uicomponent.CButton();
        txtCess1AcHd = new com.see.truetransact.uicomponent.CTextField();
        lblCess1Achd = new com.see.truetransact.uicomponent.CLabel();
        btnSess2Help = new com.see.truetransact.uicomponent.CButton();
        txtCess2AcHd = new com.see.truetransact.uicomponent.CTextField();
        lblCess2AcHd = new com.see.truetransact.uicomponent.CLabel();
        ...
        txtServiceTaxRate = new com.see.truetransact.uicomponent.CTextField();
        ...
        txtCess1Rate = new com.see.truetransact.uicomponent.CTextField();
        ...
        txtCess2Rate = new com.see.truetransact.uicomponent.CTextField();
        lblODI_Per = new com.see.truetransact.uicomponent.CLabel();
        lblStatementPenal = new com.see.truetransact.uicomponent.CLabel();
        txtTotTaxRate = new com.see.truetransact.uicomponent.CTextField();
        ...
        panServiceTaxMaintenance.setBorder(javax.swing.BorderFactory.createEtchedBorder());
        panServiceTaxMaintenance.setMinimumSize(new java.awt.Dimension(872, 561));
        panServiceTaxMaintenance.setPreferredSize(new java.awt.Dimension(872, 561));
        panServiceTaxMaintenance.setLayout(new java.awt.GridBagLayout());
        ...
        panServiceTaxMaintenance.add(lblSpaces, gridBagConstraints);

        tabServiceTaxMaintenance.setMinimumSize(new java.awt.Dimension(860, 534));
        tabServiceTaxMaintenance.setPreferredSize(new java.awt.Dimension(860, 534));
        ...
        tblCategory.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Check", "Category", "Category Description", "Status"
            }
        ) {
        ...
        tabServiceTaxMaintenance.addTab("Interest Rate Group", panInterestGroup);

        panTaxAcHd.setLayout(new java.awt.GridBagLayout());

        panGroupnfo1.setLayout(new java.awt.GridBagLayout());
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 1;
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
        ...
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.insets = new java.awt.Insets(4, 4, 4, 4);
        panGroupnfo1.add(lblGroupIdDesc1, gridBagConstraints);
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        gridBagConstraints.insets = new java.awt.Insets(4, 4, 4, 4);
        panTaxAcHd.add(panGroupnfo1, gridBagConstraints);

        btnServiceTax.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/see/truetransact/ui/images/TT_SELECT.gif"))); // NOI18N
        btnServiceTax.setMinimumSize(new java.awt.Dimension(21, 21));
        btnServiceTax.setPreferredSize(new java.awt.Dimension(21, 21));
        btnServiceTax.setEnabled(false);
        btnServiceTax.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnServiceTaxActionPerformed(evt);
            }
        });
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 2;
        gridBagConstraints.gridy = 1;
        panTaxAcHd.add(btnServiceTax, gridBagConstraints);

        txtServiceTaxAchd.setMinimumSize(new java.awt.Dimension(76, 21));
        txtServiceTaxAchd.setPreferredSize(new java.awt.Dimension(76, 21));
        txtServiceTaxAchd.setEnabled(false);
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 1;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        gridBagConstraints.insets = new java.awt.Insets(4, 4, 4, 4);
        panTaxAcHd.add(txtServiceTaxAchd, gridBagConstraints);

        lblServiceTaxHd.setText("ServiceTaxAccountHead");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 1;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.EAST;
        gridBagConstraints.insets = new java.awt.Insets(4, 4, 4, 4);
        panTaxAcHd.add(lblServiceTaxHd, gridBagConstraints);

        btnCess1Help.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/see/truetransact/ui/images/TT_SELECT.gif"))); // NOI18N
        btnCess1Help.setMinimumSize(new java.awt.Dimension(21, 21));
        btnCess1Help.setPreferredSize(new java.awt.Dimension(21, 21));
        btnCess1Help.setEnabled(false);
        btnCess1Help.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnCess1HelpActionPerformed(evt);
            }
        });
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 2;
        gridBagConstraints.gridy = 2;
        panTaxAcHd.add(btnCess1Help, gridBagConstraints);

        txtCess1AcHd.setMinimumSize(new java.awt.Dimension(76, 21));
        txtCess1AcHd.setPreferredSize(new java.awt.Dimension(76, 21));
        txtCess1AcHd.setEnabled(false);
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 2;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        gridBagConstraints.insets = new java.awt.Insets(4, 4, 4, 4);
        panTaxAcHd.add(txtCess1AcHd, gridBagConstraints);

        lblCess1Achd.setText("Cess1");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 2;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.EAST;
        gridBagConstraints.insets = new java.awt.Insets(4, 4, 4, 4);
        panTaxAcHd.add(lblCess1Achd, gridBagConstraints);

        btnSess2Help.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/see/truetransact/ui/images/TT_SELECT.gif"))); // NOI18N
        btnSess2Help.setMinimumSize(new java.awt.Dimension(21, 21));
        btnSess2Help.setPreferredSize(new java.awt.Dimension(21, 21));
        btnSess2Help.setEnabled(false);
        btnSess2Help.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnSess2HelpActionPerformed(evt);
            }
        });
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 2;
        gridBagConstraints.gridy = 3;
        panTaxAcHd.add(btnSess2Help, gridBagConstraints);

        txtCess2AcHd.setMinimumSize(new java.awt.Dimension(76, 21));
        txtCess2AcHd.setPreferredSize(new java.awt.Dimension(76, 21));
        txtCess2AcHd.setEnabled(false);
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 3;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        gridBagConstraints.insets = new java.awt.Insets(4, 4, 4, 4);
        panTaxAcHd.add(txtCess2AcHd, gridBagConstraints);

        lblCess2AcHd.setText("Cess2");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 3;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.EAST;
        gridBagConstraints.insets = new java.awt.Insets(4, 4, 4, 4);
        panTaxAcHd.add(lblCess2AcHd, gridBagConstraints);

        tabServiceTaxMaintenance.addTab("Account Head", panTaxAcHd);
        ...
        lblRateInterest.setText("Service Tax");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        ...
        txtServiceTaxRate.setMinimumSize(new java.awt.Dimension(50, 21));
        txtServiceTaxRate.setPreferredSize(new java.awt.Dimension(50, 21));
        txtServiceTaxRate.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusLost(java.awt.event.FocusEvent evt) {
                txtServiceTaxRateFocusLost(evt);
            }
        });
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        gridBagConstraints.insets = new java.awt.Insets(4, 4, 4, 4);
        panCalculations.add(txtServiceTaxRate, gridBagConstraints);
        ...
        lblPenalInterest.setText("Cess1");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        ...
        txtCess1Rate.setMinimumSize(new java.awt.Dimension(50, 21));
        txtCess1Rate.setPreferredSize(new java.awt.Dimension(50, 21));
        txtCess1Rate.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusLost(java.awt.event.FocusEvent evt) {
                txtCess1RateFocusLost(evt);
            }
        });
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        gridBagConstraints.insets = new java.awt.Insets(4, 4, 4, 4);
        panCalculations.add(txtCess1Rate, gridBagConstraints);
        ...
        txtCess2Rate.setMinimumSize(new java.awt.Dimension(50, 21));
        txtCess2Rate.setPreferredSize(new java.awt.Dimension(50, 21));
        txtCess2Rate.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusLost(java.awt.event.FocusEvent evt) {
                txtCess2RateFocusLost(evt);
            }
        });
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        gridBagConstraints.insets = new java.awt.Insets(4, 4, 4, 4);
        panCalculations.add(txtCess2Rate, gridBagConstraints);
        ...
        lblStatementPenal.setText("TotalServiceTax");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        ...
        txtTotTaxRate.setMinimumSize(new java.awt.Dimension(50, 21));
        txtTotTaxRate.setPreferredSize(new java.awt.Dimension(50, 21));
        txtTotTaxRate.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txtTotTaxRateActionPerformed(evt);
            }
        });
        txtTotTaxRate.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusLost(java.awt.event.FocusEvent evt) {
                txtTotTaxRateFocusLost(evt);
            }
        });
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        gridBagConstraints.insets = new java.awt.Insets(4, 4, 4, 4);
        panCalculations.add(txtTotTaxRate, gridBagConstraints);
        ...
        tabServiceTaxMaintenance.addTab("Interest Calculation", panInterestCalc);
        ...
        gridBagConstraints.weighty = 1.0;
        gridBagConstraints.insets = new java.awt.Insets(4, 4, 4, 4);
        panServiceTaxMaintenance.add(tabServiceTaxMaintenance, gridBagConstraints);

        getContentPane().add(panServiceTaxMaintenance, java.awt.BorderLayout.CENTER);
    ...
    private void txtGroupNameFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtGroupNameFocusLost
        ...
        HashMap ctgMap=new HashMap();
        String groupName=CommonUtil.convertObjToStr(txtGroupName.getText());
        ctgMap.put("ROI_GROUP_ID",groupName);
        List serCtgLst=ClientUtil.executeQuery("getAllServiceTaxGroupNames",ctgMap);
        System.out.println("serCtgLst-----"+serCtgLst);
        if(serCtgLst!=null && serCtgLst.size()!=0){
          ctgMap=(HashMap)serCtgLst.get(0); 
          int count=0;
          count=CommonUtil.convertObjToInt(ctgMap.get("COUNT"));
          if(count!=0){
              ClientUtil.displayAlert("Already This Groupname is their");
    ...
    private void txtCess2RateFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtCess2RateFocusLost
        // TODO add your handling code here:
        sumOfTax();
    }//GEN-LAST:event_txtCess2RateFocusLost

    private void txtCess1RateFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtCess1RateFocusLost
        // TODO add your handling code here:
        sumOfTax();
    }//GEN-LAST:event_txtCess1RateFocusLost

    private void txtServiceTaxRateFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtServiceTaxRateFocusLost
        // TODO add your handling code here:
        sumOfTax();
    }//GEN-LAST:event_txtServiceTaxRateFocusLost

    private void txtTotTaxRateFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtTotTaxRateFocusLost
        // TODO add your handling code here:
//     double total_tax=0.0;
//     total_tax=CommonUtil.convertObjToDouble(txtServiceTaxRate.getText()).doubleValue()+
//               CommonUtil.convertObjToDouble(txtCess1Rate.getText()).doubleValue()+
//               CommonUtil.convertObjToDouble(txtCess2Rate.getText()).doubleValue();
    }//GEN-LAST:event_txtTotTaxRateFocusLost

    private void txtTotTaxRateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtTotTaxRateActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_txtTotTaxRateActionPerformed

    private void btnSess2HelpActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSess2HelpActionPerformed
        // TODO add your handling code here:
       ...
       viewType=Cess2;
        viewMap.put(CommonConstants.MAP_NAME,"OperativeAcctProduct.getSelectAcctHeadTOList");
                 ...
                 viewType=-1;
    }//GEN-LAST:event_btnSess2HelpActionPerformed

    private void btnCess1HelpActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCess1HelpActionPerformed
        // TODO add your handling code here:
         HashMap viewMap=new HashMap();
        viewType=Cess1;
        viewMap.put(CommonConstants.MAP_NAME,"OperativeAcctProduct.getSelectAcctHeadTOList");
    ...
    }//GEN-LAST:event_btnCess1HelpActionPerformed

    private void btnServiceTaxActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnServiceTaxActionPerformed
        // TODO add your handling code here:
        viewType=StHd;
         HashMap viewMap=new HashMap();
               viewMap.put(CommonConstants.MAP_NAME,"OperativeAcctProduct.getSelectAcctHeadTOList");
    ...
    }//GEN-LAST:event_btnServiceTaxActionPerformed
    ...
    private void setVisibleOA(){
        ...
        lblPenalInterest.setVisible(false);
//        txtPenalInterest.setVisible(false);
        lblPenalInterestPer.setVisible(false);
...
//          tblProduct.setEnabled(false);
    ...
    public void authorizeStatus(String authorizeStatus) {
        if (viewType == AUTHORIZE && isFilled){
            ...
            //Changed BY Suresh
//            String warningMessage = tabServiceTaxMaintenance.isAllTabsVisited();
//            
...
//                ClientUtil.execute("authInterMaintenance", singleAuthorizeMap);
                ClientUtil.execute("authServiceTaxMaintenanceForDepositRoiGroupTypeRate", singleAuthorizeMap);
...
//            }
            ...
            mapParam.put(CommonConstants.MAP_NAME, "getSelectServiceTaxMaintenance");
...
//            whereMap.put("BRANCHID",TrueTransactMain.BRANCH_ID);
    ...
    private void btnTabSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTabSaveActionPerformed
        ...
        try{
            ...
            if((CommonUtil.convertObjToDouble(txtServiceTaxRate.getText()).doubleValue() > 100)
            ||(CommonUtil.convertObjToDouble(txtCess1Rate.getText()).doubleValue() > 100)){
                strBAlert.append(resourceBundle.getString("RATE_WARNING")+"\n");
            }
            ...
            if(CommonUtil.convertObjToDouble(txtCess1Rate.getText()).doubleValue() > CommonUtil.convertObjToDouble(txtServiceTaxRate.getText()).doubleValue()){
                strBAlert.append(resourceBundle.getString("PENAL_WARNING")+"\n");
            }
            
            if( !txtCess1Rate.getText().equals("") && CommonUtil.convertObjToDouble(txtCess1Rate.getText()).doubleValue()>0.0 && txtCess1AcHd.getText().equals("") ){
                displayAlert("please Select The Cess1 Account Head");
            }
            else if( !txtCess2Rate.getText().equals("") && CommonUtil.convertObjToDouble(txtCess2Rate.getText()).doubleValue()>0.0 && txtCess2AcHd.getText().equals("") ){
                displayAlert("please Select The Cess2 Account Head");
            }
            else  if( !txtServiceTaxRate.getText().equals("") && CommonUtil.convertObjToDouble(txtServiceTaxRate.getText()).doubleValue()>0.0 && txtServiceTaxAchd.getText().equals("") ){
                displayAlert("please Select The Service Tax Account Head");
            }
            
            else if( observable.getActionType() != ClientConstants.ACTIONTYPE_DELETE && strBAlert.toString().length() > 0 ){
...
//            displayAlert(resourceBundle.getString(mandatoryMessage));
            ...
            observable.resetTable();
            ClientUtil.enableDisable(panCalculations, true);
            txtServiceTaxAchd.setText(observable.getStAcHdId());
...
//            }
    ...
    private void resetUI(){
        ...
        txtCess1AcHd.setText("");
        txtCess2AcHd.setText("");
        txtServiceTaxAchd.setText("");
        observable.setIsTableSet(false);
        txtServiceTaxRate.setText("");
        txtCess1Rate.setText("");
        txtCess2Rate.setText("");
            ...
            if(observable.getActionType() != ClientConstants.ACTIONTYPE_NEW && !(observable.getRowCount() > 0)){
                ...
                if(value){
                    ...
                    if (tblInterestTable.getColumnCount()>3) {
                        ...
                        if ((!(TOAMT.equals("9999999999") && TOPERIOD.equals("999 Years")))&& flag == false) {
                            displayAlert = true;
                        }
                    }
                    if (displayAlert) {
    ...
    private void popUp(int field) {
        ...
        if(field==EDIT || field==DELETE || field==AUTHORIZE || field==VIEW ){
            ...
            lst = null;
            viewMap.put(CommonConstants.MAP_NAME, "viewServiceTaxMaintenance");
        }
...
//            cboProdType.setEnabled(false);
            ...
            for(int j = 0; j < length; j++){
                ...
                txtServiceTaxAchd.setText(observable.getStAcHdId());
                txtCess1AcHd.setText(observable.getCess1HdId());
                txtCess2AcHd.setText(observable.getCess2HdId());
                txtGroupName.setText(observable.getLblRoiGroupId());
        ...
        if(viewType==StHd){
            txtServiceTaxAchd.setText(CommonUtil.convertObjToStr(hash.get("AC_HD_ID")));
        }
        if(viewType==Cess1){
            txtCess1AcHd.setText(CommonUtil.convertObjToStr(hash.get("AC_HD_ID")));
        }
        if(viewType==Cess2){
            txtCess2AcHd.setText(CommonUtil.convertObjToStr(hash.get("AC_HD_ID")));
        }
        //__ To Save the data in the Internal Frame...
        setModified(true);
    }
    private void sumOfTax(){
        double total_tax=0.0;
    total_tax=CommonUtil.convertObjToDouble(txtServiceTaxRate.getText()).doubleValue()+
               CommonUtil.convertObjToDouble(txtCess1Rate.getText()).doubleValue()+
               CommonUtil.convertObjToDouble(txtCess2Rate.getText()).doubleValue();
    Double totalTax=new Double(total_tax);
    txtTotTaxRate.setText(CommonUtil.convertObjToStr(totalTax));
    }
    ...
    public static void main(String args[]) {
        new ServiceTaxMaintenanceUI().show();
    }
    ...
    private com.see.truetransact.uicomponent.CButton btnCess1Help;
    ...
    private com.see.truetransact.uicomponent.CButton btnServiceTax;
    private com.see.truetransact.uicomponent.CButton btnSess2Help;
    ...
    private com.see.truetransact.uicomponent.CLabel lblCess1Achd;
    private com.see.truetransact.uicomponent.CLabel lblCess2AcHd;
    ...
    private com.see.truetransact.uicomponent.CLabel lblGroupIdDesc1;
    ...
    private com.see.truetransact.uicomponent.CLabel lblServiceTaxHd;
    ...
    private com.see.truetransact.uicomponent.CPanel panGroupnfo1;
    ...
    private com.see.truetransact.uicomponent.CPanel panServiceTaxMaintenance;
    private com.see.truetransact.uicomponent.CPanel panStatus;
    private com.see.truetransact.uicomponent.CPanel panTaxAcHd;
    ...
    private com.see.truetransact.uicomponent.CTabbedPane tabServiceTaxMaintenance;
    ...
    private com.see.truetransact.uicomponent.CTextField txtCess1AcHd;
    private com.see.truetransact.uicomponent.CTextField txtCess1Rate;
    private com.see.truetransact.uicomponent.CTextField txtCess2AcHd;
    private com.see.truetransact.uicomponent.CTextField txtCess2Rate;
    ...
    private com.see.truetransact.uicomponent.CTextField txtServiceTaxAchd;
    private com.see.truetransact.uicomponent.CTextField txtServiceTaxRate;
    private com.see.truetransact.uicomponent.CTextField txtToPeriod;
    private com.see.truetransact.uicomponent.CTextField txtTotTaxRate;
