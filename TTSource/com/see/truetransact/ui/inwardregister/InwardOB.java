 ...
 *
 */
public class InwardOB extends CObservable {
    ...
    private final static Logger log = Logger.getLogger(InwardOB.class);
    ...
    public InwardOB() {
        try {
            ...
            map = new HashMap();
            map.put(CommonConstants.JNDI, "InwardRegisterJNDI");
            map.put(CommonConstants.HOME, "InwardRegister.InwardHome");
            map.put(CommonConstants.REMOTE, "InwardRegister.Inward");
            //fillDropdown();
...
//    }
    ...
    public void getData(HashMap whereMap) {
         try{
            ...
            objInwardRegisterTO = (InwardRegisterTO)((List) data.get("InwardTO")).get(0);
            System.out.println("in ob...return map"+(InwardRegisterTO)((List) data.get("InwardTO")).get(0));
            populateData(objInwardRegisterTO);
            ttNotifyObservers();
        }catch(Exception e){
            parseException.logException(e,true);
        }
    ...
    public InwardRegisterTO setInwardData() {
        
        final InwardRegisterTO objInwardRegisterTO = new InwardRegisterTO();
        try{
            
            //objInwardRegisterTO.setBranCode(TrueTransactMain.BRANCH_ID);
            objInwardRegisterTO.setStatusBy(ProxyParameters.USER_ID);
            objInwardRegisterTO.setInwardNo(getTxtInwardNo());
            System.out.println("inward no....."+objInwardRegisterTO.getInwardNo());
            objInwardRegisterTO.setSubmittedBy(getTxtSubmittedBy());
           objInwardRegisterTO.setIdate(DateUtil.getDateMMDDYYYY(getTxtDate()));
           objInwardRegisterTO.setCommand(getCommand());
           objInwardRegisterTO.setStatus(getAction());
           objInwardRegisterTO.setStatusBy(TrueTransactMain.USER_ID);
           objInwardRegisterTO.setDetails(getTxaDetails());
           objInwardRegisterTO.setRemarks(getTxaRemarks());
           objInwardRegisterTO.setReferenceNo(getTxtReferenceNo());
           objInwardRegisterTO.setActionTaken(getTxtActionTaken());
           objInwardRegisterTO.setBranchId(TrueTransactMain.BRANCH_ID); // Added by nithya on 14-07-2016 for 4796
          // objInwardRegisterTO.setBranCode(null);
           if(getCommand().equalsIgnoreCase("INSERT")){
           objInwardRegisterTO.setCreatedBy(TrueTransactMain.USER_ID);
        ...
        return objInwardRegisterTO;
    }
//    
    private void populateData(InwardRegisterTO objInwardRegisterTO) throws Exception{
        this.setTxtInwardNo((objInwardRegisterTO.getInwardNo()));
        System.out.println("populate inward no...."+getTxtInwardNo()+"dddd"+objInwardRegisterTO.getInwardNo());
        this.setTxaDetails(CommonUtil.convertObjToStr(objInwardRegisterTO.getDetails()));
        this.setTxaRemarks(CommonUtil.convertObjToStr(objInwardRegisterTO.getRemarks()));
        this.setTxtReferenceNo(CommonUtil.convertObjToStr(objInwardRegisterTO.getReferenceNo()));
        this.setTxtSubmittedBy(CommonUtil.convertObjToStr(objInwardRegisterTO.getSubmittedBy()));
        this.setTxtActionTaken(CommonUtil.convertObjToStr(objInwardRegisterTO.getActionTaken()));
        this.setTxtStatusBy(CommonUtil.convertObjToStr(objInwardRegisterTO.getStatusBy()));
        this.setCreatedDt(CommonUtil.convertObjToStr(objInwardRegisterTO.getCreatedDt()));
        this.setTxtDate(CommonUtil.convertObjToStr(objInwardRegisterTO.getIdate()));
        ...
        this.setStatusBy(CommonUtil.convertObjToStr(objInwardRegisterTO.getStatusBy()));
        setChanged();
        notifyObservers();
    }
