 ...
 * @author swaroop
 */
public class InwardUI extends com.see.truetransact.uicomponent.CInternalFrame implements java.util.Observer, UIMandatoryField{

    private String viewType = new String();
    private HashMap mandatoryMap;
    private InwardOB observable;
    final String AUTHORIZE="Authorize";
    private final static Logger log = Logger.getLogger(InwardUI.class);
...
//    }
    ...
    private void initComponents() {
        ...
        lblActionTaken = new com.see.truetransact.uicomponent.CLabel();
        ...
        lblInwardNo = new javax.swing.JLabel();
        ...
        panInward.setBorder(javax.swing.BorderFactory.createTitledBorder(""));
        ...
        lblActionTaken.setText("Action Taken");
        lblActionTaken.setFont(new java.awt.Font("DejaVu Sans", 0, 13)); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        gridBagConstraints.insets = new java.awt.Insets(3, 3, 3, 3);
        panInward.add(lblActionTaken, gridBagConstraints);
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        gridBagConstraints.insets = new java.awt.Insets(3, 3, 3, 3);
        panInward.add(panDetails, gridBagConstraints);
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        gridBagConstraints.insets = new java.awt.Insets(3, 3, 3, 3);
        panInward.add(panRemarks, gridBagConstraints);
        ...
        txtActionTaken.setMinimumSize(new java.awt.Dimension(101, 21));
        txtActionTaken.setPreferredSize(new java.awt.Dimension(101, 21));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 2;
        gridBagConstraints.gridy = 4;
        gridBagConstraints.gridwidth = java.awt.GridBagConstraints.REMAINDER;
        gridBagConstraints.ipadx = 100;
        panInward.add(txtActionTaken, gridBagConstraints);
        ...
        lblInwardNo.setFont(new java.awt.Font("DejaVu Sans", 0, 12)); // NOI18N
        lblInwardNo.setText("Inward Number ");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 1;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        gridBagConstraints.insets = new java.awt.Insets(3, 3, 3, 3);
        panInward.add(lblInwardNo, gridBagConstraints);

        txtInwardNo.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        txtInwardNo.setDisabledTextColor(new java.awt.Color(0, 0, 0));
        txtInwardNo.setMaximumSize(new java.awt.Dimension(101, 21));
        txtInwardNo.setMinimumSize(new java.awt.Dimension(101, 21));
        txtInwardNo.setPreferredSize(new java.awt.Dimension(101, 21));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 2;
        gridBagConstraints.gridy = 1;
        panInward.add(txtInwardNo, gridBagConstraints);
        ...
        gridBagConstraints.gridx = 2;
        gridBagConstraints.gridy = 2;
        panInward.add(txtReferenceNo, gridBagConstraints);

        panInwardRegister.add(panInward, new java.awt.GridBagConstraints());
   ...
   observable.setActionType(ClientConstants.ACTIONTYPE_EDIT);
    ...
    private void btnNewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNewActionPerformed
       ...
       // btnEmp.setEnabled(true);
        ...
        txtInwardNo.setText((String) idMap.get(CommonConstants.DATA));       
       ...
       viewType = currAction;
        ...
        if (currAction.equalsIgnoreCase("Edit")){
           ...
           // map.put("BRANCH_CODE","0001");
            ...
            viewMap.put(CommonConstants.MAP_NAME, "getInwardRegisterEdit"); 
...
//        }
    ...
    public void update(Observable observed, Object arg) {
        // removeRadioButtons();
        txtInwardNo.setText(observable.getTxtInwardNo());
    ...
    private void setFieldNames() {
        ...
        txtActionTaken.setName("txtActionTaken");
        txtInwardNo.setName("txtInwardNo");
        ...
        lblInwardNo.setName("lblInwardNo");
    ...
    public HashMap generateID() {
        ...
        try {
            ...
            where.put("ID_KEY", "INWARD_NO"); //Here u have to pass APPLICATION_NO or something else
