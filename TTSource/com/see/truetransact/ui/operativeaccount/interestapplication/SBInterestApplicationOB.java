 ...
 * @author  Lohith R.
 */
public class SBInterestApplicationOB extends Observable{
    private final static ClientParseException parseException = ClientParseException.getInstance();
    private String lblStatus = ClientConstants.ACTION_STATUS[ClientConstants.ACTIONTYPE_CANCEL];
    private static SBInterestApplicationOB objLookupMasterOB;
//    private static LookupMasterRB objLookupMasterRB = new LookupMasterRB();
    ...
    static {
        try {
            objLookupMasterOB = new SBInterestApplicationOB();
        } catch(Exception e) {
    ...
    public SBInterestApplicationOB() throws Exception {
...
//        setTxtLookupID("");
    ...
    public static SBInterestApplicationOB getInstance() {
...
//                    final LookupMasterRB objLookupMasterRB = new LookupMasterRB();
    ...
    private void fillDropdown() throws Exception {
        ...
        fillData((HashMap) lookupValues.get("APP.EXECUTION"));
