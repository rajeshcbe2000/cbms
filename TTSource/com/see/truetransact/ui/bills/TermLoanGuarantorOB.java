...
import com.see.truetransact.transferobject.bills.TermLoanGuarantorTO;
...
//    private final   TermLoanRB objTermLoanRB = new TermLoanRB();
    ...
    private void setMax_Del_Guarantor_No(String acctNum){
        try{
            ...
            List resultList = ClientUtil.executeQuery("getSelectBillsGuarantorMaxSLNO", transactionMap);
