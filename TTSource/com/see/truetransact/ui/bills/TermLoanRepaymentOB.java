...
import com.see.truetransact.transferobject.bills.TermLoanInstallmentTO;
import com.see.truetransact.transferobject.bills.TermLoanInstallMultIntTO;
import com.see.truetransact.transferobject.bills.TermLoanRepaymentTO;
    ...
    public int addRepaymentDetails(int recordPosition, boolean update){
        ...
        try{
            ...
            if (!update && recordPosition==-1) {
                ...
                if (repaymentEachRecord.get(ACTIVE_STATUS).equals(YES) && CommonUtil.convertObjToDouble(getStrLimitAmt()).doubleValue() < (getActiveLoanAmt() + CommonUtil.convertObjToDouble(getTxtLaonAmt()).doubleValue())){
