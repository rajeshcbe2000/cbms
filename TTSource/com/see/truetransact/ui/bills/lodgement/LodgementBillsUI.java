...
public class LodgementBillsUI extends CInternalFrame implements UIMandatoryField,Observer{
    ...
    private LodgementBillsMRB objMandatoryRB = new LodgementBillsMRB();
   ...
   private Date currDt = null;
    ...
    private void initForm(){
        ...
        new MandatoryCheck().putMandatoryMarks(getClass().getName(),panLodgementDetails);
//        observable.setCombo();
...
//        observable.setCbmStdInstruction(objDepModel);
        ...
        chkEcludeOtherBankChrg.setEnabled(false);
    }
    ...
    private void setFieldNames() {
        ...
        lblReference.setName("lblReference");
...
//        panDraweeDetails.setName("panDraweeDetails");
        ...
        panProductDetails.setName("panProductDetails");
        ...
        txtReference.setName("txtReference");
...
//        ((javax.swing.border.TitledBorder)panDraweeDetails.getBorder()).setTitle(resourceBundle.getString("panDraweeDetails"));
        ...
        lblReference.setText(resourceBundle.getString("lblReference"));
...
//        rdoPostDtdCheqAllowed.add(rdoPostDtdCheqAllowed_Yes);
   ...
   method need to be added.*/
    public void update(Observable observed, Object arg) {
        ...
        txtReference.setText(observable.getTxtReference());
...
/* Auto Generated Method - updateOBFields()
   ...
   It updates the OB with UI data.*/
    public void updateOBFields() {
        ...
        observable.setTxtReference(txtReference.getText());
...
//        observable.setTxtAreaParticular(txtAreaParticular.getText());
        ...
        // Added by nithya on 30-06-2016 for 4748
        if(chkEcludeOtherBankChrg.isSelected()){ 
            observable.setExcludeOtherBankCharge("Y");
        }else{
            observable.setExcludeOtherBankCharge("N");
        }
   ...
   object. Help display Label name should be lblMsg. */
    public void setHelpMessage() {
        ...
        txtReference.setHelpMessage(lblMsg, objMandatoryRB.getString("txtReference"));
...
//        txtTotalServTax.setValidation(new CurrencyValidation());
    ...
    public static void main(String args[]){
        ...
        LodgementBillsUI ui = new LodgementBillsUI();
    ...
    private void callView(String currField) {
        ...
        currField.equals(ClientConstants.ACTION_STATUS[3])) {
            ...
            viewMap.put(CommonConstants.MAP_NAME, "getSelectLodgementMaster");
    ...
    public void fillData(Object  map) {
        ...
        if (viewType != null) {
            ...
            viewType.equals(ClientConstants.ACTION_STATUS[3]) || viewType.equals(AUTHORIZE) || viewType.equals(ClientConstants.ACTION_STATUS[16])) {
                ...
                getTransdetailsFill(txtAccountNo.getText(),productType);
...
//                        setPanOperationsEnable(false);
                ...
                if(viewType.equals(AUTHORIZE)){
                    ...
                    getTransdetailsFill(txtAccountNo.getText(),productType1);
                ...
                lblCustomerNameValue.setText(observable.getCustomerName());
                ...
                if((observable.getSubRegType().equals("CPD")) && (hashData.get("OPERATES_LIKE").equals("OUTWARD"))){
                    ...
                    mapData.put("ACT_NAME", lblCustomerNameValue.getText());
                    observable.populateTblActData(mapData,observable.getSubRegType());
...
//                txtDraweePinCode.setText(CommonUtil.convertObjToStr(hash.get("PINCODE")));
                ...
                lblCustomerNameValue.setText(CommonUtil.convertObjToStr(hash.get("CUSTOMERNAME")));
                }else{
                    ...
                    lblCustomerNameValue.setText(CommonUtil.convertObjToStr(hash.get("A/C HEAD DESCRIPTION")));//Modified by Chithra on 11-04-14
                }
               ...
               getTransdetailsFill(ACCOUNTNO,productType);
                if(!(observable.getSubRegType().equals("CPD"))){
                    ...
                    transDetails.setTransDetails(prodType, ProxyParameters.BRANCH_ID, txtAccountNo.getText());
                    }
                    HashMap mapData = new HashMap();
                    mapData.put("PRODUCT_ID", CommonUtil.convertObjToStr(((ComboBoxModel)cboProductId.getModel()).getKeyForSelected()));
        ...
        if (observable.getActionType() != ClientConstants.ACTIONTYPE_FAILED) {
            ...
            if ((activity != null && activity.equalsIgnoreCase("REALIZE")) && observable.getActionType() == ClientConstants.ACTIONTYPE_AUTHORIZE) {
                ...
                if (prodType != null && prodType.equals("TL")) {
                    transCashMap.put("BATCH_ID", txtAccountNo.getText());
                } else {
...
//                }
        ...
        try{
            ...
            if(getSelectedBranchID() != null && !ProxyParameters.BRANCH_ID.equals(getSelectedBranchID())){
                ...
                if(selectedBranchDt == null){
                    ...
                    //txtAccNo.setText("");
                    return;
                }/*else if(DateUtil.dateDiff(currentDate, selectedBranchDt)!=0){// Commented and added the block of code by nithya for KD-614
    ...
    private String validateSelection(){
        ...
        if (((billActivity.equals("REALIZE")) ||  (billActivity.equals("PROCEEDS_RECEIVED"))) && (operatesLike.equals("OUTWARD"))) {
            mandatoryMap.put("cboRemitProdID", new Boolean(true));
            mandatoryMap.put("cboRemitCity", new Boolean(cboRemitCity.isVisible()));
            mandatoryMap.put("cboRemitDraweeBank", new Boolean(cboRemitDraweeBank.isVisible()));
            mandatoryMap.put("cboRemitBranchCode", new Boolean(cboRemitBranchCode.isVisible()));
            mandatoryMap.put("txtInstAmt", new Boolean(true));
            mandatoryMap.put("txtRemitFavour", new Boolean(true));
            mandatoryMap.put("tdtRemitInstDate", new Boolean(true));
            mandatoryMap.put("txtInst1", new Boolean(txtInst1.isVisible()));
            mandatoryMap.put("txtInst2", new Boolean(false));
        }
        if (((billActivity.equals("REALIZE")) ||  (billActivity.equals("PROCEEDS_RECEIVED"))) && (operatesLike.equals("INWARD"))) {
            mandatoryMap.put("cboRemitProdID", new Boolean(true));
         //   mandatoryMap.put("cboRemitCity", new Boolean(true));
         //   mandatoryMap.put("cboRemitDraweeBank", new Boolean(true));
         //   mandatoryMap.put("cboRemitBranchCode", new Boolean(true));
            mandatoryMap.put("txtInstAmt", new Boolean(true));
         //   mandatoryMap.put("txtRemitFavour", new Boolean(true));
        //    mandatoryMap.put("tdtRemitInstDate", new Boolean(true));
      //      mandatoryMap.put("txtInst1", new Boolean(true));
      //      mandatoryMap.put("txtInst2", new Boolean(true));
            if (billActivity.equals("REALIZE")){
               // mandatoryMap.put("txtInst1", new Boolean(false));
              //  mandatoryMap.put("txtInst2", new Boolean(false));
              //  mandatoryMap.put("txtRemitFavour", new Boolean(false));
             //   mandatoryMap.put("txtRemitFavour1", new Boolean(true));
            }
            if (billActivity.equals("PROCEEDS_RECEIVED")){
           //     mandatoryMap.put("txtRemitFavour", new Boolean(false));
           //     mandatoryMap.put("txtRemitFavour1", new Boolean(false));
            }
        }
        // String operatesLike = lblOperatesLikeValue.getText();
        if(operatesLike.equals("OUTWARD"))
        if (((billActivity.equals("CLOSURE")) ||  (billActivity.equals("DISHONOUR")))) {
            mandatoryMap.put("txtRemitFavour", new Boolean(true));
            mandatoryMap.put("txtRemitFavour1", new Boolean(true));
        }
        ...
        String mandatoryMessage = objMandatory.checkMandatory(getClass().getName(),panLodgementBIlls, mandatoryMap);
    ...
    public void authorizeStatus(String authorizeStatus) {
        if (!viewType.equals(AUTHORIZE)){
            ...
            whereMap = null;
            mapParam.put(CommonConstants.MAP_NAME, "getLodgementMasterAuthorizeList");
...
//        authMap.put("AUTHORIZE", "AUTHORIZED");
    ...
    public void authorize(HashMap map) {
        ...
        if (observable.getResult()!=ClientConstants.ACTIONTYPE_FAILED) {
            if (fromNewAuthorizeUI) {
                ...
                newauthorizeListUI.displayDetails("Bills Lodgement");
            }
            if (fromAuthorizeUI) {
    ...
    private void initComponents() {
        ...
        lblReference = new com.see.truetransact.uicomponent.CLabel();
        txtReference = new com.see.truetransact.uicomponent.CTextField();
        ...
        chkEcludeOtherBankChrg = new com.see.truetransact.uicomponent.CCheckBox();
        ...
        panLodgementBIlls.setLayout(new java.awt.GridBagLayout());
        ...
        panProductDetails.setMinimumSize(new java.awt.Dimension(600, 81));
        panProductDetails.setPreferredSize(new java.awt.Dimension(600, 81));
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.EAST;
        gridBagConstraints.insets = new java.awt.Insets(1, 1, 1, 4);
        panProductDetails.add(lblReference, gridBagConstraints);

        txtReference.setAllowAll(true);
        txtReference.setMinimumSize(new java.awt.Dimension(100, 21));
        txtReference.setValidation(new DefaultValidation());
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 3;
        gridBagConstraints.gridy = 2;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        gridBagConstraints.insets = new java.awt.Insets(1, 4, 1, 1);
        panProductDetails.add(txtReference, gridBagConstraints);
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.EAST;
        gridBagConstraints.insets = new java.awt.Insets(1, 1, 1, 4);
        panProductDetails.add(lblProductType, gridBagConstraints);

        cboProductType.setMinimumSize(new java.awt.Dimension(150, 21));
        cboProductType.setPopupWidth(120);
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        gridBagConstraints.insets = new java.awt.Insets(1, 4, 1, 1);
        panProductDetails.add(cboProductType, gridBagConstraints);
        ...
        cboProductId.setPopupWidth(130);
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        gridBagConstraints.insets = new java.awt.Insets(1, 4, 1, 1);
        panProductDetails.add(cboProductId, gridBagConstraints);
        ...
        panProductDetails.add(lblAccountNo, gridBagConstraints);

        panAccountNo.setMaximumSize(new java.awt.Dimension(180, 25));
        panAccountNo.setMinimumSize(new java.awt.Dimension(180, 25));
        panAccountNo.setPreferredSize(new java.awt.Dimension(180, 25));
        ...
        gridBagConstraints.insets = new java.awt.Insets(0, 2, 0, 29);
        ...
        txtAccountNo.setValidation(new DefaultValidation());
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        gridBagConstraints.insets = new java.awt.Insets(1, 4, 1, 1);
        panProductDetails.add(panAccountNo, gridBagConstraints);
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.EAST;
        gridBagConstraints.insets = new java.awt.Insets(1, 35, 1, 4);
        panProductDetails.add(lblCustomerName, gridBagConstraints);

        lblCustomerNameValue.setForeground(new java.awt.Color(51, 51, 255));
        lblCustomerNameValue.setMaximumSize(new java.awt.Dimension(300, 21));
        lblCustomerNameValue.setMinimumSize(new java.awt.Dimension(300, 21));
        lblCustomerNameValue.setPreferredSize(new java.awt.Dimension(300, 21));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 3;
        gridBagConstraints.gridy = 1;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        gridBagConstraints.insets = new java.awt.Insets(1, 4, 1, 1);
        panProductDetails.add(lblCustomerNameValue, gridBagConstraints);
        ...
        panLodgementDetails.add(panProductDetails, gridBagConstraints);
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        gridBagConstraints.insets = new java.awt.Insets(1, 4, 1, 1);
        panRemitList.add(txtRemitFavour, gridBagConstraints);
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.EAST;
        gridBagConstraints.insets = new java.awt.Insets(1, 1, 1, 4);
        panRemitList.add(lblRemitFavour, gridBagConstraints);
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        gridBagConstraints.insets = new java.awt.Insets(1, 4, 1, 1);
        panRemitList.add(txtInstAmt, gridBagConstraints);
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.EAST;
        gridBagConstraints.insets = new java.awt.Insets(1, 1, 1, 4);
        panRemitList.add(lblRemitAmt, gridBagConstraints);
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 9;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        ...
        chkEcludeOtherBankChrg.setText("Exclude");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 11;
        panRemitList.add(chkEcludeOtherBankChrg, gridBagConstraints);
        ...
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.insets = new java.awt.Insets(4, 4, 4, 4);
        panOperations.add(btnInstNew, gridBagConstraints);
        ...
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.insets = new java.awt.Insets(4, 4, 4, 4);
        panOperations.add(btnInstSave, gridBagConstraints);
        ...
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.insets = new java.awt.Insets(4, 4, 4, 4);
        panOperations.add(btnInstDelete, gridBagConstraints);
        ...
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.fill = java.awt.GridBagConstraints.BOTH;
        panInstructions.add(panInstEntry, gridBagConstraints);
        ...
        panTblInstruction.add(srpInstructions, new java.awt.GridBagConstraints());

        panInstructions.add(panTblInstruction, new java.awt.GridBagConstraints());
        ...
        gridBagConstraints.gridy = 2;
        gridBagConstraints.gridwidth = 2;
        gridBagConstraints.insets = new java.awt.Insets(0, 367, 0, 0);
        panInstructions.add(panOperations1, gridBagConstraints);

        tabLodgementBils.addTab("Charges", panInstructions);

        panLodgementBIlls.add(tabLodgementBils, new java.awt.GridBagConstraints());
...
//            clearRemitTab();
            if(activity.equalsIgnoreCase("REALIZE") && operatesLike.equalsIgnoreCase("OUTWARD")){
                 //if(cboBillsType.getSelectedIndex()!=0){
                     chkEcludeOtherBankChrg.setEnabled(true);
                // }
            }else{
                chkEcludeOtherBankChrg.setEnabled(false);
            }
    ...
    private void btnInstSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnInstSaveActionPerformed
        ...
        if(tblChrgCount>0)
        {
          for(int i=0;i<tblChrgCount;i++)  
          {
            ...
            if(newC.equals(chrg_inst))
            {
              ClientUtil.showAlertWindow(chrg_inst+" already inserted..");
               btnNew1=0;
               selRow=0;
    ...
    private void txtAccountNoFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtAccountNoFocusLost
        ...
        if(txtAccountNo.getText().length()>0){
            ...
            if(prodType.equals("TD")){
                fillMap.put("ACCOUNTNO",txtAccountNo.getText()+"_1");
                txtAccountNo.setText(txtAccountNo.getText()+"_1");
                observable.setTxtAccountNo(txtAccountNo.getText());                
            }else
                fillMap.put("ACCOUNTNO",txtAccountNo.getText());
            lblCustomerNameValue.setText(observable.getCustomerName());            
            fillMap.put("CUSTOMERNAME",lblCustomerNameValue.getText());
            if(prodType!=null && !prodType.equals("GL")){
                if(lblCustomerNameValue.getText().length()>0)
                    fillData(fillMap);
                else{
                    ClientUtil.showAlertWindow("Invalid Account No.");
                    txtAccountNo.setText("");
...
//            if(!observable.getCbmProductType().getKeyForSelected().equals("GL")){
                callView(AN);
//            }
        }
...
//        observable.setCbmActivities(objDepModel);
        ...
        txtNextAccNo.setEnabled(true);
 		btnSave.setEnabled(true);
      cboTranstype.setSelectedItem(observable.getCbmTrantype().getDataForKey("TRANSFER"));
      chkEcludeOtherBankChrg.setEnabled(false); // Added by nithya
    // cboTranstype.setSelectedItem(observable.getCbmTrantype().getDataForKey("CASH"));
...
//        }
    ...
    private com.see.truetransact.uicomponent.CCheckBox chkEcludeOtherBankChrg;
    ...
    private com.see.truetransact.uicomponent.CLabel lblReference;
    ...
    private com.see.truetransact.uicomponent.CTextField txtReference;
