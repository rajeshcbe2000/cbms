 ...
 * @author bala
 */
public class BalanceSheetClosingScreenOB extends CObservable {
    ...
    private static BalanceSheetClosingScreenOB genLedgerOB;
    ...
    static {
        try {
            ...
            genLedgerOB = new BalanceSheetClosingScreenOB();
        } catch (Exception e) {
        }
    }

    public static BalanceSheetClosingScreenOB getInstance() {
        return genLedgerOB;
    }
     ...
     */
    public BalanceSheetClosingScreenOB() throws Exception {
        initiate();
    }
