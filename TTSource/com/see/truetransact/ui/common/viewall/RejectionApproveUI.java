 ...
 * @author  Suresh
 */
public class RejectionApproveUI extends com.see.truetransact.uicomponent.CDialog implements Observer {
    ...
    private boolean rollBackUIStatus = false;
    ...
    public RejectionApproveUI(RollBackUI rollBackUI) {
        super(rollBackUI, false);
        try {
            rollBackUIStatus = true;
            initComponents();
            initForm();
    ...
    public RejectionApproveUI(TransferUI transferUI) {
     ...
     public RejectionApproveUI(DepositClosingUI depositClosingUI) {
     ...
     public RejectionApproveUI(AccountClosingUI actClosingUI) {
    ...
    public RejectionApproveUI(HashMap termLoanDataMap, String totalAmount, String transType, boolean showDueTable, boolean penalDepositFlag) {
        initComponents();
...
/* Auto Generated Method - getMandatoryHashMap()
   Getter method for setMandatoryHashMap().*/
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        panRejection.setBorder(new javax.swing.border.TitledBorder("Rejection Approval"));
    ...
    private void btnCancelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCancelActionPerformed
        ...
        if(rollBackUIStatus){
        ClientUtil.showMessageWindow("Roll Back Transaction cannot proceed without Approval User Id and Password !!!");
        }
        if(transferUIStatus){
            ClientUtil.showMessageWindow("Back Dated Entry Deletion cannot proceed without Approval User Id and Password !!!");
        }
        if (depositClosingStatus) {
            ClientUtil.showMessageWindow("Deposit Closing cannot proceed without Approval User Id and Password !!!");
        }
         if (actClosingStatus) {
            ClientUtil.showMessageWindow("Account Closing cannot proceed without Approval User Id and Password !!!");
        }
