 ...
 * @author bala
 */
public class UnUsedChequeDetailsUI extends com.see.truetransact.uicomponent.CDialog {
...
//    private LoanSubsidyOB observable;
    ...
    ArrayList selCheqNo = new ArrayList();
    /**
     * Creates new form AuthorizeUI
     */
    public UnUsedChequeDetailsUI() {
        setupInit();
        setupScreen();
    }
     ...
     * Creates new form AuthorizeUI
     */
    public UnUsedChequeDetailsUI(CInternalFrame parent, HashMap paramMap) {
        this.parent = parent;
        setupInit();
        setupScreen();
    }
     ...
     * Creates new form AuthorizeUI
     */
    public UnUsedChequeDetailsUI(String sourceScreen, LinkedHashMap dataMap,HashMap selItemList) {
    ...
    public ArrayList getSelCheqNo() {
        return selCheqNo;
    }

    public void setSelCheqNo(ArrayList selCheqNo) {
        this.selCheqNo = selCheqNo;
    }
...
//          super.show();
    ...
    private Object[][] setTableData() {
        ...
        for (Iterator it = whereMap.entrySet().iterator(); it.hasNext();) {
           ...
           totalList[i][0] = false;
           totalList[i][1] = entry.getKey();//startCheqNo;
            i++;
        }
        return totalList;
    }
