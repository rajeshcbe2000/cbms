 ...
 * @author  bala
 */
public class PassBookOB extends CObservable {
    ...
    private static PassBookOB passBookOB;
    private HashMap lookUpHash;
    private HashMap keyValue;
    static {
        try {
            currDt = ClientUtil.getCurrentDate();
            passBookOB = new PassBookOB();
        } catch(Exception e) {
        }
    }
    
    public static PassBookOB getInstance() {
        return passBookOB;
    }
    
    /** Creates a new instance of ViewAllOB */
    public PassBookOB() throws Exception {
        initiate();
    }
    ...
    private void fillDropDown() throws Exception{
       ...
       // key.remove("TD");
        //value.remove("Deposits");
        key.remove("GL");
        value.remove("General Ledger");
        //key.remove("TL");
        //value.remove("Term Loans");
        key.remove("SA");
        value.remove("Suspense Account");
