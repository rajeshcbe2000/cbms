 ...
 * @author Swaroop
 */
public class AuthorizeListUI extends com.see.truetransact.uicomponent.CInternalFrame implements Observer {
    ...
    ArrayList data = null;
    String node = "";
    private final static Logger log = Logger.getLogger(AuthorizeListUI.class);
    ArrayList colorList = new ArrayList();

    /**
     * Creates new form ViewAll
     */
    public AuthorizeListUI() {
//        try {
...
//        }
    ...
    private void initComponents() {
        ...
        treData.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                treDataMouseClicked(evt);
            }
        });
...
//        treData.setVisible(false);
        ...
        node = new DefaultMutableTreeNode("Termloan Charges");
        flag = displayTransactionDetails(node);
        addinginParentList2(flag, node, parent2);
        ...
        // Added by nithya on 07-04-2017 for 4988
        
         node = new DefaultMutableTreeNode("Deposit AccountOpening");
        //parent1.add(node);
        flag = displayTransactionDetails(node);
        addinginParentList2(flag, node, parent2);
        ...
        node = new DefaultMutableTreeNode("Multiple Deposit Closing");
        //parent1.add(node);
        flag = displayTransactionDetails(node);
        addinginParentList1(flag, node, parent1);
...
//        addinginParentList1(flag, node, parent1);
        ...
        // splitting cash transaction node to payment & receipt
        node = new DefaultMutableTreeNode("Cash Receipt");
        //parent1.add(node);
        flag = displayTransactionDetails(node);
        addinginParentList1(flag, node, parent1);
        
        node = new DefaultMutableTreeNode("Cash Payment");
        //parent1.add(node);
        flag = displayTransactionDetails(node);
        addinginParentList1(flag, node, parent1);
        ...
        node = new DefaultMutableTreeNode("MDS Commencement");
        //parent1.add(node);
        flag = displayTransactionDetails(node);
        addinginParentList1(flag, node, parent1);
        
        node = new DefaultMutableTreeNode("MDS Bank Advance"); // Added by nithya on 18-08-2020 for KD-2162
        //parent1.add(node);
        flag = displayTransactionDetails(node);
        addinginParentList1(flag, node, parent1);
...
//        parent2.add(node);
        ...
        if(autoAuthorizeAllowed != null && autoAuthorizeAllowed.equals("N")){
            node = new DefaultMutableTreeNode("Loan Notice");
            flag = displayTransactionDetails(node);
            addinginParentList1(flag, node, parent1);
        }
...
//        ProxyParameters.BRANCH_ID = "0001";
        ...
        }else if (nodeSelected.equals("Termloan Charges")) {
            where.put("BRANCH_ID", TrueTransactMain.BRANCH_ID);
            whereMap.put(CommonConstants.MAP_NAME, "viewChargesDetailsForAuthorize");
...
//                whereMap.put(CommonConstants.MAP_NAME, "getSelectAccountMasterAuthorizeTOListWithoutTransaction");
//            }
        } else if (nodeSelected.equals("SB/Current Account Closing")) {
        ...
        } else if (nodeSelected.equals("Deposit Account Opening")) {
            where.put("OPENING_MODE", "Normal");
            where.put(CommonConstants.SELECTED_BRANCH_ID, ProxyParameters.BRANCH_ID);
            if (TrueTransactMain.CASHIER_AUTH_ALLOWED != null && TrueTransactMain.CASHIER_AUTH_ALLOWED.equals("Y")) {
                whereMap.put(CommonConstants.MAP_NAME, "viewAllDepAccAuthorizeCashierTOList");
            } else {
                whereMap.put(CommonConstants.MAP_NAME, "viewAllDepAccAuthorizeTOListForAuthScreen");
            }

        }else if (nodeSelected.equals("Deposit AccountOpening")) {// Added by nithya on 07-04-2017 for 4988
            where.put("OPENING_MODE", "Normal");
            where.put(CommonConstants.SELECTED_BRANCH_ID, ProxyParameters.BRANCH_ID);            
...
//            whereMap.put(CommonConstants.MAP_NAME, "viewAllDepAccAuthorizeTOListForAuthScreen");
        ...
        } else if (nodeSelected.equals("Multiple Deposit Closing")) {
            if (TrueTransactMain.CASHIER_AUTH_ALLOWED != null && TrueTransactMain.CASHIER_AUTH_ALLOWED.equals("Y")) {
        ...
        } else if (nodeSelected.equals("Loan Account Closing")) {
            where.put("AUTHORIZESTATUS", "AUTHORIZED");
            if (TrueTransactMain.CASHIER_AUTH_ALLOWED != null && TrueTransactMain.CASHIER_AUTH_ALLOWED.equals("Y")) {
        ...
        /*else if (nodeSelected.equals("Cash Transactions")) { // Splitting cash transaction into receipt & Payment
            where.put("AUTHORIZESTATUS", "AUTHORIZED");
            if (TrueTransactMain.CASHIER_AUTH_ALLOWED != null && TrueTransactMain.CASHIER_AUTH_ALLOWED.equals("Y")) {
        ...
        else if (nodeSelected.equals("Cash Receipt")) {
            where.put("AUTHORIZESTATUS", "AUTHORIZED");
            where.put("CASH_RECEIPT","CASH_RECEIPT");
            if (TrueTransactMain.CASHIER_AUTH_ALLOWED != null && TrueTransactMain.CASHIER_AUTH_ALLOWED.equals("Y")) {
                whereMap.put(CommonConstants.MAP_NAME, "getSelectCashTransactionCashierAuthorizeTOList");
            } else {
                whereMap.put(CommonConstants.MAP_NAME, "getSelectCashTransactionAuthorizeTOList");
            }
        }else if (nodeSelected.equals("Cash Payment")) {
            where.put("AUTHORIZESTATUS", "AUTHORIZED");
            where.put("CASH_PAYMENT","CASH_PAYMENT");
            if (TrueTransactMain.CASHIER_AUTH_ALLOWED != null && TrueTransactMain.CASHIER_AUTH_ALLOWED.equals("Y")) {
                whereMap.put(CommonConstants.MAP_NAME, "getSelectCashTransactionCashierAuthorizeTOList");
            } else {
                whereMap.put(CommonConstants.MAP_NAME, "getSelectCashTransactionAuthorizeTOList");
        ...
        else if (nodeSelected.equals("Transfer Transactions")) {
            where.put("AUTHORIZESTATUS", "AUTHORIZED");
        ...
        } else if (nodeSelected.equals("MDS Payments")) {
            if (TrueTransactMain.CASHIER_AUTH_ALLOWED != null && TrueTransactMain.CASHIER_AUTH_ALLOWED.equals("Y")) {
        ...
        }else if (nodeSelected.equals("MDS Commencement")) {
            where.put(CommonConstants.SELECTED_BRANCH_ID, ProxyParameters.BRANCH_ID);
        ...
        else if (nodeSelected.equals("Bills Lodgement")) {
            whereMap.put(CommonConstants.MAP_NAME, "getLodgementMasterAuthorizeList");
        } else if (nodeSelected.equals("Investment Trans")) {
            if (TrueTransactMain.CASHIER_AUTH_ALLOWED != null && TrueTransactMain.CASHIER_AUTH_ALLOWED.equals("Y")) {
        ...
        //        }
        ...
        } else if (nodeSelected.equals("Locker")) {
             if (TrueTransactMain.CASHIER_AUTH_ALLOWED != null && TrueTransactMain.CASHIER_AUTH_ALLOWED.equals("Y")) {                 
        ...
        } else if (nodeSelected.equals("DRF Transaction")) {
            if (TrueTransactMain.CASHIER_AUTH_ALLOWED != null && TrueTransactMain.CASHIER_AUTH_ALLOWED.equals("Y")) {
           ...
           // whereMap.put(CommonConstants.MAP_NAME, "getSelectAccCreationAuthorizeTOList");
        ...
        } else if (nodeSelected.equals("Investment Master")) {
            if (TrueTransactMain.CASHIER_AUTH_ALLOWED != null && TrueTransactMain.CASHIER_AUTH_ALLOWED.equals("Y")) {
            ...
            viewAllMap.put("FROM_AUTHORIZE_LIST_UI", "");
            viewAllMap.put("PARENT", this);
            viewAllFrm.fillData(viewAllMap);
        }else if (nodeSelected.equals("Loan Notice")) {
            where.put("USER_ID", TrueTransactMain.USER_ID);
            where.put("BRANCH_ID", TrueTransactMain.BRANCH_ID);
...
//        DefaultTreeModel model = (DefaultTreeModel) treData.getModel();
//        DefaultMutableTreeNode root = (DefaultMutableTreeNode) treData.getModel().getRoot();
//        model.removeNodeFromParent(root);
//        DefaultMutableTreeNode child = new DefaultMutableTreeNode("View All Transactions");
...
//            _isAvailable = false;
    ...
    private void whenTableRowSelected() {
        ...
        if (rowIndexSelected < 0) {
            ...
            if(node.equals("Multiple Deposit Account Opening") && TrueTransactMain.CASHIER_AUTH_ALLOWED.equals("Y")){
...
//            this.dispose();
            ...
            if (node.equals("Customer Master")) {
            ...
            }else  if (node.equals("Termloan Charges")) {
                ...
                frm = new com.see.truetransact.ui.operativeaccount.AccountsUI();
                hash.put("SB_NO_TRANSACTION", "SB_NO_TRANSACTION");
            } 
            else if (node.equals("SB/Current Account Closing")) {
                frm = new com.see.truetransact.ui.operativeaccount.AccountClosingUI();
            } else if (node.equals("Deposit Account Opening")) {// Added by nithya on 07-04-2017 for 4988
                frm = new com.see.truetransact.ui.deposit.TermDepositUI();
            }else if (node.equals("Deposit AccountOpening")) {
                frm = new com.see.truetransact.ui.deposit.TermDepositUI();
            ...
            } else if (node.equals("Multiple Deposit Closing")) {
...
//            } 
            else if (node.equals("Cash Receipt")) {
                hash.put("CASH_RECEIPT","CASH_RECEIPT");
                frm = new com.see.truetransact.ui.transaction.cash.CashTransactionUI();
            }else if (node.equals("Cash Payment")) {
                hash.put("CASH_PAYMENT","CASH_PAYMENT");
                frm = new com.see.truetransact.ui.transaction.cash.CashTransactionUI();
            ...
            } else if (node.equals("MDS Commencement")) {
                frm = new com.see.truetransact.ui.mdsapplication.mdsconmmencement.MDSCommencementUI();
            } else if (node.equals("MDS Bank Advance")) { // Added by nithya on 18-08-2020 for KD-2162
               ...
               // frm = new com.see.truetransact.ui.generalledger.AccountCreationUI();
                ...
                hash.put("FROM_AUTHORIZE_LIST_UI_SUSPENSE_COLLECTION", "");
            } else if (node.equals("Daily Loan Collection - Loan Adjstment")) {
                frm = new com.see.truetransact.ui.termloan.dailyLoanTrans.DailyLoanTransUI();
                hash.put("FROM_AUTHORIZE_LIST_UI_LOAN_ADJUSTMENT", "");
	    ...
	    }else if (node.equals("Loan Notice")) {
                frm = new com.see.truetransact.ui.termloan.notices.LoanNoticeUI();
            }
            hash.put("FROM_AUTHORIZE_LIST_UI", "");
...
//            frm.setSwitchEnglish(false);
    ...
    public void removeSelectedRow() {
        ...
        if (node.equals("Cash Receipt") || node.equals("Cash Payment")) {
...
//        returnMap = new HashMap();
    ...
    private void treDataMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_treDataMouseClicked
        // TODO add your handling code here:
        if (evt.getClickCount() == 2) {
            DefaultMutableTreeNode d = (DefaultMutableTreeNode) treData.getSelectionPath().getLastPathComponent();
            String sel = CommonUtil.convertObjToStr(d);
            System.out.println("sel :: " + sel);
            if (sel.equals("View All Transactions")) {
                CInternalFrame viewAllFrm = new com.see.truetransact.ui.common.viewall.ViewAllTransactions();
                TrueTransactMain.showScreen(viewAllFrm);
                HashMap viewAllMap = new HashMap();
                viewAllMap.put("FROM_AUTHORIZE_LIST_UI", "");
    ...
    }//GEN-LAST:event_treDataMouseClicked
...
//            tdtToDate.setDateValue(DateUtil.getStringDate(observable.getTdtToDate()));
    ...
    public boolean displayTransactionDetails(DefaultMutableTreeNode node) {
        ...
        if (CommonUtil.convertObjToStr(node).equals("Customer Master")) {
            ...
            whereMap.put(CommonConstants.MAP_NAME, "getUnAuthorizedListForCorpCustomer");
            flag = whetherRecordAvailableorNot(whereMap, where);
        }if (CommonUtil.convertObjToStr(node).equals("Termloan Charges")) {
            whereMap.put(CommonConstants.MAP_NAME, "viewChargesDetailsForAuthorize");
            flag = whetherRecordAvailableorNot(whereMap, where);
...
//            }
        ...
        else if (CommonUtil.convertObjToStr(node).equals("SB/Current Account Closing")) {
            where.put("AUTHORIZESTATUS", "AUTHORIZED");
            if (TrueTransactMain.CASHIER_AUTH_ALLOWED != null && TrueTransactMain.CASHIER_AUTH_ALLOWED.equals("Y")) {
                whereMap.put(CommonConstants.MAP_NAME, "getSelectAccountCloseCashierAuthorizeTOList");
                flag = whetherRecordAvailableorNot(whereMap, where);
        ...
        } else if (CommonUtil.convertObjToStr(node).equals("Deposit Account Opening")) {
            where.put("OPENING_MODE", "Normal");
            where.put(CommonConstants.SELECTED_BRANCH_ID, ProxyParameters.BRANCH_ID);
            if (TrueTransactMain.CASHIER_AUTH_ALLOWED != null && TrueTransactMain.CASHIER_AUTH_ALLOWED.equals("Y")) {
                whereMap.put(CommonConstants.MAP_NAME, "viewAllDepAccAuthorizeCashierTOList");
        ...
        }else if (CommonUtil.convertObjToStr(node).equals("Deposit AccountOpening")) {// Added by nithya on 07-04-2017 for 4988
            where.put("OPENING_MODE", "Normal");
            where.put(CommonConstants.SELECTED_BRANCH_ID, ProxyParameters.BRANCH_ID);
            whereMap.put(CommonConstants.MAP_NAME, "viewAllDepAccAuthorizeTOListWithOutTransaction");
            flag = whetherRecordAvailableorNot(whereMap, where);            
        ...
        } else if (CommonUtil.convertObjToStr(node).equals("Multiple Deposit Closing")) {
            if (TrueTransactMain.CASHIER_AUTH_ALLOWED != null && TrueTransactMain.CASHIER_AUTH_ALLOWED.equals("Y")) {
                whereMap.put(CommonConstants.MAP_NAME, "getMultipleDepositAccountCloseCashierAuthorizeTOList");
                flag = whetherRecordAvailableorNot(whereMap, where);
            } else {
        ...
        } else if (CommonUtil.convertObjToStr(node).equals("Loan Account Closing")) {
            where.put("AUTHORIZESTATUS", "AUTHORIZED");
            if (TrueTransactMain.CASHIER_AUTH_ALLOWED != null && TrueTransactMain.CASHIER_AUTH_ALLOWED.equals("Y")) {
                whereMap.put(CommonConstants.MAP_NAME, "getSelectLoanAccountCloseCashierAuthorizeTOList");
                flag = whetherRecordAvailableorNot(whereMap, where);
       ...
       /* else if (CommonUtil.convertObjToStr(node).equals("Cash Transactions")) {
        ...
        else if (CommonUtil.convertObjToStr(node).equals("Cash Receipt")) {
            where.put("AUTHORIZESTATUS", "AUTHORIZED");
            where.put("CASH_RECEIPT", "CASH_RECEIPT");
            if (TrueTransactMain.CASHIER_AUTH_ALLOWED != null && TrueTransactMain.CASHIER_AUTH_ALLOWED.equals("Y")) {
                whereMap.put(CommonConstants.MAP_NAME, "getSelectCashTransactionCashierAuthorizeTOList");
        ...
        }else if (CommonUtil.convertObjToStr(node).equals("Cash Payment")) {
            where.put("CASH_PAYMENT", "CASH_PAYMENT");
            if (TrueTransactMain.CASHIER_AUTH_ALLOWED != null && TrueTransactMain.CASHIER_AUTH_ALLOWED.equals("Y")) {
                whereMap.put(CommonConstants.MAP_NAME, "getSelectCashTransactionCashierAuthorizeTOList");
                flag = whetherRecordAvailableorNot(whereMap, where);
        ...
        else if (CommonUtil.convertObjToStr(node).equals("Transfer Transactions")) {
            where.put("AUTHORIZESTATUS", "AUTHORIZED");
            whereMap.put(CommonConstants.MAP_NAME, "getUnAuthorizeMasterTransferTO");
            flag = whetherRecordAvailableorNot(whereMap, where);
        ...
        } else if (CommonUtil.convertObjToStr(node).equals("MDS Commencement")) {
            where.put(CommonConstants.SELECTED_BRANCH_ID, ProxyParameters.BRANCH_ID);
            whereMap.put(CommonConstants.MAP_NAME, "getSelectCommencementList");
            flag = whetherRecordAvailableorNot(whereMap, where);
        ...
        else if (CommonUtil.convertObjToStr(node).equals("Bills Lodgement")) {
            whereMap.put(CommonConstants.MAP_NAME, "getLodgementMasterAuthorizeList");
            flag = whetherRecordAvailableorNot(whereMap, where);
        ...
        } else if (CommonUtil.convertObjToStr(node).equals("Locker")) {
            ...
            flag = whetherRecordAvailableorNot(whereMap, where);
        }else if (CommonUtil.convertObjToStr(node).equals("Locker Master")) {
            where.put(CommonConstants.AUTHORIZESTATUS, "Authorize");           
            whereMap.put(CommonConstants.MAP_NAME, "getSelectLockerMasterEditAuthorizeTOList");            
            flag = whetherRecordAvailableorNot(whereMap, where);
        }
          ...
          //  whereMap.put(CommonConstants.MAP_NAME, "getSelectAccCreationAuthorizeTOList");
            ...
            whereMap.put(CommonConstants.MAP_NAME, "getStandingInstructionAuthorizeList");
            flag = whetherRecordAvailableorNot(whereMap, where);
        } else if (CommonUtil.convertObjToStr(node).equals("Investment Master")) {
            if (TrueTransactMain.CASHIER_AUTH_ALLOWED != null && TrueTransactMain.CASHIER_AUTH_ALLOWED.equals("Y")) {
                whereMap.put(CommonConstants.MAP_NAME, "getSelectInvestmentCashierAuthDetails");
                flag = whetherRecordAvailableorNot(whereMap, where);
            } else {
            ...
            flag = whetherRecordAvailableorNot(whereMap, where);
        }else if (CommonUtil.convertObjToStr(node).equals("Loan Notice")) {
            where.put("USER_ID", TrueTransactMain.USER_ID);
            where.put("BRANCH_ID", TrueTransactMain.BRANCH_ID);
            where.put("CHARGE_DATE", currDt.clone());
            where.put("AUTHORIZE_MODE","AUTHORIZE_MODE");
