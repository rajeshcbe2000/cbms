 ...
 * @author  balachandar
 */
public class AuthorizeStatusUI extends com.see.truetransact.uicomponent.CDialog implements Observer {
    private final AuthorizeStatusRB resourceBundle = new AuthorizeStatusRB();
    private AuthorizeStatusOB observable;
    HashMap paramMap = null;
    CInternalFrame parent = null;
//    int str = 0;

    private final static Logger log = Logger.getLogger(AuthorizeStatusUI.class);

    /** Creates new form AuthorizeUI */
    public AuthorizeStatusUI(HashMap paramMap) {
        this.paramMap = paramMap;        
        setupInit();
    }
    
    /** Creates new form AuthorizeUI */
    public AuthorizeStatusUI(CInternalFrame parent, HashMap paramMap) {
        this.parent = parent;
        this.paramMap = paramMap;
        //System.out.println("#####paramMap"+paramMap);
        setupInit();
        setupScreen();
        if(CommonUtil.convertObjToStr(paramMap.get("MAPNAME")).equals("getSelectAccountMasterAuthorizeTOList"))  
        {
    ...
    private void setupInit() {
        ...
        internationalize();
        setObservable();
        if(paramMap.containsKey(CommonConstants.AUTHORIZESTATUS))
        {
...
//    }
    ...
    private void setObservable() {
        try {
            observable = new AuthorizeStatusOB();
    ...
    int blue = 107; 
        ...
        if (observable.isAvailable()) {
            super.show();
            //System.out.println("paramMap.containsKey(CommonConstants.AUTHORIZESTATUS)"+paramMap.containsKey(CommonConstants.AUTHORIZESTATUS));
    ...
    private void whenTableRowSelected() {
        ...
        if (rowIndexSelected < 0) {
            ...
            this.dispose();
            if (parent != null) {
                CInternalFrame iFrame = (CInternalFrame) parent;
                parent.setMode(ClientConstants.ACTIONTYPE_AUTHORIZE);
                parent.fillData(observable.fillData(rowIndexSelected));
            }
        }
    }
    ...
    private void initComponents() {
        ...
        cPanel1.setMinimumSize(new java.awt.Dimension(608, 643));
        cPanel1.setPreferredSize(new java.awt.Dimension(608, 643));
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        cPanel1.add(chkSelectAll, gridBagConstraints);
    ...
    private void btnAuthorizeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAuthorizeActionPerformed
        // Add your handling code here:
        observable.setResultStatus(ClientConstants.ACTIONTYPE_AUTHORIZE);
    ...
    public static void main(String args[]) {
        ...
        AuthorizeStatusUI authorizeUI = new AuthorizeStatusUI(mapParam);
