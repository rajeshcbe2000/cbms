 ...
 * @author  bala
 */
public class AuthorizationCheckUI extends com.see.truetransact.uicomponent.CDialog {
    ...
    public AuthorizationCheckUI(ArrayList param) {
        arrUnChecked = param;
        this.setModal(true);
        setupInit(param);
    }
    ...
    public static void main(String args[]) {
        ...
        AuthorizationCheckUI dui = new AuthorizationCheckUI(map);
        dui.show();
    }
