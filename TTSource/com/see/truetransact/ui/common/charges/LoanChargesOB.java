...
public class LoanChargesOB extends Observable{
    ...
    private ComboBoxModel cbmChargeDesc;
    ...
    private boolean chkDayWiseCalc = false;
    private String txtPrematureRate = "";

    public String getTxtPrematureRate() {
        return txtPrematureRate;
    }

    public void setTxtPrematureRate(String txtPrematureRate) {
        this.txtPrematureRate = txtPrematureRate;
    }

    public boolean isChkDayWiseCalc() {
        return chkDayWiseCalc;
    }

    public void setChkDayWiseCalc(boolean chkDayWiseCalc) {
        this.chkDayWiseCalc = chkDayWiseCalc;
    }
    ...
    public LoanChargesOB() {
        try {
            currDt = ClientUtil.getCurrentDate();
            proxy = ProxyFactory.createProxy();
            map = new HashMap();
            map.put(CommonConstants.JNDI, "LoanChargesJNDI");
            map.put(CommonConstants.HOME, "LoanChargesJNDIHome");
            map.put(CommonConstants.REMOTE, "LoanCharges");
            setTableTile();
    ...
    private void fillDropdown() throws Exception{
        try{
            ...
            lookup_keys = new ArrayList();
            lookup_keys.add("CHARGE DESC");
            lookupMap.put(CommonConstants.PARAMFORQUERY, lookup_keys);
            keyValue = com.see.truetransact.clientutil.ClientUtil.populateLookupData(lookupMap);
            getKeyValue((HashMap)keyValue.get("CHARGE DESC"));
            cbmChargeDesc = new ComboBoxModel(key,value);
            makeNull();
            ...
            List resultList = ClientUtil.executeQuery("InterMaintenance.getProductDataTLForLoanCharge", transactionMap);
    ...
    public LoanChargesTO setLoanChargeDetailsData() {
        ...
        final LoanChargesTO objLoanChargeTO = new LoanChargesTO();
        try{
            objLoanChargeTO.setSchemeId(getCboSchemeId());
            objLoanChargeTO.setChargeId(getTxtChargeId());
            objLoanChargeTO.setChargeDesc(getCboChargeDesc());
            objLoanChargeTO.setAccHead(getTxtAccGroupId());
            objLoanChargeTO.setMandatory(getRdoMandatory());
            ...
            objLoanChargeTO.setFlatCharge(CommonUtil.convertObjToDouble(getTxtFlatCharges()));
            ...
            objLoanChargeTO.setIsDepositOrLoan(CommonConstants.LOANS);
            objLoanChargeTO.setStatusDt(ClientUtil.getCurrentDateWithTime());
            if(isChkEditable()==true)
                objLoanChargeTO.setEditable("Y");
            else
                objLoanChargeTO.setEditable("N");
            if(isChkDayWiseCalc()==true)
                objLoanChargeTO.setDayWiseCalc("Y");
            else
                objLoanChargeTO.setDayWiseCalc("N");
            objLoanChargeTO.setPrematureRate(CommonUtil.convertObjToDouble(getTxtPrematureRate()));
        }catch(Exception e){
    ...
    private void populateChargeDetailsData(LoanChargesTO objLoanChargeTO) throws Exception{
        ...
        this.setCboChargeDesc(CommonUtil.convertObjToStr(objLoanChargeTO.getChargeDesc()));
        ...
        if(CommonUtil.convertObjToStr(objLoanChargeTO.getDayWiseCalc()).equals("Y")){
            this.setChkDayWiseCalc(true);
        }else{
            System.out.println("ssssss"+objLoanChargeTO.getDayWiseCalc());
            this.setChkDayWiseCalc(false);
        }
        this.setTxtPrematureRate(CommonUtil.convertObjToStr(objLoanChargeTO.getPrematureRate()));
        setChanged();
        notifyObservers();
    }
...
//            ttNotifyObservers();
    ...
    public void populateSlabDetails(int row){
        try{
            resetSlabDetails();
            System.out.println("slabAmountMap :: " + slabAmountMap);
...
//        ttNotifyObservers();
    ...
    void setCboChargeDesc(String cboChargeDesc){
        this.cboChargeDesc = cboChargeDesc;
        setChanged();
    }
    // Getter method for txtChargeDesc
    String getCboChargeDesc(){
        return this.cboChargeDesc;
    }
    ...
    /**
     * Getter for property cbmChargeDesc.
     * @return Value of property cbmChargeDesc.
     */
    public com.see.truetransact.clientutil.ComboBoxModel getCbmChargeDesc() {
        return cbmChargeDesc;
    }
    
    /**
     * Setter for property cbmChargeDesc.
     * @param cbmChargeDesc New value of property cbmChargeDesc.
     */
    public void setCbmChargeDesc(com.see.truetransact.clientutil.ComboBoxModel cbmChargeDesc) {
        this.cbmChargeDesc = cbmChargeDesc;
    }
