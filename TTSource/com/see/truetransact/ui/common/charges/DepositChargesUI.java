...
public class DepositChargesUI extends com.see.truetransact.uicomponent.CInternalFrame implements com.see.truetransact.uimandatory.UIMandatoryField, java.util.Observer{
    
    java.util.ResourceBundle resourceBundle = java.util.ResourceBundle.getBundle("com.see.truetransact.ui.common.charges.DepositChargesRB", ProxyParameters.LANGUAGE);
    private final static ClientParseException parseException = ClientParseException.getInstance();
    private DepositChargesMRB objMandatoryRB = new DepositChargesMRB();
    private String viewType = new String();
    private boolean updateMode = false;
    final String AUTHORIZE="Authorize";
    private boolean isFilled = false;
    HashMap mandatoryMap = null;
    DepositChargesOB observable = null;
    int updateTab=-1;
    
    /** Creates new form ChargesUI */
    public DepositChargesUI() {
        initComponents();
        setFieldNames();
        internationalize();
        observable = new DepositChargesOB();
        setMaxLengths();
        initComponentData();
        setMandatoryHashMap();
        setHelpMessage();
...
/* Auto Generated Method - setHelpMessage()
   ...
   object. Help display Label name should be lblMsg. */
    public void setHelpMessage() {
        DepositChargesMRB objMandatoryRB = new DepositChargesMRB();
    ...
    private void initComponents() {
        ...
        txtChargeDesc = new com.see.truetransact.uicomponent.CTextField();
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        gridBagConstraints.insets = new java.awt.Insets(4, 4, 4, 4);
        panChargeMainDetails.add(txtChargeDesc, gridBagConstraints);
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 9;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        ...
        rdoDeductionAccClose_no.setMaximumSize(new java.awt.Dimension(140, 18));
        rdoDeductionAccClose_no.setMinimumSize(new java.awt.Dimension(140, 18));
        rdoDeductionAccClose_no.setPreferredSize(new java.awt.Dimension(140, 18));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        ...
        rdoDeductionAccOpen_yes.setMaximumSize(new java.awt.Dimension(174, 18));
        rdoDeductionAccOpen_yes.setMinimumSize(new java.awt.Dimension(174, 18));
        rdoDeductionAccOpen_yes.setPreferredSize(new java.awt.Dimension(150, 18));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 5;
        gridBagConstraints.fill = java.awt.GridBagConstraints.VERTICAL;
        ...
        rdoApplTime.setMaximumSize(new java.awt.Dimension(140, 18));
        rdoApplTime.setMinimumSize(new java.awt.Dimension(140, 18));
        rdoApplTime.setPreferredSize(new java.awt.Dimension(140, 18));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
    ...
    private void popUp(String currAction){
        ...
        if (currAction.equalsIgnoreCase("Delete")){
            ...
            System.out.println("Viremap"+viewMap);
...
private void cboChargeBaseActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cboChargeBaseActionPerformed
    ...
    private com.see.truetransact.uicomponent.CTextField txtChargeDesc;
