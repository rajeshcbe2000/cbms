...
public class LoanChargesUI extends com.see.truetransact.uicomponent.CInternalFrame implements com.see.truetransact.uimandatory.UIMandatoryField, java.util.Observer{
    
    java.util.ResourceBundle resourceBundle = java.util.ResourceBundle.getBundle("com.see.truetransact.ui.common.charges.LoanChargesRB", ProxyParameters.LANGUAGE);
    private final static ClientParseException parseException = ClientParseException.getInstance();
    private LoanChargesMRB objMandatoryRB = new LoanChargesMRB();
    private String viewType = new String();
    private boolean updateMode = false;
    final String AUTHORIZE="Authorize";
    private boolean isFilled = false;
    HashMap mandatoryMap = null;
    LoanChargesOB observable = null;
    int updateTab=-1;
    
    /** Creates new form ChargesUI */
    public LoanChargesUI() {
        initComponents();
        setFieldNames();
        internationalize();
        observable = new LoanChargesOB();
        setMaxLengths();
        initComponentData();
        setMandatoryHashMap();
        setHelpMessage();
    ...
    private void initComponentData() {
        ...
        cboChargeDescription.setModel(observable.getCbmChargeDesc());
...
/* Auto Generated Method - setFieldNames()
   ...
   Other functions are working based on this name. */
    private void setFieldNames() {
        ...
        cboSchemeId.setName("cboSchemeId");
        ...
        lblSchemeId.setName("lblSchemeId");
        ...
        rdoDeductionAccClose_no.setName("rdoDeductionAccClose_no");
         rdoApplTime.setName("rdoApplTime");
        ...
        cboChargeDescription.setName("cboChargeDescription");
   ...
   the Resource Bundle File. */
    private void internationalize() {
        ...
        rdoDeductionAccOpen_yes.setText(resourceBundle.getString("rdoDeductionAccOpen_yes"));
         rdoApplTime.setText(resourceBundle.getString("rdoApplTime"));
    }
...
/* Auto Generated Method - update()
   ...
   method need to be added.*/
    ...
    public void update() {
        ...
        cboChargeDescription.setSelectedItem(observable.getCboChargeDesc());
        ...
        if(DeductionOccu.length()>0 && DeductionOccu.equals("O")){
            ...
            rdoApplTime.setSelected(false);
        }else if(DeductionOccu.length()>0 && DeductionOccu.equals("C")){
        ...
        System.out.println("edit"+observable.isChkEditable());
        chkEditable.setSelected(observable.isChkEditable());
        chkDaywiseCalc.setSelected(observable.isChkDayWiseCalc());
        txtPrematureRate.setText(observable.getTxtPrematureRate());
    }
...
/* Auto Generated Method - updateOBFields()
   ...
   It updates the OB with UI data.*/
    public void updateOBFields() {
        ...
        observable.setCboChargeDesc(CommonUtil.convertObjToStr(cboChargeDescription.getSelectedItem()));
        ...
        else if(rdoDeductionAccClose_no.isSelected()==true)
            observable.setRdoDeductionAcc(CommonUtil.convertObjToStr("C"));
        else
            observable.setRdoDeductionAcc(CommonUtil.convertObjToStr("R"));
        observable.setChkEditable(chkEditable.isSelected());
        observable.setChkDayWiseCalc(chkDaywiseCalc.isSelected());
        observable.setTxtPrematureRate(txtPrematureRate.getText());
    }
...
ADD: implements com.see.truetransact.uimandatory.UIMandatoryField
   ...
   It needs a class level HashMap variable mandatoryMap. */
    public void setMandatoryHashMap() {
        ...
        mandatoryMap.put("cboChargeDescription", new Boolean(false));
...
/* Auto Generated Method - setHelpMessage()
   ...
   object. Help display Label name should be lblMsg. */
    public void setHelpMessage() {
        LoanChargesMRB objMandatoryRB = new LoanChargesMRB();
        ...
        cboChargeDescription.setHelpMessage(lblMsg, objMandatoryRB.getString("cboChargeDescription"));
    ...
    private void setMaxLengths(){
        ...
        txtPrematureRate.setValidation(new NumericValidation(3,2));
    ...
    private void initComponents() {
        ...
        lblChargeDesc = new com.see.truetransact.uicomponent.CLabel();
        lblSchemeId = new com.see.truetransact.uicomponent.CLabel();
        lblChargeId = new com.see.truetransact.uicomponent.CLabel();
        cboChargeBase = new com.see.truetransact.uicomponent.CComboBox();
        lblDeductionOccu = new com.see.truetransact.uicomponent.CLabel();
        ...
        rdoDeductionAccClose_no = new com.see.truetransact.uicomponent.CRadioButton();
        rdoDeductionAccOpen_yes = new com.see.truetransact.uicomponent.CRadioButton();
        rdoMandatory_yes = new com.see.truetransact.uicomponent.CRadioButton();
        rdoMandatory_no = new com.see.truetransact.uicomponent.CRadioButton();
        cboChargeDescription = new com.see.truetransact.uicomponent.CComboBox();
        lblAccGroupId = new com.see.truetransact.uicomponent.CLabel();
        panAccountHead = new com.see.truetransact.uicomponent.CPanel();
        btnAccGroupId = new com.see.truetransact.uicomponent.CButton();
        txtAccGroupId = new com.see.truetransact.uicomponent.CTextField();
        ...
        rdoApplTime = new com.see.truetransact.uicomponent.CRadioButton();
        chkEditable = new com.see.truetransact.uicomponent.CCheckBox();
        cboSchemeId = new com.see.truetransact.uicomponent.CComboBox();
        chkDaywiseCalc = new com.see.truetransact.uicomponent.CCheckBox();
        txtPrematureRate = new com.see.truetransact.uicomponent.CTextField();
        lblPrematureRate = new com.see.truetransact.uicomponent.CLabel();
        ...
        txtToSlabAmount.setMinimumSize(new java.awt.Dimension(100, 21));
        gridBagConstraints = new java.awt.GridBagConstraints();
        ...
        txtFlatCharges.setMinimumSize(new java.awt.Dimension(100, 21));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 11;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        ...
        txtDivisibleBy.setMinimumSize(new java.awt.Dimension(100, 21));
        txtDivisibleBy.setName("");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        ...
        lblChargeDesc.setText("Charge Description");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 2;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHEAST;
        gridBagConstraints.insets = new java.awt.Insets(4, 4, 4, 4);
        panChargeMainDetails.add(lblChargeDesc, gridBagConstraints);
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHEAST;
        gridBagConstraints.insets = new java.awt.Insets(4, 4, 4, 4);
        panChargeMainDetails.add(lblSchemeId, gridBagConstraints);
        ...
        lblDeductionOccu.setText("Deduction Occurrence");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        ...
        panChargeMainDetails.add(lblDeductionOccu, gridBagConstraints);

        txtChargeId.setMinimumSize(new java.awt.Dimension(100, 21));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 1;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        ...
        txtFromSlabAmount.setMinimumSize(new java.awt.Dimension(100, 21));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 9;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        ...
        txtMinimumChrgAmt.setMinimumSize(new java.awt.Dimension(100, 21));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 16;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        ...
        txtMaximumChrgAmt.setMinimumSize(new java.awt.Dimension(100, 21));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 17;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        ...
        txtChargeRate.setMinimumSize(new java.awt.Dimension(100, 21));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 12;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        ...
        rdoDeductionAcc.add(rdoDeductionAccClose_no);
        rdoDeductionAccClose_no.setText("Account Closing Time");
        rdoDeductionAccClose_no.setToolTipText("Account Closing Time");
        rdoDeductionAccClose_no.setMaximumSize(new java.awt.Dimension(160, 18));
        rdoDeductionAccClose_no.setMinimumSize(new java.awt.Dimension(160, 18));
        rdoDeductionAccClose_no.setPreferredSize(new java.awt.Dimension(160, 18));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        panChargeMainDetails.add(rdoDeductionAccClose_no, gridBagConstraints);

        rdoDeductionAcc.add(rdoDeductionAccOpen_yes);
        rdoDeductionAccOpen_yes.setText("Account Opening Time");
        rdoDeductionAccOpen_yes.setToolTipText("Account Opening Time");
        rdoDeductionAccOpen_yes.setMaximumSize(new java.awt.Dimension(180, 18));
        rdoDeductionAccOpen_yes.setMinimumSize(new java.awt.Dimension(180, 18));
        rdoDeductionAccOpen_yes.setPreferredSize(new java.awt.Dimension(180, 18));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 5;
        gridBagConstraints.fill = java.awt.GridBagConstraints.VERTICAL;
        ...
        gridBagConstraints.ipady = 2;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        panChargeMainDetails.add(rdoDeductionAccOpen_yes, gridBagConstraints);

        rdoMandatory.add(rdoMandatory_yes);
        rdoMandatory_yes.setText("Mandatory");
        rdoMandatory_yes.setMaximumSize(new java.awt.Dimension(100, 18));
        rdoMandatory_yes.setMinimumSize(new java.awt.Dimension(100, 18));
        rdoMandatory_yes.setPreferredSize(new java.awt.Dimension(100, 18));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        ...
        gridBagConstraints.ipady = 2;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHEAST;
        panChargeMainDetails.add(rdoMandatory_yes, gridBagConstraints);

        rdoMandatory.add(rdoMandatory_no);
        rdoMandatory_no.setText("Not Mandatory");
        rdoMandatory_no.setMaximumSize(new java.awt.Dimension(110, 18));
        rdoMandatory_no.setMinimumSize(new java.awt.Dimension(110, 18));
        rdoMandatory_no.setPreferredSize(new java.awt.Dimension(110, 18));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 4;
        gridBagConstraints.fill = java.awt.GridBagConstraints.VERTICAL;
        ...
        gridBagConstraints.ipady = 2;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        panChargeMainDetails.add(rdoMandatory_no, gridBagConstraints);

        cboChargeDescription.setMinimumSize(new java.awt.Dimension(80, 22));
        cboChargeDescription.setPopupWidth(200);
        cboChargeDescription.setPreferredSize(new java.awt.Dimension(80, 22));
        cboChargeDescription.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cboChargeDescriptionActionPerformed(evt);
            }
        });
        cboChargeDescription.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusLost(java.awt.event.FocusEvent evt) {
                cboChargeDescriptionFocusLost(evt);
            }
        });
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridy = 2;
        ...
        panChargeMainDetails.add(cboChargeDescription, gridBagConstraints);

        lblAccGroupId.setText(" Account Group ID");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 3;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHEAST;
        gridBagConstraints.insets = new java.awt.Insets(4, 4, 4, 4);
        panChargeMainDetails.add(lblAccGroupId, gridBagConstraints);

        panAccountHead.setLayout(new java.awt.GridBagLayout());

        btnAccGroupId.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/see/truetransact/ui/images/TT_SELECT.gif"))); // NOI18N
        btnAccGroupId.setToolTipText("Agent ID");
        btnAccGroupId.setMinimumSize(new java.awt.Dimension(21, 21));
        btnAccGroupId.setPreferredSize(new java.awt.Dimension(21, 21));
        btnAccGroupId.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnAccGroupIdActionPerformed(evt);
            }
        });
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        ...
        panAccountHead.add(btnAccGroupId, gridBagConstraints);

        txtAccGroupId.setMinimumSize(new java.awt.Dimension(100, 21));
        txtAccGroupId.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusLost(java.awt.event.FocusEvent evt) {
                txtAccGroupIdFocusLost(evt);
            }
        });
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        ...
        panAccountHead.add(txtAccGroupId, gridBagConstraints);
        ...
        btnChargeSave.setName("btnContactNoAdd"); // NOI18N
        ...
        rdoDeductionAcc.add(rdoApplTime);
        rdoApplTime.setText("Application Time");
        rdoApplTime.setToolTipText("Application Time");
        rdoApplTime.setMaximumSize(new java.awt.Dimension(160, 18));
        rdoApplTime.setMinimumSize(new java.awt.Dimension(160, 18));
        rdoApplTime.setPreferredSize(new java.awt.Dimension(160, 18));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 7;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        panChargeMainDetails.add(rdoApplTime, gridBagConstraints);

        chkEditable.setText("Variable Amount");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 7;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHEAST;
        panChargeMainDetails.add(chkEditable, gridBagConstraints);

        cboSchemeId.setPopupWidth(200);
        cboSchemeId.setPreferredSize(new java.awt.Dimension(27, 22));
        cboSchemeId.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cboSchemeIdActionPerformed(evt);
            }
        });
        cboSchemeId.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusLost(java.awt.event.FocusEvent evt) {
                cboSchemeIdFocusLost(evt);
            }
        });
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        ...
        panChargeMainDetails.add(cboSchemeId, gridBagConstraints);

        chkDaywiseCalc.setText("Days Wise Calculation");
        chkDaywiseCalc.setHorizontalTextPosition(javax.swing.SwingConstants.LEADING);
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 18;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHEAST;
        panChargeMainDetails.add(chkDaywiseCalc, gridBagConstraints);

        txtPrematureRate.setMinimumSize(new java.awt.Dimension(100, 21));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 13;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        gridBagConstraints.insets = new java.awt.Insets(4, 5, 4, 4);
        panChargeMainDetails.add(txtPrematureRate, gridBagConstraints);

        lblPrematureRate.setText("Premature Rate(%)");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 13;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHEAST;
        gridBagConstraints.insets = new java.awt.Insets(4, 4, 4, 4);
        panChargeMainDetails.add(lblPrematureRate, gridBagConstraints);
    ...
    private void tblChargeMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblChargeMousePressed
        ...
        int st=CommonUtil.convertObjToInt(tblCharge.getValueAt(tblCharge.getSelectedRow(),0));
    ...
    private void btnChargeDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnChargeDeleteActionPerformed
        // TODO add your handling code here:
        int s=  CommonUtil.convertObjToInt(tblCharge.getValueAt(tblCharge.getSelectedRow(),0));
    ...
    private void cboChargeDescriptionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cboChargeDescriptionActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_cboChargeDescriptionActionPerformed
    
    private void txtAccGroupIdFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtAccGroupIdFocusLost
        // TODO add your handling code here:
        if(!(txtAccGroupId.getText().equalsIgnoreCase(""))){
            LinkedHashMap data = new LinkedHashMap();
            data.put("ACCT_HD",txtAccGroupId.getText());
            List lst=ClientUtil.executeQuery("TermLoan.getSelectAcctHeadTOList", data);
            if(lst!=null && lst.size()>0){
                
            }else{
                ClientUtil.showMessageWindow("This Account Head Does Not Exist !!!");
                txtAccGroupId.setText("");
            }
        }
    }//GEN-LAST:event_txtAccGroupIdFocusLost
    ...
    private void cboChargeDescriptionFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_cboChargeDescriptionFocusLost
        
    }//GEN-LAST:event_cboChargeDescriptionFocusLost
    ...
    private void btnAccGroupIdActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAccGroupIdActionPerformed
        // TODO add your handling code here:
        popUp("ACCT_HEAD");
    }//GEN-LAST:event_btnAccGroupIdActionPerformed
    ...
    private void popUp(String currAction){
        ...
        whereMap.put("IS_DEPOSIT_OR_LOAN",CommonConstants.LOANS);
        if (currAction.equalsIgnoreCase("Delete")){
            viewMap.put(CommonConstants.MAP_WHERE, whereMap);
            viewMap.put(CommonConstants.MAP_NAME, "getChargeDetailDelete");
        }else if(currAction.equalsIgnoreCase("Enquiry") || currAction.equalsIgnoreCase("Edit")){
            viewMap.put(CommonConstants.MAP_WHERE, whereMap);
            viewMap.put(CommonConstants.MAP_NAME, "getChargeDetailEditView");
...
private void cboChargeBaseActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cboChargeBaseActionPerformed
    String chargeBase = (String) cboChargeBase.getSelectedItem();
    if(chargeBase.equals("Sanction Amount")||chargeBase.equals("Total Market Value")){
        slabAmountVisible(false);
        flatChargesVisible(false);
        chargeRateVisible(true);
    ...
    if(chargeBase.equals("Sanction Amount") && rdoDeductionAccClose_no.isSelected()){
        txtPrematureRate.setVisible(true);
        lblPrematureRate.setVisible(true);
    }
    ...
    private void updateAuthorizeStatus(String authorizeStatus) {
        ...
        if (viewType == AUTHORIZE && isFilled){
            ...
            whereMap = null;
            mapParam.put(CommonConstants.MAP_NAME, "getChargeDetailAuthorize");
            isFilled = false;
    ...
    private void btnCancelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCancelActionPerformed
        ...
        btnChargeSave.setEnabled(false);
        btnChargeDelete.setEnabled(false);
        txtPrematureRate.setVisible(false);
        lblPrematureRate.setVisible(false);
    ...
    private void btnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditActionPerformed
        ...
        cboChargeDescription.setEnabled(false);
    ...
    private void cboSchemeIdActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cboSchemeIdActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_cboSchemeIdActionPerformed

    private void cboSchemeIdFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_cboSchemeIdFocusLost
        // TODO add your handling code here:
    }//GEN-LAST:event_cboSchemeIdFocusLost
    ...
    private com.see.truetransact.uicomponent.CButton btnAccGroupId;
    ...
    private com.see.truetransact.uicomponent.CComboBox cboChargeDescription;
    private com.see.truetransact.uicomponent.CComboBox cboRoundOffType;
    private com.see.truetransact.uicomponent.CComboBox cboSchemeId;
    private com.see.truetransact.uicomponent.CCheckBox chkDaywiseCalc;
    private com.see.truetransact.uicomponent.CCheckBox chkEditable;
    private com.see.truetransact.uicomponent.CLabel lbDivisibleBy;
    private com.see.truetransact.uicomponent.CLabel lblAccGroupId;
    private com.see.truetransact.uicomponent.CLabel lblChargeBase;
    private com.see.truetransact.uicomponent.CLabel lblChargeDesc;
    private com.see.truetransact.uicomponent.CLabel lblChargeId;
    private com.see.truetransact.uicomponent.CLabel lblChargeRate;
    private com.see.truetransact.uicomponent.CLabel lblDeductionOccu;
    ...
    private com.see.truetransact.uicomponent.CLabel lblPrematureRate;
    private com.see.truetransact.uicomponent.CLabel lblRoundOffType;
    private com.see.truetransact.uicomponent.CLabel lblSchemeId;
    ...
    private com.see.truetransact.uicomponent.CRadioButton rdoApplTime;
    private com.see.truetransact.uicomponent.CButtonGroup rdoDeductionAcc;
    private com.see.truetransact.uicomponent.CRadioButton rdoDeductionAccClose_no;
    private com.see.truetransact.uicomponent.CRadioButton rdoDeductionAccOpen_yes;
    private com.see.truetransact.uicomponent.CButtonGroup rdoMandatory;
    private com.see.truetransact.uicomponent.CRadioButton rdoMandatory_no;
    private com.see.truetransact.uicomponent.CRadioButton rdoMandatory_yes;
    ...
    private com.see.truetransact.uicomponent.CTextField txtAccGroupId;
    ...
    private com.see.truetransact.uicomponent.CTextField txtPrematureRate;
