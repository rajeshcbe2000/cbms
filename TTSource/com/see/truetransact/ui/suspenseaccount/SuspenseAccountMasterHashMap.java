...
public class SuspenseAccountMasterHashMap implements UIMandatoryHashMap {
    private HashMap mandatoryMap;

    public SuspenseAccountMasterHashMap(){
        ...
        mandatoryMap.put("txtMemberNumber", new Boolean(false));
