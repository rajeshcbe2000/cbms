 ...
 * @modified JK
 */
public class SHGCustomerUI extends com.see.truetransact.uicomponent.CInternalFrame implements Observer, UIMandatoryField{
    ...
    ResourceBundle resourceBundle = ResourceBundle.getBundle("com.see.truetransact.ui.customer.SHGCustomerRB", ProxyParameters.LANGUAGE);
...
/* Auto Generated Method - setHelpMessage()
   ...
   object. Help display Label name should be lblMsg. */
    public void setHelpMessage() {
        SHGCustomerMRB objMandatoryRB = new SHGCustomerMRB();
...
//        cboIntroType.setSelectedItem(observable.getCboIntroType());
        ...
        System.out.println ("observable.getChkAddrVerified() : " + observable.getChkAddrVerified());
...
/* Auto Generated Method - updateOBFields()
   ...
   It updates the OB with UI data.*/
    public void updateOBFields() {
        ...
        observable.setCboBusNature((String)((ComboBoxModel)cboBusNature.getModel()).getKeyForSelected());
        ...
        observable.setCboIdenProof((String)cboIdenProof.getSelectedItem());
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        panCorporateCustomer.setBorder(new javax.swing.border.TitledBorder(""));
        ...
        panContacts.setBorder(new javax.swing.border.TitledBorder("Contacts"));
        ...
        panContactInfo.setBorder(new javax.swing.border.TitledBorder("Contact Info"));
        ...
        panTelecomDetails.setBorder(new javax.swing.border.TitledBorder(""));
        panPhoneType.setLayout(new java.awt.GridBagLayout());

        panPhoneSave.setLayout(new java.awt.GridBagLayout());

        btnContactNoAdd.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/see/truetransact/ui/images/TT_SAVE.gif")));
        ...
        btnPhoneNew.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/see/truetransact/ui/images/TT_NEW.gif")));
        ...
        btnPhoneDelete.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/see/truetransact/ui/images/TT_DELETE.gif")));
        ...
        btnContactAdd.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/see/truetransact/ui/images/TT_SAVE.gif")));
        ...
        tabContactAndIdentityInfo.addTab("Member Photo & Signature", panPhotoSign);
        ...
        lblRegNumber.setText("SHG Reg. No.");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 3;
        gridBagConstraints.gridy = 1;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.EAST;
        ...
        txtSuspRevRemarks.setName("txtRemarks");
        ...
        panCompanyInfo.setBorder(new javax.swing.border.TitledBorder("Self Help Group Info"));
        ...
        lblCustomerType.setText("SHG Type");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 1;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.EAST;
        ...
        cboMembershipClass.setName("cboCustomerType");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 3;
        gridBagConstraints.gridy = 1;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        ...
        lblMembershipClass.setName("lblCustomerType");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 2;
        gridBagConstraints.gridy = 1;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.EAST;
        ...
        txtMemNum.setName("txtNationality");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 3;
        gridBagConstraints.gridy = 2;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        ...
        tabCorpCust.addTab("Self Help Group Details", panCompanyAuthPersonInfo);
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        gridBagConstraints.insets = new java.awt.Insets(1, 4, 1, 4);
        panKYC.add(cboIdenProof, gridBagConstraints);
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.EAST;
        gridBagConstraints.insets = new java.awt.Insets(4, 4, 4, 4);
        panKYC.add(lblIdenProof, gridBagConstraints);
        ...
        panCustomerSide.setBorder(new javax.swing.border.TitledBorder("SHG Member Details"));
        panCustomerName.setLayout(new java.awt.GridBagLayout());

        lblValCustomerName.setFont(new java.awt.Font("MS Sans Serif", 0, 11));
        ...
        lblCustomerName.setFont(new java.awt.Font("MS Sans Serif", 0, 11));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 0;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.EAST;
        ...
        lblDateOfBirth.setFont(new java.awt.Font("MS Sans Serif", 0, 11));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 2;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.EAST;
        ...
        lblValStreet.setFont(new java.awt.Font("MS Sans Serif", 0, 11));
        ...
        lblStreet1.setFont(new java.awt.Font("MS Sans Serif", 0, 11));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 3;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.EAST;
        ...
        lblArea1.setFont(new java.awt.Font("MS Sans Serif", 0, 11));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 4;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.EAST;
        ...
        lblValArea.setFont(new java.awt.Font("MS Sans Serif", 0, 11));
        ...
        lblValCity.setFont(new java.awt.Font("MS Sans Serif", 0, 11));
        ...
        lblCity1.setFont(new java.awt.Font("MS Sans Serif", 0, 11));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 5;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.EAST;
        ...
        lblCountry1.setFont(new java.awt.Font("MS Sans Serif", 0, 11));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 7;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.EAST;
        ...
        lblValCountry.setFont(new java.awt.Font("MS Sans Serif", 0, 11));
        ...
        lblValPin.setFont(new java.awt.Font("MS Sans Serif", 0, 11));
        ...
        lblPin.setText("Pin");
        lblPin.setFont(new java.awt.Font("MS Sans Serif", 0, 11));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 8;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.EAST;
        ...
        lblState1.setFont(new java.awt.Font("MS Sans Serif", 0, 11));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 6;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.EAST;
        ...
        lblValState.setFont(new java.awt.Font("MS Sans Serif", 0, 11));
        ...
        lblCorpCustDesig.setFont(new java.awt.Font("MS Sans Serif", 0, 11));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 1;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.EAST;
        ...
        lblValCorpCustDesig.setFont(new java.awt.Font("MS Sans Serif", 0, 11));
        ...
        tblJointAcctHolder.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Name", "Member Id", "Type", "Main / Joint"
            }
        ));
        ...
        lblAuthCustId.setText("Member Id");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 0;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.EAST;
        ...
        btnAuthCustId.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/see/truetransact/ui/images/TT_SELECT.gif")));
        ...
        tabCorpCust.addTab("SHG Members", panCorpCustDet);
        ...
        tblCustomerHistory.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "SHG Id", "Relationship", "Product Id", "Product Type", "Account No.", "From", "To", "Deposit Amount", "Maturity Amount", "Available Balance"
            }
        ));
        ...
        tabCorpCust.addTab("Role Info", panCustomerHistory);
        ...
        btnDeleteDetails.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/see/truetransact/ui/images/TT_SELECT.gif")));
...
//                objCustomerUISupport.fillPhotoSign(lblPhoto, lblSign, null, null);
    ...
    private void btnJointAcctNewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnJointAcctNewActionPerformed
        if(tblJointAcctHolder.getRowCount()!=0){ //--- If the Main Accnt Holder is selected,
            observable.setIstrue(true);
            callViewJnt(JOINT_CUST_ID);           //--- allow the user to add Jnt Acct Holder
