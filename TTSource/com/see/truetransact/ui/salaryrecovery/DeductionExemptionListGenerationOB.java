...
public class DeductionExemptionListGenerationOB extends CObservable{
    ...
    public DeductionExemptionListGenerationOB() {
        try {
            proxy = ProxyFactory.createProxy();
            map = new HashMap();
            map.put(CommonConstants.JNDI, "DeductionExemptionListJNDI");
            map.put(CommonConstants.HOME, "salaryrecovery.DeductionExemptionListGenerationHome");
            map.put(CommonConstants.REMOTE, "salaryrecovery.DeductionExemptionListGeneration");
            fillDropdown();
