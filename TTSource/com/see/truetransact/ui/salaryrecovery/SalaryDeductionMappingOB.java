 ...
 * @author  rahul
 */
public class SalaryDeductionMappingOB extends CObservable{
    ...
    private static SalaryDeductionMappingOB salaryDeductionMappingOB;
    ...
    static {
        try {
            ...
            salaryDeductionMappingOB = new SalaryDeductionMappingOB();
        } catch(Exception e) {
            log.info("Error in SalaryDeductionMappingOB Declaration");
        }
    }
    
    public static SalaryDeductionMappingOB getInstance(CInternalFrame frm) {
        frame = frm;
        return salaryDeductionMappingOB;
    }
    
    /** Creates a new instance of CashTransactionOB */
    public SalaryDeductionMappingOB() throws Exception {
