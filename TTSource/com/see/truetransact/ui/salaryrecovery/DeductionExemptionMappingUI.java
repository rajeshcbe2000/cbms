 ...
 * 
 * DeductionExemptionMappingUI.java
 *
 ...
 *
 */
public class DeductionExemptionMappingUI extends CInternalFrame implements java.util.Observer, UIMandatoryField {
    
    private HashMap mandatoryMap;
    DeductionExemptionMappingOB observable;
  ...
  //  java.util.ResourceBundle resourceBundle, objMandatoryRB;
    ...
    private final static Logger log = Logger.getLogger(DeductionExemptionMappingUI.class);     //Logger
    List accountNoList=null;
    boolean fromAuthorizeUI = false;
    AuthorizeListUI authorizeListUI = null;
    private String mandatoryMessage;
      DeductionExemptionMappingRB deductionExemptionMappingRB = new DeductionExemptionMappingRB();
    private String prodType="";
    java.util.ResourceBundle resourceBundle;
    DeductionExemptionMappingMRB objMandatoryRB=new DeductionExemptionMappingMRB();
    private Date currDt = null;
    /** Creates new form CashTransaction */
    public DeductionExemptionMappingUI() {
        initComponents();
        initSetup();
...
//        objMandatoryRB = java.util.ResourceBundle.getBundle("com.see.truetransact.ui.salaryrecovery.DeductionExemptionMappingMRB", ProxyParameters.LANGUAGE);
...
//         new MandatoryCheck().putMandatoryMarks(getClass().getName(), panData);
    ...
    private void setObservable() {
        ...
        try{
            observable = new DeductionExemptionMappingOB();
    ...
    private void internationalize() {
        ...
        resourceBundle = java.util.ResourceBundle.getBundle("com.see.truetransact.ui.salaryrecovery.DeductionExemptionMappingRB", ProxyParameters.LANGUAGE);
    ...
    public void update(Observable observed, Object arg) {
        ...
        System.out.println("observable.getEmployerRefNo()"+observable.getEmployerRefNo());
         txtEmployerRefNo.setText(observable.getEmployerRefNo()); 
         if(observable.getCboExemptionMode()!=null)
             cboExemptionMode.setSelectedItem(observable.getCboExemptionMode());
         //if()
         System.out.println("observable.getCbmProdType()"+observable.getCbmProdType());
         if(observable.getCbmProdType()!=null)
             cboProdType.setModel(observable.getCbmProdType());
        // cboProdType.setSelectedItem(observable)
    ...
    public void updateOBFields() {
        ...
        observable.setSelectedBranchID(getSelectedBranchID());
        observable.setCboExemptionMode(cboExemptionMode.getSelectedItem().toString());
    ...
    private void initComponents() {
        ...
        panDeductionExemptionMapping = new com.see.truetransact.uicomponent.CPanel();
        ...
        lblExemptionMode = new com.see.truetransact.uicomponent.CLabel();
        cboExemptionMode = new com.see.truetransact.uicomponent.CComboBox();
        ...
        panDeductionExemptionMapping.setBorder(javax.swing.BorderFactory.createEtchedBorder());
        panDeductionExemptionMapping.setMinimumSize(new java.awt.Dimension(600, 360));
        panDeductionExemptionMapping.setPreferredSize(new java.awt.Dimension(605, 370));
        panDeductionExemptionMapping.setLayout(new java.awt.GridBagLayout());
        ...
        lblExemptionMode.setText("Exemption Mode");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 2;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.EAST;
        gridBagConstraints.insets = new java.awt.Insets(4, 4, 4, 4);
        panData.add(lblExemptionMode, gridBagConstraints);

        cboExemptionMode.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "", "By Direct", "By Standing Instruction" }));
        cboExemptionMode.setMinimumSize(new java.awt.Dimension(100, 21));
        cboExemptionMode.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cboExemptionModeActionPerformed(evt);
            }
        });
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        gridBagConstraints.insets = new java.awt.Insets(4, 4, 4, 4);
        panData.add(cboExemptionMode, gridBagConstraints);
        ...
        panDeductionExemptionMapping.add(panData, gridBagConstraints);

        getContentPane().add(panDeductionExemptionMapping, java.awt.BorderLayout.CENTER);
    ...
    private void cboExemptionModeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cboExemptionModeActionPerformed
        // TODO add your handling code here:
        if(cboExemptionMode.getSelectedIndex()==0 || cboExemptionMode.getSelectedIndex()==1 ){
    ...
    private void callView(String currField) {
        ...
        if(currField == "CREDIT_ACC_NO"){
            ...
            statusmap.put(CommonConstants.MAP_NAME,"getDeductionExemptionMAppingEmployerRefNo");
            ...
            editmap.put(CommonConstants.MAP_NAME,"getEditExemption");
            ...
            deletemap.put(CommonConstants.MAP_NAME,"getEditExemption");
    ...
    public void authorizeStatus(String authorizeStatus) {
        ...
        if(isFilled){
            ...
            //commented by Anju Anand for Mantis Id: 10376
...
//                ClientUtil.execute("authorizeSalaryDeductionMapping" ,whereMap);
                ...
                ClientUtil.execute("authorizeDeductionMapping" ,whereMap);
            }
            else {
                // added by Anju Anand for Mantis Id: 10376
                if (observable.getActionType() == ClientConstants.ACTIONTYPE_REJECT) {
                       HashMap dataMap = new HashMap();
                    dataMap.put("EMP_REF_NO", empno);
                    dataMap.put("BRANCH_CODE", getSelectedBranchID());
                    List oldExemptionDetails = null;
                    oldExemptionDetails = ClientUtil.executeQuery("getOldExemptionDetails", dataMap);
                    if (oldExemptionDetails != null && oldExemptionDetails.size() > 0 && !oldExemptionDetails.equals("")) {
                        HashMap resultMap = new HashMap();
                        resultMap = (HashMap) oldExemptionDetails.get(0);
                        String oldAccNo = "";
                        String oldProdId = "";
                        String oldProdType = "";
                        String oldExemptionMode = "";
                        oldAccNo = CommonUtil.convertObjToStr(resultMap.get("MAP_ACT_NUM_TEMP"));
                        oldProdId = CommonUtil.convertObjToStr(resultMap.get("MAP_PROD_ID_TEMP"));
                        oldProdType = CommonUtil.convertObjToStr(resultMap.get("MAP_PROD_TYPE_TEMP"));
                        oldExemptionMode = CommonUtil.convertObjToStr(resultMap.get("EXEMPTION_MODE_TEMP"));
                        if (oldExemptionMode != null && !oldExemptionMode.equals("")) {
                            whereMap.put("EXEMPTION_MODE", oldExemptionMode);
                            whereMap.put("MAP_PROD_TYPE", oldProdType);
                            whereMap.put("MAP_PROD_ID", oldProdId);
                            whereMap.put("MAP_ACT_NUM", oldAccNo);
                            whereMap.put("AUTH_STATUS", "AUTHORIZED");
                            ClientUtil.execute("updateExemptionDetails", whereMap);
                        } else {
                            whereMap.put("AUTH_STATUS", "REJECTED");
                        }
                    }
                    n = ClientUtil.confirmationAlert("Are you sure want to Reject..?");
                    if (n != 0) {
                        return;
                    } else {
                        ClientUtil.execute("rejectDeductionMapping", whereMap);
                    }
                }
            }
            btnCancelActionPerformed(null);
...
//            mapParam.put(CommonConstants.UPDATE_MAP_NAME,"authorizeSalaryDeductionMapping");
           // added by Anju Anand for Mantis Id: 10376
            mapParam.put(CommonConstants.MAP_NAME,"getDeductionMappingAuthList");
          //end anjuanand
	...
	private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
            ...
            resourceBundle = new DeductionExemptionMappingRB();
            StringBuffer strBMandatory = new StringBuffer();
            if(txtEmployerRefNo.getText().equals("")) {
                message.append(objMandatoryRB.getString("txtEmployerRefNo"));
            }
            if(cboExemptionMode.getSelectedIndex()==0){
                message.append(objMandatoryRB.getString("cboExemptionMode"));
            }
            if(cboExemptionMode.getSelectedIndex()==2){
                if(cboProdType.getSelectedIndex()==0){
                    message.append(objMandatoryRB.getString("cboProdType"));
                }
                if(cboProdId.getSelectedIndex()==0){
                    message.append(objMandatoryRB.getString("cboProdId"));
                }
                if(txtAccNo.getText().equals("")){
                    message.append(objMandatoryRB.getString("txtAccNo"));
                }
            }
            String accno=observable.getTxtAccNo();
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        ...
        observable.setStatus();
        // added by Anju Anand for Mantis Id: 10376
         if (viewType.equals("DELETE") && isFilled == true) {
            isFilled = false;
            observable.doAction();
        ...
        public void fillData(Object param) {
            ...
            if(viewType.equals("EMPREFNO")){
                ...
                //if((hash.containsKey("MAP_PROD_ID")) && (!CommonUtil.convertObjToStr(hash.get("MAP_PROD_ID")).equals(""))){
                    List lst=ClientUtil.executeQuery("getDeductionMapping", hash);
                    if(lst!=null && lst.size()>0){
                    hmap=(HashMap)lst.get(0);
                    }
               // }
                observable.populateData(hmap);
//                System.out.println("cboprodtype"+cboProdType.getSelectedItem()+"ssss"+hmap.get("MAP_PROD_TYPE").toString());
                cboExemptionMode.setSelectedItem(hmap.get("EXEMPTION_MODE").toString());
                if(hmap.get("MAP_PROD_TYPE")!=null)
                cboProdType.setSelectedItem( ((ComboBoxModel) cboProdType.getModel()).getDataForKey(hmap.get("MAP_PROD_TYPE").toString()));
                else cboProdType.setSelectedIndex(0);
                if(hmap.get("MAP_PROD_ID")!=null){
                cboProdId.setSelectedItem(((ComboBoxModel) cboProdId.getModel()).getDataForKey(hmap.get("MAP_PROD_ID").toString()));
                }
                else cboProdId.setSelectedIndex(0);
                if(hmap.get("MAP_ACT_NUM")!=null)
                txtAccNo.setText(hmap.get("MAP_ACT_NUM").toString());
                lblCustName.setText(CommonUtil.convertObjToStr(hash.get("NAME")));
                ...
                if(viewType.equals("EDIT")){
                    ...
                    btnEdit.setEnabled(false);
                    btnEmployerRefNo.setEnabled(false);
                    cboExemptionMode.setEnabled(true);
                }
...
//                    txtAccNo.setText(ACCOUNTNO);
    ...
    private com.see.truetransact.uicomponent.CComboBox cboExemptionMode;
    ...
    private com.see.truetransact.uicomponent.CLabel lblExemptionMode;
    ...
    private com.see.truetransact.uicomponent.CPanel panDeductionExemptionMapping;
