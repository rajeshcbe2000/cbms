 ...
 * 
 * DeductionExemptionMappingOB.java
 *
 ...
 * @author  rahul
 */
public class DeductionExemptionMappingOB extends CObservable{
    ...
    private static DeductionExemptionMappingOB deductionExemptionMappingOB;
    ...
    private String cboExemptionMode="";
    
    static {
        try {
            
            deductionExemptionMappingOB = new DeductionExemptionMappingOB();
        } catch(Exception e) {
            log.info("Error in DeductionExemptionMappingOB Declaration");
        }
    }
    
    public static DeductionExemptionMappingOB getInstance(CInternalFrame frm) {
        frame = frm;
        return deductionExemptionMappingOB;
    }
    
    /** Creates a new instance of CashTransactionOB */
    public DeductionExemptionMappingOB() throws Exception {
    ...
    private void setOperationMap() throws Exception{
        ...
        operationMap.put(CommonConstants.JNDI, "DeductionExemptionJNDI");
        operationMap.put(CommonConstants.HOME, "salaryrecovery.DeductionExemptionMappingHome");
        operationMap.put(CommonConstants.REMOTE, "salaryrecovery.DeductionExemptionMapping");
    }
    ...
    public SalaryDeductionMappingTO setSalaryDeductionMapping() {
        ...
        try{
            ...
            objSalaryDeductionMappingTO.setExemptionMode(getCboExemptionMode());
            ...
            objSalaryDeductionMappingTO.setTxtOldAccNo(getTxtOldAccNo());
    ...
    void setTxtOldAccNo(String txtOldAccNo){
        this.txtOldAccNo = txtOldAccNo;
        setChanged();
    }
    String getTxtOldAccNo(){
        return this.txtOldAccNo;
    }
    ...
    /**
     * Getter for property cboExemptionMode.
     * @return Value of property cboExemptionMode.
     */
    public String getCboExemptionMode() {
        return cboExemptionMode;
    }
    
    /**
     * Setter for property cboExemptionMode.
     * @param cboExemptionMode New value of property cboExemptionMode.
     */
    public void setCboExemptionMode(String cboExemptionMode) {
        this.cboExemptionMode = cboExemptionMode;
    }
