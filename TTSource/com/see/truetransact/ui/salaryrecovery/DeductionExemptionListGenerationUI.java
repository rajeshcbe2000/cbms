 ...
 * 
 * DeductionExemptionListGenerationUI.java
 * @author  Suresh
 *
 */
...
public class DeductionExemptionListGenerationUI extends CInternalFrame implements Observer{
    
    /** Vairable Declarations */
    DeductionExemptionListGenerationOB observable = null;
    ...
    public DeductionExemptionListGenerationUI() {
        returnMap = null;
    ...
    private void initForm(){
        initComponents();
        observable = new DeductionExemptionListGenerationOB();
        initComponentData();
        initTableData();
   ...
   It needs a class level HashMap variable mandatoryMap. */
    ...
    private void initComponents() {
        ...
        tblSalaryRecoveryList.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "SNo.", "Emp Ref.No.", "Member Name", "Exemption Mode", "Scheme Name", "A/c No.", "Total Demand", "Principal", "Interest", "Penal Interest", "Charges", "Clear Balance"
            }
        ));
        ...
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 0;
        panAddition.add(panAction, gridBagConstraints);
    ...
    private void btnViewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnViewActionPerformed
        ...
        if (tdtCalcIntUpto.getDateValue().equals("")) {
            ...
            List viewList=ClientUtil.executeQuery("viewDedExmpListDetails",viewMap);
            if(viewList.size()>0){
                for(int i=0;i<viewList.size();i++){
                    ...
                    listView.add(CommonUtil.convertObjToStr(newViewMap.get("EXEMPTION_MODE")));
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        // TODO add your handling code here:
        if(j==1) {
            if((txtAccountNo.getText()!=null || (!txtAccountNo.getText().equals(""))) && (txtAmount.getText()!=null)){
                int no=tblSalaryRecoveryList.getRowCount()+1;
                ( (EnhancedTableModel) tblSalaryRecoveryList.getModel() ).addRow(new Object[]{no,txtEmployerRefNo.getText(),lblName.getText(),exemptionMode,cboProdId.getSelectedItem().toString(),txtAccountNo.getText(),Double.parseDouble(txtAmount.getText()),0.0,0.0,0.0,0.0});
                ...
                insMap.put("EXEMPTION_MODE",exemptionMode);
                insMap.put("SCHEME_NAME",cboProdId.getSelectedItem().toString());
    ...
    private void callView(String currField) {
        ...
        if(currField == "CREDIT_ACC_NO"){
            ...
            statusmap.put(CommonConstants.MAP_NAME,"getEmployerRefNoForDedExmp");
    ...
    public void fillData(Object obj) {
        ...
        if (viewType != null) {
            ...
            if(viewType.equals("EMPREFNO")){
                ...
                exemptionMode=hash.get("EXEMPTION_MODE").toString();
                System.out.println("exemptionModeexemptionMode"+exemptionMode);
                //                HashMap hmap=new HashMap();
    ...
    private void btnGenerateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGenerateActionPerformed
        ...
        if (tdtCalcIntUpto.getDateValue().equals("")) {
            ...
            List recoveryList = ClientUtil.executeQuery("checkSameDateRcdInDedMastr", whereMap);
            if(recoveryList!=null && recoveryList.size()>0){
                ClientUtil.showMessageWindow("Deduction List Already Exported for This Date... !!! ");
            } else {
                ...
                tblSalaryRecoveryList.getColumnModel().getColumn(11).setPreferredWidth(50);
                calcTotal();
    ...
    private void createExcelFile(){
        try{
            ...
            String filename=System.getProperty("user.home") + "/Desktop/"+intDt.getDate()+"-"+(intDt.getMonth()+1)+"-"+(intDt.getYear()+1900)+"-"+"RecoveryList.xls" ;
            ...
            List recoveryList = ClientUtil.executeQuery("getDedExmpListData", whereMap);
            if(recoveryList!=null && recoveryList.size()>0){
                for(int i=1;i<=recoveryList.size();i++){
                    whereMap = (HashMap)recoveryList.get(i-1);
                    HSSFRow row=   sheet.createRow((short)i);
                    row.createCell((short) 0).setCellValue(CommonUtil.convertObjToStr(whereMap.get("EMP_REF_NO")));
                    row.createCell((short) 1).setCellValue(CommonUtil.convertObjToStr(whereMap.get("MEMBER_NAME")));
                    row.createCell((short) 2).setCellValue(CommonUtil.convertObjToDouble(whereMap.get("AMOUNT")).doubleValue());
                    total = total + CommonUtil.convertObjToDouble(whereMap.get("AMOUNT"));
...
//                        cell5.setCellValue(CommonUtil.convertObjToDouble(lblTotalTransactionAmtVal.getText()).doubleValue());
                ...
                whereMap.put("INT_CALC_UPTO_DT",setProperDtFormat(DateUtil.getDateMMDDYYYY(tdtCalcIntUpto.getDateValue())));
                ClientUtil.execute("updateDedExmpListExportStatus", whereMap);
    ...
    public static void main(String[] args) {
        DeductionExemptionListGenerationUI fad = new DeductionExemptionListGenerationUI();
