 ...
 * @author Swaroop
 */
public class AuthorizeListCreditUI extends com.see.truetransact.uicomponent.CInternalFrame implements Observer {
    ...
    ArrayList data = null;
    String node = "";
    private final static Logger log = Logger.getLogger(AuthorizeListCreditUI.class);

    /**
     * Creates new form ViewAll
     */
    public AuthorizeListCreditUI() {
//        try {
...
//        }
    ...
    private void initComponents() {
        ...
        panTable.add(lblCurCashBal, new java.awt.GridBagConstraints());

        txtCurCashBal.setEditable(false);
        txtCurCashBal.setMaximumSize(new java.awt.Dimension(100, 21));
        txtCurCashBal.setMinimumSize(new java.awt.Dimension(100, 21));
        panTable.add(txtCurCashBal, new java.awt.GridBagConstraints());
...
//        ProxyParameters.BRANCH_ID = "0001";
        ...
        if (node.equals("Customer Master")) {
            whereMap.put(CommonConstants.MAP_NAME, "getUnAuthorizedListForCustomer");
                ...
                whereMap.put(CommonConstants.MAP_NAME, "getSelectActMasterAuthCredit");
        }
        else if (node.equals("Salary Recovery Transaction")) {
                whereMap.put(CommonConstants.MAP_NAME, "getSelectSalaryRecoveryTransactionAuthCredit");
        }
        ...
        //} 
            ...
            whereMap.put(CommonConstants.MAP_NAME, "getSelectDepositOpeningAuthCredit");
        } 
        ...
        //} 
            ...
            where.put("AUTHORIZESTATUS", "AUTHORIZED");
            whereMap.put(CommonConstants.MAP_NAME, "getSelectLoanClosingAuthCredit");
       } else if (node.equals("Cash Transactions")) {
            where.put("AUTHORIZESTATUS", "AUTHORIZED");
            whereMap.put(CommonConstants.MAP_NAME, "getSelectCashAuthCredit");
            ...
            whereMap.put(CommonConstants.MAP_NAME, "getSelectNonAuthRecordForShareCredit");
       } else if (node.equals("MDS Receipts")) {
            where.put(CommonConstants.SELECTED_BRANCH_ID, ProxyParameters.BRANCH_ID);
            whereMap.put(CommonConstants.MAP_NAME, "getSelectNonAuthRecordForCashReceipt");
            ...
            whereMap.put(CommonConstants.MAP_NAME, "getLodgementMasterAuthorizeCreditList");
        } else if (node.equals("Investment Trans")) {
            whereMap.put(CommonConstants.MAP_NAME, "getInvestmentTransAuthorizetCrediList");
            ...
            whereMap.put(CommonConstants.MAP_NAME, "getRentTransAuthorizeCreditList");
                ...
                whereMap.put(CommonConstants.MAP_NAME, "getAuthorizationsListForMutipleCashcredit");
            ...
            whereMap.put(CommonConstants.MAP_NAME, "getLoanApplicationAuthorizeCreditList");
        } else if (node.equals("MDS Application New")) {
            where.put(CommonConstants.SELECTED_BRANCH_ID, ProxyParameters.BRANCH_ID);
            whereMap.put(CommonConstants.MAP_NAME, "getMDSappCreditAuth");
            ...
            whereMap.put(CommonConstants.MAP_NAME, "getDrfTransCreditAuth");
...
//                frm = new com.see.truetransact.ui.termloan.GoldLoanUI("OTHERS", CommonUtil.convertObjToStr(hash.get("PROD_ID")));
           ...
           // } 
            ...
            hash.put("FROM_CASHIER_AUTHORIZE_LIST_UI", "");
...
//        returnMap = new HashMap();
    ...
    public static void main(String args[]) {
        ...
        new AuthorizeListCreditUI().show();
    }
