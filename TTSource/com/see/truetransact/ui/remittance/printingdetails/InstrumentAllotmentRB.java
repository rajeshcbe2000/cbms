...
public class InstrumentAllotmentRB extends ListResourceBundle {
    public InstrumentAllotmentRB(){
    }
    ...
    static final String[][] contents = {
        ...
        {"lblMsg", ""},
        {"btnException", ""},
        {"lblEndingInstrumentNo", "Ending Instrument No."},
        {"btnNew", ""},
        {"lblStartingInstrumentNo", "Starting Instrument No."},
        {"btnSave", ""},
        {"btnCancel", ""},
        {"lblSpace3", "     "},
        {"lblStatus", "                      "},
