...
public class GLOpeningUpdateOB extends CObservable {
    ...
    public GLOpeningUpdateOB() throws Exception {
        setOperationMap();
    ...
    private void setOperationMap() throws Exception {
        ...
        operationMap.put(CommonConstants.JNDI, "GLOpeningUpdateJNDI");
        operationMap.put(CommonConstants.HOME, "GLOpeningUpdate.GLOpeningUpdateHome");
        operationMap.put(CommonConstants.REMOTE, "GLOpeningUpdate.GLOpeningUpdate");
    }
    
    public boolean dayEndChek(HashMap map) {
        System.out.println("dayend####"+map);
        boolean dayendFlag = false;
        HashMap dayendMap = new HashMap();
        dayendMap.put("DAY_END_DT", map.get("END_DT"));
        dayendMap.put("BRANCH_CODE",map.get("BRANCH_CODE"));
        List lst = ClientUtil.executeQuery("validateDayend", dayendMap);
    ...
    public void doActionPerform(HashMap dataMap1) throws Exception {
        ...
        System.out.println("dataMapdataMap" + dataMap1);
        term.put("BALANCE", dataMap1.get("NEW_BAL"));
        term.put("AC_HD", dataMap1.get("AC_HD"));
        term.put("BRANCH_ID",dataMap1.get("BRANCH_CODE"));
        term.put("OPEN_DT",dataMap1.get("OPEN_DT"));
        term.put("OLD_CLOS_BAL",dataMap1.get("OLD_CLOS_BAL"));
        term.put("NEW_CLOS_BAL",dataMap1.get("NEW_CLOS_BAL"));
        term.put("OPEN_BAL",dataMap1.get("OPEN_BAL"));
        term.put("USER_ID", dataMap1.get("USER_ID"));
        term.put("BALANCE_TYPE",dataMap1.get("BALANCE_TYPE"));
        //String action = "";
       ...
       // } else if (getActionType() == ClientConstants.ACTIONTYPE_EDIT) {
        ...
        //}
        term.put("COMMAND", dataMap1.get("COMMAND"));
        System.out.println("term ---- " + term + " dataMap-----" + dataMap);
        proxyReturnMap = proxy.execute(term, operationMap);
    ...
    public void doAction(HashMap dataMap) {
        TTException exception = null;
