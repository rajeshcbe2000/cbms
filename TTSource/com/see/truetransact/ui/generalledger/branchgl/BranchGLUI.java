 ...
 * BranchGLUI.java
 *
 * Created on December 27, 2004, 2:06 PM
 */
 ...
 * modified by Ashok
 */
public class BranchGLUI extends CInternalFrame implements UIMandatoryField, Observer{
    
    private ResourceBundle resourceBundle = ResourceBundle.getBundle("com.see.truetransact.ui.generalledger.branchgl.BranchGLRB", ProxyParameters.LANGUAGE);
    private HashMap mandatoryMap;
    private BranchGLMRB objMandatoryRB;
    private BranchGLOB observable;
    ...
    /** Creates new form BeanForm */
    public BranchGLUI(boolean branchConfig) {
        initComponents();
        initSetup();
    ...
    private void initSetup(){
        ...
        setMaxLengths();
        initComponentData();
        new MandatoryCheck().putMandatoryMarks(getClass().getName(),panGLAccess);
    ...
    private void setObservable() {
        observable = BranchGLOB.getInstance();
        observable.addObserver(this);
    }
    
    /** Setting Model for the Lists lstAvailGL, lstGrantGL */
    private void initComponentData() {
        lstAvailGL.setModel(observable.getLsmAvailableGLHead());
        lstGrantGL.setModel(observable.getLsmGrantGLHead());
    }
...
/* Auto Generated Method - internationalize()
   ...
   the Resource Bundle File. */
    private void internationalize() {
        ...
        ((javax.swing.border.TitledBorder)panGLAccess.getBorder()).setTitle(resourceBundle.getString("panGLAccess"));
        lblSpace.setText(resourceBundle.getString("lblSpace"));
        btnEdit.setText(resourceBundle.getString("btnEdit"));
        btnInclude.setText(resourceBundle.getString("btnInclude"));
        lblAvaGL.setText(resourceBundle.getString("lblAvaGL"));
        ...
        lblGrantGL.setText(resourceBundle.getString("lblGrantGL"));
...
ADD: implements com.see.truetransact.uimandatory.UIMandatoryField
   ...
   It needs a class level HashMap variable mandatoryMap. */
    public void setMandatoryHashMap() {
        ...
        mandatoryMap.put("lstGrantGL", new Boolean(true));
    }
...
/* Auto Generated Method - setHelpMessage()
   ...
   object. Help display Label name should be lblMsg. */
    public void setHelpMessage() {
        objMandatoryRB = new BranchGLMRB();
        ...
        lstAvailGL.setHelpMessage(lblMsg, objMandatoryRB.getString("lstAvailGL"));
        lstGrantGL.setHelpMessage(lblMsg, objMandatoryRB.getString("lstGrantGL"));
    }
...
/* Auto Generated Method - setFieldNames()
   ...
   Other functions are working based on this name. */
    private void setFieldNames() {
        ...
        lblAvaGL.setName("lblAvaGL");
        lblGroupId.setName("lblGroupId");
        lblGroupName.setName("lblBranchName");
        lblGrantGL.setName("lblGrantGL");
        lblMsg.setName("lblMsg");
        lblSpace.setName("lblSpace");
        lblSpace2.setName("lblSpace2");
        lblSpace3.setName("lblSpace3");
        lblStatus.setName("lblStatus");
        lstAvailGL.setName("lstAvailGL");
        lstGrantGL.setName("lstGrantGL");
        mbrMain.setName("mbrMain");
        panBtn.setName("panBtn");
        panGLAccess.setName("panGLAccess");
    ...
    private void savePerformed()throws Exception{
        ...
        if(observable.getResult()!=ClientConstants.ACTIONTYPE_FAILED){
            ...
            observable.resetForm();
            ClientUtil.enableDisable(panGLAccess, false);
            setButtonEnableDisable();
            enableDisableButtons(false);
    ...
    public void authorizeStatus(String authorizeStatus) {
        if (!viewType.equals(AUTHORIZE)){
            ...
            mapParam.put(CommonConstants.MAP_NAME, "getBranchGLAuthorizeList");
            mapParam.put(CommonConstants.UPDATE_MAP_NAME, "authorizeBranchGL");
            ...
            ClientUtil.execute("authorizeBranchGL", singleAuthorizeMap);
            viewType = "";
    ...
    private void initComponents() {
        ...
        panGLAccess = new com.see.truetransact.uicomponent.CPanel();
        ...
        lstAvailGL = new com.see.truetransact.uicomponent.CList();
        srpGranScreen = new com.see.truetransact.uicomponent.CScrollPane();
        lstGrantGL = new com.see.truetransact.uicomponent.CList();
        lblAvaGL = new com.see.truetransact.uicomponent.CLabel();
        lblGrantGL = new com.see.truetransact.uicomponent.CLabel();
        ...
        panGLAccess.setBorder(javax.swing.BorderFactory.createTitledBorder("GL Access"));
        panGLAccess.setLayout(new java.awt.GridBagLayout());
        ...
        panGLAccess.add(lblGroupId, gridBagConstraints);
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.EAST;
        gridBagConstraints.insets = new java.awt.Insets(4, 4, 4, 4);
        panGLAccess.add(lblGroupName, gridBagConstraints);
        ...
        gridBagConstraints.insets = new java.awt.Insets(4, 4, 4, 4);
        panGLAccess.add(txtGroupId, gridBagConstraints);
        ...
        srpGranScreen.setViewportView(lstGrantGL);
        ...
        lblAvaGL.setText("Available GL Heads");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 0;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        gridBagConstraints.insets = new java.awt.Insets(4, 4, 4, 4);
        panScreens.add(lblAvaGL, gridBagConstraints);

        lblGrantGL.setText("Granted GL Heads");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 2;
        gridBagConstraints.gridy = 0;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        gridBagConstraints.insets = new java.awt.Insets(4, 4, 4, 4);
        panScreens.add(lblGrantGL, gridBagConstraints);
        ...
        gridBagConstraints.weighty = 1.0;
        gridBagConstraints.insets = new java.awt.Insets(4, 4, 4, 4);
        panGLAccess.add(panScreens, gridBagConstraints);
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        ...
        panGLAccess.add(cSeparator1, gridBagConstraints);

        getContentPane().add(panGLAccess, java.awt.BorderLayout.CENTER);
    ...
    private void btnAuthorizeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAuthorizeActionPerformed
        ...
        authorizeStatus(CommonConstants.STATUS_AUTHORIZED);
        	...
        	private void btnExcludeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExcludeActionPerformed
                    Object selected[] = lstGrantGL.getSelectedValues();
                    observable.removedGLHeads(lstGrantGL.getSelectedValues());
                    for (int i=0; i < selected.length; i++) {
                        observable.getLsmGrantGLHead().removeElement(selected[i]);
                        observable.getLsmAvailableGLHead().addElement(selected[i]);
                    }
                    includeExcludeButton((DefaultListModel)lstAvailGL.getModel(),(DefaultListModel)lstGrantGL.getModel());
                        	...
                        	private void btnIncludeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnIncludeActionPerformed
                                    Object selected[] = lstAvailGL.getSelectedValues();
                                    observable.newGLHeads(lstAvailGL.getSelectedValues());
                                    for (int i=0; i < selected.length; i++) {
                                        observable.getLsmGrantGLHead().add(i,selected[i]);
                                        observable.getLsmAvailableGLHead().removeElement(selected[i]);
                                    }
                                    includeExcludeButton((DefaultListModel)lstAvailGL.getModel(),(DefaultListModel)lstGrantGL.getModel());
                                                                                                                        	...
                                                                                                                        	private void btnCancelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCancelActionPerformed
                                                                                                                                    ...
                                                                                                                                    btnException.setEnabled(true);
                                                                                                                                                                        	...
                                                                                                                                                                        	private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
                                                                                                                                                                                    // Add your handling code here:
                                                                                                                                                                                    try{
                                                                                                                                                                                        String mandatoryMessage = checkMandatory(panGLAccess);
                                                                                                                                                                                        StringBuffer message = new StringBuffer(mandatoryMessage);
                                                                                                                                                                                        if(observable.getLsmGrantGLHead().size() == 0){
                                                                                                                                                                                            message.append(objMandatoryRB.getString("lstGrantGL"));
                                                                                                                                                                                        }
                                                                                                                                                                                        if(message.length() > 0){
                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                        enableDisableButtons(false);
                                                                                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                                                                                            private void btnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditActionPerformed
                                                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                                                ClientUtil.enableDisable(panGLAccess, true);
                                                                                                                                                                                                                                                                                                setButtonEnableDisable();
    ...
    private void btnNewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNewActionPerformed
        ...
        ClientUtil.enableDisable(panGLAccess, true);
        setButtonEnableDisable();
        observable.fillAvailableAcHdIds();
        lstAvailGL.setModel(observable.getLsmAvailableGLHead());
    ...
    private void callView(int currField) {
        ...
        viewMap.put(CommonConstants.MAP_NAME, "getSelectBranchGLGroup");
    ...
    public void fillData(Object  map) {
        ...
        setModified(true);
        final String groupId = CommonUtil.convertObjToStr(hash.get("GROUP_ID"));
...
//            btnDelete.setEnabled(false);
    ...
    private com.see.truetransact.uicomponent.CLabel lblAvaGL;
    private com.see.truetransact.uicomponent.CLabel lblGrantGL;
    ...
    private com.see.truetransact.uicomponent.CList lstAvailGL;
    private com.see.truetransact.uicomponent.CList lstGrantGL;
    ...
    private com.see.truetransact.uicomponent.CPanel panGLAccess;
