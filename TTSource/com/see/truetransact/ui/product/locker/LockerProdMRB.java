...
public class LockerProdMRB extends ListResourceBundle {
    public LockerProdMRB(){
    }
    ...
    static final String[][] contents = {
        ...
        {"txtProdDesc", "Product Description should not be empty!!!"},
        {"txtLength","Length should not be empty"},
        {"txtBreth","Breadth should not be empty"},
        {"txtHeight","Height should not be empty"},
        {"cboMetric","Metric should not be empty"},
        {"txtLockerRentAcHd","Locker rent account head should not be empty"},
        {"rdoPenalToBeCollected","Penal to be collected should not be selected"},
        ...
        {"txtContractAccountHead", "ContractAccountHead should not be empty!!!"},
