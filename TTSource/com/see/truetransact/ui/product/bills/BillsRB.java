...
public class BillsRB extends ListResourceBundle {
    public BillsRB(){
    }
    ...
    static final String[][] contents = {
        ...
        {"btnPrint", ""},
        {"lblContractCrAccountHead", "Contra Cr Account Head"},
        {"lblContractDrAccountHead", "Contra Dr Account Head"},
        ...
        {"btnSave", ""},
        {"lblStatus", "                      "},
        {"btnContractCrAccountHead", ""},
        {"btnContractDrAccountHead", ""},
        {"btnDelete", ""},
        ...
        {"btnTelChargesHead1", ""},
        {"lblGLAccountHead", "B/P - Discount Account Head"},
        {"btnIBRAccountHead", ""},
        {"btnServiceTaxHd", ""},
        {"lblCleanBills_Per", "%"},
        ...
        {"tblColumn4", "Customer Category"},
        {"tblColumn5", " Start Date"},
        {"tblColumn6", "End Date"},
        {"tblColumn7",  "From Slab"},
        {"tblColumn8",  "To Slab"},
        {"tblColumn9",   "Commission"},
        ...
        {"lblCollectCommFrmCustomer","Collect Commision/Charges From Customer A/c"},
   };
