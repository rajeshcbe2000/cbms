...
public class LoanEligibilityMaintenanceRB extends ListResourceBundle {
    public LoanEligibilityMaintenanceRB(){
    }
    ...
    static final String[][] contents = {
        ...
        {"lblEligibileAmount", "Eligibile Amount per Acre"},
        ...
        {"lblRemarks", "Remarks"}, 
        {"tblColumn1", "Sl No."}, 
        {"tblColumn2", "Crop Type"}, 
        {"tblColumn3", "Amt"}, 
        {"tblColumn4", "From Date"}, 
        {"tblColumn5", "To Date"}, 
