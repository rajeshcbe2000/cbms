 ...
 * @author user
 */
public class suspenseIndendOB extends CObservable {
    ...
    private final static Logger log = Logger.getLogger(suspenseIndendOB.class);//Creating Instace of Log
    private ProxyFactory proxy;
    private int _actionType;//This vairable is used to type of action 1-New 2-Edit 3-Delete
    private int _result;
    private static suspenseIndendOB objIndendOB;//Singleton Object Reference
    ...
    static {
        try {
            ...
            objIndendOB = new suspenseIndendOB();
        } catch (Exception e) {
            // parseException.logException(e,true);
    ...
    private void setOperationMap() throws Exception {
        map = new HashMap();
        map.put(CommonConstants.JNDI, "SuspenseIndendJNDI");
        map.put(CommonConstants.HOME, "suspenseIndend.SuspenseIndendHome");
        map.put(CommonConstants.REMOTE, "suspenseIndend.suspenseIndend");
    }
    ...
    public static suspenseIndendOB getInstance() throws Exception {
        return objIndendOB;
    }
...
//        HashMap mapData = null;
    ...
    private void setIndendTO(IndendTO objTO) {
        ...
        setTxtDiscount(CommonUtil.convertObjToStr(objTO.getDiscountAmt()));
        setChanged();
        notifyObservers();
...
//                    authMap = null;
    ...
    public IndendTO geIndendTO(String command) {
        ...
        objTO.setDiscountAmt(CommonUtil.convertObjToDouble(getTxtDiscount()));
    ...
    public String getSuspenseAcHd(String supplierId) {
        ...
        supMap = (HashMap) (ClientUtil.executeQuery("getIndendSupplierSuspenseAcHd", supMap)).get(0);
    ...
    private void fillDropdown() throws Exception {
        try {
            ...
            lookup_keys1.add("INDEND_SUSPENSE_TRANSTYPE");
            lookUpHash.put(CommonConstants.PARAMFORQUERY, lookup_keys1);
            keyValue = ClientUtil.populateLookupData(lookUpHash);
            getKeyValue((HashMap) keyValue.get("INDEND_SUSPENSE_TRANSTYPE"));
