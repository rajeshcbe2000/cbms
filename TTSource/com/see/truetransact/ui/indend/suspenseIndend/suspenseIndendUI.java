 ...
 * 
 * suspenseIndendUI.java
 *
 * Created on September 12, 2011, 12:08 PM
 */
package com.see.truetransact.ui.indend.suspenseIndend;
 ...
 * @author userdd
 */
public class suspenseIndendUI extends CInternalFrame implements Observer, UIMandatoryField {

    private suspenseIndendOB observable;
    ...
    private void setObservable() {
        try {
            observable = suspenseIndendOB.getInstance();
            observable.addObserver(this);
        } catch (Exception e) {
...
//                }              
    ...
    private void initComponents() {
        ...
        panIndeedData.setPreferredSize(new java.awt.Dimension(340, 250));
        ...
        lblNarration.setBounds(220, 300, 60, 18);
        panIndeedData.add(txtNarration);
        txtNarration.setBounds(290, 300, 330, 21);
        ...
        txtTotalPurAmt.setBounds(450, 280, 100, 20);
        ...
        lblTotalPurAmt.setBounds(340, 280, 50, 18);
        ...
        panIndeedData.add(lblDiscount);
        lblDiscount.setBounds(350, 250, 70, 18);

        txtDiscount.setAllowAll(true);
        txtDiscount.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusLost(java.awt.event.FocusEvent evt) {
                txtDiscountFocusLost(evt);
            }
        });
        panIndeedData.add(txtDiscount);
        txtDiscount.setBounds(450, 250, 100, 20);

        panIndend.add(panIndeedData);
        panIndeedData.setBounds(0, 30, 810, 330);
        ...
        mnuProcess.setText("Indend Suspense Transaction");
...
private void txtTinNoFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtTinNoFocusLost
    ...
    public static void main(String args[]) throws Exception {
        try {
            suspenseIndendUI objIfr = new suspenseIndendUI();
...
// TODO add your handling code here:
    ...
    private void txtCommRecdFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtCommRecdFocusLost
        ...
        setTransactionAmount();
        resetTranAmount();
        txtCommRecd.setNextFocusableComponent(txtDiscount);
...
// TODO add your handling code here:
    ...
    private void txtDiscountFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtDiscountFocusLost
        ...
        setTransactionAmount();
        resetTranAmount();
        txtDiscount.setNextFocusableComponent(txtstIndentNo);
    ...
    public void setTransactionAmount() {
        ...
        totAmount = (CommonUtil.convertObjToDouble(txtAmount.getText()) + CommonUtil.convertObjToDouble(txtVatAmt.getText())
                + CommonUtil.convertObjToDouble(txtOtherExp.getText())) - (misc + CommonUtil.convertObjToDouble(txtCommRecd.getText()) + CommonUtil.convertObjToDouble(txtDiscount.getText()));
