 ...
 * @author user
 */
public class IndendOB extends CObservable {
    ...
    Double txtPurAmount, txtAmount, txtVatAmt, txtOthrExpAmt, txtMiscAmt, txtCommRecvdAmt, txtVatIndAmt,txtOtherIncome;
    ...
    private final static Logger log = Logger.getLogger(IndendOB.class);//Creating Instace of Log
    private ProxyFactory proxy;
    private int _actionType;//This vairable is used to type of action 1-New 2-Edit 3-Delete
    private int _result;
    private static IndendOB objIndendOB;//Singleton Object Reference
    ...
    private String txtGSTAmt = ""; // Added by nithya on 27-09-2018 for KD 262 - GST Indend Transaction - Needed to implement GST in Indent Transaction
    ...
    private void setTableTile() throws Exception {
        ...
        tableTitle.add("Liability Amount");//Added by nithya on 28-01-2020 for KD-1342
    ...
    public static IndendOB getInstance() throws Exception {
        return objIndendOB;
    }
        ...
        for (int i = 0; i < tblData.size(); i++) {
          ...
          //      System.out.println("34545%%%%"+objTo);
            ...
            if (objTo.getAmount() != null) {
                sList.add(CommonUtil.convertObjToStr(objTo.getAmount()));
            }
            ...
            }if (objTo.getNetAmount() != null) {
                sList.add(CommonUtil.convertObjToStr(objTo.getNetAmount()));
            }                  
            //sList.add(CommonUtil.convertObjToStr(""));
            
            if (objTo.getSlNo() >0) {
                sList.add(objTo.getSlNo());
            }
            
            if(objTo.getPurAmount() > 0.0){ // Added by nithya on 29-01-2020 for KD-1342
            ...
            tblList.add(sList);
            totalIncome +=objTo.getCommRecvdAmt()+objTo.getMiscAmt();            
        }
      //  System.out.println("totalIncome#$%#%#$"+totalIncome);
        setTxtOtherIncome(totalIncome);
        insertTable(tblList);
        }catch(Exception e){
            e.printStackTrace();
        }
...
//        System.out.println("getTxtMiscAmt>>>" +getTxtMiscAmt());
        ...
        //setTxtOtherIncome(objTO.getOtherIncome());
...
//        System.out.println("CommonUtil.convertObjToStr(getCbmSupplierName().getDataForKey(objTO.getSupplier()))>>>" + CommonUtil.convertObjToStr(getCbmSupplierName().getDataForKey(objTO.getSupplier())));
        ...
        double gstAmt = objTO.getCgstAmt() + objTO.getSgstAmt();
        setTxtGSTAmt(CommonUtil.convertObjToStr(gstAmt));
        // End
        setTxtRoundOff(CommonUtil.convertObjToStr(objTO.getRoundOffAmt()));
        setChanged();
        notifyObservers();
        ...
        try {
            ...
            if (tableList != null) {
                for (int i = 0; i < tableList.size(); i++) {
                    ...
                    if (getActionType() == ClientConstants.ACTIONTYPE_NEW) {
                        eachListadd.add((String) eachList.get(4));//Added by nithya on 28-01-2020 for KD-1342
                    } else {
                        eachListadd.add((String) eachList.get(5));//Added by nithya on 28-01-2020 for KD-1342   
                    }
                    //} else {
    ...
    public void resetForm() {
        ...
        setAuthMap(null);
        setTxtVatAmt(null);
        setTxtGSTAmt("");// Added by nithya on 27-09-2018 for KD 262 - GST Indend Transaction - Needed to implement GST in Indent Transaction
        setTxtPurcBillNo("");
        setTxtRoundOff("");
        setTxtTinNo("");
...
//                    authMap = null;
    ...
    public IndendTO geIndendTO(String command) {
       ...
       // Added by nithya on 27-09-2018 for KD 262 - GST Indend Transaction - Needed to implement GST in Indent Transaction
       double gstAmt = CommonUtil.convertObjToDouble(getTxtGSTAmt())/2;
       objTO.setCgstAmt(gstAmt);
       objTO.setSgstAmt(gstAmt);
       objTO.setRoundOffAmt(CommonUtil.convertObjToDouble(getTxtRoundOff()));
       // END
...
//            }
    ...
    public Double getTxtOtherIncome() {
        return txtOtherIncome;
    }

    public void setTxtOtherIncome(Double txtOtherIncome) {
        this.txtOtherIncome = txtOtherIncome;
    }

    // Added by nithya on 27-09-2018 for KD 262 - GST Indend Transaction - Needed to implement GST in Indent Transaction
    public String getTxtGSTAmt() {
        return txtGSTAmt;
    }

    public void setTxtGSTAmt(String txtGSTAmt) {
        this.txtGSTAmt = txtGSTAmt;
    }
    // End
