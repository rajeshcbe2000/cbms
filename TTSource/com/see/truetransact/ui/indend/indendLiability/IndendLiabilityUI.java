...
import com.see.truetransact.ui.indend.IndendMRB;
 ...
 * @author userdd
 */
public class IndendLiabilityUI extends CInternalFrame implements Observer, UIMandatoryField {

    private IndendLiabilityOB observable;
    ...
    private void setObservable() {
        try {
            observable = IndendLiabilityOB.getInstance();
            observable.addObserver(this);
        } catch (Exception e) {
    ...
    private void initComponentData() {
        try {
            ...
            cboIndentHeads.setModel(observable.getCbmIndentHeads());
...
//                }              
    ...
    private void initComponents() {
        ...
        lblIndentHeads = new com.see.truetransact.uicomponent.CLabel();
        cboIndentHeads = new com.see.truetransact.uicomponent.CComboBox();
        ...
        panIndeedData.setFocusCycleRoot(true);
        panIndeedData.setMaximumSize(new java.awt.Dimension(340, 275));
        panIndeedData.setMinimumSize(new java.awt.Dimension(340, 275));
        panIndeedData.setPreferredSize(new java.awt.Dimension(340, 275));
        panIndeedData.setLayout(null);
        ...
        panIndeedData.add(lblIndDate);
        lblIndDate.setBounds(10, 10, 80, 16);

        tdtBillDate.setMinimumSize(new java.awt.Dimension(100, 21));
        tdtBillDate.setPreferredSize(new java.awt.Dimension(100, 21));
        tdtBillDate.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseReleased(java.awt.event.MouseEvent evt) {
                tdtBillDateMouseReleased(evt);
            }
        });
        panIndeedData.add(tdtBillDate);
        tdtBillDate.setBounds(450, 130, 100, 21);
        ...
        panIndeedData.add(lblDepoId);
        lblDepoId.setBounds(20, 40, 70, 16);
        ...
        panIndeedData.add(lblStoreName);
        lblStoreName.setBounds(10, 70, 80, 16);

        txtStoreName.setEditable(false);
        txtStoreName.setForeground(new java.awt.Color(0, 0, 255));
        txtStoreName.setAllowAll(true);
        txtStoreName.setMinimumSize(new java.awt.Dimension(100, 21));
        panIndeedData.add(txtStoreName);
        txtStoreName.setBounds(100, 70, 230, 21);
        ...
        panIndeedData.add(lblTransType);
        lblTransType.setBounds(10, 100, 80, 16);

        cboSupplier.setMaximumSize(new java.awt.Dimension(100, 21));
        cboSupplier.setMinimumSize(new java.awt.Dimension(100, 21));
        cboSupplier.setPopupWidth(350);
        cboSupplier.setPreferredSize(new java.awt.Dimension(150, 21));
        cboSupplier.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cboSupplierActionPerformed(evt);
            }
        });
        panIndeedData.add(cboSupplier);
        cboSupplier.setBounds(100, 160, 230, 21);
        ...
        panIndeedData.add(lblPurAmt);
        lblPurAmt.setBounds(330, 10, 100, 16);
        ...
        txtPurAmount.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusLost(java.awt.event.FocusEvent evt) {
                txtPurAmountFocusLost(evt);
            }
        });
        panIndeedData.add(txtPurAmount);
        txtPurAmount.setBounds(450, 10, 100, 21);
        ...
        panIndeedData.add(lblTinNo);
        lblTinNo.setBounds(30, 190, 60, 16);
        ...
        panIndeedData.add(txtTinNo);
        txtTinNo.setBounds(110, 190, 100, 21);

        txtDepoId.setEnabled(false);
        panIndeedData.add(txtDepoId);
        txtDepoId.setBounds(100, 40, 96, 24);

        btnDepo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/see/truetransact/ui/images/TT_SELECT.gif"))); // NOI18N
        btnDepo.setToolTipText("Depo Search");
        ...
        panIndeedData.add(btnDepo);
        btnDepo.setBounds(200, 40, 40, 20);

        lblAmt.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        lblAmt.setText("Purchase Amount");
        panIndeedData.add(lblAmt);
        lblAmt.setBounds(0, 220, 104, 18);
        ...
        panIndeedData.add(lblVatAmt);
        lblVatAmt.setBounds(20, 250, 80, 16);
        ...
        panIndeedData.add(txtPurcBillNo);
        txtPurcBillNo.setBounds(450, 100, 100, 21);
        ...
        panIndeedData.add(lblSalesDate);
        lblSalesDate.setBounds(340, 160, 70, 16);
        ...
        panIndeedData.add(lblPurchBillNo);
        lblPurchBillNo.setBounds(340, 100, 90, 16);
        ...
        panIndeedData.add(txtVatAmt);
        txtVatAmt.setBounds(110, 250, 100, 21);

        tdtDateIndand.setMinimumSize(new java.awt.Dimension(100, 21));
        tdtDateIndand.setPreferredSize(new java.awt.Dimension(100, 21));
        panIndeedData.add(tdtDateIndand);
        tdtDateIndand.setBounds(100, 10, 100, 21);

        lblSupplier.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        lblSupplier.setText("Supplier");
        panIndeedData.add(lblSupplier);
        lblSupplier.setBounds(0, 160, 80, 18);
        ...
        panIndeedData.add(cboTransType);
        cboTransType.setBounds(100, 100, 100, 21);

        lblVatIndAmt.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        lblVatIndAmt.setText("Vat Indend Amt");
        panIndeedData.add(lblVatIndAmt);
        lblVatIndAmt.setBounds(340, 40, 100, 18);
        ...
        panIndeedData.add(txtAmount);
        txtAmount.setBounds(110, 220, 100, 21);

        lblBillDate.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        lblBillDate.setText("Bill Date");
        panIndeedData.add(lblBillDate);
        lblBillDate.setBounds(340, 130, 57, 18);

        tdtSalesDate.setMinimumSize(new java.awt.Dimension(100, 21));
        tdtSalesDate.setPreferredSize(new java.awt.Dimension(100, 21));
        tdtSalesDate.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseReleased(java.awt.event.MouseEvent evt) {
                tdtSalesDateMouseReleased(evt);
            }
        });
        panIndeedData.add(tdtSalesDate);
        tdtSalesDate.setBounds(450, 160, 100, 21);

        lblOtherExp.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        lblOtherExp.setText("Other Exp.");
        panIndeedData.add(lblOtherExp);
        lblOtherExp.setBounds(30, 280, 67, 18);
        ...
        txtVatIndAmount.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusLost(java.awt.event.FocusEvent evt) {
                txtVatIndAmountFocusLost(evt);
            }
        });
        panIndeedData.add(txtVatIndAmount);
        txtVatIndAmount.setBounds(450, 40, 100, 21);
        ...
        panIndeedData.add(txtOtherExp);
        txtOtherExp.setBounds(110, 280, 100, 21);

        lblMiscIncome.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        lblMiscIncome.setText("Misc.Income");
        panIndeedData.add(lblMiscIncome);
        lblMiscIncome.setBounds(340, 190, 85, 18);
        ...
        panIndeedData.add(txtMiscIncome);
        txtMiscIncome.setBounds(450, 190, 100, 21);

        lblCommRecvd.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        lblCommRecvd.setText("Comm.Recvd");
        panIndeedData.add(lblCommRecvd);
        lblCommRecvd.setBounds(340, 220, 85, 18);
        ...
        panIndeedData.add(txtCommRecd);
        txtCommRecd.setBounds(450, 220, 100, 21);

        txtSalesmanName.setForeground(new java.awt.Color(0, 0, 255));
        txtSalesmanName.setMaximumSize(new java.awt.Dimension(100, 21));
        txtSalesmanName.setMinimumSize(new java.awt.Dimension(100, 21));
        txtSalesmanName.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txtSalesmanNameActionPerformed(evt);
            }
        });
        panIndeedData.add(txtSalesmanName);
        txtSalesmanName.setBounds(100, 130, 230, 21);
        ...
        panIndeedData.add(lblSalesmanName);
        lblSalesmanName.setBounds(0, 130, 100, 16);

        lblNarration.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        lblNarration.setText("Narration");
        panIndeedData.add(lblNarration);
        lblNarration.setBounds(220, 280, 60, 18);
        panIndeedData.add(txtNarration);
        txtNarration.setBounds(280, 280, 330, 21);

        lblstIndentNo.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        lblstIndentNo.setText("Store Indent No");
        panIndeedData.add(lblstIndentNo);
        lblstIndentNo.setBounds(340, 70, 90, 18);

        txtstIndentNo.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusLost(java.awt.event.FocusEvent evt) {
                txtstIndentNoFocusLost(evt);
            }
        });
        panIndeedData.add(txtstIndentNo);
        txtstIndentNo.setBounds(450, 70, 100, 21);
        ...
        panIndeedData.add(txtTotalPurAmt);
        txtTotalPurAmt.setBounds(450, 250, 100, 21);
        ...
        panIndeedData.add(lblTotalPurAmt);
        lblTotalPurAmt.setBounds(340, 250, 50, 18);
        ...
        tblMultiTransTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Sl No", "Trans Type", "Name", "Indend Amount", "Indend Vat"
            }
        ));
        tblMultiTransTable.setMinimumSize(new java.awt.Dimension(225, 200));
        tblMultiTransTable.setPreferredScrollableViewportSize(new java.awt.Dimension(900, 1500));
        tblMultiTransTable.setPreferredSize(new java.awt.Dimension(900, 1500));
        ...
        panIndeedData.add(panMutipleTrans);
        panMutipleTrans.setBounds(550, 30, 280, 225);
        ...
        btnaddSave.setToolTipText("Save");
        ...
        panIndeedData.add(panCheckBookBtn);
        panCheckBookBtn.setBounds(630, 260, 110, 35);

        lblIndentHeads.setText("Heads");
        lblIndentHeads.setMaximumSize(new java.awt.Dimension(63, 18));
        lblIndentHeads.setMinimumSize(new java.awt.Dimension(63, 18));
        lblIndentHeads.setPreferredSize(new java.awt.Dimension(63, 18));
        panIndeedData.add(lblIndentHeads);
        lblIndentHeads.setBounds(35, 310, 50, 18);

        cboIndentHeads.setMaximumSize(new java.awt.Dimension(100, 21));
        cboIndentHeads.setMinimumSize(new java.awt.Dimension(100, 21));
        cboIndentHeads.setPopupWidth(350);
        cboIndentHeads.setPreferredSize(new java.awt.Dimension(150, 21));
        cboIndentHeads.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cboIndentHeadsActionPerformed(evt);
            }
        });
        panIndeedData.add(cboIndentHeads);
        cboIndentHeads.setBounds(100, 310, 150, 21);

        panIndend.add(panIndeedData);
        panIndeedData.setBounds(0, 30, 810, 350);
        ...
        mnuProcess.setText("Indend Liability");
...
private void txtTinNoFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtTinNoFocusLost
    ...
    public static void main(String args[]) throws Exception {
        try {
            IndendLiabilityUI objIfr = new IndendLiabilityUI();
...
//        this.dispose();
    ...
    public void authorizeStatus(String authorizeStatus) {
        if (!viewType.equals(AUTHORIZE)) {
            ...
            whereMap = null;
            mapParam.put(CommonConstants.MAP_NAME, "getIndendLiabilityAuthorizeList");
...
//        cboSupplier.setSelectedIndex(0);
    ...
    private void savePerformed() {
        System.out.println("mmmmmsave performed");
    ...
    private void saveAction(String status) {
        ...
        //       txtAmtBorrowed.
        System.out.println("mmmmmsave action");
...
//                    ClientUtil.showMessageWindow("EDITED INDEND REGISTER ID : " +observable.getIRNo());
                    ...
                    if (observable.getActionType() == ClientConstants.ACTIONTYPE_NEW && observable.getTxtGenTrans().equals("YES")) {
                        //displayTransDetail(observable.getProxyReturnMap());
                        ClientUtil.showMessageWindow("Indend ID : "+observable.getProxyReturnMap().get("IRNO"));
...
//        System.out.println("((ComboBoxModel)cboSupplier.getModel()).getKeyForSelected()).toString()>>>"+((ComboBoxModel)cboSupplier.getModel()).getKeyForSelected().toString());
        ...
        if (cboIndentHeads.getSelectedItem().equals("")) {
            observable.setCboIndentHeads(CommonUtil.convertObjToStr(((ComboBoxModel) cboTransType.getModel()).getKeyForSelected()));
        } else {
            observable.setCboIndentHeads(CommonUtil.convertObjToStr(((ComboBoxModel) cboIndentHeads.getModel()).getKeyForSelected()));
        }
...
// TODO add your handling code here:
    ...
    private void txtVatAmtFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtVatAmtFocusLost
        ...
        if (cboTransType.getSelectedItem().equals("Purchase") || cboTransType.getSelectedItem().equals("Purchase Return")) {        
            ...
            txtVatAmt.setNextFocusableComponent(txtMiscIncome);
        }
...
// TODO add your handling code here:
    ...
    private void tblMultiTransTableMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblMultiTransTableMousePressed
        ...
        System.out.println("slno333???%%%>>>" + slno);
        String slno = "";
        if (observable.getActionType() == ClientConstants.ACTIONTYPE_EDIT || observable.getActionType() == ClientConstants.ACTIONTYPE_AUTHORIZE) {
            if (tblMultiTransTable.getRowCount() > 0) {
                ...
                if (finalMap != null) {
                    System.out.println("75893475" + finalMap.keySet());
                    slno = CommonUtil.convertObjToStr(tblMultiTransTable.getValueAt(tblMultiTransTable.getSelectedRow(), 0));
                    System.out.println("slno???2@@@$$>>>" + slno);
                    ArrayList aList = new ArrayList();
                    IndendTO obj = (IndendTO) finalMap.get(slno);
                    System.out.println("obj@@!!!11>>>" + obj);
                    aList.add(obj);
...
//             updateOBFields();
                    ...
                    model.setValueAt(CommonUtil.convertObjToDouble(txtTotalPurAmt.getText()), toRow, 4);
                }
            }
            clearNextadd(false);
//                txtPurAmount.setEnabled(true);
...
//                transactionUI.setCallingAmount(txtTotAmt.getText());
                ...
                if ((CommonUtil.convertObjToDouble(txtPurAmount.getText())) >= 0.0 || (CommonUtil.convertObjToDouble(txtAmount.getText()))>0.0) {
                    ...
                    newList.add(txtPurAmount.getText());
                    newList.add(txtVatIndAmount.getText());                    
                    if (tableList == null) {
                    ...
                    tblMultiTransTable.setModel(observable.getTblCheckBookTable());
                    updateOBFields();
                    System.out.println("observable.setTxtVatAmt%%%%%%%%" + observable.getTxtVatAmt());
                    System.out.println("observable.getTxtMiscAmt%%%%%%%%" + observable.getTxtMiscAmt());
                    System.out.println("observable.getActionType()??>>>>@@>>" + observable.getActionType());
                    if (observable.getActionType() == ClientConstants.ACTIONTYPE_NEW) {
                        String action = CommonConstants.TOSTATUS_INSERT;
                        IndendTO obj = observable.geIndendTO(action);
                        System.out.println("obj1111@@####>>>>" + obj);
                        System.out.println("finalMap1111@@####>>>>" + finalMap);
                        if (finalMap == null) {
                            System.out.println("innn@@@##?");
                            finalMap = new HashMap();
                        }
                        System.out.println("slno111???%%%>>>" + slno);
                        if (slno < tblMultiTransTable.getRowCount()) {
                            slno = slno + 1;
                            System.out.println("slno22@@####>>>>" + slno);
                            System.out.println("obj22@@####>>>>" + obj);
                            finalMap.put(String.valueOf(slno), obj);
                        } else if (selectedFlag == true && observable.getActionType() == ClientConstants.ACTIONTYPE_NEW) {
                            System.out.println("tblMultiTransTable.getSelectedRow()22@@####>>>>" + tblMultiTransTable.getSelectedRow());
                            System.out.println("obj2%%%2@@####>>>>" + obj);
                            System.out.println("selRow%%%2@@####>>>>" + selRow);
    ...
    private void clearNextadd(boolean s) {
        ...
        cboIndentHeads.setSelectedItem("");
        txtSalesmanName.setText("");
        ...
        try {
            if (tblMultiTransTable.getRowCount() > 0) {
                for (int i = 0; i < tblMultiTransTable.getRowCount(); i++) {
                    ...
                    if (transType.equals("Damage") || transType.equals("Deficite") || transType.equals("Sales") || transType.equals("Purchase Return")) {
            ...
            //    gen_trans = "NO";
            //}
            System.out.println("totallllllllllll" + total);
...
//        int lastDigit = (int)amt%10;
    ...
    private void btnAddDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddDeleteActionPerformed
        ...
        if (s != -1) {
            System.out.println("fmapppp brfoore" + finalMap);
            tableList.remove(s);
            ...
            calcTotal();
            clearNextadd(false);
            System.out.println("fmapppp after" + finalMap);
        } else {
...
// TODO add your handling code here:
    ...
    private void cboIndentHeadsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cboIndentHeadsActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_cboIndentHeadsActionPerformed
    ...
    public void setTransactionAmount() {
        ...
        if (txtMiscIncome.getText() == null) {
            ...
            if (cboTransType.getSelectedItem().toString().equals("Sales")) {
                misc = -1 * CommonUtil.convertObjToDouble(txtMiscIncome.getText());
            } else {
                misc = CommonUtil.convertObjToDouble(txtMiscIncome.getText());
            }
        }
        if (txtCommRecd.getText() == null) {
            txtCommRecd.setText("0.0");
        }
        totAmount = (CommonUtil.convertObjToDouble(txtAmount.getText()) + CommonUtil.convertObjToDouble(txtVatAmt.getText())
    ...
    public void update() {
        ...
        System.out.println("DE{PPOOO IS DSETTT ===================================" + observable.getTxtStoreName());
        if (observable.getTxtDepoId() != null && !observable.getTxtDepoId().equals("")) {
            txtDepoId.setText(observable.getTxtDepoId());
        }

        System.out.println("observable.getCboSupplier()111>>>>" + observable.getCboSupplier());
        ...
        if (observable.getCboIndentHeads() != null && !observable.getCboIndentHeads().equals("")) {
            cboIndentHeads.setSelectedItem((observable.getCboIndentHeads()).toString());
        }
        System.out.println("observable.getCboSupplier()333>>>>" + cboSupplier.getSelectedItem());
        if (observable.getTxtStoreName() != null && !observable.getTxtStoreName().equals("")) {
            txtStoreName.setText(observable.getTxtStoreName());
        }
        System.out.println("observable.getTxtPurAmount()333>>>>" + observable.getTxtPurAmount());
        if (observable.getTxtPurAmount() != null) {
            txtPurAmount.setText(String.valueOf(observable.getTxtPurAmount()));
        }
        System.out.println("observable.getTxtAmount()333>>>>" + observable.getTxtAmount());
        ...
        if (observable.getTxtVatAmt() != null && !observable.getTxtVatAmt().equals("")) {
            System.out.println("observable.getTxtVatAmt()inside>>>>" + observable.getTxtVatAmt());
            txtVatAmt.setText(String.valueOf(observable.getTxtVatAmt()));
        }
        System.out.println("observable.getTxtVatIndAmt()111>>>>" + observable.getTxtVatIndAmt());
        ...
        System.out.println("observable.getTxtMiscAmt()111>>>>" + observable.getTxtMiscAmt());
        ...
        System.out.println("observable.getTxtCommRecvdAmt()111>>>" + observable.getTxtCommRecvdAmt());
        ...
        System.out.println("observable.getTdtSalesDate()111>>>>" + observable.getTdtSalesDate());
    ...
    private com.see.truetransact.uicomponent.CComboBox cboIndentHeads;
    ...
    private com.see.truetransact.uicomponent.CLabel lblIndentHeads;
