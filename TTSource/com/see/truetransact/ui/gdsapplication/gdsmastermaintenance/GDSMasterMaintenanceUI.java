...
public class GDSMasterMaintenanceUI extends com.see.truetransact.uicomponent.CInternalFrame implements java.util.Observer {

    java.util.ResourceBundle resourceBundle = java.util.ResourceBundle.getBundle("com.see.truetransact.ui.gdsapplication.gdsmastermaintenance.GDSMasterMaintenanceRB", ProxyParameters.LANGUAGE);
    private final static ClientParseException parseException = ClientParseException.getInstance();
    private GDSMasterMaintenanceMRB objMandatoryRB = new GDSMasterMaintenanceMRB();
    NomineeUI nomineeUi = new NomineeUI("SCREEN");
    GDSMasterMaintenanceOB observable = null;
    ...
    private void initForm() {
        setFieldNames();
        internationalize();
        observable = new GDSMasterMaintenanceOB();
        setMaxLengths();
        initComponentData();
        setMandatoryHashMap();
        setHelpMessage();
...
//        txtProductId.setName("txtProductId");
    ...
    private void internationalize() {
        resourceBundle = new GDSMasterMaintenanceRB();
...
//        mandatoryMap.put("txtProductId", new Boolean(true));
    ...
    public void populateMasterMaintenanceFields() {
        ...
        txtOverDueAmount.setText(observable.getTxtOverDueAmount());
        txtTotalAmountTillDate.setText(observable.getTxtTotalAmountTillDate());
        txtLastInstNo.setText(observable.getTxtLastInstNo());
        txtOverDueInstallments.setText(observable.getTxtOverDueInstallments());
     ...
     //  txtSchemeName.setText(observable.getTxtGroupNo());
    ...
    public void updateMasterMaintenanceFields() {
        ...
        observable.setTxtOverDueAmount(txtOverDueAmount.getText());
        observable.setTxtTotalAmountTillDate(txtTotalAmountTillDate.getText());
        observable.setTxtLastInstNo(txtLastInstNo.getText());
        observable.setTxtOverDueInstallments(txtOverDueInstallments.getText());
...
//        observable.setTxtSalsetTxtMemNetwortharyRemark(txtSalaryRemark.getText());
...
//        txtProductId.setText(observable.getTxtProductId());
    ...
    public void setHelpMessage() {
        GDSMasterMaintenanceMRB objMandatoryRB = new GDSMasterMaintenanceMRB();
...
//        txtProductId.setAllowAll(true);
    ...
    private void initComponents() {
        ...
        panMdsSchemeNameDetails.setLayout(new java.awt.GridBagLayout());
        ...
        panMdsSchemeNameDetails.add(lblChittalNo, gridBagConstraints);
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.EAST;
        gridBagConstraints.insets = new java.awt.Insets(1, 1, 1, 1);
        panMdsSchemeNameDetails.add(lblChitStartDt, gridBagConstraints);
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 3;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        gridBagConstraints.insets = new java.awt.Insets(2, 2, 2, 2);
        panMdsSchemeNameDetails.add(tdtChitStartDt, gridBagConstraints);

        lblGdsName.setText("GDS Name");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 0;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.EAST;
        gridBagConstraints.insets = new java.awt.Insets(1, 1, 1, 1);
        panMdsSchemeNameDetails.add(lblGdsName, gridBagConstraints);
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.EAST;
        gridBagConstraints.insets = new java.awt.Insets(1, 1, 1, 1);
        panMdsSchemeNameDetails.add(lblDivisionNo, gridBagConstraints);
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        gridBagConstraints.insets = new java.awt.Insets(2, 2, 2, 2);
        panMdsSchemeNameDetails.add(panSchemeName, gridBagConstraints);
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        gridBagConstraints.insets = new java.awt.Insets(2, 2, 2, 2);
        panMdsSchemeNameDetails.add(panChittalNo, gridBagConstraints);
        ...
        panMdsSchemeNameDetails.add(txtSubNo, gridBagConstraints);
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        gridBagConstraints.insets = new java.awt.Insets(2, 2, 2, 2);
        panMdsSchemeNameDetails.add(panChittalNo1, gridBagConstraints);
        ...
        panMdsSchemeNameDetails.add(lblProdDesc, gridBagConstraints);
        ...
        panMdsSchemeNameDetails.add(lblChitCloseDt, gridBagConstraints);
        ...
        gridBagConstraints.gridy = 3;
        panMdsSchemeNameDetails.add(tdtChitCloseDt, gridBagConstraints);
        ...
        panDepositType.add(lblProductId, gridBagConstraints);
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.EAST;
        gridBagConstraints.insets = new java.awt.Insets(2, 0, 2, 4);
        panDepositType.add(lblSameChittal, gridBagConstraints);
        ...
        gridBagConstraints.gridy = 0;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        panDepositType.add(cbxSameChittal, gridBagConstraints);
...
//        txtSchemeName.setText("");
    ...
    private void updateAuthorizeStatus(String authorizeStatus) {
        ...
        if (viewType == AUTHORIZE && isFilled) {
            ...
            singleAuthorizeMap.put("GDS_NO", observable.getTxtChittalNo());
            singleAuthorizeMap.put("GROUP_NO", txtSchemeName.getText());
            ...
            mapParam.put(CommonConstants.MAP_NAME, "getGDSMasterMaintenanceAuthorize");
            isFilled = false;
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        ...
        HashMap mapProd= new HashMap();
          ...
          if (CommonUtil.convertObjToStr(CommonConstants.SAL_REC_MODULE).equals("Y")) {
            ...
            paymentMap.put("GDS_NO", CommonUtil.convertObjToStr(txtChittalNo.getText()));
            paymentMap.put("SUB_NO", CommonUtil.convertObjToInt(txtSubNo.getText()));
            List paymentList = ClientUtil.executeQuery("getGDSSchemeNameDetailsNoOfMember",paymentMap);
...
//            }
           ...
           // double sanctionAmt = CommonUtil.convertObjToDouble(txtLimit_SD.getText()).doubleValue();
            if ((tot < prizedAmount) && !cbxDefaulter.isSelected() && !cbxOnlyApplication.isSelected() && !thalayal) {
...
//added by nitdhin
        ...
        //String subNo = txtSubNo.getText();
        mdsMap.put("CHITTAL_NO", chittalNo);
        mdsMap.put("GDS_NO", chittalNo);
        //mdsMap.put("SUB_NO", subNo);
        mdsMap.put("SUB_NO", CommonUtil.convertObjToInt(txtSubNo.getText())); // Added by nithya on 16-01-2020 for KD-1279
        double noinset = 0.0;
        double instAmt = 0.0;
        double paidInst = 0.0;
        double totAmt = 0.0;
        List mdsList = ClientUtil.executeQuery("getGDSTotalInstAmount", mdsMap);
        List mdsList1 = ClientUtil.executeQuery("getGDSSelctApplnReceiptDetails", mdsMap);
        if (mdsList1 != null && mdsList1.size() > 0) {
            ...
            instAmt = CommonUtil.convertObjToDouble(mdsMap.get("INST_AMT")).doubleValue() * mdsList1.size();
...
//            }
            ...
            System.out.println("tot=="+tot);
           // double sanctionAmt = CommonUtil.convertObjToDouble(txtLimit_SD.getText()).doubleValue();
            if ((tot < tobepaidInst) && !cbxDefaulter.isSelected() && !cbxOnlyApplication.isSelected()&& !thalayal) {
                ClientUtil.displayAlert("Security Amount is lesser than the Sanctioned amount");
                return;
            }
        ...
        //String subNo = CommonUtil.convertObjToStr(txtSubNo.getText());
        mdsMap.put("CHITTAL_NO", chittalNo);
        mdsMap.put("GDS_NO", chittalNo);
        //mdsMap.put("SUB_NO", subNo);
        mdsMap.put("SUB_NO", CommonUtil.convertObjToInt(txtSubNo.getText())); // Added by nithya on 16-01-2020 for Kd-1279
...
//            }
            ...
            System.out.println("tot=="+tot);
           // double sanctionAmt = CommonUtil.convertObjToDouble(txtLimit_SD.getText()).doubleValue();
            if (tot < whichEverIsLessPrzOrInst && !cbxDefaulter.isSelected() && !cbxOnlyApplication.isSelected()&& !thalayal) {
                ClientUtil.displayAlert("Security Amount is lesser than the Sanctioned amount..");
                return;
            }
          }
    ...
    private void popUp(String currAction) {
        ...
        if (currAction.equalsIgnoreCase("Edit") || currAction.equalsIgnoreCase("Delete")) {
          ...
          //  viewMap.put(CommonConstants.MAP_NAME, "getSelectEachSchemeDetails");
            ...
            where.put("GROUP_NO",txtSchemeName.getText());
            viewMap.put(CommonConstants.MAP_WHERE, where);            
           // viewMap.put(CommonConstants.MAP_NAME, "getSelectChitNoNotinMasterDetails");
            viewMap.put(CommonConstants.MAP_NAME, "getSelectGDSChitNoNotinMasterDetails");
    ...
    public void fillData(Object obj) {
        try {
            ...
            if (viewType == "SCHEME_DETAILS") {
                ...
                observable.setTxtGroupNo(CommonUtil.convertObjToStr(hashMap.get("GROUP_NO")));
          ...
          //  HashMap hash = (HashMap) map;
            ...
            txtResolutionNo.setText(resolutionno);
                ...
                txtSchemeName.setText(CommonUtil.convertObjToStr(groupMap.get("GROUP_NO")));
                ...
                txtOverDueAmount.setText(observable.getTxtOverDueAmount());
                observable.setTxtSchemeName(CommonUtil.convertObjToStr(hashMap.get("GROUP_NO")));
                hashMap.put("GROUP_NO",observable.getTxtGroupNo());
...
//                
                ...
                if (!cbxDefaulter.isSelected() == true) {
                    ...
                    int LastBonNo = 0;
                    bondMap.put("GDS_NO", txtChittalNo.getText());
                    bondMap.put("GROUP_NO", txtSchemeName.getText());
                    bondMap.put("SCHEME_NAME",observable.getCommonScheme());
                    bondMap.put("SCHEME",observable.getCommonScheme());
...
//                         observable.updateMDSSchemeBond(LastBondNo);
                    ...
                    int LastApplNo = 0;
                    applicationmap.put("GDS_NO", txtChittalNo.getText());
                    applicationmap.put("GROUP_NO", txtSchemeName.getText());
                    applicationmap.put("SCHEME_NAME",observable.getCommonScheme());
                    applicationmap.put("SCHEME",observable.getCommonScheme());
...
//                        }
                ...
                this.setButtonEnableDisable();                
                // Added by nithya 
                System.out.println("hashmap for authorize :: "+hashMap);
                HashMap groupMap = new HashMap();
...
//            }
    ...
    private void btnCollateralNewActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        if (txtSchemeName.getText().length() > 0 && txtChittalNo.getText().length() > 0) {
            ...
            MdsDetailsMap.put("SUB_NO", CommonUtil.convertObjToInt(txtSubNo.getText()));
    ...
    public static void main(String[] arg) {
        ...
        GDSMasterMaintenanceUI gui = new GDSMasterMaintenanceUI();
