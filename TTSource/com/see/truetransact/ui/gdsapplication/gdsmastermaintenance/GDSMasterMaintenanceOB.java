...
package com.see.truetransact.ui.gdsapplication.gdsmastermaintenance;


import com.see.truetransact.ui.gdsapplication.gdsmastermaintenance.*;
...
import com.see.truetransact.transferobject.gdsapplication.gdsmastermaintenance.GDSMasterMaintenanceTO;
import com.see.truetransact.transferobject.gdsapplication.gdsmastermaintenance.*;
...
public class GDSMasterMaintenanceOB extends CObservable{
    
    private String txtRemarks = "";
    private String txtOverDueAmount = "";
    private String txtTotalAmountTillDate = "";
    private String txtLastInstNo = "";
    private String txtOverDueInstallments = "";
   ...
   //
    ...
    private HashMap map;
    private final static Logger log = Logger.getLogger(GDSMasterMaintenanceOB.class);
    ...
    private GDSMasterMaintenanceTO objMaintenanceTO;
 ...
 private TransactionOB transactionOB; //trans details
  private HashMap authMap = new HashMap(); //trans details
   private Date currDt=null; //trans details
    ...
    public GDSMasterMaintenanceOB() {
        try {
            proxy = ProxyFactory.createProxy();
            map = new HashMap();
            map.put(CommonConstants.JNDI, "GDSMasterMaintenanceJNDI");
            map.put(CommonConstants.HOME, "gdsapplication.gdsmastermaintenance.GDSMasterMaintenanceHome");
            map.put(CommonConstants.REMOTE, "gdsapplication.gdsmastermaintenance.GDSMasterMaintenance");
...
//            makeNull();
    ...
    public void addCollateralTable(int rowSelected, boolean updateMode){
        try{
            ...
            objMDSMasterSecurityLandTO.setSubNo(CommonUtil.convertObjToInt(getTxtSubNo())); //AJITH
            ...
            objMDSMasterSecurityLandTO.setPledgeAmount(CommonUtil.convertObjToDouble(getTxtPledgeAmount()).doubleValue()/getSchemeCount());
    ...
    public void addMemberTypeTable(int rowSelected, boolean updateMode){
        try{
            ...
            objMemberTypeTO.setSubNo(CommonUtil.convertObjToInt(getTxtSubNo()));   //AJITH
            ...
            System.out.println("getSchemeCount() :: "+getSchemeCount());
            System.out.println("getTxtNetWorth() :: " + getTxtMemNetworth());
            double networth = CommonUtil.convertObjToDouble(getTxtMemNetworth()).doubleValue()/getSchemeCount();
            objMemberTypeTO.setNetworth(String.valueOf(networth));
    ...
    public void addDepositTypeTable(int rowSelected, boolean updateMode){
        try{
            ...
            objDepositTypeTO.setSubNo(CommonUtil.convertObjToInt(getTxtSubNo()));   //AJITH
...
//            objDepositTypeTO.setProdId(getTxtProductId());
            ...
            double depositAmount = CommonUtil.convertObjToDouble(getTxtDepAmount()).doubleValue()/getSchemeCount();
            objDepositTypeTO.setAmount(depositAmount);  //AJITH
    ...
    public void addSocietyTypeTable(int rowSelected, boolean updateMode){
        try{
            ...
            objMDSSocietyTypeTO.setSubNo(CommonUtil.convertObjToInt(getTxtSubNo()));   //AJITH
    ...
    public void setPaymentDetails(){
        ...
        listMap.put("GDS_NO",getTxtChittalNo());
        listMap.put("SUB_NO",CommonUtil.convertObjToInt(getTxtSubNo()));
        List lst = ClientUtil.executeQuery("getGDSMemberDetailsMaster", listMap);
        if(lst!=null && lst.size()>0){
            ...
            prodMap.put("SCHEME_NAME",getCommonScheme());
            prodMap.put("CHITTAL_NO",listMap.get("CHITTAL_NO"));
            prodMap.put("SUB_NO",CommonUtil.convertObjToInt(getTxtSubNo()));
            prodMap.put("GDS_NO",getTxtChittalNo());
            lst = ClientUtil.executeQuery("getGDSSchemeNameDetailsNoOfMember", prodMap);
            if(lst!=null && lst.size()>0){
                prodMap = (HashMap)lst.get(0);
                double prizedAmount = CommonUtil.convertObjToDouble(prodMap.get("PRIZED_AMOUNT"));
                setTxtPrizedAmount(CommonUtil.convertObjToStr(prizedAmount*getSchemeCount()));
            ...
            insDateMap.put("SCHEME_NAME",getCommonScheme());
            ...
            whereMap.put("GDS_NO",getTxtChittalNo());
            whereMap.put("SUB_NO",CommonUtil.convertObjToInt(getTxtSubNo()));
            whereMap.put("COUNT",getSchemeCount());
            List list = ClientUtil.executeQuery("getGDSTotalInstAmount", whereMap);
            if(list!=null && list.size()>0){
                whereMap = (HashMap)list.get(0);
                setTxtTotalAmountTillDate(CommonUtil.convertObjToStr(whereMap.get("PAID_AMT")));
            }
            ...
            this.setLblMemberType(CommonUtil.convertObjToStr(listMap.get("MEMBER_TYPE")));
            this.setLblNomineeName(CommonUtil.convertObjToStr(""));
            setTxtOverDueInstallments(String.valueOf(CommonUtil.convertObjToLong(listMap.get("NO_OF_INSTALLMENTS")) -
            CommonUtil.convertObjToLong(listMap.get("INST_COUNT"))));
            ...
            insDtMap.put("GDS_NO",getTxtChittalNo());
            List insDtLst = ClientUtil.executeQuery("getGDSNextInsDate", insDtMap);
...
//                instDay = instalDay;
            ...
            instMap.put("GDS_NO",getTxtChittalNo());
            ...
            if(stYear == currYear && stMonth == currMonth){
                pending = 0;
                setTxtOverDueInstallments(String.valueOf("0"));
...
//                    pending = pendingVal+1;
                ...
                if(pending>0){
                    setTxtOverDueInstallments(String.valueOf(pending));
                }
                else{
                    setTxtOverDueInstallments(String.valueOf(0));
                }
...
//                    pending = pendingVal+1;
            ...
            setTxtOverDueAmount(String.valueOf(CommonUtil.convertObjToLong(getTxtOverDueInstallments()) * CommonUtil.convertObjToLong(listMap.get("INST_AMT"))));
        }
    }
...
//            }
    ...
    public void getData(HashMap whereMap,NomineeOB objNomineeOB) {
        try{
            ...
            objMaintenanceTO = (GDSMasterMaintenanceTO) ((List) data.get("MasterMaintenanceListTO")).get(0);
...
//                    incTabRow.add(CommonUtil.convertObjToStr(objDepositTypeTO.getMaturityDt()));
    ...
    private void populateMasterMaintenanceData(GDSMasterMaintenanceTO objMaintenanceTO) throws Exception{
        this.setTxtSchemeName(CommonUtil.convertObjToStr(objMaintenanceTO.getSchemeName()));
        this.setTxtChittalNo(CommonUtil.convertObjToStr(objMaintenanceTO.getGdsNo()));
        this.setTxtDivisionNo(CommonUtil.convertObjToStr(objMaintenanceTO.getDivisionNo()));
        this.setTxtSubNo(CommonUtil.convertObjToStr(objMaintenanceTO.getSubNo()));
...
//        this.setTxtOverDueAmount(CommonUtil.convertObjToStr(objMaintenanceTO.getInstalOverdueAmt()));
        this.setTxtPinCode(CommonUtil.convertObjToStr(objMaintenanceTO.getPin()));
        this.setTxtContactNo(CommonUtil.convertObjToStr(objMaintenanceTO.getContactNo()));
        this.setTxtTotalSalary(CommonUtil.convertObjToStr(objMaintenanceTO.getTotalSalary()));
...
//        this.setTxtRemarks(CommonUtil.convertObjToStr(objMaintenanceTO.getInstalRemarks()));
        ...
        this.setTxtGrossWeight(CommonUtil.convertObjToStr(objMaintenanceTO.getGrossWeight()));
        this.setTxtNetWeight(CommonUtil.convertObjToStr(objMaintenanceTO.getNetWeight()));
...
//        }
    ...
    public GDSMasterMaintenanceTO setMasterMaintenanceTOData() {
        
        final GDSMasterMaintenanceTO objMaintenanceTO = new GDSMasterMaintenanceTO();
        try{
            objMaintenanceTO.setSchemeName(getTxtSchemeName());
            objMaintenanceTO.setChittalNo(getTxtChittalNo());
            objMaintenanceTO.setGdsNo(getTxtChittalNo());
            objMaintenanceTO.setDivisionNo(CommonUtil.convertObjToInt(getTxtDivisionNo()));
            objMaintenanceTO.setSubNo(CommonUtil.convertObjToInt(getTxtSubNo()));
            objMaintenanceTO.setPrizedAmount(CommonUtil.convertObjToDouble(getTxtPrizedAmount()));
            objMaintenanceTO.setTotalAmount(CommonUtil.convertObjToDouble(getTxtTotalAmountTillDate()));
            objMaintenanceTO.setInstallmentDue(CommonUtil.convertObjToInt(getTxtOverDueInstallments()));
            objMaintenanceTO.setInstalOverdueAmt(CommonUtil.convertObjToDouble(getTxtOverDueAmount()));
...
//            objMaintenanceTO.setSalaryRemarks(getTxtSalaryRemark());
            ...
            objMaintenanceTO.setGrossWeight(CommonUtil.convertObjToDouble(getTxtGrossWeight()));
            objMaintenanceTO.setNetWeight(CommonUtil.convertObjToDouble(getTxtNetWeight()));
...
//            objMaintenanceTO.setStatusDt(ClientUtil.getCurrentDateWithTime());
    ...
    // Setter method for txtOverDueAmount
    void setTxtOverDueAmount(String txtOverDueAmount){
        this.txtOverDueAmount = txtOverDueAmount;
        setChanged();
    }
    // Getter method for txtOverDueAmount
    String getTxtOverDueAmount(){
        return this.txtOverDueAmount;
    }
    
    // Setter method for txtTotalAmountTillDate
    void setTxtTotalAmountTillDate(String txtTotalAmountTillDate){
        this.txtTotalAmountTillDate = txtTotalAmountTillDate;
        setChanged();
    }
    // Getter method for txtTotalAmountTillDate
    String getTxtTotalAmountTillDate(){
        return this.txtTotalAmountTillDate;
    }
    ...
    // Setter method for txtOverDueInstallments
    void setTxtOverDueInstallments(String txtOverDueInstallments){
        this.txtOverDueInstallments = txtOverDueInstallments;
        setChanged();
    }
    // Getter method for txtOverDueInstallments
    String getTxtOverDueInstallments(){
        return this.txtOverDueInstallments;
    }
    ...
    // Setter method for txtTotalSalary
    void setTxtTotalSalary(String txtTotalSalary){
        this.txtTotalSalary = txtTotalSalary;
        setChanged();
    }
    // Getter method for txtTotalSalary
    String getTxtTotalSalary(){
        return this.txtTotalSalary;
    }
    ...
    // Setter method for txtGrossWeight
