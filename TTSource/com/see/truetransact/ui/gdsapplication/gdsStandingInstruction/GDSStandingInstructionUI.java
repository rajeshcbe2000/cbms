...
public class GDSStandingInstructionUI extends CInternalFrame implements Observer {
    ...
    GDSStandingInstructionOB observable = null;
    ...
    public GDSStandingInstructionUI() {
        initForm();
    ...
    private void initForm() {
        initComponents();
        observable = new GDSStandingInstructionOB();
        initTableData();
        ...
        try {
            ...
            if (viewType != null) {
                ...
                if (viewType.equalsIgnoreCase("GROUP_DETAILS")) {
                    ...
                    groupMap.put("GROUP_NO", hash.get("GROUP_NO"));
                    ...
                    schemeMap.put("SCHEME_NAME", commonGroup);
    ...
    private void initComponents() {
        ...
        lblChittalSelected = new com.see.truetransact.uicomponent.CLabel();
        ...
        cLabel1.setText("Current Installment");
        ...
        panSchemeNameDetailsLayout.setHorizontalGroup(
            ...
            .addGroup(panSchemeNameDetailsLayout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(txtInstNo, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(28, 28, 28)
                .addComponent(lblProduct, javax.swing.GroupLayout.PREFERRED_SIZE, 107, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
                .addComponent(cboProdId, javax.swing.GroupLayout.DEFAULT_SIZE, 91, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        panSchemeNameDetailsLayout.setVerticalGroup(
            panSchemeNameDetailsLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(panSchemeNameDetailsLayout.createSequentialGroup()
                .addGroup(panSchemeNameDetailsLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(panSchemeNameDetailsLayout.createSequentialGroup()
                        .addGap(3, 3, 3)
                        .addComponent(panSchemeName, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(panSchemeNameDetailsLayout.createSequentialGroup()
                        ...
                        .addGroup(panSchemeNameDetailsLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(cboProdId, javax.swing.GroupLayout.PREFERRED_SIZE, 22, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        srpStandingIns.setPreferredSize(new java.awt.Dimension(32767, 32767));
        ...
        tblStandingInstruction.setPreferredScrollableViewportSize(new java.awt.Dimension(804, 596));
        tblStandingInstruction.setPreferredSize(new java.awt.Dimension(775, 7000));
        tblStandingInstruction.setReorderingAllowed(false);
        tblStandingInstruction.addMouseListener(new java.awt.event.MouseAdapter() {
            ...
            public void mouseReleased(java.awt.event.MouseEvent evt) {
                tblStandingInstructionMouseReleased(evt);
            }
        });
        ...
        panProcess.setMinimumSize(new java.awt.Dimension(850, 80));
        ...
        gridBagConstraints.gridy = 0;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.EAST;
        gridBagConstraints.insets = new java.awt.Insets(0, 50, 4, 4);
        panProcess.add(lblTotalTransactionAmt, gridBagConstraints);

        cLabel2.setForeground(new java.awt.Color(0, 0, 255));
        cLabel2.setText("No Of Chittal Nos Selected :");
        cLabel2.setFont(new java.awt.Font("MS Sans Serif", 1, 12)); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 4;
        gridBagConstraints.gridy = 1;
        ...
        lblChittalSelected.setForeground(new java.awt.Color(0, 0, 255));
        lblChittalSelected.setFont(new java.awt.Font("MS Sans Serif", 1, 13)); // NOI18N
        lblChittalSelected.setMinimumSize(new java.awt.Dimension(100, 21));
        lblChittalSelected.setPreferredSize(new java.awt.Dimension(100, 21));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 5;
        gridBagConstraints.gridy = 1;
        panProcess.add(lblChittalSelected, gridBagConstraints);
    ...
    private void btnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPrintActionPerformed
        ...
        if (txtFromTransID.getText().length() > 0 && txtToTransID.getText().length() > 0 && tdtTransDate.getDateValue().length() > 0) {
            ...
            ttIntgration.integrationForPrint("MDS_SI_TransferVoucher");
...
//    }
    private void chkSelectAllActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_chkSelectAllActionPerformed
        ...
        for (int i = 0; i < tblStandingInstruction.getRowCount(); i++) {
            ...
            String prodType = CommonUtil.convertObjToStr(tblStandingInstruction.getValueAt(i, 9));
            if (availbalnce < netamt && flag == true && !(prodType.equalsIgnoreCase("AB"))) {// prod type AB checking added by nithya on 26-11-2019 for KD-679
        ...
        setTotalAmount();
        calculateTotalChittalSelected();
    }//GEN-LAST:event_chkSelectAllActionPerformed
    
    private void calculateTotalChittalSelected(){
        double selectedCount =  0.0;
        if(tblStandingInstruction.getRowCount() > 0){         
            int count = tblStandingInstruction.getRowCount();            
            for(int i=0;i<count;i++){
                if((Boolean)tblStandingInstruction.getValueAt(i, 0)){                   
                    selectedCount = selectedCount+1;                  
                }
            }
        }
        lblChittalSelected.setText(CommonUtil.convertObjToStr(selectedCount)); 
    }
    ...
    private void tblStandingInstructionMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblStandingInstructionMouseClicked
        ...
        if (selectMode == true) {
            ...
            if (st.equals("true")) {
                ...
                String prodType = CommonUtil.convertObjToStr(tblStandingInstruction.getValueAt(tblStandingInstruction.getSelectedRow(), 9));
                if (availBalance < netAmt && !(prodType.equalsIgnoreCase("AB"))) {// prod type AB checking added by nithya on 26-11-2019 for KD-679
                    tblStandingInstruction.setValueAt(new Boolean(false), tblStandingInstruction.getSelectedRow(), 0);
                } else {
    ...
    public void modifyTransData(Object obj) {
        ...
        double intAmt = CommonUtil.convertObjToDouble(enteredData).doubleValue()/schemeCount;
        ...
        if (observable.getFinalList() != null && observable.getFinalList().size() > 0) {
            for (int i = 0; i < observable.getFinalList().size(); i++) {
                ...
                if (selectedDepNo.equals(depNo)) {
                    ...
                    dataMap.put("NET_AMOUNT", (CommonUtil.convertObjToDouble(dataMap.get("NET_AMOUNT"))-CommonUtil.convertObjToDouble(dataMap.get("PENAL")))+intAmt);
                    System.out.println("%#%#%#%#%#$^$^$"+(CommonUtil.convertObjToDouble(dataMap.get("NET_AMOUNT"))));
                    dataMap.put("PENAL", new Double(intAmt));
                    double netAmtDisplayed = CommonUtil.convertObjToDouble(tblStandingInstruction.getValueAt(tblStandingInstruction.getSelectedRow(), 13));
                    double penalDisplayed = CommonUtil.convertObjToDouble(tblStandingInstruction.getValueAt(tblStandingInstruction.getSelectedRow(), 8));
                    double netAmtTobeDisplayed = (( netAmtDisplayed - penalDisplayed ) + CommonUtil.convertObjToDouble(enteredData).doubleValue());
                    tblStandingInstruction.setValueAt(CommonUtil.convertObjToStr(netAmtTobeDisplayed),tblStandingInstruction.getSelectedRow(), 13);
    ...
    private void btnCalculateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCalculateActionPerformed
        ...
        if (txtSchemeName.getText().length() > 0) {
            ...
            whereMap.put("GROUP_NO",txtSchemeName.getText());
            System.out.println("cboProdId.getSelectedIndex()###"+cboProdId.getSelectedIndex());
            System.out.println("observable.getCbmProdId()###"+observable.getCbmProdId());
            ...
            if (CommonUtil.convertObjToStr(txtInstNo.getText()).length() > 0) {
                whereMap.put("CURRENT_INSALL_NO", CommonUtil.convertObjToInt(txtInstNo.getText()));
            } else {
    ...
    private void TallyCheck() {
        ...
        if (tblStandingInstruction.getRowCount() > 0) {
            ...
            for (int i = 0; i < tblStandingInstruction.getRowCount(); i++) {
                ...
                if ((demandAmt < recoveredAmt) && !prodType.equalsIgnoreCase("AB")) { // prod type AB checking added by nithya on 26-11-2019 for KD-679
...
// TODO add your handling code here:
    ...
    private void tblStandingInstructionMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblStandingInstructionMouseReleased
        // TODO add your handling code here:
      //  calculateTotalChittalSelected();
    }//GEN-LAST:event_tblStandingInstructionMouseReleased
    ...
    private com.see.truetransact.uicomponent.CLabel lblChittalSelected;
    ...
    public static void main(String[] args) {
        GDSStandingInstructionUI fad = new GDSStandingInstructionUI();
