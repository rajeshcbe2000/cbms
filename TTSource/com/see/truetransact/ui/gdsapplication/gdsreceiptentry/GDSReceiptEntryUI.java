...
import com.see.truetransact.ui.gdsapplication.gdsreceiptentry.GDSReceiptEntryMRB;
...
public class GDSReceiptEntryUI extends com.see.truetransact.uicomponent.CInternalFrame implements Observer, UIMandatoryField {
    ...
    ArrayList bonusReversalLsit = null;
    String forfeitChk = null;
    ...
    java.util.ResourceBundle resourceBundle = java.util.ResourceBundle.getBundle("com.see.truetransact.ui.gdsapplication.gdsreceiptentry.GDSReceiptEntryRB", ProxyParameters.LANGUAGE);
    final GDSReceiptEntryMRB objMandatoryMRB = new GDSReceiptEntryMRB();
    private TransactionUI transactionUI = new TransactionUI();
    private HashMap mandatoryMap;
    private GDSReceiptEntryOB observable;
    private HashMap graceCalculateMap = null;
    ...
    private void settingupUI() {
        ...
        transactionUI.setSourceScreen("GDS_RECEIPT");
        txtGDSName.setEnabled(false);
    ...
    private void setObservable() {
        try {
              observable = GDSReceiptEntryOB.getInstance();
    ...
    private void setFieldNames() {
        ...
        btnGDSName.setName("btnSchemeName");
        ...
        lblGDSName.setName("lblSchemeName");
    ...
    private void internationalize() {
        ...
        lblGDSName.setText(resourceBundle.getString("lblSchemeName"));
        ...
        btnGDSName.setText(resourceBundle.getString("btnSchemeName"));
    ...
    public void setMandatoryHashMap() {
        ...
        mandatoryMap.put("txtGDSName", new Boolean(true));
    ...
    public void update(Observable observed, Object arg) {
        removeRadioButtons();
        txtGDSName.setText(observable.getGroup_no());
        
        //txtChittalNo.setText(observable.getTxtChittalNo());//commented by shany
        txtChittalNo.setText(observable.getGds_no());
...
//        rdoBankPay_No.setSelected(observable.getRdoBankPay_No());
        ...
        txtForfeitBonus.setText(observable.getTxtForfietbonus());
    ...
    public void updateOBFields() {
        ...
        observable.setTxtGDSName(txtGDSName.getText());
        observable.setGds_no(txtChittalNo.getText());
        ...
        observable.setTxtNoOfInstToPaay(this.txtNoOfInstToPaay.getText());
        ...
        observable.setTxtForfietbonus(txtForfeitBonus.getText());
...
//        HashMap mapScheme=new HashMap();
//        mapScheme.put("SCHEME_NAME", txtSchemeName.getText());
//        List lstMdsAdv=ClientUtil.executeQuery("checkMdsAdv", mapScheme);
//        mapScheme=(HashMap)lstMdsAdv.get(0);
//        String advColl=CommonUtil.convertObjToStr(mapScheme.get("ADVANCE_COLLECTION"));


        String narration = "";
        java.text.SimpleDateFormat sdf = new java.text.SimpleDateFormat("MMM/yyyy");
        java.text.SimpleDateFormat weeklyFormat = new java.text.SimpleDateFormat("E, dd MMM yyyy");
...
//        if(advColl.equals("Y"))
//        {
        System.out.println("Last inst date--->" + observable.getLastInstDate());
        ...
        if (noInstPay == 1) {
            ...
            //  Date dt = DateUtil.getDateMMDDYYYY(tdtInstDt.getDateValue());
            // Date dt = DateUtil.getDateMMDDYYYY(observable.getLastInstDate());
            Date dt1 = DateUtil.addDays(DateUtil.getDateMMDDYYYY(observable.getTdtChitStartDt()), installmentFreq * paidInstallments);
            Date dt = DateUtil.addDays(DateUtil.getDateMMDDYYYY(observable.getLastInstDate()), 30 * (1));
            // Date dt=DateUtil.getDateMMDDYYYY(tdtInsUptoPaid.getDateValue());
            //Added by sreekrishnan for 0003894
            if (isWeeklyOrMonthlyScheme != null && !isWeeklyOrMonthlyScheme.equals("") && isWeeklyOrMonthlyScheme.equals("W")) {
                narration += " " + weeklyFormat.format(dt1);
            }else{
            ...
            // Date dt = DateUtil.addDays(DateUtil.getDateMMDDYYYY(tdtInsUptoPaid.getDateValue()), 30);
            //Date dt=DateUtil.getDateMMDDYYYY(tdtInsUptoPaid.getDateValue());
            // dt = DateUtil.addDays(DateUtil.getDateMMDDYYYY(tdtInsUptoPaid.getDateValue()), 30 * (1));
            Date dt = DateUtil.getDateMMDDYYYY(observable.getLastInstDate());
            dt = DateUtil.addDays(DateUtil.getDateMMDDYYYY(observable.getLastInstDate()), 30 * (1));
            Date dt1 = DateUtil.addDays(DateUtil.getDateMMDDYYYY(observable.getTdtChitStartDt()), installmentFreq * paidInstallments);
            System.out.println("dddttt inttt>....." + dt1);
            //narration += " " + sdf.format(dt1);
            //Added by sreekrishnan for 0003894
            if (isWeeklyOrMonthlyScheme != null && !isWeeklyOrMonthlyScheme.equals("") && isWeeklyOrMonthlyScheme.equals("W")) {
                narration += " " + weeklyFormat.format(dt1);
            ...
            bankAdv.put("CHITTAL", txtChittalNo.getText());
            bankAdv.put("SUB_NO", CommonUtil.convertObjToInt(txtSubNo.getText()));
            ...
            if (bankAdv != null && bankAdv.containsKey("NUM") && bankAdv.get("NUM") != null && CommonUtil.convertObjToInt(bankAdv.get("NUM")) > 0) {
                // dt = DateUtil.addDays(DateUtil.getDateMMDDYYYY(tdtInsUptoPaid.getDateValue()), 30 * (noInstPay-1));
                dt = DateUtil.addDays(DateUtil.getDateMMDDYYYY(observable.getLastInstDate()), installmentFreq * (noInstPay - 1));

            } else {
                // System.out.println("rish..........."+observable.getLastInstDate());
                // System.out.println("rish......123"+30 * (noInstPay));
                // dt = DateUtil.addDays(DateUtil.getDateMMDDYYYY(tdtInsUptoPaid.getDateValue()), 30 * (noInstPay));
                dt = DateUtil.addDays(DateUtil.getDateMMDDYYYY(observable.getLastInstDate()), installmentFreq * (noInstPay));
            }
            //aded by rishad
            dt1 = DateUtil.addDays(dt1, installmentFreq * (noInstPay - 1));
//            if (bankList != null && bankList.size() > 0) {
//                bankAdv = new HashMap();
//                bankAdv = (HashMap) bankList.get(0);
//                System.out.println("in bank advance"+bankAdv);
//                if (bankAdv != null && bankAdv.containsKey("NUM") && bankAdv.get("NUM") != null&&CommonUtil.convertObjToInt(bankAdv.get("NUM"))>0) {
//                    dt = DateUtil.addDays(DateUtil.getDateMMDDYYYY(tdtInsUptoPaid.getDateValue()), 30 * (noInstPay-1));
//                    System.out.println("risssssssssss"+dt);
//                }
//               
//            }else{  
//                 dt = DateUtil.addDays(DateUtil.getDateMMDDYYYY(tdtInsUptoPaid.getDateValue()), 30 * (noInstPay));
//                System.out.println(" other than bankadvance"+dt);                   
//            }
            //narration += " To " + sdf.format(dt1);
            //Added by sreekrishnan for 0003894
            if (isWeeklyOrMonthlyScheme != null && !isWeeklyOrMonthlyScheme.equals("") && isWeeklyOrMonthlyScheme.equals("W")) {
                narration += " To " + weeklyFormat.format(dt1);
            }else{
                narration += " To " + sdf.format(dt1);
            }
        }
...
//        }
    ...
    public void setHelpMessage() {
        GDSReceiptEntryMRB objMandatoryRB = new GDSReceiptEntryMRB();
        ...
        txtGDSName.setHelpMessage(lblMsg, objMandatoryRB.getString("txtGDSName"));
    ...
    private void initComponents() {
        ...
        lblGDSName = new com.see.truetransact.uicomponent.CLabel();
        panSchemeName = new com.see.truetransact.uicomponent.CPanel();
        txtGDSName = new com.see.truetransact.uicomponent.CTextField();
        btnGDSName = new com.see.truetransact.uicomponent.CButton();
        ...
        panInsideGeneralRemittance3.setMinimumSize(new java.awt.Dimension(450, 355));
        panInsideGeneralRemittance3.setPreferredSize(new java.awt.Dimension(450, 355));
        ...
        panMemberDetails.setMinimumSize(new java.awt.Dimension(210, 72));
        panMemberDetails.setPreferredSize(new java.awt.Dimension(210, 72));
        ...
        txtCurrentInstNo.setHorizontalAlignment(javax.swing.JTextField.LEFT);
        txtCurrentInstNo.setMinimumSize(new java.awt.Dimension(90, 21));
        txtCurrentInstNo.setPreferredSize(new java.awt.Dimension(90, 21));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridy = 1;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        ...
        lblPaidInstallments.setText("Paid Inst");
        lblPaidInstallments.setToolTipText("Paid Installments");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        ...
        txtPaidInstallments.setHorizontalAlignment(javax.swing.JTextField.LEFT);
        txtPaidInstallments.setMinimumSize(new java.awt.Dimension(90, 21));
        txtPaidInstallments.setPreferredSize(new java.awt.Dimension(90, 21));
        gridBagConstraints = new java.awt.GridBagConstraints();
        ...
        lblPendingInst.setText("Pending Inst");
        lblPendingInst.setToolTipText("Pending installments");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        ...
        txtPendingInst.setHorizontalAlignment(javax.swing.JTextField.LEFT);
        txtPendingInst.setMinimumSize(new java.awt.Dimension(90, 21));
        txtPendingInst.setPreferredSize(new java.awt.Dimension(90, 21));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 3;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        ...
        panPendingInstallmentDetails.setMinimumSize(new java.awt.Dimension(225, 72));
        panPendingInstallmentDetails.setPreferredSize(new java.awt.Dimension(225, 72));
        ...
        lblTotalInstAmt.setText("Total Inst Amt Due");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        ...
        txtNoOfInstToPaay.setMinimumSize(new java.awt.Dimension(75, 21));
        txtNoOfInstToPaay.setPreferredSize(new java.awt.Dimension(75, 21));
        ...
        panInsDetails.setMinimumSize(new java.awt.Dimension(340, 139));
        panInsDetails.setPreferredSize(new java.awt.Dimension(340, 139));
        ...
        lblServiceTaxval.setMaximumSize(new java.awt.Dimension(90, 18));
        lblServiceTaxval.setMinimumSize(new java.awt.Dimension(90, 18));
        lblServiceTaxval.setPreferredSize(new java.awt.Dimension(90, 18));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 4;
        ...
        panSchemeNameDetails.setMinimumSize(new java.awt.Dimension(430, 85));
        panSchemeNameDetails.setPreferredSize(new java.awt.Dimension(430, 85));
        panSchemeNameDetails.setLayout(new java.awt.GridBagLayout());

        lblGDSName.setText("GDS Group Name");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 2;
        gridBagConstraints.gridy = 0;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.EAST;
        gridBagConstraints.insets = new java.awt.Insets(0, 1, 0, 1);
        panSchemeNameDetails.add(lblGDSName, gridBagConstraints);

        panSchemeName.setLayout(new java.awt.GridBagLayout());

        txtGDSName.setHorizontalAlignment(javax.swing.JTextField.LEFT);
        txtGDSName.setMinimumSize(new java.awt.Dimension(100, 21));
        txtGDSName.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txtGDSNameActionPerformed(evt);
            }
        });
        txtGDSName.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusLost(java.awt.event.FocusEvent evt) {
                txtGDSNameFocusLost(evt);
            }
        });
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        panSchemeName.add(txtGDSName, gridBagConstraints);

        btnGDSName.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/see/truetransact/ui/images/TT_SELECT.gif"))); // NOI18N
        btnGDSName.setEnabled(false);
        btnGDSName.setMinimumSize(new java.awt.Dimension(21, 21));
        btnGDSName.setPreferredSize(new java.awt.Dimension(21, 21));
        btnGDSName.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnGDSNameActionPerformed(evt);
            }
        });
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 0;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        panSchemeName.add(btnGDSName, gridBagConstraints);
        ...
        txtChittalNo.setMinimumSize(new java.awt.Dimension(125, 21));
        txtChittalNo.setPreferredSize(new java.awt.Dimension(125, 21));
        ...
        panInsideGeneralRemittance2.setMinimumSize(new java.awt.Dimension(410, 355));
        panInsideGeneralRemittance2.setPreferredSize(new java.awt.Dimension(410, 355));
        ...
        gridBagConstraints.gridwidth = 2;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        gridBagConstraints.insets = new java.awt.Insets(4, 78, 0, 0);
        ...
        txtNoOfInst.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txtNoOfInstActionPerformed(evt);
            }
        });
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        ...
        rdoPrizedMember_Yes.setFont(new java.awt.Font("MS Sans Serif", 1, 13)); // NOI18N
        ...
        rdoPrizedMember_No.setFont(new java.awt.Font("MS Sans Serif", 1, 13)); // NOI18N
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        gridBagConstraints.insets = new java.awt.Insets(1, 1, 0, 36);
        ...
        gridBagConstraints.gridheight = 2;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        gridBagConstraints.insets = new java.awt.Insets(4, 3, 7, 0);
        ...
        gridBagConstraints.gridwidth = 4;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        gridBagConstraints.insets = new java.awt.Insets(5, 129, 0, 0);
        ...
        gridBagConstraints.gridwidth = 4;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        gridBagConstraints.insets = new java.awt.Insets(7, 107, 0, 0);
        panChitDetails.add(lblBonusAmt, gridBagConstraints);

        cLabel1.setText("Forfeit Bonus");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
    ...
    private void processPenalAmount() {
        ...
        observable.setMDSTransListMap(splitTransMap);
    }
    ...
    private void txtPenalAmtPayableFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtPenalAmtPayableFocusLost
        ...
        if(txtPenalAmtPayable.getText().length() == 0){
            txtPenalAmtPayable.setText("0.00");
        }
        ...
        if (txtPenalAmtPayable.getText().length() > 0) {
            ...
            double taxval = 0.0;
            if (lblServiceTaxval.getText() != null && !lblServiceTaxval.getText().equals("")) {
                taxval = CommonUtil.convertObjToDouble(lblServiceTaxval.getText());
            }
            txtNetAmtPaid.setText(CommonUtil.convertObjToStr(CommonUtil.convertObjToDouble(txtInstPayable.getText()).doubleValue() //-
                    ...
                    + CommonUtil.convertObjToDouble(txtAribitrationAmt.getText()).doubleValue() + taxval));
            ...
            if (observable.getThalayalChittal() != null && !observable.getThalayalChittal().equals("") && observable.getThalayalChittal().equals("Y")) {
                //setThalayalTransactionUI();
                 transactionUI.setChitType("THALAYAL");
                 transactionUI.setSchemeName(observable.getScheme_name());
            } else if (observable.getMunnalChittal() != null && !observable.getMunnalChittal().equals("") && observable.getMunnalChittal().equals("Y")) {
                //setMunnalTransactionUI();
    ...
    private void setCaseExpensesAmount() {
        ...
        whereMap.put("ACT_NUM", txtChittalNo.getText());
        //List chargeList = ClientUtil.executeQuery("getMDSCaseChargeDetails", whereMap);
        List chargeList = ClientUtil.executeQuery("getGDSCaseChargeDetails", whereMap);
...
//        List chargeList = ClientUtil.executeQuery("getMDSNoticeChargeDetails", whereMap);
        whereMap.put("ACT_NUM", txtChittalNo.getText());
        List chargeList = ClientUtil.executeQuery("getGDSNoticeChargeDetails", whereMap);
        if (chargeList != null && chargeList.size() > 0) {
            for (int i = 0; i < chargeList.size(); i++) {
                whereMap = (HashMap) chargeList.get(i);
                chargeAmount += CommonUtil.convertObjToDouble(whereMap.get("CHARGE_AMT")).doubleValue();
...
//            chargeAmount = (double)rod.getNearest((long)(chargeAmount *100),100)/100;
    ...
    private void btnNoOfInstToPaayActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNoOfInstToPaayActionPerformed
        ...
        bonusReversalLsit = new ArrayList();
        ...
        if (tdtInstDt.getDateValue().length() == 0) {
            ...
            //if (observable.getPredefinedInstallment()!=null && !observable.getPredefinedInstallment().equals("") && observable.getPredefinedInstallment().equals("N")) {
                ...
                forfeitChk = CommonUtil.convertObjToStr(productMap.get("FORFEITE_HD_Y_N"));
...
//            String bonusFirstInst = CommonUtil.convertObjToStr(productMap.get("BONUS_FIRST_INSTALLMENT"));
                ...
                long currentInst = CommonUtil.convertObjToLong(txtCurrentInstNo.getText());
                long pendingInst = CommonUtil.convertObjToLong(txtPendingInst.getText());
                long noOfInstPay = CommonUtil.convertObjToLong(txtNoOfInstToPaay.getText());
                ...
                HashMap whereMap = new HashMap();
                whereMap.put("GDS_NO", observable.getGds_no());
                whereMap.put("CHITTAL_NO", observable.getChittal_no());
                whereMap.put("SUB_NO", CommonUtil.convertObjToInt(txtSubNo.getText()));//getGDSNoOfInstalmentsPaid
                ...
                if (balanceIns >= (CommonUtil.convertObjToDouble(txtNoOfInstToPaay.getText()).doubleValue())) {
                    ...
                    //deducting bank advanced installments from penal calculation

                    int bankAd = 0;
                    HashMap bankAdv = new HashMap();
                    bankAdv.put("CHITTAL", observable.getChittal_no());
                    bankAdv.put("SUB_NO", CommonUtil.convertObjToInt(txtSubNo.getText()));
                    bankAdv.put("NEXT_INSTALL", DateUtil.getDateMMDDYYYY(tdtInsUptoPaid.getDateValue()));
                    bankAdv.put("CURR_DATE", DateUtil.getDateMMDDYYYY(tdtTrnDate.getDateValue()));
                    List bankList = ClientUtil.executeQuery("getMdsBAnkAdvForReciept", bankAdv);
                    ...
                    if (pendingInst >= 0) {//pending installment calculation starts... && pendingInst>=noOfInstPay
                        ...
                        System.out.println("types penalIntType" + penalIntType + " penalValue " + penalValue + " penalGraceType " + penalGraceType + " penalGraceValue " + penalGraceValue);
                        System.out.println("Pending Inst" + pendingInst);

                        List bonusAmout = new ArrayList();
//                    int graceCalculated = 1;
                        if (calculateIntOn != null && calculateIntOn.equals("Installment Amount")) {
                            ...
                            for (int i = startNoForPenal; i <= noOfInstPay - addNo; i++) {
                               ...
                               // nextInstMaps.put("SCHEME_NAME", txtGDSName.getText());
                                nextInstMaps.put("SCHEME_NAME", observable.getScheme_name());
                                nextInstMaps.put("DIVISION_NO", CommonUtil.convertObjToInt(txtDivisionNo.getText()));
                        ...
                        Rounding rod = new Rounding();
                        int installmentFreq = CommonUtil.convertObjToInt(observable.getInstalmntFreq());
//                        if (CommonUtil.convertObjToStr(productMap.get("PREDEFINITION_INSTALLMENT")).equals("Y")) {
//                            System.out.println("nithya :: "+ CommonUtil.convertObjToInt(observable.getChittalMap().get("INSTALLMENT_DAY")));
//                            long instday = CommonUtil.convertObjToInt(observable.getChittalMap().get("INSTALLMENT_DAY")) + penalGraceValue;    // 10+1 = 11                                        
//                            long instcurrdate = currDate.getDate();
//                            System.out.println("instcurrdate :: " + instcurrdate);
//                            System.out.println("instday :: " + instday);
//                            System.out.println("penalGraceValue :: " + penalGraceValue);
//                            if (instday <= instcurrdate) {
...
//                        }
                //KD-3759
                        ...
                        System.out.println("CommonUtil.convertObjToInt(txtPendingInst.getText()) :: " + CommonUtil.convertObjToInt(txtPendingInst.getText()));
                        if (observable.getRdoPrizedMember_Yes() == true && specialInt.equals("Y") && CommonUtil.convertObjToInt(txtPendingInst.getText()) >= specialIntDueMonths) {
                        ...
                        for (int i = startNoForPenal; i < noOfInstPay + startNoForPenal; i++) {
                            if (calculateIntOn != null && calculateIntOn.equals("Installment Amount")) {
                                ...
                                if (bonusAmout != null && bonusAmout.size() > 0) {
                                    if (isAdvanceCollection.equals("Y") || CommonUtil.convertObjToStr(productMap.get("PREDEFINITION_INSTALLMENT")).equals("Y")) {
                                        instAmount -= (CommonUtil.convertObjToDouble(bonusAmout.get(predefinedIterator)) * observable.getSchemeCount());
                                    } else {
                                        instAmount -= (CommonUtil.convertObjToDouble(bonusAmout.get(i))  * observable.getSchemeCount());
                                    }
                                }
                                insAmt = instAmount;                                
                            }
                            HashMap nextInstMap = new HashMap();
                            nextInstMap.put("GROUP_NO",observable.getGroup_no());
...
//                                                calc = insAmt*(((pendingInst+1)*pendingInst/2)*penalValue)/1200;
                                    ...
                                    if (penalGraceType != null && !penalGraceType.equals("") && penalGraceType.equals("Days")) {                                        
                                        ...
                                        if ((diffDayPending > (penalGraceValue * instFreq)) && (pendingInst >= penalGraceValue)) {
                                            if (penalIntType != null && !penalIntType.equals("") && penalIntType.equals("Percent")) {
                                                //calc = insAmt*(((pendingInst+1)*pendingInst/2)*penalValue)/1200;
                                                if (observable.getRdoPrizedMember_Yes() == true || calculateIntOn.equals("Installment Amount")) {
                                                    if (isWeeklyOrMonthlyScheme != null && !isWeeklyOrMonthlyScheme.equals("") && isWeeklyOrMonthlyScheme.equals("W")) {
                                                        calc += (double) ((insAmt * penalValue) * 7 / 36500.0) * pendingInst--;
                                                    } else {
                                                        calc += (double) ((insAmt * penalValue) / 1200.0) * pendingInst--;
                                ...
                                c_hash.put("SCHEME_NAME", observable.getScheme_name());
...
//                    for(int i = 1;i<=noOfInstPay;i++){
                        HashMap nextInstMap = new HashMap();
                        nextInstMap.put("SCHEME_NAME", txtGDSName.getText());
                        nextInstMap.put("GROUP_NO", observable.getGroup_no());
                    ...
                    for (int i = startNoForPenal; i <= noOfInstPay - addNo; i++) {
                        ...
                        if (productMap.containsKey("BANK_ADV_FORFIET") && productMap.get("BANK_ADV_FORFIET") != null && productMap.get("BANK_ADV_FORFIET").equals(("N"))) {
                            ...
                            reversalMap.put("SCHEME_NAME", observable.getScheme_name());
                    ...
                    // End
                        ...
                        HashMap nextInstMap = new HashMap();
                        //nextInstMap.put("SCHEME_NAME", txtGDSName.getText());
                        nextInstMap.put("SCHEME_NAME", observable.getScheme_name());
                        ...
                        nextInstMap.put("GDS_NO",txtChittalNo.getText());
                        //check for cur inst
                         
                         List bankAdvLst = ClientUtil.executeQuery("getGDSBankAdvCntForInstNo", nextInstMap);
                        ...
                        if (listRec != null && listRec.size() > 0) {
                            ...
                            if (observable.getMultipleMember().equals("Y")) {
                                ...
                                whereMap.put("SCHEME_NAME", txtGDSName.getText());
                            ...
                            if (productMap.get("BONUS_ALLOWED") != null && !productMap.get("BONUS_ALLOWED").equals("") && (productMap.get("BONUS_ALLOWED").equals("Y"))) {
                                ...
                                if (bonusAvailabe == true) {//edit Here PRIZED_DEFAULTERS
                                    ...
                                    if (observable.getRdoPrizedMember_Yes() == true) {
                                        ...
                                        nextActMap.put("SCHEME_NAME", CommonUtil.convertObjToStr(observable.getScheme_name()));
                                        ...
                                        long dateDiff = CommonUtil.convertObjToLong(DateUtil.dateDiff(curr_dt, newDate));
                                        ...
                                        whereMap = new HashMap();
                                        whereMap.put("CHITTAL_NO", CommonUtil.convertObjToStr(observable.getChittal_no()));
                                        whereMap.put("SUB_NO", CommonUtil.convertObjToInt(txtSubNo.getText()));
                                        whereMap.put("SCHEME_NAME", observable.getScheme_name());
                                         whereMap.put("GDS_NO", observable.getGds_no());
                                          whereMap.put("GROUP_NO", observable.getGroup_no());
                                        List paymentList = ClientUtil.executeQuery("getSelectGDSPaymentDetails", whereMap);
...
//                                            if(prizedDefaultYesN.equals("N") || diffDay <= bonusPrizedValue){
                                                ...
                                                if (dateDiff >= 0 && (prizedDefaultYesN.equals("N") || prizedDefaultYesN.equals("Y"))) {
                                                    totBonusAmt = (totBonusAmt + bonusAmt);//*observable.getSchemeCount();
                                                    bonusAmountList.add(CommonUtil.convertObjToDouble(bonusAmt)*observable.getSchemeCount());
                                                } else {
...
//                                                    }
                                            ...
                                            if (bonusGraceDays != null && !bonusGraceDays.equals("") && bonusGraceDays.equals("D") && diffDay <= bonusGraceValue /*
                                                ...
                                                System.out.println("currnt date" + curr_dt);
...
//                                            if(prizedDefaultYesN.equals("Y") && diffDay <= bonusPrizedValue){
                                                ...
                                                if (productMap.get("FORFEITE_HD_Y_N") != null && productMap.get("FORFEITE_HD_Y_N").equals("Y")) {
                                                    System.out.println("Execute hereeee hkhk 2::"+ bonusAmt);
                                                    if(!bankAdvEntry)
                                                       ForfeitebonusAmountList.add(CommonUtil.convertObjToDouble(bonusAmt));
//                                                   if (reversalBonusExists) {
//                                                        bonusReversalLsit.add(CommonUtil.convertObjToDouble(bonusAmt));
...
//                                                    }
                                        ...
                                        if (bonusGraceDays != null && !bonusGraceDays.equals("") && bonusGraceDays.equals("D") && diffDay <= bonusGraceValue /*
                                            ...
                                            bonusAmountList.add(CommonUtil.convertObjToDouble(0));
                                            if (productMap.get("FORFEITE_HD_Y_N") != null && productMap.get("FORFEITE_HD_Y_N").equals("Y")) {
                                                System.out.println("Execute hereeee hkhk 1::"+ bonusAmt);
                                                if(!bankAdvEntry)
                                                   ForfeitebonusAmountList.add(CommonUtil.convertObjToDouble(bonusAmt));
//                                                 if (reversalBonusExists) {
//                                                        bonusReversalLsit.add(CommonUtil.convertObjToDouble(bonusAmt));
...
//                                                 }
                    ...
                    int calc = 0;
                    double instalAmt = 0;
                    txtBonusAmt.setText(String.valueOf(totBonusAmt*observable.getSchemeCount()));
  
                    txtForfeitBonus.setText(String.valueOf(totReversalBonusAmt*observable.getSchemeCount()));
                ...
                if (installmentMap == null || installmentMap.size() <= 0) {
                    ...
                    for (int s = 1; s <= noOfInstPay; s++) {
                        ...
                        System.out.println("s :" + s + "noOfInsPaid : " + noOfInsPaid);
                        whereMap.put("INST_AMT", String.valueOf(txtInstAmt.getText()));
                        installmentMap.put(String.valueOf(s + noOfInsPaid), whereMap);
                    }
                }
                TreeMap<Integer, LinkedHashMap> map = new TreeMap<Integer, LinkedHashMap>(installmentMap);
                LinkedHashMap tempinstallmentMap = new LinkedHashMap();
                NavigableMap<Integer, LinkedHashMap> nmap = map.descendingMap();
                for (Iterator it = nmap.entrySet().iterator(); it.hasNext();) {
                    Map.Entry entry = (Map.Entry) it.next();
                    tempinstallmentMap.put(entry.getKey(), entry.getValue());
                }
                observable.setInstallmentMap(tempinstallmentMap);
                GregorianCalendar gcal = new GregorianCalendar();
                if (productMap.get("FORFEITE_HD_Y_N") != null && productMap.get("FORFEITE_HD_Y_N").equals("Y")) {
                    if (installmentMap != null && (!installmentMap.isEmpty())) {
                        bonusIterator = installmentMap.keySet().iterator();
                        String key = "";
                        for (int i = 0; i < installmentMap.size(); i++) {
                            key = (String) bonusIterator.next();
                            HashMap myMap = (HashMap) installmentMap.get(key);
                            bonusAmt += CommonUtil.convertObjToDouble(myMap.get("BONUS"));
                            HashMap insBonusMap = new HashMap();
                        }
                    }
                }
                if (isSplitMDSTransaction != null && isSplitMDSTransaction.equals("Y")) {
                ...
                observable.setBonusListNew(bonusN);
                System.out.println("forfeitChkforfeitChk  :" + forfeitChk);
    ...
    private void setMunnalTransactionUI() {
        HashMap whereMap = new HashMap();
        double chargeAmount = 0.0;
        whereMap.put("SCHEME_NAME", observable.getScheme_name());
        List chargeList = ClientUtil.executeQuery("getMunnalHeadForChittal", whereMap);
        if (chargeList != null && chargeList.size() > 0) {
            whereMap = (HashMap) chargeList.get(0);
            if (whereMap != null && whereMap.get("MUNNAL_REP_PAY_HEAD") != null && !whereMap.get("MUNNAL_REP_PAY_HEAD").equals("")) {
                transactionUI.cancelAction(false);
                transactionUI.setButtonEnableDisable(true);
                transactionUI.resetObjects();
                transactionUI.setCallingAmount(txtNetAmtPaid.getText());
                ...
                transactionUI.setCallingTransAcctNo(CommonUtil.convertObjToStr(whereMap.get("MUNNAL_REP_PAY_HEAD")));
    ...
    private void btnNewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNewActionPerformed
        // Add your handling code here:
         setModified(true);
        System.out.println("before  observable.setActionType");
     observable.setActionType(ClientConstants.ACTIONTYPE_NEW);
        System.out.println("after  observable.setActionType");
...
//        observable.setStatus();
        ...
        txtGDSName.setEnabled(true);
        txtChittalNo.setEnabled(true);
        btnChittalNo.setEnabled(true);
        btnGDSName.setEnabled(true);
        lblMDSDescription.setText("");
        cbobranch.setEnabled(true);
        
        System.out.print("ProxyParameters BRANCH_ID "+ProxyParameters.BRANCH_ID);
        System.out.print("observable BRANCH_ID "+observable.getSelectedBranchID());
    ...
    private HashMap getLastGraceDate() {
        ...
        forFeiteMap.put("SCHEME_NAME", observable.getScheme_name());
...
//                System.out.println("selectedMDSBranchDetails()-->" + selectedMDSBranchDetails() + "interbranchFlag-->" + interbranchFlag);
                if (interbranchFlag) {
                    displayAlert("Incase of interbranch transaction either " + "\n" + "Dr or Cr account of the transaction should be of own branch");
                } else {
//                if (selectedMDSBranchDetails()) {
                    savePerformed();
                    btnSave.setEnabled(false);
                }
            }
...
//            }
    ...
    private void btnCancelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCancelActionPerformed
        ...
        //__ Make the Screen Closable..
        setModified(false);
        observable.setGds_no("");       
        observable.setGroup_no("");
        txtChittalNo.setText("");
        txtGDSName.setText("");
    ...
    public void authorize(HashMap map) {
        ...
        //System.out.println("MAp auth--- "+map +"instMap ="+instMap);
        ...
        try {
            ...
            if (observable.getResult() != ClientConstants.ACTIONTYPE_FAILED) {
                 if (fromNewAuthorizeUI) {
                    ...
                    this.dispose();
                    newauthorizeListUI.setFocusToTable();
                    newauthorizeListUI.displayDetails("GDSReceiptEntry");
                }
                if (fromAuthorizeUI) {
                    authorizeListUI.removeSelectedRow();
                    this.dispose();
                    authorizeListUI.setFocusToTable();
                    authorizeListUI.displayDetails("GDS Receipts");
                }
                if (fromCashierAuthorizeUI) {
...
//            strWarnMsg = null;
            ...
            if (TrueTransactMain.CASHIER_AUTH_ALLOWED != null && TrueTransactMain.CASHIER_AUTH_ALLOWED.equals("Y")) {
                ...
                mapParam.put(CommonConstants.MAP_NAME, "getGDSSelectNonAuthRecordForReceipt");
            }
            mapParam.put(CommonConstants.UPDATE_MAP_NAME, "getGDSSelectNonAuthRecordForReceipt");
            viewType = AUTHORIZE;
...
private void txtGDSNameFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtGDSNameFocusLost
        // TODO add your handling code here:
        if(txtGDSName.getText().length()>0){
            HashMap whereMap = new HashMap();
            whereMap.put("SCHEME_NAME",txtGDSName.getText());
...
}//GEN-LAST:event_txtGDSNameFocusLost

private void btnGDSNameActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGDSNameActionPerformed
        // TODO add your handling code here:
        //callView("SCHEME_DETAILS");//commented by 
    
         callView("GROUP_DETAILS");
}//GEN-LAST:event_btnGDSNameActionPerformed
...
private void txtChittalNoFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtChittalNoFocusLost
        ...
        if(txtChittalNo.getText().length()>0){
            HashMap whereMap = new HashMap();
            whereMap.put("SCHEME_NAMES",txtGDSName.getText());
            whereMap.put("CHITTAL_NUMBER",txtChittalNo.getText());
            List lst=ClientUtil.executeQuery("getSelectChittalReceiptEntryDetails",whereMap);
            System.out.println("lstlstlstlstlst"+lst);
            //System.out.println("txtChittalNoFocusLost :: getSelectChittalReceiptEntryDetails");
            if(lst !=null && lst.size()>0){
                viewType = "CHITTAL_NO";
                whereMap=(HashMap)lst.get(0);
                fillData(whereMap);
...
private void cbobranchFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_cbobranchFocusLost
    ...
    private void txtGDSNameActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtGDSNameActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_txtGDSNameActionPerformed

    private void txtNoOfInstActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtNoOfInstActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_txtNoOfInstActionPerformed
    ...
    private void callView(String currField) {
        ...
        if (currField.equals("Edit") || currField.equals("Enquirystatus") || currField.equals("Delete")) {
            ...
            viewMap.put(CommonConstants.MAP_NAME, "getSelectEachSchemeDetailsForReciept");

        } 
        
        else if (currField.equalsIgnoreCase("GDS_NO")) {
            //System.out.println("Inside else if :" + currField);
            if (!txtGDSName.getText().equals("")) {
                HashMap map1 = new HashMap();
                HashMap mapTrans = new HashMap();
                System.out.println("GROUP_NO" + observable.getGroup_no());
                map1.put("GROUP_NO", observable.getGroup_no());
                map1.put("GROUP_NAME", txtGDSName.getText());
                String branch = CommonUtil.convertObjToStr(cbobranch.getSelectedItem());
                if(branch != null && branch.length()>0 && !branch.equals(ProxyParameters.BRANCH_ID)){
                    where.put("BRANCH_CODE",branch);
                }
                List list1 = ClientUtil.executeQuery("getGDSSelectTransDet", map1);
                if (list1 != null && list1.size() > 0) {
                    mapTrans = (HashMap) list1.get(0);
                    if (CommonUtil.convertObjToStr(mapTrans.get("TRANS_FIRST_INSTALLMENT")).equals("Y")) {
                       // where.put("SCHEME_NAMES", txtGDSName.getText());//commented by shany
                        //where.put("GROUP_NAMES", txtGDSName.getText());
                        where.put("GROUP_NAMES", txtGDSName.getText());
                        where.put("GROUP_NO", observable.getGroup_no());
                        viewMap.put(CommonConstants.MAP_WHERE, where);
                        viewMap.put(CommonConstants.MAP_NAME, "getGDSSelectChittalReceiptEntryDetails");
                    } else {
                       // where.put("SCHEME_NAMES", txtGDSName.getText());
                        where.put("GROUP_NAMES", txtGDSName.getText());
                        where.put("GROUP_NO", observable.getGroup_no());
                        viewMap.put(CommonConstants.MAP_WHERE, where);
                ...
                viewMap.put(CommonConstants.MAP_NAME, "getSelectAllChittalReceiptEntryDetails");
            }
        }
        
        
        //commented by shany 
        // because, here we checking GDS_NO
...
//        }
            ...
            datemap.put("CURR_DATE", curr_dt);
            datemap.put("BRANCH_CODE", branch);
            datemap.put("BRANCH_ID", branch);
            System.out.println("curr_dt.." + curr_dt);
            viewMap.put(CommonConstants.MAP_WHERE, datemap);
            // viewMap.put(CommonConstants.MAP_NAME, "getSelectEachSchemeDetails");
            viewMap.put(CommonConstants.MAP_NAME, "getSelectGroupMDSDepositTO");
            
        }
        System.out.println("viewMap:GROUP_NO" + viewMap);
    ...
    private void insertScreenLock() {
        ...
        hash.put("TRANS_ID", observable.getTransId());
        hash.put("MODE_OF_OPERATION", viewType);
        hash.put("TRANS_DT", curr_dt.clone());
    ...
    private boolean validateScreenLock() {
        ...
        authDataMap.put("TRANS_DT", curr_dt.clone());
     ...
     * fields
     *
     * @param obj param The selected Selected :data from the viewAll() is passed as a
     * param
     */
    public void fillData(Object obj) {
        HashMap hash = (HashMap) obj;
        System.out.println("fill data map" + hash);
        HashMap schemeMap = new HashMap();
        observable.setGroup_no(CommonUtil.convertObjToStr(hash.get("GROUP_NO")));
        observable.setGds_no(CommonUtil.convertObjToStr(hash.get("GDS_NO")));
        System.out.println("fill GROUP_NO" + observable.getGroup_no());
        if (viewType.equalsIgnoreCase("GROUP_DETAILS")) {
            if (hash.containsKey("GROUP_NO") && hash.get("GROUP_NO") != null) {
                schemeMap.put("GROUP_NO", CommonUtil.convertObjToStr(hash.get("GROUP_NO")));
                List lst = ClientUtil.executeQuery("getGDSSelectSchemeAcctHeadForReceiptEntry", schemeMap);
                if (lst != null && lst.size() > 0) {
        ...
        if (hash.containsKey("FROM_SMART_CUSTOMER_UI")) {
            ...
            txtGDSName.setText(CommonUtil.convertObjToStr(hash.get("SCHEME_NAME")));
            txtGDSNameFocusLost(null);            
           // txtChittalNo.setText(CommonUtil.convertObjToStr(hash.get("CHITTAL_NO")));//commented by shany
            txtChittalNo.setText(CommonUtil.convertObjToStr(hash.get("GDS_NO")));
...
//                observable.checkAcNoWithoutProdType(CommonUtil.convertObjToStr(hashMap.get("CHITTAL_NO")));
                observable.setTransId(CommonUtil.convertObjToStr(hash.get("TRANS_ID")));
                observable.setTxtGDSName(CommonUtil.convertObjToStr(hash.get("GROUP_NO")));
                observable.setGroup_no(CommonUtil.convertObjToStr(hash.get("GROUP_NO")));
               // lblMDSDescription.setText(CommonUtil.convertObjToStr(hash.get("SCHEME_DESC")));
                ...
                mdsDetailsMap.put("CHITTAL_NO", CommonUtil.convertObjToStr(observable.getTxtChittalNo()));
                mdsDetailsMap.put("GDS_NO", CommonUtil.convertObjToStr(observable.getGds_no()));
                mdsDetailsMap.put("STATUS_DT", setProperDtFormat((Date) curr_dt.clone()));
                List authDataList = (ArrayList) ClientUtil.executeQuery("getGDSReceiptEntryAuthStatus", mdsDetailsMap);
                if (authDataList == null || authDataList.size() <= 0) {
                    ClientUtil.showAlertWindow("This transaction already been Authorized");
                    return;
                }
                ...
                if (viewType.equals("Edit") || viewType.equals("Enquirystatus")) {
                    ...
                    System.out.println("#$#$$ yesNo : in edit " + yesNo);

                    System.out.println("ddddddd" + observable.getProxyReturnMap());
                    HashMap returnMap = observable.getProxyReturnMap();
                    if (returnMap != null) {
                        cashTransMap = new HashMap();
                        ArrayList cashTransList = new ArrayList();
                        Set cashTransferSet = observable.getProxyReturnMap().keySet();
                        Iterator cashTransIterator = cashTransferSet.iterator();
                        while (cashTransIterator.hasNext()) {
                            cashTransList.add(cashTransIterator.next());
                        }
                        for (int i = 0; i < cashTransList.size(); i++) {
                            if (returnMap != null && returnMap.containsKey(cashTransList.get(i))) {
                                if (cashTransList.get(i).toString().endsWith("_CASH_DATA")) {
                                    List lst = (List) returnMap.get(cashTransList.get(i));
                                    HashMap cashMap = (HashMap) lst.get(0);
                                    cashTransMap.put("CASH_TRANS_ID", cashMap.get("SINGLE_TRANS_ID"));
                                } else if (cashTransList.get(i).toString().endsWith("_TRANSFER_DATA")) {
                                    List lst = (List) returnMap.get(cashTransList.get(i));
                                    HashMap transferMap = (HashMap) lst.get(0);
                                    cashTransMap.put("TRANSFER_TRANS_ID", transferMap.get("BATCH_ID"));
                                }
                            }
                        }
                        System.out.println("cashtrns " + cashTransMap);
                    ...
                    if (yesNo == 0) {
                        ...
                        TTIntegration ttIntgration = null;
                        HashMap paramMap = new HashMap();
                        if (cashTransMap != null && cashTransMap.containsKey("CASH_TRANS_ID") && cashTransMap.get("CASH_TRANS_ID") != null) {
                            //paramMap.put("TransId", cashTransMap.get("CASH_TRANS_ID"));
                            paramMap.put("TransId", cashTransMap.get("CASH_TRANS_ID"));
                            paramMap.put("TransDt", curr_dt);
                            paramMap.put("BranchId", ProxyParameters.BRANCH_ID);
                            ttIntgration.setParam(paramMap);
                            //reportname = "CashReceipt";
                            reportname = "MDSReceipts";
                            ttIntgration.integrationForPrint(reportname, false);
                        }
                        if (cashTransMap != null && cashTransMap.containsKey("TRANSFER_TRANS_ID") && cashTransMap.get("TRANSFER_TRANS_ID") != null) {
                            //paramMap.put("TransId", cashTransMap.get("TRANSFER_TRANS_ID"));
                            paramMap.put("TransId", cashTransMap.get("TRANSFER_TRANS_ID"));
                            paramMap.put("TransDt", curr_dt);
                            paramMap.put("BranchId", ProxyParameters.BRANCH_ID);
                            ttIntgration.setParam(paramMap);
                ...
                hashMap.put("GDS_NO", hash.get("GDS_NO"));
...
//                    observable.setTxtDivisionNo("1");
                ...
                observable.setTxtGDSName(CommonUtil.convertObjToStr(hash.get("GROUP_NAME")));
                txtGDSName.setText(CommonUtil.convertObjToStr(hash.get("GROUP_NO")));
               // lblMDSDescription.setText(CommonUtil.convertObjToStr(hash.get("SCHEME_DESC")));
                btnGDSName.setEnabled(true);
                btnChittalNo.setEnabled(true);
                List closureList = ClientUtil.executeQuery("checkGDSSchemeClosureDetails", hash);
                if (closureList != null && closureList.size() > 0) {
                ...
                //Added BY Suresh 
                if (observable.getActionType() == ClientConstants.ACTIONTYPE_NEW && txtGDSName.getText().length() > 0) {
                    String branch = CommonUtil.convertObjToStr(cbobranch.getSelectedItem());
                    txtChittalNo.setText(CommonUtil.convertObjToStr(branch + hash.get("GROUP_NO")));
                } else {
                    txtChittalNo.setText("");
                }
               // observable.setTxtChittalNo(txtChittalNo.getText());
                //Added by sreekrishnan for predefined Installment
                ...
                observable.resetOBFields();
                 //Added by sreekrishnan for 10957
                observable.setThalayalChittal(CommonUtil.convertObjToStr(hash.get("THALAYAL")));
                System.out.println("hashhh" + hash);
                hash.put("SUB_NO", CommonUtil.convertObjToInt(hash.get("SUB_NO")));
                List defaulterList = ClientUtil.executeQuery("getGDSDefaulterDts", hash);
                ...
                List pendingAuthlst = ClientUtil.executeQuery("checkGDSPendingForAuthorization", hash);
                if (pendingAuthlst != null && pendingAuthlst.size() > 0) {
                    ...
                    if (CommonUtil.convertObjToStr(CommonConstants.SAL_REC_MODULE).equals("Y")) {
                        HashMap whereMap = new HashMap();
                        whereMap.put("GROUP_NAME", txtGDSName.getText());
            ...
            else if (viewType.equalsIgnoreCase("GDS_NO")) {
               observable.resetOBFields();
                 //Added by sreekrishnan for 10957
                observable.setThalayalChittal(CommonUtil.convertObjToStr(hash.get("THALAYAL")));
                observable.setMunnalChittal(CommonUtil.convertObjToStr(hash.get("MUNNAL")));
                System.out.println("hashhh" + hash);
                hash.put("SUB_NO", CommonUtil.convertObjToInt(hash.get("SUB_NO")));
                List defaulterList = ClientUtil.executeQuery("getGDSDefaulterDts", hash);
                if (defaulterList != null && defaulterList.size() > 0) {
                ...
                if (pendingAuthlst != null && pendingAuthlst.size() > 0) {
                    ...
                    System.out.println("txtChittalNo.setText  "+CommonUtil.convertObjToStr(hash.get("GDS_NO")));
                    System.out.println("TxtGDSName.setText  "+CommonUtil.convertObjToStr(observable.getTxtGDSName())+txtGDSName.getText());
                    txtGDSName.setText(CommonUtil.convertObjToStr(observable.getGroup_no()));
                    //observable.setTxtGDSName(CommonUtil.convertObjToStr(hash.get("GROUP_NAME")));
                    txtChittalNo.setText(CommonUtil.convertObjToStr(hash.get("GDS_NO")));
                    observable.setGds_no(CommonUtil.convertObjToStr(hash.get("GDS_NO")));
                    ...
                    //added by shany
                     ...
                     observable.setSchemeCount(CommonUtil.convertObjToInt(schemeCount)); 
                     if (schemeList != null && schemeList.size() > 0) {
                    scheme = (HashMap) schemeList.get(0);
                      }
                    //
                    observable.setTxtChittalNo(CommonUtil.convertObjToStr(hash.get("CHITTAL_NO")));
                    observable.setTxtSchemeName(CommonUtil.convertObjToStr(scheme.get("SCHEME_NAME")));
                    observable.setScheme_name(CommonUtil.convertObjToStr(scheme.get("SCHEME_NAME")));
                    System.out.println("txtChittalNo.setText  "+observable.getGds_no()+"   "+observable.getScheme_name());
                    observable.setSelectedBranchID(CommonUtil.convertObjToStr(hash.get("BRANCH_CODE")));
                    txtSubNo.setText(CommonUtil.convertObjToStr(hash.get("SUB_NO")));
                    observable.setTxtSubNo(CommonUtil.convertObjToStr(hash.get("SUB_NO")));
                    observable.setReceiptDetails(hash);
                   ...
                   // txtGDSName.setEnabled(false);
                    ...
                    if (CommonUtil.convertObjToStr(CommonConstants.SAL_REC_MODULE).equals("Y")) {
                        HashMap whereMap = new HashMap();
                        whereMap.put("GROUP_NAME", txtGDSName.getText());
                        whereMap.put("GROUP_NO", txtGDSName.getText());
                     //   whereMap.put("CHITTAL_NO", txtChittalNo.getText()); //commented by shany
                        whereMap.put("GDS_NO", txtChittalNo.getText());//added by shany
                        whereMap.put("SUB_NO", CommonUtil.convertObjToInt(txtSubNo.getText()));
                        List masterLst = ClientUtil.executeQuery("getSelectMDSMasterData", whereMap);
                        if (masterLst != null && masterLst.size() > 0) {
                            whereMap = (HashMap) masterLst.get(0);
...
//            else if (viewType.equalsIgnoreCase("GROUP_NO")) {
//                
//                System.out.println("Inside else if (viewType.equalsIgnoreCase("+"GROUP_NO"+")");
//                observable.resetOBFields();
//                 //Added by sreekrishnan for 10957
//                observable.setThalayalChittal(CommonUtil.convertObjToStr(hash.get("THALAYAL")));
//                System.out.println("hashhh" + hash);
//                hash.put("SUB_NO", CommonUtil.convertObjToStr(hash.get("SUB_NO")));
...
//                } else {
//
//                    txtGDSName.setText(CommonUtil.convertObjToStr(hash.get("GROUP_NAME")));
//                    observable.setTxtGDSName(CommonUtil.convertObjToStr(hash.get("GROUP_NAME")));
//                    observable.setTxtChittalNo(CommonUtil.convertObjToStr(hash.get("CHITTAL_NO")));
//                    observable.setSelectedBranchID(CommonUtil.convertObjToStr(hash.get("BRANCH_CODE")));
//                    txtSubNo.setText(CommonUtil.convertObjToStr(hash.get("SUB_NO")));
...
//                        whereMap.put("GROUP_NAME", txtGDSName.getText());
//                        whereMap.put("CHITTAL_NO", txtChittalNo.getText());
//                        whereMap.put("SUB_NO", txtSubNo.getText());
//                        List masterLst = ClientUtil.executeQuery("getSelectMDSMasterData", whereMap);
//                        if (masterLst != null && masterLst.size() > 0) {
//                            whereMap = (HashMap) masterLst.get(0);
//                            if (CommonUtil.convertObjToStr(whereMap.get("LOCK_STATUS")).equals("Y")) {
...
//                        int transferCount = 0;
                        ...
                        for (int i = 0; i < keys.length; i++) {
                            ...
                            for (int j = 0; j < tempList.size(); j++) {
                                ...
                                if (transMap.containsKey("SINGLE_TRANS_ID") && transMap.get("SINGLE_TRANS_ID") != null) {
                                    ...
                                    trBatchId = CommonUtil.convertObjToStr(transMap.get("SINGLE_TRANS_ID"));
                        ...
                        if (cashCount > 0) {
                            ...
                            ttIntgration.integrationForPrint("MDSReceipts", false);
                            System.out.println("bous print@$@$@$@$@"+bonusPrint);
                                if (transferCount > 0) {
                                    if(bonusPrint!=null && !bonusPrint.equals("") && bonusPrint.equalsIgnoreCase("Y")){
                                        System.out.println("cash innnn");
                                        lockMap.put("TransId", transID);
                                        ttIntgration.setParam(lockMap);
                            ...
                            System.out.println("only trasfer innnn");
                            lockMap.put("TransId", transID);
                            ttIntgration.setParam(lockMap);
                            ttIntgration.integrationForPrint("MDSReceiptsTransfer", false);
                        }
    ...
    private void populateChittalDetails() {
       // txtGDSName.setText(observable.getgr());  
        System.out.println("populateChittalDetails:getGds_no: "+observable.getGds_no());
        txtChittalNo.setText(CommonUtil.convertObjToStr(observable.getGds_no()));        
        lblMemberNameVal.setText(observable.getLblMemberNameVal());
        lblMemberNo.setText(observable.getLblMemberNo());
        txtDivisionNo.setText(observable.getTxtDivisionNo());
        tdtChitStartDt.setDateValue(observable.getTdtChitStartDt());
    ...
    private com.see.truetransact.uicomponent.CButton btnGDSName;
    ...
    private com.see.truetransact.uicomponent.CLabel lblGDSName;
    ...
    private com.see.truetransact.uicomponent.CTextField txtGDSName;
    ...
    public static void main(String[] arg) {
        ...
        GDSReceiptEntryUI gui = new GDSReceiptEntryUI();
