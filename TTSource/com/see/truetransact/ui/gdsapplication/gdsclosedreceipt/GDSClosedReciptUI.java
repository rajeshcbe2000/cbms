  ...
  * 
   * GDSClosedReciptUI.java
   *
   * Created on November 26, 2003, 11:27 AM
   */

package com.see.truetransact.ui.gdsapplication.gdsclosedreceipt;

import com.see.truetransact.ui.mdsapplication.mdsclosedreceipt.*;
import java.util.*;
...
public class GDSClosedReciptUI extends com.see.truetransact.uicomponent.CInternalFrame implements Observer, UIMandatoryField{
    ...
    final GDSClosedReciptMRB objMandatoryMRB = new GDSClosedReciptMRB();
    
    private TransactionUI transactionUI = new TransactionUI();
    private HashMap mandatoryMap;
    private GDSClosedReciptOB observable;
    ...
    private void setObservable() {
        try{
            observable = GDSClosedReciptOB.getInstance();
   ...
   Other functions are working based on this name. */
    private void setFieldNames() {
        ...
        txtGDSName.setName("txtSchemeName");
...
//        rdoBankPay_No.setSelected(observable.getRdoBankPay_No());
    ...
    public void updateOBFields() {
        ...
        observable.setTxtSchemeName(txtGDSName.getText());
   ...
   object. Help display Label name should be lblMsg. */
    public void setHelpMessage() {
        ...
        txtGDSName.setHelpMessage(lblMsg, objMandatoryRB.getString("txtSchemeName"));
    ...
    private void initComponents() {
        ...
        txtTotalInstAmt.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txtTotalInstAmtActionPerformed(evt);
            }
        });
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        ...
        panInstallmentToPay.setMinimumSize(new java.awt.Dimension(335, 27));
        panInstallmentToPay.setPreferredSize(new java.awt.Dimension(335, 29));
        ...
        txtNoOfInstToPaay.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txtNoOfInstToPaayActionPerformed(evt);
            }
        });
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
...
//            String bonusFirstInst = CommonUtil.convertObjToStr(productMap.get("BONUS_FIRST_INSTALLMENT"));
            ...
            c_hash1.put("SCHEME_NAME", txtGDSName.getText().trim());
            ...
            if(balanceIns >= (CommonUtil.convertObjToDouble(txtNoOfInstToPaay.getText()).doubleValue())){
                ...
                if(pendingInst>=0){//pending installment calculation starts... && pendingInst>=noOfInstPay
                    ...
                    if(observable.getRdoPrizedMember_Yes() == true){
                        ...
                        System.out.println("penalValue: "+penalValue);
                        ...
                        System.out.println("penalValue1: "+penalValue);
...
//                                                calc = insAmt*(((pendingInst+1)*pendingInst/2)*penalValue)/1200;
                            ...
                            c_hash.put("SCHEME_NAME", txtGDSName.getText().trim());
    ...
    //bonus calculation details...
                            if (bonusAvailabe == true) {
                                ...
                                if (observable.getRdoPrizedMember_Yes() == true) {
                                    ...
                                    nextActMap.put("SCHEME_NAME", observable.getScheme_name());
...
//            strWarnMsg = null;
    ...
    private void txtTotalInstAmtActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtTotalInstAmtActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_txtTotalInstAmtActionPerformed

    private void txtNoOfInstToPaayActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtNoOfInstToPaayActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_txtNoOfInstToPaayActionPerformed
    ...
    private void callView(String currField) {
        ...
        if (currField.equals("Edit")|| currField.equals("Enquirystatus") || currField.equals("Delete")){
           ...
           // Date d=Date
            ...
            HashMap datemap = new HashMap();
            String branch = CommonUtil.convertObjToStr(cbobranch.getSelectedItem());
            datemap.put("TODAY_DT", curr_dt);
            datemap.put("BRANCH_CODE", branch);
            System.out.println("curr_dt.." + curr_dt);
            viewMap.put(CommonConstants.MAP_WHERE, datemap);           
            viewMap.put(CommonConstants.MAP_NAME, "getSelectClosedGroupDetailsForRecieptEntry");            
        }else if (currField.equalsIgnoreCase("CHITTAL_NO")) {
            if(!txtGDSName.getText().equals(""))
            {
            HashMap map1= new HashMap();
            HashMap mapTrans = new HashMap();
            map1.put("SCHEME_NAME", txtGDSName.getText());
            String branch=CommonUtil.convertObjToStr(cbobranch.getSelectedItem());
            if(branch != null && branch.length()>0 && !branch.equals(ProxyParameters.BRANCH_ID)){
                where.put("BRANCH_CODE", branch);
            }                        
...
//                    observable.setTxtDivisionNo("1");
                ...
                if (observable.getActionType() == ClientConstants.ACTIONTYPE_NEW && txtGDSName.getText().length() > 0) {
                    String branch = CommonUtil.convertObjToStr(cbobranch.getSelectedItem());
                    txtChittalNo.setText(CommonUtil.convertObjToStr(branch + txtGDSName.getText()));
                    observable.setTxtChittalNo(CommonUtil.convertObjToStr(branch + txtGDSName.getText()));
                } else {
                    txtChittalNo.setText("");
                }
                btnGDSName.setEnabled(true);
...
//                            }
    ...
    public static void main(String[] arg){
        ...
        GDSClosedReciptUI gui = new GDSClosedReciptUI();
