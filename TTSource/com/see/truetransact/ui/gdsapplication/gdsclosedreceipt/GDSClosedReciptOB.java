...
public class GDSClosedReciptOB extends CObservable {
    ...
    private GDSClosedReciptTO splitMDSClosedReceiptEntryTO = null;
    ...
    private static GDSClosedReciptOB MDSReceiptEntryOB;
    static {
        try {
            MDSReceiptEntryOB = new GDSClosedReciptOB();
        } catch(Exception e) {
    ...
    public GDSClosedReciptOB() throws Exception{
        operationMap = new HashMap();
        operationMap.put(CommonConstants.JNDI, "GDSClosedReciptJNDI");
        operationMap.put(CommonConstants.HOME, "mdsapplication.mdsreceiptentry.GDSReceiptEntryHome");
        operationMap.put(CommonConstants.REMOTE, "mdsapplication.mdsreceiptentry.GDSReceiptEntry");
        try {
    ...
    public static GDSClosedReciptOB getInstance() {
    ...
    private GDSClosedReciptTO setMDSReceiptEntryTO(){
        GDSClosedReciptTO mdsReceiptEntryTO = new GDSClosedReciptTO();        
        mdsReceiptEntryTO.setGroup_no(CommonUtil.convertObjToStr(getGroup_no()));
        mdsReceiptEntryTO.setGds_no(CommonUtil.convertObjToStr(getGds_no()));
...
//        HashMap chittalMap = new HashMap();
        ...
        if(lst!=null && lst.size()>0){            
            ...
            for( int i =0; i< lst.size(); i++){
               instamount = instamount + CommonUtil.convertObjToDouble(chittalMap.get("INST_AMT")); 
            }            
            ...
            setTxtInstAmt(CommonUtil.convertObjToStr(instamount));
...
//                setTdtInsUptoPaid(CommonUtil.convertObjToStr(startDate));
            ...
            if(lst!=null && lst.size()>0){
                ...
                double prizedamOunt = CommonUtil.convertObjToDouble(prizedMap.get("PRIZED_AMOUNT")) * getSchemeCount();
               // setTxtBonusAmtAvail(CommonUtil.convertObjToStr(prizedMap.get("PRIZED_AMOUNT")));
                 setTxtBonusAmtAvail(CommonUtil.convertObjToStr(prizedamOunt));
...
//                        mdsReceiptEntryTO = new MDSReceiptEntryTO();
                        for (int i = 0; i < lst.size(); i++) {
                            mdsReceiptEntryTO = (GDSClosedReciptTO) lst.get(i);
                ...
                mdsReceiptEntryTO = (GDSClosedReciptTO) ((List) mapData.get("MDSReceiptEntryTO")).get(0);
                List lst = (List) mapData.get("MDSReceiptEntryTO");
                schemeCount=lst.size(); 
                getMDSReceiptEntryTO(mdsReceiptEntryTO);
            }
    ...
    private GDSClosedReciptTO getMDSReceiptEntryTO(GDSClosedReciptTO mdsReceiptEntryTO){
        ...
        setTxtInstAmt(CommonUtil.convertObjToStr(mdsReceiptEntryTO.getInstAmt()*schemeCount));
        setTxtPendingInst(CommonUtil.convertObjToStr(mdsReceiptEntryTO.getPendingInst()));
        setTxtTotalInstAmt(CommonUtil.convertObjToStr(mdsReceiptEntryTO.getTotalInstDue()*schemeCount));
        setTxtBonusAmtAvail(CommonUtil.convertObjToStr(mdsReceiptEntryTO.getBonusAmtAvail()*schemeCount));
        ...
        if (isSplitMDSTransaction != null && isSplitMDSTransaction.equals("Y")) {
            ...
            setTxtNoticeAmt(CommonUtil.convertObjToStr(mdsReceiptEntryTO.getNoticeAmt()*schemeCount));
        }
        if (isSplitMDSTransaction != null && isSplitMDSTransaction.equals("Y")) {
            ...
            setTxtAribitrationAmt(CommonUtil.convertObjToStr(mdsReceiptEntryTO.getArbitrationAmt()*schemeCount));
        }
        ...
        if (isSplitMDSTransaction != null && isSplitMDSTransaction.equals("Y")) {
            ...
            setTxtInstPayable(CommonUtil.convertObjToStr(mdsReceiptEntryTO.getInstAmtPayable()*schemeCount));
        }
        if (isSplitMDSTransaction != null && isSplitMDSTransaction.equals("Y")) {
            setTxtPenalAmtPayable(CommonUtil.convertObjToStr(penalAmount));
        } else {
            setTxtPenalAmtPayable(CommonUtil.convertObjToStr(mdsReceiptEntryTO.getPenalAmtPayable()*schemeCount));
        }
        if (isSplitMDSTransaction != null && isSplitMDSTransaction.equals("Y")) {
            setTxtBonusAmt(CommonUtil.convertObjToStr(bonusAmount));
        } else {
            setTxtBonusAmt(CommonUtil.convertObjToStr(mdsReceiptEntryTO.getBonusAmtPayable()*schemeCount));
        }
        setTxtDiscountAmt(CommonUtil.convertObjToStr(mdsReceiptEntryTO.getDiscountAmt()*schemeCount));
        setTxtInterest(CommonUtil.convertObjToStr(mdsReceiptEntryTO.getMdsInterset()*schemeCount));
        if (isSplitMDSTransaction != null && isSplitMDSTransaction.equals("Y")) {
