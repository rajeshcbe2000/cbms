...
public class MultipleTermDepositOB extends CObservable {
    ...
    ArrayList depositNoList = new ArrayList();
    ...
    public final String QUARTERLY = "Quaterly";
    ...
    private final String TERM_DEP_HOME = "deposit.multipledeposit.MultipleTermDepositHome";
    private final String TERM_DEP_REMOTE = "deposit.multipledeposit.MultipleTermDeposit";
    ...
    private double noOfAccounts = 0;
    //Mobile Number related thing added by Kannan AR
    private boolean chkMobileNumRequired = false;
    private String txtMobileNo = "";
    private String tdtMobileSubscribedFrom = "";
    SMSSubscriptionTO objSMSSubscriptionTO = null;

    public double getNoOfAccounts() {
        return noOfAccounts;
    }

    public void setNoOfAccounts(double noOfAccounts) {
    ...
    public ArrayList getDepositNoList() {
        return depositNoList;
    }

    public void setDepositNoList(ArrayList depositNoList) {
        this.depositNoList = depositNoList;
    }
    ...
    //        }
    //    }
    public static MultipleTermDepositOB getInstance() throws Exception {
        MultipleTermDepositOB termDepositOB = new MultipleTermDepositOB();
     ...
     */
    private MultipleTermDepositOB() throws Exception {
...
//    private boolean rdoExtensionWithIntAutoRenewal_No = false;
    ...
    public void resetForm() {
        ...
        extensionReset();
        setChkMobileNumRequired(false);
        setTxtMobileNo("");
        setTdtMobileSubscribedFrom(null);
        nomineeTOList = null;
        jntAcctAll = null;
...
//    added by nikhil
    ...
    private void doActionPerform(NomineeOB objNomineeOB) throws Exception {
        //System.out.println("inside actionperform");
        data = new HashMap();
...
//                    data.put("TransactionTO",transactionDetailsTO);
            ...
            //System.out.println("inside setting data");
            ...
            if (this.getTxtDepsoitNo().equals(RENEW) || objAccInfoTO.getOpeningMode().equals(RENEWAL) && renewaldepSubNoAll != null) {
                ...
                for (int i = 0; i < depSubNoSize; i++) {
                    ...
                    renewalMap.put("RENEWAL_MATURITY_AMT", renewaldepSubNoAccInfo.get(FLD_DEP_RENEWAL_SUB_NO_MAT_AMT));
                    renewalMap.put("RENEWAL_DEPOSIT_DAYS", renewaldepSubNoAccInfo.get(FLD_DEP_RENEWAL_SUB_NO_DEP_PER_DD));
                    renewalMap.put("RENEWAL_DEPOSIT_MONTHS", renewaldepSubNoAccInfo.get(FLD_DEP_RENEWAL_SUB_NO_DEP_PER_MM));
                    renewalMap.put("RENEWAL_DEPOSIT_YEARS", renewaldepSubNoAccInfo.get(FLD_DEP_RENEWAL_SUB_NO_DEP_PER_YY));
...
//                    renewalMap.put("BALANCE_INT_AMT",renewaldepSubNoAccInfo.get(FLD_DEP_RENEWAL_SUB_BALANCE_INTAMT));
                    ...
                    renewalMap.put("SB_INT_AMT", renewaldepSubNoAccInfo.get(FLD_DEP_RENEWAL_SUB_SB_INTAMT));
                    renewalMap.put("SB_PERIOD_RUN", renewaldepSubNoAccInfo.get(FLD_DEP_RENEWAL_SUB_SB_PERIOD));
...
//            objAccInfoTO.setRenewalCount(new Double(objAccInfoTO.getRenewalCount().doubleValue()-1));
//        }
        data.put("NO_OF_ACCOUNTS", CommonUtil.convertObjToStr(getNoOfAccounts()));
        data.put("MULTIPLE_DEPOSIT", "MULTIPLE_DEPOSIT");        
...
//        }
        if (proxyResultMap != null) {
            //System.out.println("newProxy"+proxyResultMap);
            //System.out.println("value="+CommonUtil.convertObjToStr(proxyResultMap.get("DEPOSIT NO")));
            //setTxtDepsoitNo(CommonUtil.convertObjToStr(proxyResultMap.get("DEPOSIT NO")));
            for(int i = 0 ; i < proxyResultMap.size() ; i++){
                depositNoList.add(CommonUtil.convertObjToStr(proxyResultMap.get("DEPOSIT NO"+CommonUtil.convertObjToStr(i))));   
            }            
...
//                }
    ...
    private SMSSubscriptionTO getMobileBanking(AccInfoTO objAccInfoTO) {
        if (isChkMobileNumRequired() && objAccInfoTO != null) {
                ...
                if (calcDepSubNo.get("ACCT_STATUS").equals("CLOSED") && (getViewTypeDeposit().equals("CLOSED_DEPOSIT")
                    ...
                    if (lstRenewal != null && lstRenewal.size() > 0) {
                        if (getViewTypeDeposit().equals("AUTHORIZE") || getViewTypeDeposit().equals("EDIT")) {
                            ...
                            depositNoList.add(CommonUtil.convertObjToStr(renewalMap.get("DEPOSIT_NO")));                            
...
//                    TILL HERE          ADDED BY NIKHIL                                
                    ...
                    if (lstExtension != null && lstExtension.size() > 0) {
                        if (getViewTypeDeposit().equals("AUTHORIZE") || getViewTypeDeposit().equals("EDIT")) {
                            ...
                            depositNoList.add(CommonUtil.convertObjToStr(extensionMap.get("DEPOSIT_NO")));                            
                    ...
                    if (lstStand != null && lstStand.size() > 0) {
                        ...
                        if (siFreq == 30) {
                            ...
                            setSIFrequencyValue(CommonUtil.convertObjToStr("Quaterly"));
                        } else if (siFreq == 180) {
    ...
    private void setDepSubNoDetailsInExtension(List depSubNoDetailsList) {
        ...
        depSubNoAll = new HashMap();
        extensiondepSubNoAll = new HashMap();
        Date todaysDt = (Date)currDt.clone();
            ...
            if (calcDepSubNo.get("ACCT_STATUS").equals("CLOSED") && getViewTypeDeposit().equals("CLOSED_DEPOSIT")) {
                ...
                if (list != null && list.size() > 0) {
                    ...
                    if (freq == 0) {
                        ...
                        setExtensionPaymentFreqValue("Quaterly");
                    } else if (freq == 180) {
    ...
    private void setAcctInfoDetails(HashMap accountInfoMap) {
        ...
        depositNoList.add(CommonUtil.convertObjToStr(accountInfoMap.get("DEPOSIT_NO")));        
    ...
    public void populateRenewalDepSubNoFields(int row) {
        try {
            ...
            if (listDepSubNoAll.get(FLD_DEP_RENEWAL_SUB_NO_INT_PAY_FREQ) != null && listDepSubNoAll.get(FLD_DEP_RENEWAL_SUB_NO_INT_PAY_FREQ).equals("0")) {
                ...
                setCboRenewalInterestPaymentFrequency("Quaterly");
...
//            }
        if (paramMap == null) {
            ...
            if (startDt != null && endDt != null) {
                 //added by rishad at 14/02/2015  for mantis 0010412
    ...
    public double setExtensionRateOfInterset(Date depDt, double depAmount, boolean extension) {
        ...
        if (depDt != null && currDt != null) {
            ...
            if (extension == true) {
                ...
                Date todayDt = (Date)currDt.clone();
...
//        depSubNoRow.set(getSelectedRowCount, changedDepSubNoRow);
    ...
    public double setRateOfInterset(HashMap paramMap) {
        ...
        if (paramMap == null) {
            ...
            if (startDt != null && endDt != null) {
                //added by rishad at 18/03/2015  for mantis 0010412
                int year = CommonUtil.convertObjToInt(getTxtPeriodOfDeposit_Years());
                int month = CommonUtil.convertObjToInt(getTxtPeriodOfDeposit_Months());
                if (year != 0 || month != 0) {
                    HashMap whereDateMap = new HashMap();
...
//            }
    ...
    public void populateExtensionDepSubNoFields(int row) {
        try {
            ...
            if (listDepSubNoAll.get(FLD_DEP_EXTENSION_SUB_NO_INT_PAY_FREQ) != null && listDepSubNoAll.get(FLD_DEP_EXTENSION_SUB_NO_INT_PAY_FREQ).equals("0")) {
                ...
                setCboExtensionPaymentFrequency("Quaterly");
    ...
    public String getMaturityDateArrayList() {
        ...
        Date leastDate = (Date)currDt.clone();
...
//                    detailsHash.put("PROD_ID", cbmRenewalDepositProdId.getKeyForSelected());
    ...
    public HashMap depositRateInterestCalculation(HashMap calculationMap, String prodId) {
        ...
        if (period + 1 > backDateFreq) {
            ...
            renewalMap.put("PERIOD", CommonUtil.convertObjToLong(calculationMap.get("PERIOD")));
    ...
    public boolean isChkMobileNumRequired() {
        return chkMobileNumRequired;
    }

    public void setChkMobileNumRequired(boolean chkMobileNumRequired) {
        this.chkMobileNumRequired = chkMobileNumRequired;
    }
