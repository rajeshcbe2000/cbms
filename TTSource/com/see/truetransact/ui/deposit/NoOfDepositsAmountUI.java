 ...
 * @author  Suresh
 */
public class NoOfDepositsAmountUI extends com.see.truetransact.uicomponent.CDialog implements Observer {
    ...
    TermDepositUI termDeposit = null;
    
    //    public LienDetailsUI() {
    public NoOfDepositsAmountUI() {
        initComponents();
        initForm();
    ...
    public NoOfDepositsAmountUI(TermDepositUI termDeposit) {
...
/* Auto Generated Method - getMandatoryHashMap()
   Getter method for setMandatoryHashMap().*/
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        panTotal1.add(txtAmount, gridBagConstraints);
