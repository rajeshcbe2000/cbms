 ...
 * @author  Sunil (152691)
 */
public class CashInHandCheck{
    private String branch = null ;      
    private Date currDt = null;
    /** Creates a new instance of CashInHandCheck */
    public CashInHandCheck() throws Exception {
    }
    ...
    public String executeTask() throws Exception {
        ...
        List output = ClientUtil.executeQuery("getCashInHand", paramMap) ;
        paramMap = null ;
   ...
   public String executeTask(String lable,HashMap isPrev)throws Exception {
    ...
    public static void main(String args[]){
        try{
            CashInHandCheck ft = new CashInHandCheck();
