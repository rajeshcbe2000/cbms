 ...
 * @author  Sunil (152691)
 */
public class CashAndTransferAuthCheck{
    private Date currDt = null;
    
    /** Creates a new instance of AuthorizationCheck */
    public CashAndTransferAuthCheck() throws Exception {
    }
    ...
    public String executeTask() throws Exception {
        ...
        List tableList = ClientUtil.executeQuery("CashAndTransferAuth_view", paramMap) ;
        boolean header = true;
        boolean footer = true;
        int len = 15;
