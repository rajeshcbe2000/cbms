 ...
 *
 */
public class OutwardOB extends CObservable {
 ...
 private String cmbMessenger="";
    public String getCmbMessenger() {
        return cmbMessenger;
    }

    public void setCmbMessenger(String cmbMessenger) {
        this.cmbMessenger = cmbMessenger;
    }
    ...
    private final static Logger log = Logger.getLogger(OutwardOB.class);
    ...
    public OutwardOB() {
        try {
            ...
            map = new HashMap();
            map.put(CommonConstants.JNDI, "OutwardRegisterJNDI");
            map.put(CommonConstants.HOME, "OutwardRegister.OutwardHome");
            map.put(CommonConstants.REMOTE, "OutwardRegister.Outward");
            //fillDropdown();
...
//    }
    ...
    private void doActionPerform() throws Exception{
        final OutwardRegisterTO objOutwardRegisterTO = new OutwardRegisterTO();
        final HashMap data = new HashMap();
         data.put("COMMAND",getCommand());
        if(get_authorizeMap() == null){
         data.put("OutwardRegister",setOutwardData());
         System.out.println("outward dataaaaaaaaaaaaa"+data);
        }
        else{
        data.put(CommonConstants.AUTHORIZEMAP, get_authorizeMap());
        }
        System.out.println("data in outwardRegister OB : " + data);
        HashMap proxyResultMap = proxy.execute(data, map);
        setProxyReturnMap(proxyResultMap);
         System.out.println("data in OutwardRegister OB return... : " + proxyResultMap);
        if (proxyResultMap != null  &&  getCommand()!=null && getCommand().equalsIgnoreCase("INSERT")){
                ClientUtil.showMessageWindow("Outward No. : " + CommonUtil.convertObjToStr(proxyResultMap.get("OUTWARD_NO")));
            }
    ...
    public void getData(HashMap whereMap) {
         try{
            ...
            objOutwardRegisterTO = (OutwardRegisterTO)((List) data.get("OutwardTO")).get(0);
            
            //System.out.println("in ob...return map"+(InwardRegisterTO)((List) data.get("InwardTO")).get(0));
            populateData(objOutwardRegisterTO);
            ttNotifyObservers();
        }catch(Exception e){
            parseException.logException(e,true);
        }
    ...
    public OutwardRegisterTO setOutwardData() {
        ...
        try{
           ...
           objOutwardRegisterTO.setOdate(DateUtil.getDateMMDDYYYY(getTdtDate()));
           //objOutwardRegisterTO.setCommand(getCommand());
           objOutwardRegisterTO.setStatus(getAction());
           //objInwardRegisterTO.setStatusBy(TrueTransactMain.USER_ID);
           objOutwardRegisterTO.setDetails(getTxaDetails());
           objOutwardRegisterTO.setRemarks(getTxaRemarks());
           objOutwardRegisterTO.setReferenceNo(getTxtReferenceNo());
            objOutwardRegisterTO.setCbmmessenger(getCmbMessenger());
              objOutwardRegisterTO.setAddress(getTxaAddress());
              objOutwardRegisterTO.setBranchId(TrueTransactMain.BRANCH_ID); // Added by nithya on 14-07-2016 for 4796
           //objInwardRegisterTO.setActionTaken(getTxtActionTaken());
          
          // objInwardRegisterTO.setBranCode(null);
           if(getCommand().equalsIgnoreCase("INSERT")){
//           objOutwardRegisterTO.setCreatedBy(TrueTransactMain.USER_ID);
//           objInwardRegisterTO.setCreatedDt(currDt);
           }
            if(getCommand().equalsIgnoreCase("UPDATE")||getCommand().equalsIgnoreCase("DELETE")){
              //objInwardRegisterTO.setEmpTransferID(getTxtEmpTransferID());  
            }
        }catch(Exception e){
            log.info("Error In setOutwardData()");
            e.printStackTrace();
        }
        return objOutwardRegisterTO;
    }
//    
    private void populateData(OutwardRegisterTO objOutwardRegisterTO) throws Exception{
        this.setTxtOutwardNo((objOutwardRegisterTO.getOutwardNo()));
        System.out.println("populate outward no...."+getTxtOutwardNo()+"dddd"+objOutwardRegisterTO.getOutwardNo());
        this.setTxaDetails(CommonUtil.convertObjToStr(objOutwardRegisterTO.getDetails()));
        this.setTxaRemarks(CommonUtil.convertObjToStr(objOutwardRegisterTO.getRemarks()));
        this.setTxtReferenceNo(CommonUtil.convertObjToStr(objOutwardRegisterTO.getReferenceNo()));
        //this.setTxtSubmittedBy(CommonUtil.convertObjToStr(objOutwardRegisterTO.getSubmittedBy()));
        //this.setTxtActionTaken(CommonUtil.convertObjToStr(objOutwardRegisterTO.getActionTaken()));
        //this.setTxtStatusBy(CommonUtil.convertObjToStr(objOutwardRegisterTO.getStatusBy()));
        //this.setCreatedDt(CommonUtil.convertObjToStr(objOutwardRegisterTO.getCreatedDt()));
        this.setTdtDate(CommonUtil.convertObjToStr(objOutwardRegisterTO.getOdate()));
          this.setCmbMessenger(CommonUtil.convertObjToStr(objOutwardRegisterTO.getCbmmessenger()));
         
             this.setTxaAddress(CommonUtil.convertObjToStr(objOutwardRegisterTO.getAddress()));
        //this.setTxt(CommonUtil.convertObjToStr(objInwardRegisterTO.getCurrBran()));
        //this.setCurrBranName(CommonUtil.convertObjToStr(objInwardRegisterTO.getCurrBranName()));
        //this.setStatusBy(CommonUtil.convertObjToStr(objOutwardRegisterTO.getStatusBy()));
        setChanged();
        notifyObservers();
    }
