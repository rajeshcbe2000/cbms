 ...
 */
package com.see.truetransact.ui.mdsapplication.mdsreceiptentry;
...
/**
 *
 * @author Hemant Modification Lohith R. @modified : Sunil Added Edit Locking -
 * 08-07-2005
 */
public class MDSReceiptEntryUI extends com.see.truetransact.uicomponent.CInternalFrame implements Observer, UIMandatoryField {
    ...
    final MDSReceiptEntryMRB objMandatoryMRB = new MDSReceiptEntryMRB();
    private TransactionUI transactionUI = new TransactionUI();
    private HashMap mandatoryMap;
    private MDSReceiptEntryOB observable;
    ...
    private void setObservable() {
        try {
            observable = MDSReceiptEntryOB.getInstance();
...
//        rdoBankPay_No.setSelected(observable.getRdoBankPay_No());
        ...
        txtForfeitBonus.setText(observable.getTxtForfietbonus()); // 16-07-2020
    ...
    public void updateOBFields() {
        ...
        observable.setTxtForfietbonus(txtForfeitBonus.getText()); //16-07-2020
...
//        }  
//        }
        if(!isWeeklyOrMonthlyScheme.equals("W")){
    ...
    public void setHelpMessage() {
        MDSReceiptEntryMRB objMandatoryRB = new MDSReceiptEntryMRB();
    ...
    private void initComponents() {
        ...
        btnWaiveAmt = new com.see.truetransact.uicomponent.CButton();
        ...
        btnWaiveAmt.setText("Waive");
        btnWaiveAmt.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnWaiveAmtActionPerformed(evt);
            }
        });
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 3;
        gridBagConstraints.gridy = 0;
        panInstallmentToPay.add(btnWaiveAmt, gridBagConstraints);
    ...
    private void txtPenalAmtPayableFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtPenalAmtPayableFocusLost
        ...
        if (txtPenalAmtPayable.getText().length() == 0) {     // this block addded by rishad 06/11/2021 for avoiding  issue when clearing penal amount field 
        ...
        // Added by nithya on 10-2-2021 for KD-2672
    ...
    private HashMap checkServiceTaxApplicable(String chargeType) {// Modifyng return type of this function by nithya for GST changes
    ...
    private void setCaseExpensesAmount() {
        ...
        if (chargeList != null && chargeList.size() > 0) {
            // Commenting by nithya for GST Changes
...
//            }
            ...
            //Commented the below lines of code by nithya on 24-07-2018 for KD-178 0013928: 12/7/18--When ARC filing Arbitration fee showing double in mds status. Ledger is showing correctly.
            //totChrgAmt+=CommonUtil.convertObjToDouble(whereMap.get("CHARGE_AMT")).doubleValue();
            //chargeAmount = CommonUtil.convertObjToDouble(whereMap.get("CHARGE_AMT")).doubleValue();
            // End
            //if (totTaxAmt > 0) {
...
//            chargeAmount = (double)rod.getNearest((long)(chargeAmount *100),100)/100;
    ...
    private void btnNoOfInstToPaayActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNoOfInstToPaayActionPerformed
        ...
        if (txtChittalNo.getText().length() == 0) { // Added by nithya for KD 483
        ...
        if (tdtInstDt.getDateValue().length() == 0) {
            ...
            txtBonusAmt.setText("");
            txtForfeitBonus.setText(""); // 16-07-2020
...
//                    int graceCalculated = 1;
                  ...
                  //   added by rishad 10/01/2018 for predefinition installment
...
//                        }
                    ...
                    for (int i = startNoForPenal; i < noOfInstPay + startNoForPenal; i++) {
                        // Modified by nithya on 02-01-2018 for 0008272: Advance collection issue_MDS [ for solving array index out of bound exception ]
                        if (calculateIntOn != null && calculateIntOn.equals("Installment Amount")) {
                                    ...
                                    if ((diffDayPending > (penalGraceValue * instFreq)) && (pendingInst >= penalGraceValue)) {
                                        if (penalIntType != null && !penalIntType.equals("") && penalIntType.equals("Percent")) {
                                            ...
                                            if (observable.getRdoPrizedMember_Yes() == true || calculateIntOn.equals("Installment Amount")) {
                                                ...
                                                System.out.println("Checking ---- Execute here --- Postgress");
                                                if (isWeeklyOrMonthlyScheme != null && !isWeeklyOrMonthlyScheme.equals("") && isWeeklyOrMonthlyScheme.equals("W")) {
...
//                                }
                        ...
                        if (observable.getMultipleMember().equals("Y")) {
                            ...
                            whereMap.put("SCHEME_NAMES", txtSchemeName.getText());    // changed SCHEME_NAME To SCHEME_NAMES by nithya on 09-03-2018 for 0009389: Co -Chittal Bonus not dividing                        
...
//                                }
                ...
                txtForfeitBonus.setText(String.valueOf(totReversalBonusAmt)); // 16-07-2020
                ...
                txtInstPayable.setText(String.valueOf(
                        ...
                        * CommonUtil.convertObjToDouble(txtNoOfInstToPaay.getText()).doubleValue()
                        - CommonUtil.convertObjToDouble(txtDiscountAmt.getText()).doubleValue()
                        - CommonUtil.convertObjToDouble(txtBonusAmt.getText()).doubleValue())); 
//                if(pendingInst >0 && observable.getRdoPrizedMember_No() == true && calculateIntOn.equals("Installment Amount")){
//                    System.out.println("diffDayPending....No" + diffDayPending+" BBBpending "+pendingForPenCal + "penalValue" + penalValue + "instAmt" + "pen inst"+pendingInst);
//                    instalAmt = CommonUtil.convertObjToDouble(txtInstPayable.getText());
//                    calc += (double) ((pendingForPenCal * instalAmt * penalValue) / 36500);
//                    txtPenalAmtPayable.setText(CommonUtil.convertObjToStr(calc));
//                }
//                else if(pendingInst >0 && observable.getRdoPrizedMember_Yes() == true && calculateIntOn.equals("Installment Amount")){
//                    System.out.println("diffDayPending....Yes" + diffDayPending +" BBBpenddding "+pendingForPenCal+ "penalValue" + penalValue + "instAmt" + "pen inst"+pendingInst);
//                    instalAmt = CommonUtil.convertObjToDouble(txtInstPayable.getText());
//                    calc += (double) ((pendingForPenCal * instalAmt * penalValue) / 36500);
//                    txtPenalAmtPayable.setText(CommonUtil.convertObjToStr(calc));
//                }
        ...
        try {
            ...
            if (observable.getResult() != ClientConstants.ACTIONTYPE_FAILED) {
                if (fromNewAuthorizeUI) {
                    ...
                    this.dispose();
                    newauthorizeListUI.setFocusToTable();
                    newauthorizeListUI.displayDetails("MDS Receipt Entry");
                }
                if (fromAuthorizeUI) {
                    authorizeListUI.removeSelectedRow();
                    this.dispose();
                    authorizeListUI.setFocusToTable();
                    authorizeListUI.displayDetails("MDS Receipts");
                }
                if (fromCashierAuthorizeUI) {
...
private void txtSchemeNameFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtSchemeNameFocusLost
    ...
    if (txtSchemeName.getText().length() > 0) {
        ...
        List lst = ClientUtil.executeQuery("getSelectSchemeNameForMDSReceiptEntry", whereMap); // Added by nithya on 22-04-2020 for KD-1611
        if (lst != null && lst.size() > 0) {
            observable.setTxtSchemeName(txtSchemeName.getText());
...
private void cbobranchFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_cbobranchFocusLost
    ...
    private void btnWaiveAmtActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnWaiveAmtActionPerformed
        // TODO add your handling code here:
        transactionUI.setMdsWaiveAmt(0.0);
    ...
    }//GEN-LAST:event_btnWaiveAmtActionPerformed
...
//       TrueTransactMain.showScreen(editableUI);
    ...
    private void insertScreenLock() {
        ...
        hash.put("TRANS_ID", observable.getTxtChittalNo());
    ...
    private boolean validateScreenLock() {
        HashMap authDataMap = new HashMap();
        authDataMap.put("TRANS_ID", observable.getTxtChittalNo());
...
//                observable.checkAcNoWithoutProdType(CommonUtil.convertObjToStr(hashMap.get("CHITTAL_NO")));
                ...
                List authDataList = (ArrayList) ClientUtil.executeQuery("getMdsReceiptEntryAuthStatus", mdsDetailsMap);
...
//                        int transferCount = 0;
    ...
    private com.see.truetransact.uicomponent.CButton btnWaiveAmt;
    ...
    public static void main(String[] arg) {
        ...
        MDSReceiptEntryUI gui = new MDSReceiptEntryUI();
