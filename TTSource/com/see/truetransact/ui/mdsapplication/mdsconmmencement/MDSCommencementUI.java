...
public class MDSCommencementUI extends com.see.truetransact.uicomponent.CInternalFrame implements Observer, UIMandatoryField{
    private final static ClientParseException parseException = ClientParseException.getInstance();
    
    java.util.ResourceBundle resourceBundle = java.util.ResourceBundle.getBundle("com.see.truetransact.ui.mdsapplication.mdsconmmencement.MDSCommencementRB", ProxyParameters.LANGUAGE);
    final MDSCommencementMRB objMandatoryMRB = new MDSCommencementMRB();
    TransactionUI transactionUI = new TransactionUI();
    private HashMap mandatoryMap;
    private MDSCommencementOB observable;
    ...
    private void setObservable() {
        observable = MDSCommencementOB.getInstance();
   ...
   object. Help display Label name should be lblMsg. */
    public void setHelpMessage() {
        MDSCommencementMRB objMandatoryRB = new MDSCommencementMRB();
...
/* Auto Generated Method - getMandatoryHashMap()
   Getter method for setMandatoryHashMap().*/
    ...
    public void update(Observable observed, Object arg) {
        ...
        txtTotAmt.setText(CommonUtil.convertObjToStr(observable.getTxtTotAmt())); //AJITH
    ...
    public void updateOBFields() {
        ...
        observable.setTxtTotAmt(CommonUtil.convertObjToDouble(txtTotAmt.getText())); //AJITH
    ...
    private void initComponents() {
        ...
        lblStartDt.setText("MDS Start Date");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 1;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.EAST;
...
//                java.util.Date currDt = currDt.clone();
                ...
                if(observable.getActionType() == ClientConstants.ACTIONTYPE_NEW){
                    ...
                    whereMap.put("INSTALLMENT_AMOUNT",CommonUtil.convertObjToDouble(txtInstAmtClosure.getText()));
    ...
    public void authorize(HashMap map){
        ...
        try{
            ...
            if (fromAuthorizeUI) {
                ...
                this.dispose();
                authorizeListUI.setFocusToTable();
                authorizeListUI.displayDetails("MDS Commencement");
            }
            if (fromNewAuthorizeUI) {
                newauthorizeListUI.removeSelectedRow();
                this.dispose();
                newauthorizeListUI.setFocusToTable();
                newauthorizeListUI.displayDetails("MDS Commencement");
            }
        } catch(Exception e) {
            e.printStackTrace();
        }
    ...
    public void authorizeStatus(String authorizeStatus) {
        ...
        if (viewType.equals(AUTHORIZE) && isFilled) {
            ...
            whereMap = null;
            mapParam.put(CommonConstants.MAP_NAME, "getSelectCommencementList");
...
// TODO add your handling code here:
    ...
    private void callView(String currField) {
        ...
        if(PAN == COMMENCEMENT){
            if (currField.equals("Edit")|| currField.equals("Enquirystatus") || currField.equals("Delete")){
                ...
                viewMap.put(CommonConstants.MAP_NAME, "getSelectEachSchemeDetailsForCommence");
            }
        }else if(PAN == CLOSURE){
            ...
            if(PAN == COMMENCEMENT){
                if (viewType.equals("Edit") || viewType.equals(AUTHORIZE) ||  viewType.equals("Enquirystatus") || viewType.equals("Delete") ) {
                    ...
                    if(viewType ==  AUTHORIZE) {
                        ...
                        observable.setDiscountFirstInstScheme(CommonUtil.convertObjToStr(hash.get("DISCOUNT_FIRST_INSTALLMENT"))); // Added by nithya on 23-12-2020 for KD-2521
                        observable.setDiscountAmount(CommonUtil.convertObjToDouble(hash.get("FIRST_DISCOUNT_AMT")));
                    }
                    ...
                    if(flag){
                        ...
                        transactionUI.setCallingAmount(CommonUtil.convertObjToStr(observable.getTxtTotAmt())); //AJITH
                    }
                }
    ...
    public static void main(String[] arg){
        ...
        MDSCommencementUI gui = new MDSCommencementUI();
