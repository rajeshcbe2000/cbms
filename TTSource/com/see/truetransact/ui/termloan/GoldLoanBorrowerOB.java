...
public class GoldLoanBorrowerOB extends CObservable{
    
    /**
     * Creates a new instance of TermLoanBorrowerOB
     * @throws Exception exception
     */
    public GoldLoanBorrowerOB() throws Exception{
        termLoanBorrowerOB();
    }
    ...
    private       static GoldLoanBorrowerOB termLoanBorrowerOB;
    private       static AuthorizedSignatoryOB termLoanAuthorizedSignatoryOB;
    private       static PowerOfAttorneyOB termLoanPoAOB;
    
    private final static Logger log = Logger.getLogger(GoldLoanBorrowerOB.class);
...
//    private final   TermLoanRB objTermLoanRB = new TermLoanRB();
    ...
    private int loanActionType;
        private String txtCustomerPhoneNumber = "";
    private boolean  phoneNumberContainedorNot =false;
...
//    }
     ...
     */
//    public static GoldLoanBorrowerOB getInstance() {
...
//    }
    ...
    public void resetBorrowerDetails(){
        ...
        setLblBorrowerNo_2("");
//        setCboConstitution("");
        getCbmConstitution().setKeyForSelected("");
        setCboCategory("");
        setTxtReferences("");
        setLblCustNameValue("");
    }
...
//        getCbmConstitution().setKeyForSelected(getCbmConstitution().getDataForKey(objTermLoanBorrowerTO.getConstitution()));
...
//        strCust = null;
    ...
    public void setTermLoanJointAcctTO(ArrayList jntAcctList){
        ...
        for (int i = 0;i < jntAcctList.size();++i){
            ...
            if(termLoanJointAcctTO.getCustId().length()>0){
...
//            }
    ...
    public TermLoanBorrowerTO setTermLoanBorrower(String renewalNo,boolean isRenewal) {
        final TermLoanBorrowerTO objTermLoanBorrowerTO = new TermLoanBorrowerTO();
        try{
            objTermLoanBorrowerTO.setCustId(txtCustID);
            if(isRenewal || renewalNo.length()>0)
                objTermLoanBorrowerTO.setBorrowNo(renewalNo);
            else
    ...
    public boolean isPhoneNumberContainedorNot() {
        return phoneNumberContainedorNot;
    }
    public void setPhoneNumberContainedorNot(boolean phoneNumberContainedorNot) {
        this.phoneNumberContainedorNot = phoneNumberContainedorNot;
    }
    public String getTxtCustomerPhoneNumber() {
        return txtCustomerPhoneNumber;
    }
    public void setTxtCustomerPhoneNumber(String txtCustomerPhoneNumber) {
    ...
    public boolean populateBorrowerTabCustomerDetails(HashMap queryWhereMap, boolean jntAcctNewClicked, String loanType){
        ...
        boolean display = false;
        try {
            if(queryWhereMap.get("CUSTOMER ID")!=null){
                setTxtCustID(CommonUtil.convertObjToStr(queryWhereMap.get("CUSTOMER ID")));
            }else{
                queryWhereMap.put("CUSTOMER ID",getTxtCustID());
            }
            ...
            if(custListData !=null && custListData.size()>0) {
                ...
                setLblCustNameValue(CommonUtil.convertObjToStr(custMapData.get("Name")));
                setTxtCustomerPhoneNumber(CommonUtil.convertObjToStr(custMapData.get("PHONE_NUMBER")));
                ...
                if( loanType.equals("OTHERS") || loanType.equals("LTD") || btnPressed){
                    ...
                    if(getLoanActionType() == ClientConstants.ACTIONTYPE_NEW){
                        setCboConstitution(CommonUtil.convertObjToStr(custMapData.get("CUST_TYPE")));
//                        getCbmConstitution().setKeyForSelected(getCbmConstitution().getDataForKey(custMapData.get("CUST_TYPE")));
//                        setCboCategory(CommonUtil.convertObjToStr(getCbmCategory().getDataForKey(custMapData.get("CUST_CATEGORY"))));
                        setCboCategory("GENERAL_CATEGORY");
                    }
...
//        }
    ...
    /**
     * Getter for property loanActionType.
     * @return Value of property loanActionType.
     */
    public int getLoanActionType() {
        return loanActionType;
    }
    
    /**
     * Setter for property loanActionType.
     * @param loanActionType New value of property loanActionType.
     */
    public void setLoanActionType(int loanActionType) {
        this.loanActionType = loanActionType;
    }
