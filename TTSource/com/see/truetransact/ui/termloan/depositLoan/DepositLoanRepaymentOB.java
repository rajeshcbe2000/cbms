...
public class DepositLoanRepaymentOB extends CObservable{
    
    /** Creates a new instance of DepositLoanRepaymentOB */
   public DepositLoanRepaymentOB()  throws Exception{
        curDate = ClientUtil.getCurrentDate();
        termLoanRepaymentOB();
    }
    
    private       static DepositLoanRepaymentOB termLoanRepaymentOB;
    
    private final static Logger log = Logger.getLogger(DepositLoanRepaymentOB.class);
...
//            }
     ...
     public int addRepaymentDetails(boolean update){
         System.out.println("rishhhhhhhhhhhhhhu123");
        int option = -1;
        try{
...
//                }
    ...
    private void insertRepayment(int recordPosition){
        ...
        repaymentEachRecord.put(REPAY_TYPE,"UNIFORM_PRINCIPLE_EMI");
        repaymentEachRecord.put(REPAY_FREQ, "30");
