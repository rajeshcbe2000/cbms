...
public class GroupLoanPaymentUI extends com.see.truetransact.uicomponent.CInternalFrame implements Observer, UIMandatoryField{
...
//    final MDSApplicationMRB objMandatoryMRB = new MDSApplicationMRB();
    ...
    GroupLoanPaymentOB observable = null;
    ...
    private void settingupUI(){
        setFieldNames();
        observable = new GroupLoanPaymentOB();
        //initComponentData();
        setMaximumLength();
   ...
   Other functions are working based on this name. */
    ...
    public void update(Observable observed, Object arg) {
        System.out.println("observable.getPurchaseDt()&$^$$^^$^"+observable.getPurchaseDt());
        tdtPurDt.setDateValue(DateUtil.getStringDate(observable.getPurchaseDt())); 
    }
    ...
    public void updateOBFields() {
       observable.setPurchaseDt(DateUtil.getDateMMDDYYYY(tdtPurDt.getDateValue())); 
    }
    ...
    private void initComponents() {
        ...
        tdtPurDt = new com.see.truetransact.uicomponent.CDateField();
        ...
        tblSHGDetails.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Credit Card No", "Customer Id", "Customer Name", "Limit", "Avail Balance", "Total Due", "Payment Amt", "Particulars"
            }
        ));
        tblSHGDetails.setMinimumSize(new java.awt.Dimension(150, 0));
        ...
        tdtPurDt.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseReleased(java.awt.event.MouseEvent evt) {
                tdtPurDtMouseReleased(evt);
            }
        });
        tdtPurDt.addPropertyChangeListener(new java.beans.PropertyChangeListener() {
            public void propertyChange(java.beans.PropertyChangeEvent evt) {
                tdtPurDtPropertyChange(evt);
            }
        });
        tdtPurDt.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                tdtPurDtKeyPressed(evt);
            }
        });
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 24;
        gridBagConstraints.gridy = 0;
        panGroupIdDetail.add(tdtPurDt, gridBagConstraints);

        lblPurchaseDt.setText("Purchase Date");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 23;
        gridBagConstraints.gridy = 0;
        panGroupIdDetail.add(lblPurchaseDt, gridBagConstraints);
        ...
        txtNarration.setMinimumSize(new java.awt.Dimension(300, 21));
        txtNarration.setPreferredSize(new java.awt.Dimension(300, 21));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 4;
        gridBagConstraints.gridy = 0;
        gridBagConstraints.insets = new java.awt.Insets(0, 7, 0, 2);
        panTotalPayment.add(txtNarration, gridBagConstraints);
        ...
        tabSHGTransaction.addTab("Group Loan Payment", panSHGTransDetails);
...
//            selectedRow = row;
     ...
     private void updateAuthorizeStatus(String authorizeStatus) {
        if (viewType == AUTHORIZE && isFilled){
            ...
            if (TrueTransactMain.CASHIER_AUTH_ALLOWED != null && TrueTransactMain.CASHIER_AUTH_ALLOWED.equals("Y")) {
                mapParam.put(CommonConstants.MAP_NAME, "getGroupLoanPaymentForAuthCashUI");
            } else {
                mapParam.put(CommonConstants.MAP_NAME, "getGroupLoanPaymentForAuthUI");
            }
            isFilled = false;
    ...
    private void btnNewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNewActionPerformed
        ...
        tdtPurDt.setEnabled(true);
        tdtPurDt.setDateValue(DateUtil.getStringDate(currDt));
...
//        btnView.setEnabled(false);       
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        // Add your handling code here:
      if(DateUtil.dateDiff(DateUtil.getDateMMDDYYYY(tdtPurDt.getDateValue()), currDt) >= 0){
        if(observable.getActionType() == ClientConstants.ACTIONTYPE_NEW || observable.getActionType() == ClientConstants.ACTIONTYPE_EDIT){
           ...
           ClientUtil.showAlertWindow("Future Date can't be Purachase Date...!!") ;
           return;
        }
            ...
            for(int i=0; i<finalList.size(); i++){
                ...
                for(int j=0; j<tblSHGDetails.getRowCount();j++) {
                    if (CommonUtil.convertObjToStr(tblSHGDetails.getValueAt(j, 1)).equals(custNo)) {
                        custMap.put("PAYMENT",tblSHGDetails.getValueAt(j, 6));
                        custMap.put("NARRATION",tblSHGDetails.getValueAt(j, 7));
                    }
...
private void txtAcctNumFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtAcctNumFocusLost
        ...
        if(txtAcctNum.getText().length()>0){
            HashMap whereMap = new HashMap();
            whereMap.put("ACCT_NUM",txtAcctNum.getText());
            whereMap.put("BRANCH_CODE", getSelectedBranchID());
            List lst=ClientUtil.executeQuery("getGroupLoanDetails",whereMap);
...
private void tdtPurDtMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tdtPurDtMouseReleased
// TODO add your handling code here:    
}//GEN-LAST:event_tdtPurDtMouseReleased

private void tdtPurDtPropertyChange(java.beans.PropertyChangeEvent evt) {//GEN-FIRST:event_tdtPurDtPropertyChange
// TODO add your handling code here:
    System.out.println("tdtTransDtPropertyChangetdtTransDtPropertyChange");
    
}//GEN-LAST:event_tdtPurDtPropertyChange

private void tdtPurDtKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tdtPurDtKeyPressed
// TODO add your handling code here:
}//GEN-LAST:event_tdtPurDtKeyPressed
     ...
     */
        ...
        try{
            ...
            if(viewType == "GROUP_ID"){
                ...
                List checkList = ClientUtil.executeQuery("getGroupLoanTransAuthorizeCheck", checkMap);
            ...
            observable.getActionType() == ClientConstants.ACTIONTYPE_REJECT){
                this.setButtonEnableDisable();
                txtAcctNum.setText(CommonUtil.convertObjToStr(hashMap.get("ACT_NUM")));
                lblName.setText(CommonUtil.convertObjToStr(hashMap.get("CUST_NAME")));
                observable.setTxtAcctNum(txtAcctNum.getText());
                hashMap.put("TRANS_DT",DateUtil.getDateMMDDYYYY(CommonUtil.convertObjToStr(hashMap.get("TRANS_DT"))));                
    ...
    private Object[][] setTableData() {
        ...
        whereMap.put("BRANCH_CODE",getSelectedBranchID());
        whereMap.put("ACT_NUM",CommonUtil.convertObjToStr(txtAcctNum.getText()));   
        whereMap.put("TRANS_DT",currDt);
        ...
        if (loanList != null && loanList.size() > 0) {
            ...
            for (int j = 0; j < loanList.size(); j++) {
                ...
                totalList[j][3] = CommonUtil.convertObjToStr(CommonUtil.convertObjToDouble(dataMap.get("LIMIT")));
                totalList[j][4] = CommonUtil.convertObjToStr(CommonUtil.convertObjToDouble(dataMap.get("AVIL_BAL")));
                totalList[j][5] = CommonUtil.convertObjToStr(CommonUtil.convertObjToDouble(dataMap.get("TOTAL_DUE")));
                totalList[j][6] = CommonUtil.convertObjToStr(String.valueOf(0));
                totalList[j][7] = CommonUtil.convertObjToStr(String.valueOf(""));
            }
    ...
    private Object[][] setTableAuthData(HashMap editMap1) {
        ...
        whereMap.put("BRANCH_CODE",getSelectedBranchID());
        whereMap.put("ACT_NUM",CommonUtil.convertObjToStr(txtAcctNum.getText()));   
        whereMap.put("TRANS_DT",editMap1.get("TRANS_DT"));
        whereMap.put("TRANS_ID",CommonUtil.convertObjToStr(editMap1.get("TRANS_ID")));
        ...
        if (editList != null && editList.size() > 0) {
            ...
            for (int j = 0; j < editList.size(); j++) {
                ...
                totalList[j][2] = CommonUtil.convertObjToStr(dataMap.get("CUSTOMER"));
                totalList[j][3] = CommonUtil.convertObjToStr(CommonUtil.convertObjToDouble(dataMap.get("LIMIT")));
                totalList[j][4] = CommonUtil.convertObjToStr(CommonUtil.convertObjToDouble(dataMap.get("AVAIL_BAL")));
                totalList[j][5] = CommonUtil.convertObjToStr(CommonUtil.convertObjToDouble(dataMap.get("TOTAL_DUE")));
                totalList[j][6] = CommonUtil.convertObjToStr(CommonUtil.convertObjToDouble(dataMap.get("PAYMENT")));
                totalList[j][7] = CommonUtil.convertObjToStr(dataMap.get("NARRATION"));
            }
            ...
            public void tableChanged(TableModelEvent e) {
                if (e.getType() == TableModelEvent.UPDATE) {
                    ...
                    if (column == 6) {
                            ...
                            double payment =  CommonUtil.convertObjToDouble(tblSHGDetails.getValueAt(row, 6)) .doubleValue();
                            double availBal =  CommonUtil.convertObjToDouble(tblSHGDetails.getValueAt(row, 4)) .doubleValue();
                            double totDue =  CommonUtil.convertObjToDouble(tblSHGDetails.getValueAt(row, 5)) .doubleValue();
                            System.out.println("negativeeee@@@@@@@@@@@@@@"+isNegative(payment));
                            System.out.println("value#######"+tblSHGDetails.getValueAt(row, column));
                            if(tblSHGDetails.getValueAt(row, 6)!=null && !tblSHGDetails.getValueAt(row, 6).toString().equals("") && observable.duePayYN(txtAcctNum.getText(),CommonUtil.convertObjToStr(tblSHGDetails.getValueAt(row, 1).toString()))){
                                ClientUtil.showMessageWindow("Payment not allowed if due...");
                                tblSHGDetails.setValueAt("", row, 6);
                                calc();
                                return;
                            ...
                            if(payment > 0){
                                 if(availBal < payment ){
                                    ClientUtil.showMessageWindow("Paymnet Amount Cannot exceeds the available balance..." );
                                    tblSHGDetails.setValueAt("", row, 6);
                                    calc();
                                    return;
                                }
                       ...
                       for (int i = 0; i < tblSHGDetails.getRowCount(); i++) {
                           recTotal =  recTotal + CommonUtil.convertObjToDouble(tblSHGDetails.getValueAt(i, 6)).doubleValue();
                       }
    ...
    private com.see.truetransact.uicomponent.CDateField tdtPurDt;
    ...
    public static void main(String[] arg){
        ...
        GroupLoanPaymentUI gui = new GroupLoanPaymentUI();
