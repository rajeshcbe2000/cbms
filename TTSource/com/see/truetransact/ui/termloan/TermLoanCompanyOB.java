...
public class TermLoanCompanyOB extends CObservable{
    
    /** Creates a new instance of TermLoanCompanyOB */
    private TermLoanCompanyOB() throws Exception{
    ...
    private final static Logger log = Logger.getLogger(TermLoanCompanyOB.class);
...
//    private final   TermLoanRB objTermLoanRB = new TermLoanRB();
    ...
    public static TermLoanCompanyOB getInstance() {
    ...
    public void setTermLoanCompanyTO(TermLoanCompanyTO objTermLoanCompanyTO) {
        try{
...
//            e.printStackTrace();
    ...
    public TermLoanCompanyTO setTermLoanCompany() {
...
//            Date EstDt = getProperDateFormat(tdtDateEstablishment);
//            if(EstDt != null){
...
//            }else{
                objTermLoanCompanyTO.setEstablishDt(getProperDateFormat(tdtDateEstablishment));
//            }
...
//            }else{
                objTermLoanCompanyTO.setDealBankSince(getProperDateFormat(tdtDealingWithBankSince));
//            }
...
//            }else{
              objTermLoanCompanyTO.setNetWorthOn(getProperDateFormat(tdtAsOn)); 
//            }
//            objTermLoanCompanyTO.setNetWorthOn(DateUtil.getDateMMDDYYYY(tdtAsOn));
...
//            }else{
                objTermLoanCompanyTO.setCrFacilitiesSince(getProperDateFormat(tdtCreditFacilityAvailSince));
//            }
    ...
    public java.util.HashMap getNetworthDetails(){
        ...
        try{
            if (!(CommonUtil.convertObjToStr(CommonUtil.convertObjToDouble(getTxtNetWorth())).equals(getNetWorthInCust()))){
                TermLoanBorrowerOB termLoanBorrowerOB = TermLoanBorrowerOB.getInstance();
...
//                }else{
                    netWorthDetailsMap.put("NETWORTH_AS_ON", getProperDateFormat(getTdtAsOn()));
//                }
