 ...
 * @author bala
 */
public class GoldStockReleaselOB extends CObservable {
...
//                selectedList.add(_tableModel.getValueAt(i, 1));
    ...
    public ArrayList populateClosedLoanData(HashMap mapID, CTable tblData) {
        ...
        if (whereMap.containsKey("LOAN_LIST")) {
            chargeList = (List) whereMap.get("LOAN_LIST");
        }
...
*/
            newList.add(CommonUtil.convertObjToStr(map.get("Acct No")));
            newList.add(CommonUtil.convertObjToStr(map.get("Customer ID")));
            newList.add(CommonUtil.convertObjToStr(map.get("Name")));
            newList.add(CommonUtil.convertObjToStr(map.get("Open Dt")));
            newList.add(CommonUtil.convertObjToStr(map.get("Close Dt")));
