        ...
        try{
            ...
            if (!(termLoanOB.getCbmIntGetFrom().getKeyForSelected().equals("PROD") || termLoanOB.getCbmIntGetFrom().getKeyForSelected().equals(""))){
                ...
                for (int i = keySet.size() - 1,j = 0;i >= 0;--i,++j){
                    ...
                    objTermLoanInterestTO.setRetCreateDt((Date)oneRecord.get("RET_CREATE_DT"));
...
//            }
    ...
    public  boolean setNextValue(){
        ...
        if(nextSlabList!=null && nextSlabList.size()>0){
            ...
            setTxtFromAmt(String.valueOf(1));
             setTxtToAmt(String.valueOf(999999999));
             setTxtAgainstClearingInter(String.valueOf(0));
             setTxtInterExpLimit(String.valueOf(0));
             setTxtPenalStatement(String.valueOf(0));
             dataEnable=true;
        }
        return dataEnable;
    }
    ...
    public boolean slabBasedEnableDisable(boolean actionTypeDelete){
        ...
        Date fromDt=getProperDateFormat(DateUtil.getDateMMDDYYYY(tdtFrom));
