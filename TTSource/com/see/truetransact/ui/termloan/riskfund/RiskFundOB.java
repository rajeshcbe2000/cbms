 ...
 * @author bala
 */
public class RiskFundOB extends CObservable {
...
//    private ComboBoxModel cbmNoticeType;
    ...
    public RiskFundOB() {
        try {
            ...
            //setOperationMap();
           map = new HashMap();
            map.put(CommonConstants.JNDI, "RiskFundJNDI");
            map.put(CommonConstants.HOME, "RiskFundHome");
            map.put(CommonConstants.REMOTE, "RiskFund");
            //setTableTitle();
            fillDropDown();
            fillBranch();
    ...
    public void fillDropDown() throws Exception{
        ...
        lookup_keys.add("TERMLOAN.RISK_CHARGE_TYPE");
        lookUpHash.put(CommonConstants.PARAMFORQUERY, lookup_keys);
        keyValue = ClientUtil.populateLookupData(lookUpHash);       
        getKeyValue((HashMap) keyValue.get("TERMLOAN.RISK_CHARGE_TYPE"));
...
//        setRiskFundTot(riskFindTot);
    ...
    public void executeOB(ArrayList riskFund) throws Exception{
        ...
        mapRiskFund.put("RISK_FUND_DR_DET",riskFund);
        ...
        if(getChkNoTrans().equals("Y")){
            mapRiskFund.put("NO_TRANSACTION", "Y");
        }
