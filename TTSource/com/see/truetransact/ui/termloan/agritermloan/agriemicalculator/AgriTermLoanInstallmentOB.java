...
public class AgriTermLoanInstallmentOB extends CObservable{
    private       static AgriTermLoanInstallmentOB termLoanInstallmentOB;
    private final        AgriTermLoanInstallmentRB objTermLoanInstallmentRB = new AgriTermLoanInstallmentRB();
    private final static Logger log = Logger.getLogger(AgriTermLoanInstallmentOB.class);
    ...
    public AgriTermLoanInstallmentOB(){
    ...
    public HashMap calculateInterest(HashMap data){
        ...
        try{
            ...
            if (data.containsKey(FROM_DT)){
                ...
                repayMap.put(FROM_DT, DateUtil.getStringDate(ClientUtil.getCurrentDate()));
            }
            if (data.containsKey(TO_DT)){
