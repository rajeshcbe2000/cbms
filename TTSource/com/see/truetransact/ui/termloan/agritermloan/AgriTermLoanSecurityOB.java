...
import com.see.truetransact.transferobject.termloan.agritermloan.AgriTermLoanSecurityTO;
...
public class AgriTermLoanSecurityOB extends CObservable{
    
    /** Creates a new instance of TermLoanSecurityOB */
    private AgriTermLoanSecurityOB() throws Exception{
    ...
    private final static Logger log = Logger.getLogger(AgriTermLoanSecurityOB.class);
...
//    private final   TermLoanRB objTermLoanRB = new TermLoanRB();
    ...
    static {
        try {
            termLoanSecurityOB = new AgriTermLoanSecurityOB();
        } catch(Exception e) {
            log.info("try: " + e);
    ...
    public static AgriTermLoanSecurityOB getInstance() {
    ...
    public void setTermLoanSecurityTO(ArrayList objSecurityTOList, String act_Num, String strFaciType){
        try{
            ...
            if(objSecurityTOList!=null && (!objSecurityTOList.isEmpty()))
            for (int i = objSecurityTOList.size() - 1,j = 0;i >= 0;--i,++j){
                objTermLoanSecurityTO = (AgriTermLoanSecurityTO) objSecurityTOList.get(j);
    ...
    private void setMax_Del_Security_No(String act_Num){
        try{
            ...
            List resultList = ClientUtil.executeQuery("getSelectAgriTermLoanSecurityMaxSLNO", transactionMap);
    ...
    public HashMap setTermLoanSecurity(){
        ...
        try{
            ...
            for (int i = keySet.size() - 1,j = 0;i >= 0;--i,++j){
                oneRecord = (HashMap) securityAll.get(objKeySet[j]);
                objTermLoanSecurityTO = new AgriTermLoanSecurityTO();
...
//                objTermLoanSecurityTO.setToDt((Date)oneRecord.get(TO_DATE));
    ...
    public int addSecurityDetails(int recordPosition, boolean update){
        ...
        try{
            ...
            termLoanOB = AgriTermLoanOB.getInstance();
