...
public class AgriTermLoanBorrowerOB extends CObservable{
    
    /**
     * Creates a new instance of TermLoanBorrowerOB
     * @throws Exception exception
     */
    private AgriTermLoanBorrowerOB() throws Exception{
        termLoanBorrowerOB();
    }
    ...
    private final static Logger log = Logger.getLogger(AgriTermLoanBorrowerOB.class);
...
//    private final   TermLoanRB objTermLoanRB = new TermLoanRB();
    ...
    static {
        try {
            termLoanBorrowerOB = new AgriTermLoanBorrowerOB();
        } catch(Exception e) {
            log.info("try: " + e);
    ...
    public void setAuthSignAndPoAOB(AuthorizedSignatoryOB authSignOB, PowerOfAttorneyOB poaOB,AgriSubLimitOB agriSubLimitOB,
                                    AgriSubSidyOB subsidyOB, AgriInspectionOB agriInspection){
        try{
            termLoanAuthorizedSignatoryOB = authSignOB;
            termLoanPoAOB = poaOB;
            agriSubLimitOB=agriSubLimitOB;
            agriSubSidyOB=subsidyOB;
            agriInspectionOB=agriInspection;
        }catch(Exception e){
     ...
     */
    public static AgriTermLoanBorrowerOB getInstance() {
    ...
    public void setTermLoanBorrowerTO(AgriTermLoanBorrowerTO objTermLoanBorrowerTO) {
    ...
    public AgriTermLoanBorrowerTO setTermLoanBorrower() {
        final AgriTermLoanBorrowerTO objTermLoanBorrowerTO = new AgriTermLoanBorrowerTO();
        try{
    ...
    public void populateBorrowerTabCustFields(HashMap hash, String custType){
        try{
            ...
            if (custDetailsList.size() > 0){
                ...
                AgriTermLoanCompanyOB termLoanCompanyOB = AgriTermLoanCompanyOB.getInstance();
