 ...
 * 
 * AgriTermLoanDocumentDetailsOB.java
 *
 ...
 * @author  152713
 */
public class AgriTermLoanDocumentDetailsOB extends CObservable {
    
    /** Creates a new instance of TermLoanDocumentDetailsOB */
    public AgriTermLoanDocumentDetailsOB() {
    ...
    private final static Logger log = Logger.getLogger(AgriTermLoanDocumentDetailsOB.class);
...
//    private final   TermLoanRB objTermLoanRB = new TermLoanRB();
    ...
    static {
        try {
            termLoanDocumentDetailsOB = new AgriTermLoanDocumentDetailsOB();
        } catch(Exception e) {
            log.info("try: " + e);
     ...
     */
    public static AgriTermLoanDocumentDetailsOB getInstance() {
