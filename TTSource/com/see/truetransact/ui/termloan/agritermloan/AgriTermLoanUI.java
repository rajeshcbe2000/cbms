...
import com.see.truetransact.ui.termloan.agritermloan.agriemicalculator.AgriTermLoanInstallmentUI;
import com.see.truetransact.ui.termloan.agritermloan.agrinewdetails.AgriSubLimitUI;
import com.see.truetransact.ui.termloan.agritermloan.agrisubsidydetails.AgriSubSidyUI;
import com.see.truetransact.ui.termloan.agritermloan.agriinspectiondetails.AgriInspectionUI;
...
public class AgriTermLoanUI extends CInternalFrame  implements java.util.Observer {
    java.util.ResourceBundle resourceBundle = java.util.ResourceBundle.getBundle("com.see.truetransact.ui.termloan.agritermloan.AgriTermLoanRB", ProxyParameters.LANGUAGE);
    //    TermLoanRB resourceBundle = new TermLoanRB();
    AgriTermLoanOB observable;
    AgriTermLoanBorrowerOB observableBorrow;
    AgriTermLoanCompanyOB observableComp;
    AgriTermLoanSecurityOB observableSecurity;
    AgriTermLoanRepaymentOB observableRepay;
    AgriTermLoanGuarantorOB observableGuarantor;
    AgriTermLoanDocumentDetailsOB observableDocument;
    AgriTermLoanInterestOB observableInt;
    AgriTermLoanClassificationOB observableClassi;
    AgriTermLoanOtherDetailsOB observableOtherDetails;
    //    TermLoanPeakSanctionOB observablePeakSanctionDetails;
    AuthorizedSignatoryUI authSignUI = null;
    PowerOfAttorneyUI poaUI = null;
    AgriSubLimitUI subLimitUI=null;
    AgriSubSidyUI  agriSubSidyUI=null;
    AgriInspectionUI agriInspectionUI=null;
    private Date date;
    ...
    private int selectInsuranceRow=-1;
    private boolean isInsuranceUpdate=false;
    int result;
    int modeAuthorize = -1;
    int modePoA       = -1;
    ...
    int rowsan=-1;
    int rowsanDetail=-1;
    private final static Logger log = Logger.getLogger(AgriTermLoanUI.class);
    ...
    public AgriTermLoanUI() {
        termLoanUI();
    }
    
    public AgriTermLoanUI(String loanType) {
    ...
    private void termLoanUI(){
        initComponents();
        setFieldNames();
        AgriTermLoanExtendedCodeUI atl = new AgriTermLoanExtendedCodeUI();
        atl.internationalize(this, resourceBundle);
        internationalize();
        setMaxLength();
        setObservable();
        ...
        subLimitUI=new AgriSubLimitUI();
        agriSubSidyUI=new AgriSubSidyUI();
        agriInspectionUI=new AgriInspectionUI();
        
        observableBorrow.setAuthSignAndPoAOB(authSignUI.getAuthorizedSignatoryOB(), poaUI.getPowerOfAttorneyOB(),subLimitUI.getAgriSubLimitOB(),agriSubSidyUI.getAgriSubSidyOB(),agriInspectionUI.getagriInspectionOB());
        
        observable.setExtendedOB(authSignUI.getAuthorizedSignatoryOB(), authSignUI.getAuthorizedSignatoryInstructionOB(),
        poaUI.getPowerOfAttorneyOB(),subLimitUI.getAgriSubLimitOB(),agriSubSidyUI.getAgriSubSidyOB(),agriInspectionUI.getagriInspectionOB());
        ClientUtil.enableDisable(this, false);
        lblSelectScreen.setVisible(false);
        cboSelectScreen.setVisible(false);
        allEnableDisable();
        initComponentData();
        ...
        atl.setMandatoryHashMap();
        mandatoryMap = atl.getMandatoryHashMap();
        setHelpMessage();
        ...
        //        tabLimitAmount.add(subLimitUI, "SubLimit/Inspection", 5);
        ...
        tabLimitAmount.remove(panInsuranceDetails);
        ...
        new MandatoryCheck().putMandatoryMarks(getClass().getName(), panTableFields);
        new MandatoryCheck().putMandatoryMarks(getClass().getName(), panFacilityProdID);
        new MandatoryCheck().putMandatoryMarks(getClass().getName(),panInsuranceDetailsFields);
    ...
    private void setObservable(){
        observable = AgriTermLoanOB.getInstance();
        observable.addObserver(this);
        observable.setLoanType(loanType);
        observableBorrow = AgriTermLoanBorrowerOB.getInstance();
        observableBorrow.addObserver(this);
        observableComp = AgriTermLoanCompanyOB.getInstance();
        observableComp.addObserver(this);
        observableSecurity = AgriTermLoanSecurityOB.getInstance();
        observableSecurity.addObserver(this);
        observableRepay = AgriTermLoanRepaymentOB.getInstance();
        observableRepay.addObserver(this);
        observableInt = AgriTermLoanInterestOB.getInstance();
        observableInt.addObserver(this);
        //        if (loanType.equals("OTHERS")) {
        observableGuarantor = AgriTermLoanGuarantorOB.getInstance();
        observableGuarantor.addObserver(this);
        observableOtherDetails = AgriTermLoanOtherDetailsOB.getInstance();
        observableOtherDetails.addObserver(this);
        //        }
        observableDocument = AgriTermLoanDocumentDetailsOB.getInstance();
        observableDocument.addObserver(this);
        observableClassi = AgriTermLoanClassificationOB.getInstance();
        observableClassi.addObserver(this);
        //            observablePeakSanctionDetails=TermLoanPeakSanctionOB.getInstance();
        //            observablePeakSanctionDetails.addObserver(this);
    }
    
    public void setHelpMessage() {
        final AgriTermLoanMRB objMandatoryRB = new AgriTermLoanMRB();
        ...
        //        txtAreaRemarks.setHelpMessage(lblMsg, objMandatoryRB.getString("txtRemarks"));
    ...
    private void setFieldNames() {
        ...
        lblAccountOpenDate.setName("lblAccountOpenDate");
        cboCardType.setName("cboCardType");
        ...
        //        lblPeakSanctionFromDt.setName("lblPeakSanctionFromDt");
        //        lblPeakSanctionToDate.setName("lblPeakSanctionToDate");
        //        lblPeakSanctionAmt.setName("lblPeakSanctionAmt");
        //        tdtPeakSanctionFromDate.setName("tdtPeakSanctionFromDate");
        //        tdtPeakSanctionToDate.setName("tdtPeakSanctionToDate");
        //        txtPeakSanctionAmt.setName("txtPeakSanctionAmt");
        //        btnNew_PSD.setName("btnNew_PSD");
        //        btnSave_PSD.setName("btnSave_PSD");
        //        btnDelete_PSD.setName("btnDelete_PSD");
        //        panPeakSanctionDetails_Sanction1.setName("panPeakSanctionDetails_Sanction1");
        //        panTable_PSD1.setName("panTable_PSD1");
        //        srpTable_PSD.setName("srpTable_PSD");
        ...
        chkPOFAttorney.setName("chkPOFAttorney");
        chkAuthorizedSignatory.setName("chkAuthorizedSignatory");
        chkDocDetails.setName("chkDocDetails");
        ...
        //insuranceDetails
        lblInsDetails.setName("lblInsDetails");
        cboInsDetails.setName("cboInsDetails");
        cboInsUnderScheme.setName("cboInsUnderScheme");
        lblInsComName.setName("lblInsComName");
        txtInsComName.setName("txtInsComName");
        txtAddress.setName("txtAddress");
        txtPhoneNo.setName("txtPhoneNo");
        lblPolicyNo.setName("lblPolicyNo");
        txtPolicyNo.setName("txtPolicyNo");
        lblInsIssueDt.setName("lblInsIssueDt");
        tdtInsIssueDt.setName("tdtInsIssueDt");
        lblInsFrom.setName("lblInsFrom");
        tdtInsExpiryDt.setName("tdtInsExpiryDt");
        lblInsExpiryDt.setName("lblInsExpiryDt");
        ...
        lblNatureOfRiskCoverd.setName("lblNatureOfRiskCover");
        cboNatureOfRiskCoverd.setName("cboNatureOfRiskCoverd");
        lblDebitProdType.setName("lblDebitProdType");
        cboDebitProdType.setName("cboDebitProdType");
        lblDebitProdId.setName("lblDebitProdId");
        cboDebitProdId.setName("cboDebitProdId");
        lblFromActNo.setName("lblFromActNo");
        txtFromActNo.setName("txtFromActNo");
        lblFromActNo1.setName("lblFromActNo1");
        txtFromActNo1.setName("txtFromActNo1");
        tdtInsFrom.setName("tdtInsFrom");
        panInsuranceDetailsFields.setName("panInsuranceDetailsFields");
        panInsuranceDetailsTable.setName("panInsuranceDetailsTable");
        panInsuranceDetails.setName("panInsuranceDetails");
        panCardPeriod.setName("panCardPeriod");
        lblReviewDate.setName("lblReviewDate");
        lblCardType.setName("lblCardType");
        lblCardLimit.setName("lblCardLImit");
        lblCardValidity.setName("lblCardValidity");
        tdtReviewDate.setName("tdtReviewDate");
        txtCardLimit.setName("txtCardLimit");
        txtCardPeriod.setName("txtCardPeriod");
        cboCardType.setName("cboCardType");
        cboCardPeriod.setName("cboCardPeriod");
    ...
    private void internationalize() {
        ...
        lblCardType.setText(resourceBundle.getString("lblCardType"));
        ...
        lblCustName.setText(resourceBundle.getString("lblCustName"));
        lblAccountOpenDate.setText(resourceBundle.getString("lblAccountOpenDate"));
        
        //insurance details
        lblInsDetails.setText(resourceBundle.getString("lblInsDetails"));
        lblInsUnderScheme.setText(resourceBundle.getString("lblInsUnderScheme"));
        lblInsComName.setText(resourceBundle.getString("lblInsComName"));
        lblAddress.setText(resourceBundle.getString("lblAddress"));
        lblPhoneNo.setText(resourceBundle.getString("lblPhoneNo"));
        lblPolicyNo.setText(resourceBundle.getString("lblPolicyNo"));
        lblInsIssueDt.setText(resourceBundle.getString("lblInsIssueDt"));
        lblInsFrom.setText(resourceBundle.getString("lblInsFrom"));
        lblInsExpiryDt.setText(resourceBundle.getString("lblInsTo"));
        ...
        lblNatureOfRiskCoverd.setText(resourceBundle.getString("lblNatureOfRiskCoverd"));
        lblDebitProdType.setText(resourceBundle.getString("lblDebitProdType"));
        lblDebitProdId.setText(resourceBundle.getString("lblDebitProdId"));
        lblFromActNo.setText(resourceBundle.getString("lblFromActNo"));
        lblFromActNo1.setText(resourceBundle.getString("lblFromActNo1"));
        
        lblReviewDate.setText(resourceBundle.getString("lblReviewDate"));
        lblCardType.setText(resourceBundle.getString("lblCardType"));
        lblCardLimit.setText(resourceBundle.getString("lblCardLimit"));
        lblCardValidity.setText(resourceBundle.getString("lblCardValidity"));
        
        chkPOFAttorney.setText(resourceBundle.getString("chkPOFAttorney"));
        chkAuthorizedSignatory.setText(resourceBundle.getString("chkAuthorizedSignatory"));
        chkDocDetails.setText(resourceBundle.getString("chkDocDetails"));
        //        //insurance details
        //        lblInsDetails.setText(resourceBundle.getString("chkPOFAttorney"));
        //        lblInsIssueDt.setText(resourceBundle.getString("chkPOFAttorney"));
        //        lblInsFrom.setText(resourceBundle.getString("chkPOFAttorney"));
        //        lblInsuranceAmt.setText(resourceBundle.getString("chkPOFAttorney"));
        //        lblPremiumAmt.setText(resourceBundle.getString("chkPOFAttorney"));
        //        lblNatureOfRiskCoverd.setText(resourceBundle.getString("chkPOFAttorney"));
        //        lblDebitProdType.setText(resourceBundle.getString("chkPOFAttorney"));
        //        lblDebitProdId.setText(resourceBundle.getString("chkPOFAttorney"));
        //        lblFromActNo.setText(resourceBundle.getString("chkPOFAttorney"));
        //        lblFromActNo1.setText(resourceBundle.getString("chkPOFAttorney"));
        //        lblPeakSanctionFromDt.setText(resourceBundle.getString("lblPeakSanctionFromDt"));
        //        lblPeakSanctionToDate.setText(resourceBundle.getString("lblPeakSanctionToDate"));
        //        lblPeakSanctionAmt.setText(resourceBundle.getString("lblPeakSanctionAmt"));
        //        btnNew_PSD.setText(resourceBundle.getString("btnNew_PSD"));
        //        btnSave_PSD.setText(resourceBundle.getString("btnSave_PSD"));
        //        btnDelete_PSD.setText(resourceBundle.getString("btnDelete_PSD"));
    ...
    public void update(Observable observed, Object arg) {
        ...
        if(observableClassi.isRdoDirectFinance()){
            rdoDirectFin.setSelected(true);
            rdoInDirectFin.setSelected(false);
        }
        else{
            rdoInDirectFin.setSelected(true);
            rdoDirectFin.setSelected(false);
        }
        
        if(observableClassi.isRdoPrioritySector()){
            rdoPrioritySec.setSelected(true);
            rdoNonPrioritySec.setSelected(false);
        }
        else{
            rdoNonPrioritySec.setSelected(true);
            rdoPrioritySec.setSelected(false);
        }
        chkInspection.setSelected(observable.isChkInspection());
        ...
        rdoAccLimit_SubmitActionPerformed();
        ...
        txtAreaRemarks.setText(observable.getTxtRemarks());
        ...
        cboSecurityType.setSelectedItem(observableGuarantor.getCboSecurityType());
        observableGuarantor.setCboSecurityType(CommonUtil.convertObjToStr(cboSecurityType.getSelectedItem()));
        ...
        cboCardPeriod.setSelectedItem(observable.getCboCardPeriod());
        txtCardLimit.setText(observable.getTxtCardLimit());
        tdtReviewDate.setDateValue(observable.getTdtReviewDate());
        txtCardPeriod.setText(observable.getTxtCardPeriod());
        
        
        //insurance Details
        ((ComboBoxModel)cboInsDetails.getModel()).setKeyForSelected(observable.getCboInsDetails());
        //        cboInsDetails.setSelectedItem(observable.getCboInsDetails());
        
        //        cboInsDetails.setToolTipText(cboInsDetails.createToolTip().getTipText());
        ((ComboBoxModel)cboInsUnderScheme.getModel()).setKeyForSelected(observable.getCboInsUnderScheme());
        ((ComboBoxModel)cboDebitProdType.getModel()).setKeyForSelected(observable.getCboDebitProdType());
        ((ComboBoxModel)cboDebitProdId.getModel()).setKeyForSelected(observable.getCboDebitProdId());
        ((ComboBoxModel)cboNatureOfRiskCoverd.getModel()).setKeyForSelected(observable.getCboNatureOfRiskCoverd());
        //        ((ComboBoxModel)cboCardType.getModel()).setKeyForSelected(observable.getCboCardType());
        cboCardType.setModel(observable.getCbmCardType());
        cboCardType.setSelectedItem(observable.getCboCardType());
        
        txtInsComName.setText(observable.getInsComName());
        txtAddress.setText(observable.getAddress());
        txtPhoneNo.setText(observable.getPhoneNo());
        txtPolicyNo.setText(observable.getPolicyNo());
        txtPremiumAmt.setText(observable.getPremiumAmt());
        tdtInsIssueDt.setDateValue(observable.getInsIssueDt());
        tdtInsFrom.setDateValue(observable.getInsStDt());
        tdtInsExpiryDt.setDateValue(observable.getInsExpiryDt());
        txtInsuranceAmt.setText(observable.getInsuranceAmt());
        txtFromActNo.setText(observable.getFromActNo());
        txtFromActNo1.setText(observable.getFromActNo1());
        ...
        tblInsuranceDetails.setModel(observable.getTblInsuranceDetails());
        
        //            tblPeakSanctionDetails.setModel(observablePeakSanctionDetails.getTblPeakSanctionTab());
        ...
        addRadioButtons();
        //load at the time edit and authorize also
        
        chkDocDetailsActionPerformed();
        chkAuthorizedSignatoryActionPerformed();
        chkPOFAttorneyActionPerformed();
        chkInsuranceActionPerformed();
        chkStockInspectActionPerformed();
        chkInspectionActionPerformed();
        if(allowResetVisit)
        tabLimitAmount.resetVisits();
    ...
    public void updateOBFields() {
        ...
        observable.setTxtRemarks(txtAreaRemarks.getText());
        ...
        //insurance Details
        observable.setCboInsDetails(CommonUtil.convertObjToStr(cboInsDetails.getSelectedItem()));
        observable.setCboInsUnderScheme(CommonUtil.convertObjToStr(cboInsUnderScheme.getSelectedItem()));
        observable.setCboDebitProdType(CommonUtil.convertObjToStr(cboDebitProdType.getSelectedItem()));
        observable.setCboDebitProdType(CommonUtil.convertObjToStr(cboProdType.getSelectedItem()));
        observable.setCboDebitProdId(CommonUtil.convertObjToStr(cboDebitProdId.getSelectedItem()));
        observable.setCboNatureOfRiskCoverd(CommonUtil.convertObjToStr(cboNatureOfRiskCoverd.getSelectedItem()));
        observable.setInsComName(txtInsComName.getText());
        observable.setAddress(txtAddress.getText());
        
        observable.setPhoneNo(txtPhoneNo.getText());
        observable.setPolicyNo(txtPolicyNo.getText());
        observable.setPremiumAmt(txtPremiumAmt.getText());
        observable.setInsIssueDt(tdtInsIssueDt.getDateValue());
        observable.setInsStDt(tdtInsFrom.getDateValue());
        observable.setInsExpiryDt(tdtInsExpiryDt.getDateValue());
        observable.setInsuranceAmt(txtInsuranceAmt.getText());
        observable.setFromActNo(txtFromActNo.getText());
        observable.setFromActNo1(txtFromActNo1.getText());
        
        observable.setCboCardPeriod(CommonUtil.convertObjToStr(cboCardPeriod.getSelectedItem()));
        observable.setTxtCardLimit(txtCardLimit.getText());
        observable.setTdtReviewDate(tdtReviewDate.getDateValue());
        observable.setTxtCardPeriod(txtCardPeriod.getText());
        ...
        observable.setChkInspection(chkInspection.isSelected());
        ...
        observableClassi.setRdoDirectFinance(rdoDirectFin.isSelected());
        observableClassi.setRdoPrioritySector(rdoPrioritySec.isSelected());
        ...
        //            observablePeakSanctionDetails.setPeakSanctionFromDate(tdtPeakSanctionFromDate.getDateValue());
        //            observablePeakSanctionDetails.setPeakSanctionToDate(tdtPeakSanctionToDate.getDateValue());
        //            observablePeakSanctionDetails.setPeakSanctionAmt(txtPeakSanctionAmt.getText());
    }
    ...
    private void initComponentData() {
        ...
        cboSecurityType.setModel(observableGuarantor.getCbmSecurityType());
        ...
        cboSelectScreen.setModel(observable.getCbmSelectScreen());
        cboDebitProdType.setModel(observable.getCbmDebitProdType());
        cboDebitProdId.setModel(observable.getCbmDebitProdId());
        cboNatureOfRiskCoverd.setModel(observable.getCbmNatureOfRiskCoverd());
        cboInsDetails.setModel(observable.getCbmInsDetails());
        cboInsUnderScheme.setModel(observable.getCbmInsUnderScheme());
        cboCardType.setModel(observable.getCbmCardType());
        cboCardPeriod.setModel(observable.getCbmCardPeriod());
    ...
    private void setMaxLength(){
        ...
        txtPhoneNo.setValidation(new NumericValidation());
        txtInsuranceAmt.setValidation(new CurrencyValidation(14,2));
        ...
        txtPolicyNo.setAllowNumber(true);
        ...
        txtCardLimit.setValidation(new CurrencyValidation(14,2));
        txtCardPeriod.setValidation(new NumericValidation());
        //        txtPeakSanctionAmt.setValidation(new NumericValidation(10,0));
    }
    ...
    private void initComponents() {
        ...
        rdoDirectFinance = new com.see.truetransact.uicomponent.CButtonGroup();
        rdoPrioritySector = new com.see.truetransact.uicomponent.CButtonGroup();
        ...
        lblSelectScreen = new com.see.truetransact.uicomponent.CLabel();
        cboSelectScreen = new com.see.truetransact.uicomponent.CComboBox();
        ...
        lblAccountOpenDate = new com.see.truetransact.uicomponent.CLabel();
        ...
        chkInspection = new com.see.truetransact.uicomponent.CCheckBox();
        panFacilityChkBoxes1 = new com.see.truetransact.uicomponent.CPanel();
        ...
        cboCardType = new com.see.truetransact.uicomponent.CComboBox();
        lblCardType = new com.see.truetransact.uicomponent.CLabel();
        srpTxtAreaParticulars = new com.see.truetransact.uicomponent.CScrollPane();
        txtAreaRemarks = new com.see.truetransact.uicomponent.CTextArea();
        tdtReviewDate = new com.see.truetransact.uicomponent.CDateField();
        lblReviewDate = new com.see.truetransact.uicomponent.CLabel();
        txtCardLimit = new com.see.truetransact.uicomponent.CTextField();
        lblCardLimit = new com.see.truetransact.uicomponent.CLabel();
        lblCardValidity = new com.see.truetransact.uicomponent.CLabel();
        panCardPeriod = new com.see.truetransact.uicomponent.CPanel();
        txtCardPeriod = new com.see.truetransact.uicomponent.CTextField();
        cboCardPeriod = new com.see.truetransact.uicomponent.CComboBox();
        ...
        rdoPrioritySec = new javax.swing.JRadioButton();
        rdoInDirectFin = new javax.swing.JRadioButton();
        rdoDirectFin = new javax.swing.JRadioButton();
        rdoNonPrioritySec = new javax.swing.JRadioButton();
        panInsuranceDetails = new com.see.truetransact.uicomponent.CPanel();
        panInsuranceDetails_Table = new com.see.truetransact.uicomponent.CPanel();
        panInsuranceDetailsFields = new com.see.truetransact.uicomponent.CPanel();
        lblInsDetails = new com.see.truetransact.uicomponent.CLabel();
        lblInsFrom = new com.see.truetransact.uicomponent.CLabel();
        lblInsComName = new com.see.truetransact.uicomponent.CLabel();
        txtInsComName = new com.see.truetransact.uicomponent.CTextField();
        lblAddress = new com.see.truetransact.uicomponent.CLabel();
        txtAddress = new com.see.truetransact.uicomponent.CTextField();
        lblPhoneNo = new com.see.truetransact.uicomponent.CLabel();
        txtPhoneNo = new com.see.truetransact.uicomponent.CTextField();
        tdtInsFrom = new com.see.truetransact.uicomponent.CDateField();
        lblInsExpiryDt = new com.see.truetransact.uicomponent.CLabel();
        tdtInsExpiryDt = new com.see.truetransact.uicomponent.CDateField();
        ...
        lblPolicyNo = new com.see.truetransact.uicomponent.CLabel();
        txtPolicyNo = new com.see.truetransact.uicomponent.CTextField();
        panInsuranceButtons = new com.see.truetransact.uicomponent.CPanel();
        btnInsuranceDetailsNew = new com.see.truetransact.uicomponent.CButton();
        btnInsuranceDetailsSave = new com.see.truetransact.uicomponent.CButton();
        btnInsuranceDetailsDelete = new com.see.truetransact.uicomponent.CButton();
        txtFromActNo = new com.see.truetransact.uicomponent.CTextField();
        btnacctNo = new com.see.truetransact.uicomponent.CButton();
        lblDebitProdType = new com.see.truetransact.uicomponent.CLabel();
        lblDebitProdId = new com.see.truetransact.uicomponent.CLabel();
        lblFromActNo = new com.see.truetransact.uicomponent.CLabel();
        cboDebitProdId = new com.see.truetransact.uicomponent.CComboBox();
        cboDebitProdType = new com.see.truetransact.uicomponent.CComboBox();
        cboInsUnderScheme = new com.see.truetransact.uicomponent.CComboBox();
        lblInsUnderScheme = new com.see.truetransact.uicomponent.CLabel();
        cboNatureOfRiskCoverd = new com.see.truetransact.uicomponent.CComboBox();
        lblNatureOfRiskCoverd = new com.see.truetransact.uicomponent.CLabel();
        lblFromActNo1 = new com.see.truetransact.uicomponent.CLabel();
        txtFromActNo1 = new com.see.truetransact.uicomponent.CTextField();
        lblInsIssueDt = new com.see.truetransact.uicomponent.CLabel();
        tdtInsIssueDt = new com.see.truetransact.uicomponent.CDateField();
        cboInsDetails = new com.see.truetransact.uicomponent.CComboBox();
        panInsuranceDetailsTable = new com.see.truetransact.uicomponent.CPanel();
        ...
        lblSelectScreen.setText("Select Screen");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 7;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.EAST;
        gridBagConstraints.insets = new java.awt.Insets(1, 6, 0, 4);
        panStatus.add(lblSelectScreen, gridBagConstraints);

        cboSelectScreen.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "---Select---" }));
        cboSelectScreen.setMinimumSize(new java.awt.Dimension(100, 21));
        cboSelectScreen.setPopupWidth(225);
        cboSelectScreen.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cboSelectScreenActionPerformed(evt);
            }
        });
        gridBagConstraints = new java.awt.GridBagConstraints();
        ...
        panStatus.add(cboSelectScreen, gridBagConstraints);
        ...
        cboConstitution.setNextFocusableComponent(txtRiskRating);
        ...
        cboCategory.setNextFocusableComponent(cboNatureBusiness);
        ...
        txtReferences.setNextFocusableComponent(txtRemarks__CompDetail);
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 9;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        ...
        tdtDealingWithBankSince.setNextFocusableComponent(tdtCreditFacilityAvailSince);
        ...
        txtRiskRating.setNextFocusableComponent(cboCategory);
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 6;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        ...
        cboNatureBusiness.setNextFocusableComponent(txtReferences);
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 8;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        ...
        txtRemarks__CompDetail.setNextFocusableComponent(txtNetWorth);
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 10;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        ...
        txtNetWorth.setNextFocusableComponent(tdtAsOn);
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 11;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        ...
        tdtCreditFacilityAvailSince.setNextFocusableComponent(cboConstitution);
        ...
        txtCustID.setNextFocusableComponent(tdtDealingWithBankSince);
        ...
        tdtSanctionDate.setFocusCycleRoot(true);
        ...
        cboModeSanction.setNextFocusableComponent(txtSanctionRemarks);
        ...
        txtSanctionRemarks.setNextFocusableComponent(btnSave2_SD);
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 2;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        ...
        cboSanctioningAuthority.setNextFocusableComponent(cboModeSanction);
        ...
        tdtFDate.setNextFocusableComponent(tdtFacility_Repay_Date);
        ...
        tdtTDate.setNextFocusableComponent(btnSave1);
        ...
        btnSave1.setNextFocusableComponent(btnSave2_SD);
        ...
        cboProductId.setNextFocusableComponent(txtLimit_SD);
        ...
        tdtFacility_Repay_Date.setNextFocusableComponent(tdtTDate);
        ...
        panFacilityDetails_Data.setMinimumSize(new java.awt.Dimension(800, 500));
        panFacilityDetails_Data.setPreferredSize(new java.awt.Dimension(800, 500));
        panFacilityDetails_Data.setLayout(new java.awt.GridBagLayout());

        panFDAccount.setMinimumSize(new java.awt.Dimension(400, 490));
        panFDAccount.setPreferredSize(new java.awt.Dimension(400, 490));
        ...
        panSecurityDetails_FD.setMinimumSize(new java.awt.Dimension(140, 110));
        panSecurityDetails_FD.setPreferredSize(new java.awt.Dimension(140, 110));
        ...
        rdoAccLimit_Submit.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                rdoAccLimit_SubmitActionPerformed(evt);
            }
        });
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
        ...
        panFacilityProdID.setMaximumSize(new java.awt.Dimension(430, 150));
        panFacilityProdID.setMinimumSize(new java.awt.Dimension(430, 150));
        panFacilityProdID.setPreferredSize(new java.awt.Dimension(430, 150));
        ...
        lblAccountOpenDate.setText("Account Open Date");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 4;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.EAST;
        gridBagConstraints.insets = new java.awt.Insets(4, 4, 4, 4);
        panFacilityProdID.add(lblAccountOpenDate, gridBagConstraints);
        ...
        gridBagConstraints.insets = new java.awt.Insets(2, 44, 0, 20);
        ...
        panFacilityChkBoxes.setMaximumSize(new java.awt.Dimension(290, 100));
        panFacilityChkBoxes.setMinimumSize(new java.awt.Dimension(290, 100));
        panFacilityChkBoxes.setPreferredSize(new java.awt.Dimension(290, 100));
        ...
        chkInsurance.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusLost(java.awt.event.FocusEvent evt) {
                chkInsuranceFocusLost(evt);
            }
        });
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        ...
        chkGurantor.setText("Guarantor/CoOblicant/surity");
        chkGurantor.setMaximumSize(new java.awt.Dimension(180, 16));
        chkGurantor.setMinimumSize(new java.awt.Dimension(180, 16));
        chkGurantor.setPreferredSize(new java.awt.Dimension(180, 16));
        ...
        chkStockInspect.setText("Subsidy/Valution");
        chkStockInspect.setMaximumSize(new java.awt.Dimension(150, 16));
        chkStockInspect.setMinimumSize(new java.awt.Dimension(150, 16));
        chkStockInspect.setPreferredSize(new java.awt.Dimension(150, 16));
        chkStockInspect.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                chkStockInspectActionPerformed(evt);
            }
        });
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        ...
        chkInspection.setText(" Inspection");
        chkInspection.setMaximumSize(new java.awt.Dimension(150, 16));
        chkInspection.setMinimumSize(new java.awt.Dimension(150, 16));
        chkInspection.setPreferredSize(new java.awt.Dimension(150, 16));
        chkInspection.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                chkInspectionActionPerformed(evt);
            }
        });
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        gridBagConstraints.insets = new java.awt.Insets(4, 4, 4, 4);
        panFacilityChkBoxes.add(chkInspection, gridBagConstraints);
        ...
        panFacilityChkBoxes1.setBorder(javax.swing.BorderFactory.createTitledBorder(""));
        panFacilityChkBoxes1.setMinimumSize(new java.awt.Dimension(654, 40));
        panFacilityChkBoxes1.setPreferredSize(new java.awt.Dimension(654, 40));
        ...
        panFacilityChkBoxes1.add(chkDocDetails);
        ...
        panFacilityChkBoxes1.add(chkAuthorizedSignatory);
        ...
        panFacilityChkBoxes1.add(chkPOFAttorney);
        ...
        gridBagConstraints.gridwidth = 2;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        gridBagConstraints.insets = new java.awt.Insets(4, 0, 6, 4);
        panFDAccount.add(panFacilityChkBoxes1, gridBagConstraints);
        ...
        txtPurposeDesc.setNextFocusableComponent(txtGroupDesc);
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 8;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        ...
        txtAcct_Name.setNextFocusableComponent(txtGroupDesc);
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 7;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        ...
        gridBagConstraints.gridy = 15;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.EAST;
        gridBagConstraints.insets = new java.awt.Insets(1, 35, 1, 4);
        ...
        cboInterestType.setNextFocusableComponent(txtContactPerson);
        ...
        cboCardType.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "---Select---" }));
        cboCardType.setMinimumSize(new java.awt.Dimension(100, 21));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 2;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.insets = new java.awt.Insets(1, 4, 1, 4);
        panFDDate.add(cboCardType, gridBagConstraints);
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.EAST;
        gridBagConstraints.insets = new java.awt.Insets(1, 35, 1, 4);
        panFDDate.add(lblCardType, gridBagConstraints);
        ...
        txtAreaRemarks.setBorder(javax.swing.BorderFactory.createBevelBorder(1));
        txtAreaRemarks.setLineWrap(true);
        txtAreaRemarks.setNextFocusableComponent(btnFacilitySave);
        srpTxtAreaParticulars.setViewportView(txtAreaRemarks);

        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 16;
        panFDDate.add(srpTxtAreaParticulars, gridBagConstraints);

        tdtReviewDate.setMinimumSize(new java.awt.Dimension(100, 21));
        tdtReviewDate.setPreferredSize(new java.awt.Dimension(100, 21));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 0;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        gridBagConstraints.insets = new java.awt.Insets(1, 4, 1, 4);
        panFDDate.add(tdtReviewDate, gridBagConstraints);
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.EAST;
        gridBagConstraints.insets = new java.awt.Insets(1, 4, 1, 4);
        panFDDate.add(lblReviewDate, gridBagConstraints);

        txtCardLimit.setMinimumSize(new java.awt.Dimension(100, 21));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 3;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        gridBagConstraints.insets = new java.awt.Insets(1, 4, 1, 4);
        panFDDate.add(txtCardLimit, gridBagConstraints);

        lblCardLimit.setText("Card Limit");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 3;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.EAST;
        gridBagConstraints.insets = new java.awt.Insets(1, 35, 1, 4);
        panFDDate.add(lblCardLimit, gridBagConstraints);

        lblCardValidity.setText("Card Validity");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 4;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.SOUTHEAST;
        gridBagConstraints.insets = new java.awt.Insets(1, 35, 1, 4);
        panFDDate.add(lblCardValidity, gridBagConstraints);

        panCardPeriod.setLayout(new java.awt.GridBagLayout());

        txtCardPeriod.setMinimumSize(new java.awt.Dimension(50, 21));
        txtCardPeriod.setPreferredSize(new java.awt.Dimension(50, 21));
        panCardPeriod.add(txtCardPeriod, new java.awt.GridBagConstraints());

        cboCardPeriod.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "---Select---" }));
        cboCardPeriod.setMinimumSize(new java.awt.Dimension(88, 21));
        cboCardPeriod.setPreferredSize(new java.awt.Dimension(88, 21));
        panCardPeriod.add(cboCardPeriod, new java.awt.GridBagConstraints());
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        gridBagConstraints.insets = new java.awt.Insets(4, 4, 4, 4);
        panFDDate.add(panCardPeriod, gridBagConstraints);
        ...
        btnCustID_Security.setNextFocusableComponent(txtSecurityNo);
        ...
        btnSecurityNo_Security.setNextFocusableComponent(tdtFromDate);
        ...
        tdtFromDate.setNextFocusableComponent(tdtToDate);
        ...
        tdtToDate.setNextFocusableComponent(txtSecurityValue);
        ...
        txtSecurityValue.setNextFocusableComponent(txtMargin);
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 0;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        ...
        txtMargin.setNextFocusableComponent(txtEligibleLoan);
        ...
        txtEligibleLoan.setNextFocusableComponent(btnSecuritySave);
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 2;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        ...
        panGuarantorDetails.setMaximumSize(new java.awt.Dimension(830, 370));
        panGuarantorDetails.setMinimumSize(new java.awt.Dimension(830, 370));
        panGuarantorDetails.setPreferredSize(new java.awt.Dimension(830, 370));
        ...
        panGuarantorDetail_Detail.setMaximumSize(new java.awt.Dimension(520, 260));
        panGuarantorDetail_Detail.setMinimumSize(new java.awt.Dimension(520, 260));
        panGuarantorDetail_Detail.setPreferredSize(new java.awt.Dimension(520, 260));
        panGuarantorDetail_Detail.setLayout(new java.awt.GridBagLayout());

        panGuarantor.setMinimumSize(new java.awt.Dimension(270, 245));
        panGuarantor.setPreferredSize(new java.awt.Dimension(270, 245));
        ...
        txtGuarantorNo.setNextFocusableComponent(txtCustomerID_GD);
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 1;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        ...
        cboSecurityType.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "---Select---" }));
        cboSecurityType.setMinimumSize(new java.awt.Dimension(100, 21));
        cboSecurityType.setNextFocusableComponent(txtGuarantorNo);
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 0;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        gridBagConstraints.insets = new java.awt.Insets(4, 4, 0, 4);
        panGuarantor.add(cboSecurityType, gridBagConstraints);

        lblSecurityType.setText("Securtiy Type");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 0;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.EAST;
        gridBagConstraints.insets = new java.awt.Insets(4, 4, 0, 4);
        panGuarantor.add(lblSecurityType, gridBagConstraints);
        ...
        tdtAsOn_GD.setNextFocusableComponent(btnGuarantorSave);
        ...
        txtInter.setCaretColor(new java.awt.Color(51, 51, 255));
        ...
        rdoPrioritySector.add(rdoPrioritySec);
        rdoPrioritySec.setFont(new java.awt.Font("MS Sans Serif", 0, 13)); // NOI18N
        rdoPrioritySec.setText("Priority Sector");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 6;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHEAST;
        panCode2.add(rdoPrioritySec, gridBagConstraints);

        rdoDirectFinance.add(rdoInDirectFin);
        rdoInDirectFin.setFont(new java.awt.Font("MS Sans Serif", 0, 13)); // NOI18N
        rdoInDirectFin.setText("In Direct Finance");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 5;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        panCode2.add(rdoInDirectFin, gridBagConstraints);

        rdoDirectFinance.add(rdoDirectFin);
        rdoDirectFin.setFont(new java.awt.Font("MS Sans Serif", 0, 13)); // NOI18N
        rdoDirectFin.setText("Direct Finance");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 5;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHEAST;
        panCode2.add(rdoDirectFin, gridBagConstraints);

        rdoPrioritySector.add(rdoNonPrioritySec);
        rdoNonPrioritySec.setFont(new java.awt.Font("MS Sans Serif", 0, 13)); // NOI18N
        rdoNonPrioritySec.setText("Non Priority Sector");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 6;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        panCode2.add(rdoNonPrioritySec, gridBagConstraints);
        ...
        panInsuranceDetails_Table.setMaximumSize(new java.awt.Dimension(826, 500));
        panInsuranceDetails_Table.setMinimumSize(new java.awt.Dimension(826, 500));
        panInsuranceDetails_Table.setPreferredSize(new java.awt.Dimension(826, 500));
        panInsuranceDetails_Table.setLayout(new java.awt.GridBagLayout());

        panInsuranceDetailsFields.setMaximumSize(new java.awt.Dimension(340, 500));
        panInsuranceDetailsFields.setMinimumSize(new java.awt.Dimension(340, 500));
        panInsuranceDetailsFields.setPreferredSize(new java.awt.Dimension(340, 500));
        panInsuranceDetailsFields.setLayout(new java.awt.GridBagLayout());

        lblInsDetails.setText("InsuranceType");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 0;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHEAST;
        gridBagConstraints.insets = new java.awt.Insets(3, 4, 3, 4);
        panInsuranceDetailsFields.add(lblInsDetails, gridBagConstraints);

        lblInsFrom.setText("InsuranceEffectiveFromDt");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 7;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.EAST;
        gridBagConstraints.insets = new java.awt.Insets(3, 4, 3, 4);
        panInsuranceDetailsFields.add(lblInsFrom, gridBagConstraints);

        lblInsComName.setText("InsComName");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 2;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.EAST;
        gridBagConstraints.insets = new java.awt.Insets(3, 4, 3, 4);
        panInsuranceDetailsFields.add(lblInsComName, gridBagConstraints);

        txtInsComName.setMinimumSize(new java.awt.Dimension(100, 21));
        txtInsComName.setNextFocusableComponent(txtAddress);
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 2;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        gridBagConstraints.insets = new java.awt.Insets(3, 4, 3, 4);
        panInsuranceDetailsFields.add(txtInsComName, gridBagConstraints);
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.EAST;
        gridBagConstraints.insets = new java.awt.Insets(3, 4, 3, 4);
        panInsuranceDetailsFields.add(lblAddress, gridBagConstraints);

        txtAddress.setMinimumSize(new java.awt.Dimension(100, 21));
        txtAddress.setNextFocusableComponent(txtPhoneNo);
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 3;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        gridBagConstraints.insets = new java.awt.Insets(3, 4, 3, 4);
        panInsuranceDetailsFields.add(txtAddress, gridBagConstraints);
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.EAST;
        gridBagConstraints.insets = new java.awt.Insets(3, 4, 3, 4);
        panInsuranceDetailsFields.add(lblPhoneNo, gridBagConstraints);

        txtPhoneNo.setMinimumSize(new java.awt.Dimension(100, 21));
        txtPhoneNo.setNextFocusableComponent(txtPolicyNo);
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 4;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        gridBagConstraints.insets = new java.awt.Insets(3, 4, 3, 4);
        panInsuranceDetailsFields.add(txtPhoneNo, gridBagConstraints);

        tdtInsFrom.setMinimumSize(new java.awt.Dimension(100, 21));
        tdtInsFrom.setNextFocusableComponent(tdtInsExpiryDt);
        tdtInsFrom.setPreferredSize(new java.awt.Dimension(100, 21));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 7;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        gridBagConstraints.insets = new java.awt.Insets(3, 4, 3, 4);
        panInsuranceDetailsFields.add(tdtInsFrom, gridBagConstraints);

        lblInsExpiryDt.setText("insuranceEffectiveEndDt");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 8;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.EAST;
        gridBagConstraints.insets = new java.awt.Insets(3, 4, 3, 4);
        panInsuranceDetailsFields.add(lblInsExpiryDt, gridBagConstraints);

        tdtInsExpiryDt.setMinimumSize(new java.awt.Dimension(100, 21));
        tdtInsExpiryDt.setNextFocusableComponent(txtInsuranceAmt);
        tdtInsExpiryDt.setPreferredSize(new java.awt.Dimension(100, 21));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 8;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        gridBagConstraints.insets = new java.awt.Insets(3, 4, 3, 4);
        panInsuranceDetailsFields.add(tdtInsExpiryDt, gridBagConstraints);

        lblInsuranceAmt.setText("Insurance Amt");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 9;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.EAST;
        gridBagConstraints.insets = new java.awt.Insets(3, 4, 3, 4);
        panInsuranceDetailsFields.add(lblInsuranceAmt, gridBagConstraints);

        txtInsuranceAmt.setMinimumSize(new java.awt.Dimension(100, 21));
        txtInsuranceAmt.setNextFocusableComponent(txtPremiumAmt);
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 9;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        gridBagConstraints.insets = new java.awt.Insets(3, 4, 3, 4);
        panInsuranceDetailsFields.add(txtInsuranceAmt, gridBagConstraints);

        lblPremiumAmt.setText("Premium Amt");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 10;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.EAST;
        gridBagConstraints.insets = new java.awt.Insets(3, 4, 3, 4);
        panInsuranceDetailsFields.add(lblPremiumAmt, gridBagConstraints);

        txtPremiumAmt.setMinimumSize(new java.awt.Dimension(100, 21));
        txtPremiumAmt.setNextFocusableComponent(cboNatureOfRiskCoverd);
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        gridBagConstraints.insets = new java.awt.Insets(3, 4, 3, 4);
        panInsuranceDetailsFields.add(txtPremiumAmt, gridBagConstraints);
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.EAST;
        gridBagConstraints.insets = new java.awt.Insets(3, 4, 3, 4);
        panInsuranceDetailsFields.add(lblPolicyNo, gridBagConstraints);

        txtPolicyNo.setMinimumSize(new java.awt.Dimension(100, 21));
        txtPolicyNo.setNextFocusableComponent(tdtInsIssueDt);
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        gridBagConstraints.insets = new java.awt.Insets(3, 4, 3, 4);
        panInsuranceDetailsFields.add(txtPolicyNo, gridBagConstraints);

        panInsuranceButtons.setLayout(new java.awt.GridBagLayout());

        btnInsuranceDetailsNew.setText("New");
        btnInsuranceDetailsNew.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnInsuranceDetailsNewActionPerformed(evt);
            }
        });
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.insets = new java.awt.Insets(4, 4, 4, 4);
        panInsuranceButtons.add(btnInsuranceDetailsNew, gridBagConstraints);

        btnInsuranceDetailsSave.setText("Save");
        btnInsuranceDetailsSave.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnInsuranceDetailsSaveActionPerformed(evt);
            }
        });
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.insets = new java.awt.Insets(4, 4, 4, 4);
        panInsuranceButtons.add(btnInsuranceDetailsSave, gridBagConstraints);

        btnInsuranceDetailsDelete.setText("Delete");
        btnInsuranceDetailsDelete.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnInsuranceDetailsDeleteActionPerformed(evt);
            }
        });
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.insets = new java.awt.Insets(4, 4, 4, 4);
        panInsuranceButtons.add(btnInsuranceDetailsDelete, gridBagConstraints);
        ...
        gridBagConstraints.insets = new java.awt.Insets(3, 4, 3, 4);
        panInsuranceDetailsFields.add(panInsuranceButtons, gridBagConstraints);

        txtFromActNo.setMinimumSize(new java.awt.Dimension(100, 21));
        txtFromActNo.setNextFocusableComponent(txtFromActNo1);
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 14;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        gridBagConstraints.insets = new java.awt.Insets(3, 4, 3, 4);
        panInsuranceDetailsFields.add(txtFromActNo, gridBagConstraints);

        btnacctNo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/see/truetransact/ui/images/TT_SELECT.gif"))); // NOI18N
        btnacctNo.setText("cButton1");
        btnacctNo.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        btnacctNo.setMaximumSize(new java.awt.Dimension(35, 25));
        btnacctNo.setMinimumSize(new java.awt.Dimension(35, 25));
        ...
        gridBagConstraints.gridx = 2;
        gridBagConstraints.gridy = 14;
        panInsuranceDetailsFields.add(btnacctNo, gridBagConstraints);

        lblDebitProdType.setText("Premium debit From Prod Type");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 12;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.EAST;
        gridBagConstraints.insets = new java.awt.Insets(3, 4, 3, 4);
        panInsuranceDetailsFields.add(lblDebitProdType, gridBagConstraints);

        lblDebitProdId.setText("Premium debit From Prod Id");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 13;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.EAST;
        gridBagConstraints.insets = new java.awt.Insets(3, 4, 3, 4);
        panInsuranceDetailsFields.add(lblDebitProdId, gridBagConstraints);

        lblFromActNo.setText("Premium Debit From Acct No");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 14;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.EAST;
        gridBagConstraints.insets = new java.awt.Insets(3, 4, 3, 4);
        panInsuranceDetailsFields.add(lblFromActNo, gridBagConstraints);

        cboDebitProdId.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "---Select---" }));
        cboDebitProdId.setMinimumSize(new java.awt.Dimension(100, 21));
        cboDebitProdId.setNextFocusableComponent(txtFromActNo);
        cboDebitProdId.setPopupWidth(115);
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 13;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        gridBagConstraints.insets = new java.awt.Insets(3, 4, 3, 4);
        panInsuranceDetailsFields.add(cboDebitProdId, gridBagConstraints);

        cboDebitProdType.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "---Select---" }));
        cboDebitProdType.setMinimumSize(new java.awt.Dimension(100, 21));
        cboDebitProdType.setNextFocusableComponent(cboDebitProdId);
        cboDebitProdType.setPopupWidth(115);
        cboDebitProdType.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cboDebitProdTypeActionPerformed(evt);
            }
        });
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        gridBagConstraints.insets = new java.awt.Insets(3, 4, 3, 4);
        panInsuranceDetailsFields.add(cboDebitProdType, gridBagConstraints);

        cboInsUnderScheme.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "---Select---" }));
        cboInsUnderScheme.setMinimumSize(new java.awt.Dimension(100, 21));
        cboInsUnderScheme.setNextFocusableComponent(txtInsComName);
        cboInsUnderScheme.setPopupWidth(115);
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 1;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        gridBagConstraints.insets = new java.awt.Insets(3, 4, 3, 4);
        panInsuranceDetailsFields.add(cboInsUnderScheme, gridBagConstraints);

        lblInsUnderScheme.setText("Insurance under scheme");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 1;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.EAST;
        gridBagConstraints.insets = new java.awt.Insets(3, 4, 3, 4);
        panInsuranceDetailsFields.add(lblInsUnderScheme, gridBagConstraints);

        cboNatureOfRiskCoverd.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "---Select---" }));
        cboNatureOfRiskCoverd.setMinimumSize(new java.awt.Dimension(100, 21));
        cboNatureOfRiskCoverd.setNextFocusableComponent(cboDebitProdType);
        cboNatureOfRiskCoverd.setPopupWidth(115);
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 11;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        gridBagConstraints.insets = new java.awt.Insets(3, 4, 3, 4);
        panInsuranceDetailsFields.add(cboNatureOfRiskCoverd, gridBagConstraints);

        lblNatureOfRiskCoverd.setText("Nature of Risk Covered");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 11;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.EAST;
        gridBagConstraints.insets = new java.awt.Insets(3, 4, 3, 4);
        panInsuranceDetailsFields.add(lblNatureOfRiskCoverd, gridBagConstraints);

        lblFromActNo1.setText("Remarks");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 15;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.EAST;
        gridBagConstraints.insets = new java.awt.Insets(3, 4, 3, 4);
        panInsuranceDetailsFields.add(lblFromActNo1, gridBagConstraints);

        txtFromActNo1.setMinimumSize(new java.awt.Dimension(100, 21));
        txtFromActNo1.setNextFocusableComponent(btnInsuranceDetailsSave);
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 15;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        gridBagConstraints.insets = new java.awt.Insets(3, 4, 3, 4);
        panInsuranceDetailsFields.add(txtFromActNo1, gridBagConstraints);

        lblInsIssueDt.setText("PolicyIssuedDate");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 6;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.EAST;
        gridBagConstraints.insets = new java.awt.Insets(3, 4, 3, 4);
        panInsuranceDetailsFields.add(lblInsIssueDt, gridBagConstraints);

        tdtInsIssueDt.setMinimumSize(new java.awt.Dimension(100, 21));
        tdtInsIssueDt.setNextFocusableComponent(tdtInsFrom);
        tdtInsIssueDt.setPreferredSize(new java.awt.Dimension(100, 21));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 6;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        gridBagConstraints.insets = new java.awt.Insets(3, 4, 3, 4);
        panInsuranceDetailsFields.add(tdtInsIssueDt, gridBagConstraints);

        cboInsDetails.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "---Select---" }));
        cboInsDetails.setMinimumSize(new java.awt.Dimension(100, 21));
        cboInsDetails.setNextFocusableComponent(cboInsUnderScheme);
        cboInsDetails.setPopupWidth(115);
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 0;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        gridBagConstraints.insets = new java.awt.Insets(3, 4, 3, 4);
        panInsuranceDetailsFields.add(cboInsDetails, gridBagConstraints);

        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.fill = java.awt.GridBagConstraints.VERTICAL;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTH;
        gridBagConstraints.insets = new java.awt.Insets(4, 4, 4, 4);
        panInsuranceDetails_Table.add(panInsuranceDetailsFields, gridBagConstraints);

        panInsuranceDetailsTable.setMaximumSize(new java.awt.Dimension(470, 500));
        panInsuranceDetailsTable.setMinimumSize(new java.awt.Dimension(470, 500));
        panInsuranceDetailsTable.setPreferredSize(new java.awt.Dimension(470, 500));
        panInsuranceDetailsTable.setLayout(new java.awt.GridBagLayout());

        srpInsuranceDetails.setMaximumSize(new java.awt.Dimension(470, 500));
        srpInsuranceDetails.setMinimumSize(new java.awt.Dimension(470, 500));
        srpInsuranceDetails.setPreferredSize(new java.awt.Dimension(470, 500));
        ...
        tblInsuranceDetails.setPreferredScrollableViewportSize(new java.awt.Dimension(450, 100));
        tblInsuranceDetails.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tblInsuranceDetailsMouseClicked(evt);
            }
        });
        srpInsuranceDetails.setViewportView(tblInsuranceDetails);

        panInsuranceDetailsTable.add(srpInsuranceDetails, new java.awt.GridBagConstraints());

        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.fill = java.awt.GridBagConstraints.VERTICAL;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTH;
        gridBagConstraints.insets = new java.awt.Insets(4, 4, 4, 4);
        panInsuranceDetails_Table.add(panInsuranceDetailsTable, gridBagConstraints);
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        gridBagConstraints.insets = new java.awt.Insets(4, 4, 4, 4);
        panInsuranceDetails.add(panInsuranceDetails_Table, gridBagConstraints);

        tabLimitAmount.addTab("Insurance Details", panInsuranceDetails);
    ...
    private void txtPremiumAmtFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtPremiumAmtFocusLost
        ...
        double  insuranceAmt=CommonUtil.convertObjToDouble(txtInsuranceAmt.getText()).doubleValue();
        double  premiumAmt=CommonUtil.convertObjToDouble(txtPremiumAmt.getText()).doubleValue();
        if(insuranceAmt<=premiumAmt){
            ClientUtil.showMessageWindow("Premium amount Should Not Cross InsuranceAmt");
    ...
    private void tdtAccountOpenDateFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_tdtAccountOpenDateFocusLost
        ...
        if(acct_open_dt.length()>0 && sanction_dt.length()>0){
            ...
            //             tdtAccountOpenDate.setDateValue("");
            return;
        }
        if(acct_open_dt.length()>0)
            observable.setAccOpenDtForSubLimit(tdtAccountOpenDate.getDateValue());
    }//GEN-LAST:event_tdtAccountOpenDateFocusLost
    
    private void chkInspectionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_chkInspectionActionPerformed
        // TODO add your handling code here:
        if(!chkInspection.isSelected()){
            if(observable.getStrACNumber().length()>0 &&observable.getInspectionTableRecords()>0 ) {
                ClientUtil.showMessageWindow("Delete record from Inspection Details");
                chkInspection.setSelected(true);
                return;
            }
        }
        chkInspectionActionPerformed();
    }//GEN-LAST:event_chkInspectionActionPerformed
    private void chkInspectionActionPerformed(){
        if(chkInspection.isSelected()){
            tabLimitAmount.add("Inspection Details",agriInspectionUI);
            if(observable.getStrACNumber().length()>0) {
                agriInspectionUI.enableDisableInspectionNewButton(false);
            }
            if(viewType.equals(AUTHORIZE)){
                agriInspectionUI.enableDisableInspectionButton(false);
            }
        }else{
            tabLimitAmount.remove(agriInspectionUI);
        }
    }
    private void chkInsuranceFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_chkInsuranceFocusLost
        // TODO add your handling code here:
        //        if(chkInsurance.isSelected())
        //            tabLimitAmount.add(panInsuranceDetails,resourceBundle.getString("panInsuranceDetails"));
        //        else{
        //            if(observable.getTblInsuranceDetails().getDataArrayList().size()>0){
        //                ClientUtil.showMessageWindow("Delete record from Insurance Detaqils");
        ...
        //        }
        //        if(observable.getStrACNumber().length()>0)
        //            setInsuranceNewBtnEnableDisable(false);
        
    }//GEN-LAST:event_chkInsuranceFocusLost
    
    private void chkStockInspectActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_chkStockInspectActionPerformed
        // TODO add your handling code here:
        if(!chkStockInspect.isSelected()) {
            if(observable.getSubSidyTableRecord()>0){
                ClientUtil.showMessageWindow("Delete record from Valuation/Subsidy Details");
                chkStockInspect.setSelected(true);
                return;
            }
        }
        chkStockInspectActionPerformed();
    }//GEN-LAST:event_chkStockInspectActionPerformed
    
    private void chkStockInspectActionPerformed(){
        if(chkStockInspect.isSelected()){
            tabLimitAmount.add("Land Valuation/Subsidy",agriSubSidyUI);
            if(observable.getStrACNumber().length()>0) {
                agriSubSidyUI.enableDisableValutionNewButton(false);
                agriSubSidyUI.enableDisableSubsidyNewButton(false);
                if(viewType.equals(AUTHORIZE)){
                    agriSubSidyUI.enableDisableValutionButton(false);
                    agriSubSidyUI.enableDisableSubsidyButton(false);
                }
            }
        }
        else{
            tabLimitAmount.remove(agriSubSidyUI);
    ...
    private void rdoAccLimit_SubmitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rdoAccLimit_SubmitActionPerformed
        // TODO add your handling code here:
        rdoAccLimit_SubmitActionPerformed();
        //        if(rdoAccLimit_Submit.isSelected()){
        //            tabLimitAmount.add("SubLimit/Inspection",subLimitUI);
        //        }else
        //            tabLimitAmount.remove(subLimitUI);
    }//GEN-LAST:event_rdoAccLimit_SubmitActionPerformed
    private void rdoAccLimit_SubmitActionPerformed(){
        if(rdoAccLimit_Submit.isSelected()){
            tabLimitAmount.add("SubLimit Details",subLimitUI);
            if(observable.getStrACNumber().length()>0) {
                subLimitUI.enableDisableSubLimitNewButton(false);
                subLimitUI.enableDisableInspectionNewButton(false);
                if(viewType.equals(AUTHORIZE)) {
                    subLimitUI.enableDisableSubLimitButton(false);
                    subLimitUI.enableDisableInspectionButton(false);
    ...
    private void chkDocDetailsActionPerformed(){
        if(chkDocDetails.isSelected()){
            tabLimitAmount.add(panDocumentDetails,resourceBundle.getString("panDocumentDetails"));
        }else{
            tabLimitAmount.remove(panDocumentDetails);
    ...
    private void btnacctNoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnacctNoActionPerformed
        ...
        String prod_id= CommonUtil.convertObjToStr(((ComboBoxModel) cboDebitProdId.getModel()).getKeyForSelected());
        viewType="DEBIT_ACT_NO";
        if(!prod_id.equals("")){
            viewMap.put(CommonConstants.MAP_NAME,"Cash.getAccountList"
            + ((ComboBoxModel)cboDebitProdType.getModel()).getKeyForSelected().toString());
            whereMap.put("PROD_ID", ((ComboBoxModel) cboDebitProdId.getModel()).getKeyForSelected());
        }else{
    ...
    private void cboDebitProdTypeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cboDebitProdTypeActionPerformed
        // TODO add your handling code here:
        String prodType=CommonUtil.convertObjToStr(((ComboBoxModel)cboDebitProdType.getModel()).getKeyForSelected());
        
        if(!prodType.equals("")){
            if(prodType.equals("GL")){
                cboDebitProdId.setEnabled(false);
                lblFromActNo.setText(resourceBundle.getString("lblFromActHead"));
            }
            else{
                cboDebitProdId.setEnabled(true);
                lblFromActNo.setText(resourceBundle.getString("lblFromActNo"));
            }
    ...
    }//GEN-LAST:event_cboDebitProdTypeActionPerformed
    
    private void tblInsuranceDetailsMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblInsuranceDetailsMouseClicked
        // TODO add your handling code here:
        selectInsuranceRow=tblInsuranceDetails.getSelectedRow();
        observable.setSelectInsuranceDetails(selectInsuranceRow);
        ...
        if ((observable.getLblStatus().equals(ClientConstants.ACTION_STATUS[3])) || (viewType.equals(AUTHORIZE) || viewType.equals(EXCEPTION) || viewType.equals(REJECT) ||  (observable.getActionType() == ClientConstants.ACTIONTYPE_VIEW)|| (observable.getCboAccStatus().equals("Closed")))){
            insDetailEnableDisable(false);
            setInsuranceBtnEnableDisable(false);
        }else {
            insDetailEnableDisable(true);
            setInsuranceNewBtnEnableDisable(true);
        }
        tabLimitAmount.setSelectedComponent(panInsuranceDetails);
    }//GEN-LAST:event_tblInsuranceDetailsMouseClicked
    
    private void btnInsuranceDetailsDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnInsuranceDetailsDeleteActionPerformed
        // TODO add your handling code here:
        selectInsuranceRow=tblInsuranceDetails.getSelectedRow();
        observable.deleteInsuranceDetails(selectInsuranceRow);
        insDetailEnableDisable(false);
        insDetailResetCompontents();
        setInsuranceNewBtnEnableDisable(false);
        isInsuranceUpdate=false;
    }//GEN-LAST:event_btnInsuranceDetailsDeleteActionPerformed
    
    private void btnInsuranceDetailsSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnInsuranceDetailsSaveActionPerformed
        // TODO add your handling code here:
        StringBuffer mandatoryMessage = new StringBuffer("");
        mandatoryMessage.append(new MandatoryCheck().checkMandatory(getClass().getName(), panInsuranceDetailsFields));
        if(mandatoryMessage.length()>0){
            ClientUtil.showMessageWindow(mandatoryMessage.toString());
            return;
        }
        updateOBFields();
        observable.addInsuranceData(selectInsuranceRow,isInsuranceUpdate);
        insDetailEnableDisable(false);
        insDetailResetCompontents();
        setInsuranceNewBtnEnableDisable(false);
        selectInsuranceRow=-1;
        isInsuranceUpdate=false;
        
    }//GEN-LAST:event_btnInsuranceDetailsSaveActionPerformed
    
    private void btnInsuranceDetailsNewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnInsuranceDetailsNewActionPerformed
        // TODO add your handling code here:
        isInsuranceUpdate=false;
        selectInsuranceRow=-1;
        insDetailEnableDisable(true);
        insDetailResetCompontents();
        setInsuranceNewBtnEnableDisable(true);
    }//GEN-LAST:event_btnInsuranceDetailsNewActionPerformed
    ...
    private void insDetailEnableDisable(boolean val){
        cboInsDetails.setEnabled(val);
        cboInsUnderScheme.setEnabled(val);
        txtInsComName.setEnabled(val);
        txtAddress.setEnabled(val);
        txtPhoneNo.setEnabled(val);
        txtPolicyNo.setEnabled(val);
        tdtInsIssueDt.setEnabled(val);
        tdtInsFrom.setEnabled(val);
        tdtInsExpiryDt.setEnabled(val);
        txtInsuranceAmt.setEnabled(val);
        txtPremiumAmt.setEnabled(val);
        cboNatureOfRiskCoverd.setEnabled(val);
        btnacctNo.setEnabled(val);
        
        cboDebitProdType.setEnabled(val);
        cboDebitProdId.setEnabled(val);
        txtFromActNo.setEnabled(val);
        txtFromActNo1.setEnabled(val);
        
    }
    private void insDetailResetCompontents(){
        cboInsDetails.setSelectedItem("");
        cboInsUnderScheme.setSelectedItem("");
        txtInsComName.setText("");
        txtAddress.setText("");
        txtPhoneNo.setText("");
        txtPolicyNo.setText("");
        tdtInsIssueDt.setDateValue("");
        tdtInsFrom.setDateValue("");
        tdtInsExpiryDt.setDateValue("");
        txtInsuranceAmt.setText("");
        txtPremiumAmt.setText("");
        cboNatureOfRiskCoverd.setSelectedItem("");
        cboDebitProdType.setSelectedItem("");
        cboDebitProdId.setSelectedItem("");
        txtFromActNo.setText("");
        txtFromActNo1.setText("");
        
    }
    private void cboSelectScreenActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cboSelectScreenActionPerformed
        // TODO add your handling code here:
        String selectScreen=CommonUtil.convertObjToStr(((ComboBoxModel) cboSelectScreen.getModel()).getKeyForSelected());
        String value=CommonUtil.convertObjToStr(((ComboBoxModel) cboSelectScreen.getModel()).getDataForKey(selectScreen));
        System.out.println(value +"selectScreen"+selectScreen);
        if(selectScreen.length()>0) {
            tabLimitAmount.removeAll();
            if(value.equals("panBorrowCompanyDetails")){
                tabLimitAmount.add(panBorrowCompanyDetails,value.toString(),0);
            }else if(value.equals("panSanctionDetails")){
                tabLimitAmount.add(panSanctionDetails,value.toString(),0);
            } else  if(value.equals("panFacilityDetails")){
                tabLimitAmount.add(panFacilityDetails,value.toString(),0);
            }else  if(value.equals("panSecurityDetails")){
                tabLimitAmount.add(panSecurityDetails,value.toString(),0);
            } else   if(value.equals("panGuarantorInsuranceDetails")){
                tabLimitAmount.add(panGuarantorInsuranceDetails,value.toString(),0);
            }else   if(value.equals("panInterMaintenance")){
                tabLimitAmount.add(panInterMaintenance,value.toString(),0);
            } else    if(value.equals("panFacilityDetails")){
                tabLimitAmount.add(panFacilityDetails,value.toString(),0);
            } else   if(value.equals("panRepaymentSchedule")){
                tabLimitAmount.add(panRepaymentSchedule,value.toString(),0);
            }else   if(value.equals("panAccountDetails")){
                tabLimitAmount.add(panAccountDetails,value.toString(),0);
            }else   if(value.equals("panDocumentDetails")){
                tabLimitAmount.add(panDocumentDetails,value.toString(),0);
            }else   if(value.equals("panClassDetails")){
                tabLimitAmount.add(panClassDetails,value.toString(),0);
            }else   if(value.equals("panSublimitDetails")){
                tabLimitAmount.add(subLimitUI, value.toString(), 0);
            }else   if(value.equals("poaUI")){
                tabLimitAmount.add(poaUI, value.toString(), 0);
            }else if(value.equals("authSignUI")){
                tabLimitAmount.add(authSignUI, value.toString(), 0);
            }else   if(value.equals("panInsuranceDetailsFields")){
                tabLimitAmount.add(panInsuranceDetails,value.toString(),0);
            }
        }
    }//GEN-LAST:event_cboSelectScreenActionPerformed
    ...
    private void rdoAccLimit_MainActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rdoAccLimit_MainActionPerformed
        // TODO add your handling code here:
        if(observable.getSubLimitTableRecord()>0){
            ClientUtil.showMessageWindow("Delete record from Sub Limit Details");
            rdoAccLimit_Submit.setSelected(true);
            return;
        }
        tabLimitAmount.remove(subLimitUI);
    ...
    private void txtCustIDActionPerform() {
        ...
        lst=ClientUtil.executeQuery("getSelectAgriLoanAccInfoList",executeMap);
    ...
    private void txtLaonAmtFocusLost() {
        ...
        if ((CommonUtil.convertObjToDouble(txtLaonAmt.getText()).doubleValue() <= CommonUtil.convertObjToDouble(txtLimit_SD.getText()).doubleValue()) || outStandingAmtRepayment==true){
            // To chk the Total Loan amount doesn't exceed limit amt
            if (outStandingAmtRepayment){}
            else if(!isLoanAmtExceedLimit()){
    ...
    private void btnEMI_CalculateActionPerformed() {
        if(tblInterMaintenance.getRowCount() > 0){
            ...
            if (interestList !=null && interestList.size() > 0){
                ...
                int installmentCount = CommonUtil.convertObjToInt(ClientUtil.executeQuery("getCountOfAgriInstallments",repayData).get(0));
                if (installmentCount>0){
                    new AgriTermLoanInstallmentUI(this, repayData, true);
                }else{
                    new AgriTermLoanInstallmentUI(this, repayData);
                }
            }else{
    ...
    private String isMandatoryEnteredNDocDetails(){
        ...
        AgriTermLoanMRB termLoanMRB = new AgriTermLoanMRB();
    ...
    private void moratorium_Given_RepayscheduleCalculation(){
        if (!tdtFirstInstall.getDateValue().equals("") && !cboRepayFreq.getSelectedItem().equals("") && !(txtNoInstallments.getText().length() == 0)){
    ...
    private void tdtAODDateFocusLost() {
        ...
        ClientUtil.validateToDate(tdtAODDate, DateUtil.getStringDate(DateUtil.addDays(ClientUtil.getCurrentDate(),-1)));
    }
    ...
    private void btnRepayment_DeleteActionPerformed() {
        // TODO add your handling code here
        if(transCount!=0){
            int yes_no=ClientUtil.confirmationAlert("Already Repayment Over " +"\n"+
                    ...
                    if(lst !=null && lst.size()>0){
                        ...
                        if(recordMap !=null && recordMap.size()>0){
                            ...
                            if(clear_balance<0){
                                ...
                                "Do U Want to Reschedule Based on Remaining Period && Out Standing Amt ");
                                //                        if(yes_no==1)
                                //                            return;
                            }
                        ...
                        if(yes_no==0){
                            if(amtOption!=1){
                                String[] obj ={"Repayment Schedule Based on sanction Amt","Repayment Schedule Based on OutStanding Amt"};
                            ...
                            if(amtOption==1){//option
                                ...
                                transMap.put("CURR_DATE",ClientUtil.getCurrentDate());
                                ...
                                if(lst !=null && lst.size()>0){
                                    ...
                                    ClientUtil.showMessageWindow("Out Standing LoanAmt"+clear_balance+"\n"+
                                    "Upto Date Interest"+interestAmt);
                                    ...
                                    transMap.put("INTEREST_AMT",new Double(interestAmt));
                                    outStandingAmtRepayment=true;
                                    try{
                                        if(interestAmt>=1){
                                            observable.interestTransaction(transMap);
                                        }else
                                            ClientUtil.showMessageWindow("Interest Amt shoude be MOre than zero ");
                                    }catch(Exception e){
                                        e.printStackTrace();
                                    }
                                }
                ...
                for(int i=0;i<arryList.size();i++){
                    ...
                    if(limitAmt<=toAmt){
                        ...
                        if(todate !=null &&todate.length()>0){
                            ...
                            if(DateUtil.dateDiff(toDate,sanToDate)>0  && (!interestType.equals("FLOATING_RATE"))){
        ...
        if(outStandingAmtRepayment)
            if (! (viewType.equals(AUTHORIZE) || viewType.equals(EXCEPTION) || viewType.equals(REJECT) || viewType.equals("Delete")))
                if (!tdtFirstInstall.getDateValue().equals("") && !cboRepayFreq_Repayment.getSelectedItem().equals("") && !txtNoInstall.getText().equals("")){
                    ...
                    gCalendar.setGregorianChange(DateUtil.getDateMMDDYYYY(tdtFirstInstall.getDateValue()));
                    gCalendar.setTime(DateUtil.getDateMMDDYYYY(tdtFirstInstall.getDateValue()));
                    gCalendarrepaydt.setGregorianChange(DateUtil.getDateMMDDYYYY(tdtFirstInstall.getDateValue()));
                    gCalendarrepaydt.setTime(DateUtil.getDateMMDDYYYY(tdtFirstInstall.getDateValue()));
                    int dateVal = observableRepay.getRepayScheduleIncrementType();
                    int incVal = observable.getInstallNo(txtNoInstall.getText(), dateVal);
                    date=new java.util.Date();
                    date=DateUtil.getDateMMDDYYYY(tdtFirstInstall.getDateValue());
                    if (txtNoInstallments.getText().equals("1"))
                        date=DateUtil.getDateMMDDYYYY(tdtFirstInstall.getDateValue());
                    ...
                    observableRepay.setTdtLastInstall(tdtLastInstall.getDateValue());
                    //                tdtFirstInstall.setDateValue(tdtFirstInstall.getDateValue());//repay
                    //                tdtFirstInstall.setDateValue(DateUtil.getStringDate(gCalendarrepaydt.getTime()));
                    //                observableRepay.setTdtFirstInstall(tdtFirstInstall.getDateValue()); //for repaydate
                    gCalendar = null;
    ...
    private void setRepayDefaultValueNewBtnPressed(){
        ...
        observableRepay.setTdtDisbursement_Dt(DateUtil.getStringDate(ClientUtil.getCurrentDate()));
    ...
    private void cboTypeOfFacilityActionPerformed(){
        ...
        observable.setCboTypeOfFacility(CommonUtil.convertObjToStr(cboTypeOfFacility.getSelectedItem()));
        if (strFacilityType.equals("ACC") || strFacilityType.equals("AOD")){
    ...
    private void changesInUIForAdvanceProducts(){
        ...
        //        tabLimitAmount.add(panPeakSanctionDetails, "PeakSanctionDetails", 5);
        //        panPeakSanctionDetails.setVisible(true);
        fieldsToHideBasedOnAccount(false);
        lblNoInstallments.setText(resourceBundle.getString("lblNoInstallments_PROD"));
        lblRepayFreq.setText("Period Freq");
    ...
    private void changesInUIForLoanProducts(){
        fieldsToHideBasedOnAccount(true);
            tabLimitAmount.add(panRepaymentSchedule, "Repayment Schedule");
        tabLimitAmount.remove(panAccountDetails);
...
//GEN-LAST:event_btnDelete_BorrowerActionPerformed
    ...
    public void callView(String currField) {
        ...
        if ((currField.equals("CUSTOMER ID")) || (currField.equals("JOINT ACCOUNT"))){
            ...
            //            } else {
            viewMap.put("MAPNAME", "getSelectAgriLoanAccInfoList");
            //            }
            HashMap whereMap = new HashMap();
    ...
    private void tdtFromFocusLost(){
        ...
        //should not cross sanction date
        if(updateInterest){
            ArrayList firstList=(ArrayList)((EnhancedTableModel)observableInt.getTblInterestTab()).getDataArrayList().get(0);
            ArrayList list=(ArrayList)((EnhancedTableModel)observableInt.getTblInterestTab()).getDataArrayList().get(tblInterMaintenance.getSelectedRow());
            Date firstSlabDt=DateUtil.getDateMMDDYYYY(CommonUtil.convertObjToStr(firstList.get(1)));
            Date selectedtSlabDt=DateUtil.getDateMMDDYYYY(CommonUtil.convertObjToStr(list.get(1)));
            if(DateUtil.dateDiff(firstSlabDt,selectedtSlabDt)==0){
                Date enteredDt=DateUtil.getDateMMDDYYYY(CommonUtil.convertObjToStr(tdtFrom.getDateValue()));
                Date sanctionDt=DateUtil.getDateMMDDYYYY(CommonUtil.convertObjToStr(tdtSanctionDate.getDateValue()));
                if(DateUtil.dateDiff(enteredDt,sanctionDt)<0){
                    ClientUtil.showMessageWindow("First Slab Rate From Date Should be less than or equal to " +
                    tdtSanctionDate.getDateValue());
                    tdtFrom.setDateValue("");
                    return;
                }
            }
        }
    ...
    private void chkGurantorActionPerformeds(){
        if(chkGurantor.isSelected()){
            tabLimitAmount.add(panGuarantorDetails,resourceBundle.getString("panGuarantorDetails"));
    ...
    private void chkInsuranceActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_chkInsuranceActionPerformed
        ...
        if(!chkInsurance.isSelected()) {
            if(observable.getTblInsuranceDetails().getDataArrayList().size()>0){
                ClientUtil.showMessageWindow("Delete record from Insurance Details");
                chkInsurance.setSelected(true);
                return;
            }
        }
    ...
    private void rdoFullySecuredActionPerformed(){
        if (rdoSecurityDetails_Fully.isSelected()){
            ...
            String strFacilityType = getCboTypeOfFacilityKeyForSelected();
            tabLimitAmount.add(panSecurityDetails,resourceBundle.getString("panSecurityDetails"));
    ...
    private void btnInterestMaintenanceSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnInterestMaintenanceSaveActionPerformed
        ...
        if(((EnhancedTableModel)observableInt.getTblInterestTab()).getRowCount()==0) {
            String sanctionDt=CommonUtil.convertObjToStr(tdtSanctionDate.getDateValue());
            ClientUtil.validateFromDate(tdtFrom,sanctionDt,true);
            if (mandatoryMessage.length() > 0 || tdtFrom.getDateValue().length()==0 ){
                if (mandatoryMessage.length() > 0)
    ...
    private void authorizeActionPerformed(String authorizeStatus){
        ...
        if ((viewType.equals(AUTHORIZE) || viewType.equals(EXCEPTION) || viewType.equals(REJECT)) && isFilled){
            ...
            todMap.put("CURR_DT",ClientUtil.getCurrentDate());
            ...
            //            else
            mapParam.put(CommonConstants.MAP_NAME, "getSelectAgriTermLoanAuthorizeTOList");
...
//        strWarnMsg = null;
    ...
    private void setInsuranceBtnEnableDisable(boolean val){
        btnInsuranceDetailsNew.setEnabled(val);
        btnInsuranceDetailsSave.setEnabled(val);
        btnInsuranceDetailsDelete.setEnabled(val);
    }
    private void setInsuranceNewBtnEnableDisable(boolean val){
        btnInsuranceDetailsNew.setEnabled(!val);
        btnInsuranceDetailsSave.setEnabled(val);
        btnInsuranceDetailsDelete.setEnabled(val);
    }
    ...
    private void displayTabsByAccountNumber(){
        ...
        if (observable.getStrACNumber().length() > 0){
            ...
            btnsDisableBasedOnAccountNumber();
            //sublimit ui enable disable
            subLimitUI. enableDisableInspectionButton(false);
            subLimitUI.enableDisableSubLimitButton(false);
            setDefaultValB4AcctCreation();
            observable.resetSubLimitInsureance();
        ...
        if(shareList !=null && shareList.size()>0) {
            ...
            if(share !=null && share.size()>0){
                ...
                if(notElegibleLoan !=null && notElegibleLoan.equals("Y") && shareMap.get("NOT_ELIGIBLE_DT")!=null ){
                    ...
                    if(DateUtil.dateDiff(eligibal_dt,ClientUtil.getCurrentDate())<0)
    ...
    private boolean btnFacilitySavePressed(){
        ...
        if (productBasedValidation()){
            mandatoryMessage5 = new AgriTermLoanMRB().getString("rdoMultiDisburseAllow_Yes");
        }
        ...
        if (mandatoryMessage1.length() > 0 || mandatoryMessage2.length() > 0 || mandatoryMessage3.length() > 0 || mandatoryMessage4.length() > 0 || mandatoryMessage5.length() > 0 || mandatoryMessage6.length() > 0 || mandatoryMessage7.length() > 0 || mandatoryMessage8.length() > 0){
            ...
            System.out.println("@@@@ tblSecurityTable.getRowCount() : "+tblSecurityTable.getRowCount());
            if (isTablesInEditMode(false) && allCTablesNotNull() && checkForSecurityValue() && repayTableNotNull() && observable.checkSubLimitDetails(txtLimit_SD.getText()) && observable.checkMaxAmountRange(tdtTDate.getDateValue())){
                updateOBFields();
    ...
    private String validateOtherDetailsMandatoryFields(){
        ...
        if ((strSelectedProdType.equals("AOD") || strSelectedProdType.equals("ACC"))){
            AgriTermLoanMRB objMandatoryRB = new AgriTermLoanMRB();
    ...
    private String isInterestDetailsExistForThisAcct(){
        StringBuffer stbWarnMsg = new StringBuffer("");
        String strSelectedProdType = getCboTypeOfFacilityKeyForSelected();
        if (!(strSelectedProdType.equals("AOD") || strSelectedProdType.equals("ACC")) && tblInterMaintenance.getRowCount() < 1){
            stbWarnMsg.append("\n");
    ...
    private void tblSanctionDetailsMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblSanctionDetailsMousePressed
        ...
        if(btnSave1.isEnabled()){
            ClientUtil.showMessageWindow("First Save Facility_details");
            return;
        }
        if (!(viewType.equals(AUTHORIZE) || viewType.equals("Delete")))
        ...
        if(CommonUtil.convertObjToStr(cboAccStatus.getSelectedItem()).equals("Closed")){
            ClientUtil.showMessageWindow("Already Account closed (OR)Account Closed but Authorization pending ");
            ClientUtil.enableDisable(this,false);
            btnSave.setEnabled(false);
        }
    ...
    private void tblSanctionDetailsPopulate(){
        ...
        if (tblSanctionDetails.getSelectedRow() >= 0 || loanType.equals("LTD") || sandetail){
            ...
            List behaveslike=ClientUtil.executeQuery("getAgriLoanBehaves", hash2);
            if(behaveslike !=null && behaveslike.size()>0){
                hash2=(HashMap)behaveslike.get(0);
            }
            if(hash2.containsKey("BEHAVES_LIKE")&& (!CommonUtil.convertObjToStr(hash2.get("BEHAVES_LIKE")).equals("AOD") ||
            CommonUtil.convertObjToStr(hash2.get("BEHAVES_LIKE")).equals("ACC")) && lblAcctNo_Sanction_Disp.getText() !=null &&
            lblAcctNo_Sanction_Disp.getText().length()>0){
                ...
                List lst=ClientUtil.executeQuery("checkTransactionATL", hash2);
                hash2=(HashMap)lst.get(0);
                transCount=0;
                transCount=CommonUtil.convertObjToInt(hash2.get("CNT"));
                System.out.print("hash###2"+hash2);
                Date curr_dt=ClientUtil.getCurrentDate();
                Date repay_dt=DateUtil.getDateMMDDYYYY(tdtFacility_Repay_Date.getDateValue());
                if(transCount !=0 || (DateUtil.dateDiff(repay_dt,curr_dt )>0) || observable.getShadowCredit()>0 || observable.getShadowDebit()>0 || observable.getClearBalance()!=0) {
            ...
            //renewal od
            if(DateUtil.dateDiff(DateUtil.getDateMMDDYYYY(observable.getTdtTDate()),DateUtil.getDateWithoutMinitues(ClientUtil.getCurrentDate()))>=0)
    ...
    private void btnSave1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSave1ActionPerformed
        ...
        if(observable.getStrACNumber().length()>0)
            mandatoryMessage =mandatoryMessage + new MandatoryCheck().checkMandatory(getClass().getName(), panFacilityProdID);
        /* mandatoryMessage1 length will be greater than 0 if the mandatory conditions are not satisfied and so the alert should be displayed*/
        if (chkMoratorium_Given.isSelected() && (txtFacility_Moratorium_Period.getText().length() == 0)){
            AgriTermLoanRB termLoanRB = new AgriTermLoanRB();
    ...
    private boolean sanctionDetailsBasedRepayment(){
        ...
        if(! acct_num.equals("")){
            ...
            List lst=ClientUtil.executeQuery("getSelectTermLoanSanctionFacilityTO.AUTHORIZE", map);
            if(lst !=null && lst.size()>0){
                boolean deleteRecord=false;
                AgriTermLoanSanctionFacilityTO termLoanSanctionFacilityTO=(AgriTermLoanSanctionFacilityTO)lst.get(0);
                ...
                if(DateUtil.dateDiff(termLoanSanctionFacilityTO.getFromDt(),DateUtil.getDateMMDDYYYY(tdtFDate.getDateValue()))!=0){
                    deleteRecord=true;
                    msg.append("Actual From Date      :"+termLoanSanctionFacilityTO.getFromDt()+"\n"+
                    "Change From Date "+txtLimit_SD.getText()+"\n");
                ...
                if(termLoanSanctionFacilityTO.getNoInstall().doubleValue()!=CommonUtil.convertObjToDouble(txtNoInstallments.getText()).doubleValue()){
                    deleteRecord=true;
                    msg.append("Actual Installment     :"+termLoanSanctionFacilityTO.getNoInstall().doubleValue()+"\n"+
                    "Change Installment "+txtNoInstallments.getText()+"\n");
                ...
                if(termLoanSanctionFacilityTO.getRepaymentFrequency().doubleValue() !=CommonUtil.convertObjToDouble(((ComboBoxModel)cboRepayFreq.getModel()).getKeyForSelected()).doubleValue()){
                    deleteRecord=true;
                    msg.append("Actual Repayment Frequency     :"+termLoanSanctionFacilityTO.getRepaymentFrequency().doubleValue()+"\n"+
                    "Change Repayment Frequency "+CommonUtil.convertObjToDouble(((ComboBoxModel)cboRepayFreq.getModel()).getKeyForSelected()).doubleValue()+"\n");
                ...
                if(!CommonUtil.convertObjToStr(txtFacility_Moratorium_Period.getText()).equals("")){
                    if(termLoanSanctionFacilityTO.getNoMoratorium().doubleValue()!=CommonUtil.convertObjToDouble(txtFacility_Moratorium_Period.getText()).doubleValue()){
                        deleteRecord=true;
                        msg.append("Actual Morotorium     :"+termLoanSanctionFacilityTO.getNoMoratorium().doubleValue()+"\n"+
                        "Change Limit "+txtFacility_Moratorium_Period.getText()+"\n");
                        
                    }
                }
                if( deleteRecord){
                    msg.append("we shoude create new Repayment Schedule");
    ...
    private void btnNew1Action(){
        ...
        btnsDisableBasedOnAccountNumber();
        observable.ttNotifyObservers();
        //        tdtFDate.setDateValue(DateUtil.getStringDate(DateUtil.addDays(ClientUtil.getCurrentDate(), 30)));
        //        tdtFDate.setDateValue(DateUtil.getStringDate(ClientUtil.getCurrentDate()));tdtSanctionDate for mahila sandate assend as from date
    ...
    private void btnNew2_SDAction(){
        ...
        observable.setTdtSanctionDate(DateUtil.getStringDate(ClientUtil.getCurrentDate()));
        observable.ttNotifyObservers();
    ...
    private boolean isTablesInEditMode(boolean isMainSave){
        ...
        StringBuffer stbWarnMsg = new StringBuffer("");
        if (authSignUI.isUpdateModeAuthorize() && observable.getStrACNumber().length()>0  && chkAuthorizedSignatory.isSelected()){//authSignUI.isUpdateModeAuthorize() &&
            stbWarnMsg.append(resourceBundle.getString("authSignatoryEditWarning"));
            stbWarnMsg.append("\n");
        }
        
        //        if (authSignUI.isUpdateModeAuthorize() &&observable.getStrACNumber().length()>0  && chkStockInspect.isSelected()){//authSignUI.isUpdateModeAuthorize() &&
        //            stbWarnMsg.append(resourceBundle.getString("valuationEditWarning"));
        //            stbWarnMsg.append("\n");
        //        }
        
        if (isInsuranceUpdate && observable.getStrACNumber().length()>0){
            stbWarnMsg.append(resourceBundle.getString("insuranceEditWarning"));
            stbWarnMsg.append("\n");
        }
        
        if (authSignUI.isUpdateModeAuthorizeInst() && observable.getStrACNumber().length()>0){
            stbWarnMsg.append(resourceBundle.getString("authSignatoryInstEditWarning"));
            stbWarnMsg.append("\n");
        }
        if ( poaUI.isUpdateModePoA() && observable.getStrACNumber().length()>0 && chkPOFAttorney.isSelected()){  //poaUI.isUpdateModePoA() &&
    ...
    private boolean repayTableNotNull(){
        ...
        if(behaves !=null && (!(behaves.equals("AOD")||behaves.equals("ACC"))))
    ...
    private boolean allCTablesNotNull(){
        ...
        if (!observable.getStrACNumber().equals("") && chkAuthorizedSignatory.isSelected() && observable.getAuthorizeSigantoryRecord() < 1){
            strWarning = strWarning + resourceBundle.getString("existenceAurhorizedSignatoryTableWarning")+"\n";
        }
        
        //check POA details
        if (!observable.getStrACNumber().equals("") && chkPOFAttorney.isSelected() && observable.getPOARecord() < 1){
            strWarning = strWarning + resourceBundle.getString("existencePOATableWarning")+"\n";
        }
        
        //check Gurantor details
        ...
        //check InsuranceDetails details
        if (!observable.getStrACNumber().equals("") && chkInsurance.isSelected() && tblInsuranceDetails.getRowCount() < 1){
            strWarning = strWarning + resourceBundle.getString("existenceInsuranceTableWarning")+"\n";
        }
        //check security details
        if (!observable.getStrACNumber().equals("") && (rdoSecurityDetails_Partly.isSelected() || rdoSecurityDetails_Fully.isSelected()) && tblSecurityTable.getRowCount() < 1){
            strWarning = strWarning + resourceBundle.getString("existenceSecurityWarning")+"\n";
        }
        //check interest details
        if (!observable.getStrACNumber().equals("") && tblInterMaintenance.getRowCount() < 1){
            strWarning = strWarning + resourceBundle.getString("existenceInterestWarning")+"\n";
        }
        //check SubLimit details
        if (!observable.getStrACNumber().equals("") && rdoAccLimit_Submit.isSelected()&& observable.getSubLimitTableRecord() < 1 && observable.getInspectionTableRecord()< 1){
            strWarning = strWarning + resourceBundle.getString("existenceSubLimitWarning")+"\n";
        }
        
        //check SubLimit details
        if (!observable.getStrACNumber().equals("") && chkStockInspect.isSelected() && observable.getSubSidyTableRecord() < 1 && observable.getValutionTableRecord()< 1){
            strWarning = strWarning + resourceBundle.getString("existenceSubsidyWarning")+"\n";
        }
        //        if (!observable.getStrACNumber().equals("")&&  tblRepaymentCTable.getRowCount() < 1 ) //&&  tblRepaymentCTable.getRowCount() < 1
    ...
    private void btnnewActionPerformed(){
        btnNewPressed = true;
        //        tabLimitAmount.removeAll();
        //        tabLimitAmount.add(panBorrowCompanyDetails,panBorrowCompanyDetails,0);
        setFocusFirstTab();
        resetAllExtendedTab();
        observable.destroyObjects();
        observable.createObject();
    ...
    private void popUp(String field) {
        ...
        if(field.equals("Edit") || field.equals("Delete") || field.equals("Enquirystatus") ) {
            ...
            if (loanType.equals("LTD"))
                ...
                viewMap.put(CommonConstants.MAP_NAME, "viewAgriTermLoan");
        ...
        if (viewType != null) {
            if (viewType.equals("Edit") || viewType.equals("Delete") || viewType.equals(AUTHORIZE) || viewType.equals(EXCEPTION) || viewType.equals(REJECT) || viewType.equals("Enquirystatus")) {
                ...
                if (viewType.equals(AUTHORIZE) || viewType.equals(EXCEPTION) || viewType.equals(REJECT) || viewType.equals("Delete")){
                    ...
                    //                    tabLimitAmount.removeAll();
                    //                    tabLimitAmount.add(panSanctionDetails,panSanctionDetails,0);
            ...
            }else if(viewType.equals("DEBIT_ACT_NO")){
                String act_num=CommonUtil.convertObjToStr(hash.get("ACT_NUM"));
                if(act_num.equals("")){
                    act_num=CommonUtil.convertObjToStr(hash.get("ACCOUNTNO"));
                    if(act_num.equals(""))
                        act_num=CommonUtil.convertObjToStr(hash.get("A/C HEAD"));
                }
                txtFromActNo.setText(act_num);
            }
    ...
    private void setAllFacilityDetailsEnableDisable(boolean val){
        ...
        chkPOFAttorney.setEnabled(val);
        chkAuthorizedSignatory.setEnabled(val);
        chkDocDetails.setEnabled(val);
    ...
    private void setAllGuarantorDetailsEnableDisable(boolean val){
        ...
        cboSecurityType.setEnabled(val);
    }
    ...
    public static void main(String args[]) {
        ...
        AgriTermLoanUI termLoanUI = new AgriTermLoanUI();
    ...
    private com.see.truetransact.uicomponent.CButton btnInsuranceDetailsDelete;
    private com.see.truetransact.uicomponent.CButton btnInsuranceDetailsNew;
    private com.see.truetransact.uicomponent.CButton btnInsuranceDetailsSave;
    ...
    private com.see.truetransact.uicomponent.CComboBox cboCardPeriod;
    private com.see.truetransact.uicomponent.CComboBox cboCardType;
    ...
    private com.see.truetransact.uicomponent.CComboBox cboDebitProdId;
    private com.see.truetransact.uicomponent.CComboBox cboDebitProdType;
    ...
    private com.see.truetransact.uicomponent.CComboBox cboInsDetails;
    private com.see.truetransact.uicomponent.CComboBox cboInsUnderScheme;
    ...
    private com.see.truetransact.uicomponent.CComboBox cboNatureOfRiskCoverd;
    ...
    private com.see.truetransact.uicomponent.CComboBox cboSelectScreen;
    ...
    private com.see.truetransact.uicomponent.CCheckBox chkInspection;
    ...
    private com.see.truetransact.uicomponent.CLabel lblAccountOpenDate;
    ...
    private com.see.truetransact.uicomponent.CLabel lblCardLimit;
    private com.see.truetransact.uicomponent.CLabel lblCardType;
    private com.see.truetransact.uicomponent.CLabel lblCardValidity;
    ...
    private com.see.truetransact.uicomponent.CLabel lblDebitProdId;
    private com.see.truetransact.uicomponent.CLabel lblDebitProdType;
    ...
    private com.see.truetransact.uicomponent.CLabel lblFromActNo;
    private com.see.truetransact.uicomponent.CLabel lblFromActNo1;
    ...
    private com.see.truetransact.uicomponent.CLabel lblInsComName;
    private com.see.truetransact.uicomponent.CLabel lblInsDetails;
    private com.see.truetransact.uicomponent.CLabel lblInsExpiryDt;
    private com.see.truetransact.uicomponent.CLabel lblInsFrom;
    private com.see.truetransact.uicomponent.CLabel lblInsIssueDt;
    private com.see.truetransact.uicomponent.CLabel lblInsUnderScheme;
    ...
    private com.see.truetransact.uicomponent.CLabel lblNatureOfRiskCoverd;
    ...
    private com.see.truetransact.uicomponent.CLabel lblPhoneNo;
    ...
    private com.see.truetransact.uicomponent.CLabel lblPolicyNo;
    ...
    private com.see.truetransact.uicomponent.CLabel lblReviewDate;
    ...
    private com.see.truetransact.uicomponent.CLabel lblSelectScreen;
    ...
    private com.see.truetransact.uicomponent.CPanel panCardPeriod;
    ...
    private com.see.truetransact.uicomponent.CPanel panFacilityChkBoxes1;
    ...
    private com.see.truetransact.uicomponent.CPanel panInsuranceButtons;
    private com.see.truetransact.uicomponent.CPanel panInsuranceDetails;
    private com.see.truetransact.uicomponent.CPanel panInsuranceDetailsFields;
    private com.see.truetransact.uicomponent.CPanel panInsuranceDetailsTable;
    private com.see.truetransact.uicomponent.CPanel panInsuranceDetails_Table;
    ...
    private javax.swing.JRadioButton rdoDirectFin;
    private com.see.truetransact.uicomponent.CButtonGroup rdoDirectFinance;
    ...
    private javax.swing.JRadioButton rdoInDirectFin;
    ...
    private javax.swing.JRadioButton rdoNonPrioritySec;
    ...
    private javax.swing.JRadioButton rdoPrioritySec;
    private com.see.truetransact.uicomponent.CButtonGroup rdoPrioritySector;
    ...
    private com.see.truetransact.uicomponent.CDateField tdtInsExpiryDt;
    private com.see.truetransact.uicomponent.CDateField tdtInsFrom;
    private com.see.truetransact.uicomponent.CDateField tdtInsIssueDt;
    ...
    private com.see.truetransact.uicomponent.CDateField tdtReviewDate;
    ...
    private com.see.truetransact.uicomponent.CTextArea txtAreaRemarks;
    ...
    private com.see.truetransact.uicomponent.CTextField txtCardLimit;
    private com.see.truetransact.uicomponent.CTextField txtCardPeriod;
    ...
    private com.see.truetransact.uicomponent.CTextField txtFromActNo;
    private com.see.truetransact.uicomponent.CTextField txtFromActNo1;
    ...
    private com.see.truetransact.uicomponent.CTextField txtInsComName;
    ...
    private com.see.truetransact.uicomponent.CTextField txtPolicyNo;
