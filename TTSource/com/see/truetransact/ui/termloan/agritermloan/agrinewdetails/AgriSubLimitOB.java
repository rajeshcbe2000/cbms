 ...
 */
public class AgriSubLimitOB extends CObservable{
    
    private String lblStatus = ClientConstants.ACTION_STATUS[ClientConstants.ACTIONTYPE_CANCEL];
    private static  AgriSubLimitOB agriSubLimitOB;
    private static final Logger log = Logger.getLogger(AgriSubLimitOB.class);
    java.util.ResourceBundle agriTermLoanRB = java.util.ResourceBundle.getBundle("com.see.truetransact.ui.termloan.agritermloan.agrinewdetails.AgriSubLimitRB",ProxyParameters.LANGUAGE);
    ...
    private void fillDropDown()throws Exception{
        ...
        lookup_keys.add("AGRILOAN_PURPOSE_CODE");
    ...
    public void setSubLimitTO(ArrayList subLimitList,String act_num,ArrayList subLimitDetails){
        LinkedHashMap finalMap=new LinkedHashMap();
        ...
        if(subLimitList !=null){
            for(int i=0;i<subLimitList.size();i++){
                ...
                singleSubLimitMap.put("SUBLIMIT",CommonUtil.convertObjToStr(agriSubLimitTO.getSubLimit()));
                singleSubLimitMap.put("SUBLIMIT_FROMDT",CommonUtil.convertObjToStr(agriSubLimitTO.getStartDt()));
                singleSubLimitMap.put("SUBLIMIT_TODT",CommonUtil.convertObjToStr(agriSubLimitTO.getEndDt()));
                singleSubLimitMap.put("ACCT_NUM",act_num);
