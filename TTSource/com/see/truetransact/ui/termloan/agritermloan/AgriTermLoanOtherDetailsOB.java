 ...
 * 
 * AgriTermLoanOtherDetailsOB.java
 *
 ...
 * @author  152713
 */
public class AgriTermLoanOtherDetailsOB extends CObservable{
    
    private       static AgriTermLoanOtherDetailsOB termLoanOtherDetailsOB;
    
    private final static Logger log = Logger.getLogger(AgriTermLoanOtherDetailsOB.class);
    ...
    public AgriTermLoanOtherDetailsOB() throws Exception{
    ...
    static {
        try {
            termLoanOtherDetailsOB = new AgriTermLoanOtherDetailsOB();
        } catch(Exception e) {
            log.info("try: " + e);
    ...
    public static AgriTermLoanOtherDetailsOB getInstance() {
    ...
    public void setTermLoanOtherDetailsTO(AgriTermLoanOtherDetailsTO termLoanOtherDetailsTO){
        try{
    ...
    public AgriTermLoanOtherDetailsTO setTermLoanOtherDetails(){
        final AgriTermLoanOtherDetailsTO termLoanOtherDetailsTO = new AgriTermLoanOtherDetailsTO();
        try{
...
//                termLoanOtherDetailsTO.setDrCardExprdt(DateUtil.getDateMMDDYYYY(CommonUtil.convertObjToStr(getTdtDebitToDateAD())));
    ...
    public void populateProdLevelValB4AcctCreation(String strProdID){
        try{
            ...
            List resultList = ClientUtil.executeQuery("getAgriProdLevelOtherDetails", transactionMap);
