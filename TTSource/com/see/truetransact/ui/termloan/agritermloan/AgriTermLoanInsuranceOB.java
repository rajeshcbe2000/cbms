...
public class AgriTermLoanInsuranceOB extends CObservable{
    
    /** Creates a new instance of TermLoanInsuranceOB */
    private AgriTermLoanInsuranceOB() throws Exception{
        curDate = ClientUtil.getCurrentDate();
        termLoanInsuranceOB();
    }
    
    private       static AgriTermLoanInsuranceOB termLoanInsuranceOB;
    
    private final static Logger log = Logger.getLogger(AgriTermLoanInsuranceOB.class);
...
//    private final   String  PRODUCT_ID = "PRODUCT_ID";
    ...
    private final   AgriTermLoanRB objTermLoanRB = new AgriTermLoanRB();
    ...
    static {
        try {
            termLoanInsuranceOB = new AgriTermLoanInsuranceOB();
        } catch(Exception e) {
            log.info("try: " + e);
    ...
    public static AgriTermLoanInsuranceOB getInstance() {
