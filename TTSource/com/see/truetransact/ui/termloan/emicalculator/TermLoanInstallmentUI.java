 ...
 * @author  152713
 */
public class TermLoanInstallmentUI extends CDialog implements Observer, UIMandatoryField{
    HashMap mandatoryMap;
    HashMap data;
    TermLoanUI parent = null;
    GoldLoanUI parentGoldLoanUI = null;
    DepositLoanUI parentDepositLoanUI = null;
    LoanApplicationUI parentLoanApplicationUI = null;
    
    TransDetailsUI parantTransUI =null; 
   	final TermLoanInstallmentRB resourceBundle = new TermLoanInstallmentRB();
    TermLoanInstallmentOB observable;
    ...
    TrueTransactMain trueTransactMain;
    /**
     ...
     */
    public TermLoanInstallmentUI(TermLoanUI parent, HashMap data, boolean hideSubmit) {
    ...
    public TermLoanInstallmentUI(GoldLoanUI parent, HashMap data, boolean hideSubmit) {
...
//            setupScreen();
     ...
     public TermLoanInstallmentUI(LoanApplicationUI parent, HashMap data, boolean hideSubmit) {
        System.out.println("here .....in LoanApplicationUI ");
        this.parentLoanApplicationUI = parent;
        parentWindow = parent;
        setupinit(data);
        if (data !=null && (!data.containsKey("LTD")))
            setupScreen();
     ...
     public TermLoanInstallmentUI(DepositLoanUI parent, HashMap data, boolean hideSubmit) {
        this.parentDepositLoanUI = parent;
        parentWindow = parent;
        setupinit(data);
		canShow = true;
        data.put("LTD", "");
...
//            setupScreen();
    ...
    public TermLoanInstallmentUI(TermLoanUI parent, HashMap data) {
...
//        populateData();
    ...
    public TermLoanInstallmentUI(boolean goldLoanUI, GoldLoanUI parent, HashMap data) {
        this(parent, data, false);
        parentWindow = parent;
//        populateData();
    }
   
     public TermLoanInstallmentUI(TransDetailsUI parent, HashMap data, boolean hideSubmit) {
...
//        populateData();
    ...
    public TermLoanInstallmentUI() {
        this(null, null);
        show();
    }
    
    public void setTrueTransactMain(TrueTransactMain trueTransactMain) {
        this.trueTransactMain = trueTransactMain;
    }
...
//       btnOkActionPerformed();
       try{
        ...
        if (!canShow && (mandatoryKeyValueCheck(data) == true)){
            ...
            if (data != null){
                ...
                setPopulateFieldsEnableDisable(true);//Enable Populating fields
                //panSubmitBtn.setVisible(false);// Commented by nithya 02-08-2017
                btnPrint.setVisible(true); // Added by nithya on 02-08-2017
                btnSubmit.setVisible(false);
                panInstallmentFields.setVisible(false);
                isUserDefinedPanelVisible = false;
            }
    ...
    private void setObservable(){
        observable = new TermLoanInstallmentOB();
...
/* Auto Generated Method - getMandatoryHashMap()
   Getter method for setMandatoryHashMap().*/
    ...
    private void initComponents() {
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.EAST;
        gridBagConstraints.insets = new java.awt.Insets(1, 55, 1, 4);
        ...
        gridBagConstraints.gridx = 3;
        gridBagConstraints.gridy = 2;
        gridBagConstraints.insets = new java.awt.Insets(1, 15, 1, 4);
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.EAST;
        panAcctInfo.add(lblloanBalance, gridBagConstraints);

        txtLoanBalance.setMinimumSize(new java.awt.Dimension(100, 21));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 3;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        gridBagConstraints.insets = new java.awt.Insets(1, 4, 1, 4);
        panAcctInfo.add(txtLoanBalance, gridBagConstraints);

        lblMoratoriumPeriodInterst.setText("Moratorium Period Interst");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 4;
        gridBagConstraints.gridy = 2;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.LINE_END;
        panAcctInfo.add(lblMoratoriumPeriodInterst, gridBagConstraints);

        txtMoratoriumInt.setMinimumSize(new java.awt.Dimension(100, 21));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 5;
        gridBagConstraints.gridy = 2;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.LINE_START;
        gridBagConstraints.insets = new java.awt.Insets(4, 0, 4, 0);
        panAcctInfo.add(txtMoratoriumInt, gridBagConstraints);
        ...
        srpInstallmentTable.setVerticalScrollBarPolicy(javax.swing.ScrollPaneConstants.VERTICAL_SCROLLBAR_ALWAYS);
        ...
        panInstallmentFields.setBorder(javax.swing.BorderFactory.createTitledBorder("Installment Details"));
        ...
        panSubmitBtn.add(btnPrint, gridBagConstraints);
...
//            btnSubmitActionPerformed();
//        System.out.println("#@#@#@#@#@#@#@ 1 exit here trueTransactMain visible :"+trueTransactMain.isVisible());
...
//        }
        if (observable.checkLoanLimit()) {
            ...
            this.dispose();
            if (parent != null) {
                ((TermLoanUI) parent).repaymentFillData(observable.getInstallmentAll(), observable.getTotalRepayAmount());
            }
            if (parentGoldLoanUI != null) {
                ((GoldLoanUI) parentGoldLoanUI).repaymentFillData(observable.getInstallmentAll(), observable.getTotalRepayAmount());
            }
            if (parentDepositLoanUI != null) {
                ((DepositLoanUI) parentDepositLoanUI).repaymentFillData(observable.getInstallmentAll(), observable.getTotalRepayAmount());
            }
        } else {
    ...
    private void exitForm(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_exitForm
        ...
        observable = null;
        this.dispose();
        TrueTransactMain.setAlreadyOpen(false);
...
private void btnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPrintActionPerformed
    ...
    public static void main(String args[]) {
        ...
        new TermLoanInstallmentUI().show();
    }
