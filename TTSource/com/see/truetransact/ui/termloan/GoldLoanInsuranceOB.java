...
public class GoldLoanInsuranceOB extends CObservable{
    
    /** Creates a new instance of TermLoanInsuranceOB */
    private GoldLoanInsuranceOB() throws Exception{
        curDate = ClientUtil.getCurrentDate();
        termLoanInsuranceOB();
    }
    
    private       static GoldLoanInsuranceOB termLoanInsuranceOB;
    
    private final static Logger log = Logger.getLogger(GoldLoanInsuranceOB.class);
...
//    private final   String  PRODUCT_ID = "PRODUCT_ID";
    ...
    private final   GoldLoanRB objTermLoanRB = new GoldLoanRB();
    ...
    static {
        try {
            termLoanInsuranceOB = new GoldLoanInsuranceOB();
        } catch(Exception e) {
            log.info("try: " + e);
    ...
    public static GoldLoanInsuranceOB getInstance() {
...
//                termLoanInsuranceTO.setExpiryDt((Date)oneRecord.get(EXPIRY_DATE));
                termLoanInsuranceTO.setExpiryDt(getProperDateFormat(oneRecord.get(EXPIRY_DATE)));
...
//                termLoanInsuranceTO.setPolicyDt((Date)oneRecord.get(POLICY_DATE));
                termLoanInsuranceTO.setPolicyDt(getProperDateFormat(oneRecord.get(POLICY_DATE)));
