 ...
 * @author bala
 */
public class LoanSubsidyProvisionOB extends CObservable {
...
//            setResul t(ClientConstants.RESULT_STATUS[4]);
    ...
    public void doAction(String actionType){
        try
        {
            ...
            finalMap.put("TermLoanSubsidyTO",getTermLoanSubsidyTO());
            finalMap.put(CommonConstants.BRANCH_ID,ProxyParameters.BRANCH_ID);
            finalMap.put("SOURCE_SCREEN","LOAN_SUBSIDY_PROVISION_IN_BETWEEN");
