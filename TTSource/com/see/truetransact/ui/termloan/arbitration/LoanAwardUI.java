 ...
 * @author balachandar
 */
public class LoanAwardUI extends com.see.truetransact.uicomponent.CInternalFrame implements Observer, ListSelectionListener {
//    private final AuthorizeRB resourceBundle = new AuthorizeRB();

    private LoanAwardOB observable;
    ...
    private final static Logger log = Logger.getLogger(LoanAwardUI.class);
    ...
    public LoanAwardUI() {
        ...
        ClientUtil.enableDisable(panAward, false);
     ...
     * Creates new form AuthorizeUI
     */
    public LoanAwardUI(CInternalFrame parent, HashMap paramMap) {
        this.parent = parent;
...
//        txtLastNoticeSentBefore.setMaxLength(3);
        ...
        txtAwardNo.setAllowAll(true);
        txtInspOrderNo.setAllowAll(true);
...
//            }
    ...
    private void initComponents() {
        ...
        lblArbDtFrom = new com.see.truetransact.uicomponent.CLabel();
        tdtArbDtTo = new com.see.truetransact.uicomponent.CDateField();
        lblArbDateTo = new com.see.truetransact.uicomponent.CLabel();
        tdtArbDtFrom = new com.see.truetransact.uicomponent.CDateField();
        ...
        lblAwardNo = new com.see.truetransact.uicomponent.CLabel();
        txtAwardNo = new com.see.truetransact.uicomponent.CTextField();
        lblAwardDate = new com.see.truetransact.uicomponent.CLabel();
        txtInspOrderNo = new com.see.truetransact.uicomponent.CTextField();
        tdtAwardDate = new com.see.truetransact.uicomponent.CDateField();
        tdtInspOrderDate = new com.see.truetransact.uicomponent.CDateField();
        lbInspOrderNo = new com.see.truetransact.uicomponent.CLabel();
        lblInspOrderDate = new com.see.truetransact.uicomponent.CLabel();
        ...
        lblTotalCharge = new com.see.truetransact.uicomponent.CLabel();
        cLabel5 = new com.see.truetransact.uicomponent.CLabel();
        lblTotalARC = new com.see.truetransact.uicomponent.CLabel();
        ...
        lblArbDtFrom.setText("Arbitration Date Between");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 0;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        gridBagConstraints.insets = new java.awt.Insets(2, 2, 2, 2);
        panArbit.add(lblArbDtFrom, gridBagConstraints);
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 3;
        gridBagConstraints.gridy = 0;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.EAST;
        gridBagConstraints.insets = new java.awt.Insets(2, 2, 2, 2);
        panArbit.add(tdtArbDtTo, gridBagConstraints);

        lblArbDateTo.setText("and");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 2;
        gridBagConstraints.gridy = 0;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        gridBagConstraints.insets = new java.awt.Insets(2, 2, 2, 2);
        panArbit.add(lblArbDateTo, gridBagConstraints);
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 0;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.EAST;
        gridBagConstraints.insets = new java.awt.Insets(2, 2, 2, 2);
        panArbit.add(tdtArbDtFrom, gridBagConstraints);
        ...
        panArbit.add(lblProdType, gridBagConstraints);
        ...
        btnEdit.setMaximumSize(new java.awt.Dimension(71, 27));
        btnEdit.setMinimumSize(new java.awt.Dimension(71, 27));
        btnEdit.setPreferredSize(new java.awt.Dimension(71, 27));
        ...
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 1;
        panMultiSearch1.add(btnEdit, gridBagConstraints);
        ...
        panAward.setLayout(new java.awt.GridBagLayout());
        ...
        panAward.add(lblAwardNo, gridBagConstraints);
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 0;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.SOUTHEAST;
        gridBagConstraints.insets = new java.awt.Insets(3, 3, 3, 3);
        panAward.add(txtAwardNo, gridBagConstraints);

        lblAwardDate.setText("Award Date");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 1;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        gridBagConstraints.insets = new java.awt.Insets(3, 3, 3, 3);
        panAward.add(lblAwardDate, gridBagConstraints);
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 2;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.SOUTHEAST;
        gridBagConstraints.insets = new java.awt.Insets(3, 3, 3, 3);
        panAward.add(txtInspOrderNo, gridBagConstraints);
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 1;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.SOUTHEAST;
        gridBagConstraints.insets = new java.awt.Insets(3, 3, 3, 3);
        panAward.add(tdtAwardDate, gridBagConstraints);
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 3;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.SOUTHEAST;
        gridBagConstraints.insets = new java.awt.Insets(3, 3, 3, 3);
        panAward.add(tdtInspOrderDate, gridBagConstraints);

        lbInspOrderNo.setText("Inspector Order No");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 2;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        gridBagConstraints.insets = new java.awt.Insets(3, 3, 3, 3);
        panAward.add(lbInspOrderNo, gridBagConstraints);

        lblInspOrderDate.setText("Inspector Order Date");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 3;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        gridBagConstraints.insets = new java.awt.Insets(3, 3, 3, 3);
        panAward.add(lblInspOrderDate, gridBagConstraints);
        ...
        panAward.add(btnAdd, gridBagConstraints);

        panSearchCondition.add(panAward, new java.awt.GridBagConstraints());
        ...
        gridBagConstraints.gridy = 0;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        gridBagConstraints.insets = new java.awt.Insets(8, 35, 9, 0);
        cPanel1.add(cLabel1, gridBagConstraints);
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 0;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        gridBagConstraints.insets = new java.awt.Insets(8, 18, 9, 0);
        cPanel1.add(lblSelectedRecords, gridBagConstraints);

        cLabel3.setText("Total Charge:");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 2;
        gridBagConstraints.gridy = 0;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        gridBagConstraints.insets = new java.awt.Insets(8, 96, 9, 0);
        ...
        cPanel1.add(lblTotalCharge, gridBagConstraints);

        cLabel5.setText("Total ARC Fee:");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 4;
        gridBagConstraints.gridy = 0;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        gridBagConstraints.insets = new java.awt.Insets(8, 113, 9, 0);
        cPanel1.add(cLabel5, gridBagConstraints);
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 5;
        gridBagConstraints.gridy = 0;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        gridBagConstraints.insets = new java.awt.Insets(8, 6, 9, 75);
        cPanel1.add(lblTotalARC, gridBagConstraints);
...
//        btnPostCharges.setEnabled(true);
    ...
    public void fillData(Object param) {
        ...
        if (isEdit) {
            ...
            HashMap whereMap = new HashMap();
            viewMap.put(CommonConstants.MAP_NAME, "getAwardDetailsForEdit");
            whereMap.put("AWARD_NO", CommonUtil.convertObjToStr(hash.get("AWARD_NO")));
...
//        }
        ...
        if (isOK) {
            ...
            if (lst != null && lst.size() > 0) {
             ...
             {
                viewMap.put(CommonConstants.MAP_NAME, "getArbitrationMDSDetails"); 
             }
             else
                viewMap.put(CommonConstants.MAP_NAME, "getArbitrationDetails");
...
//            }
            ...
            if (tdtArbDtFrom.getDateValue() != null && tdtArbDtFrom.getDateValue().length() > 0) {
                whereMap.put("ARB_FROMDT", getProperDate(DateUtil.getDateMMDDYYYY(tdtArbDtFrom.getDateValue())));
            }
            if (tdtArbDtTo.getDateValue() != null && tdtArbDtTo.getDateValue().length() > 0) {
                whereMap.put("ARB_TODT", getProperDate(DateUtil.getDateMMDDYYYY(tdtArbDtTo.getDateValue())));
            }
...
//        }
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        ...
        if (tblData.getRowCount() > 0) {
            for (int i = 0; i < tblData.getRowCount(); i++) {
                if (((Boolean) tblData.getValueAt(i, 0)).booleanValue()) {
                    tblData.setValueAt(txtAwardNo.getText(), i, 9);
                    tblData.setValueAt(tdtAwardDate.getDateValue(), i, 10);//DateUtil.getDateMMDDYYYY(
                    tblData.setValueAt(txtInspOrderNo.getText(), i, 11);
                    tblData.setValueAt(tdtInspOrderDate.getDateValue(), i, 12);//DateUtil.getDateMMDDYYYY(
                }
            }
        }
        ...
        if(tblData.getRowCount()>0){    
            ...
            for(int i=0; i < count; i++){
                if((Boolean)tblData.getValueAt(i, 0)){
                    selectedCount ++;
                    totalCharge += CommonUtil.convertObjToDouble(tblData.getValueAt(i, 4));
                    totalArcFee += CommonUtil.convertObjToDouble(tblData.getValueAt(i, 5));
                }
            }
            lblSelectedRecords.setText(CommonUtil.convertObjToStr(selectedCount));  
            lblTotalCharge.setText(CommonUtil.convertObjToStr(totalCharge));
            lblTotalARC.setText(CommonUtil.convertObjToStr(totalArcFee));
        }
    }
...
//        authorizeUI.show();
    ...
    private com.see.truetransact.uicomponent.CLabel lbInspOrderNo;
    private com.see.truetransact.uicomponent.CLabel lblArbDateTo;
    private com.see.truetransact.uicomponent.CLabel lblArbDtFrom;
    private com.see.truetransact.uicomponent.CLabel lblAwardDate;
    private com.see.truetransact.uicomponent.CLabel lblAwardNo;
    private com.see.truetransact.uicomponent.CLabel lblInspOrderDate;
    ...
    private com.see.truetransact.uicomponent.CLabel lblTotalARC;
    private com.see.truetransact.uicomponent.CLabel lblTotalCharge;
    ...
    private com.see.truetransact.uicomponent.CDateField tdtArbDtFrom;
    private com.see.truetransact.uicomponent.CDateField tdtArbDtTo;
    private com.see.truetransact.uicomponent.CDateField tdtAwardDate;
    private com.see.truetransact.uicomponent.CDateField tdtInspOrderDate;
    private com.see.truetransact.uicomponent.CTextField txtAwardNo;
    private com.see.truetransact.uicomponent.CTextField txtInspOrderNo;
