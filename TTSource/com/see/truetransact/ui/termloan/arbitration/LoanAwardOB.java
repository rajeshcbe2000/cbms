 ...
 * @author bala
 */
public class LoanAwardOB extends CObservable {
...
//    private ComboBoxModel cbmNoticeType;
    ...
    public HashMap insertCharges(HashMap whereMap) {
        ...
        // System.out.println("wheremappppp@@@@!!!1111>>>>",whereMap);
        obj.put("AWARD", "AWARD");
        if (whereMap.get("AWARD_LIST") != null) {
            obj.put("AWARD_LIST", whereMap.get("AWARD_LIST"));
...
//                selectedList.add(_tableModel.getValueAt(i, 1));
    ...
    public ArrayList populateData(HashMap mapID, CTable tblData) {
        ...
        System.out.println("Screen   : LoanAwardOB");
...
//            }
            ...
            _heading.add("AWARD_AMOUNT");
            _heading.add("AWARD_INTEREST");
            _heading.add("CHARGES");
            _heading.add("ARC_FEE");
            _heading.add("TOT_AMT");
            _heading.add("ARB_DATE");
            _heading.add("FILE_NO");
            _heading.add("AWARD_NO");
            _heading.add("AWARD_DATE");
            _heading.add("INSPECTOR_ORDER_NO");
            _heading.add("INSPECTOR_ORDER_DATE");
             _heading.add("NAME");
        }
...
//        System.out.println("lst"+list);
        for (int i = 0; i < list.size(); i++) {
            ...
            newList.add(CommonUtil.convertObjToStr(map.get("AWARD_AMOUNT")));
            newList.add(CommonUtil.convertObjToStr(map.get("AWARD_INTEREST")));
            ...
            newList.add(CommonUtil.convertObjToStr(map.get("ARB_DATE")));//DateUtil.getDateMMDDYYYY(
            newList.add(CommonUtil.convertObjToStr(map.get("FILE_NO")));
            if(editFlag!=null && editFlag.equals("Y")){
            newList.add(CommonUtil.convertObjToStr(map.get("AWARD_NO")));
            newList.add(CommonUtil.convertObjToStr(map.get("AWARD_DATE")));
            newList.add(CommonUtil.convertObjToStr(map.get("INSPECTOR_ORDER_NO")));
            newList.add(CommonUtil.convertObjToStr(map.get("INSPECTOR_ORDER_DATE")));    
            }else{
            newList.add("");
            newList.add("");
            newList.add("");
