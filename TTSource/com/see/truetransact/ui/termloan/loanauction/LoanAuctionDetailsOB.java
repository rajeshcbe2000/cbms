...
package com.see.truetransact.ui.termloan.loanauction;

//import java.util.Observable;
import com.see.truetransact.ui.termloan.loansubsidy.*;
 ...
 * @author bala
 */
public class LoanAuctionDetailsOB extends CObservable {
...
//    private String result;
    ...
    private String tdtAuctionDt = "";
    private String txtSubsidyAmount = "";
    
    /** Creates a new instance of AuthorizeOB */
    public LoanAuctionDetailsOB() {
        try {
...
//            setResul t(ClientConstants.RESULT_STATUS[4]);
    ...
    //TermLoanSubsidyTO objTermLoanSubsidyTO
    private TermLoanSubsidyTO getTermLoanSubsidyTO(){
        TermLoanSubsidyTO objTermLoanSubsidyTO = new TermLoanSubsidyTO();
        objTermLoanSubsidyTO.setAcctNum(getTxtAcctNum());
        objTermLoanSubsidyTO.setSubsidyAmt(CommonUtil.convertObjToDouble(getTxtSubsidyAmount()));
        objTermLoanSubsidyTO.setSubsidyDt(currDt);
        objTermLoanSubsidyTO.setBranchCode(TrueTransactMain.BRANCH_ID);
        objTermLoanSubsidyTO.setStatus(CommonConstants.STATUS_CREATED);
        objTermLoanSubsidyTO.setStatusDt(currDt);
        objTermLoanSubsidyTO.setStatusBy(TrueTransactMain.USER_ID);
        objTermLoanSubsidyTO.setSubsidyId(getSubsidyId());
        if(getActionType()==ClientConstants.ACTIONTYPE_AUTHORIZE){
            objTermLoanSubsidyTO.setAuthorizeStatus(CommonConstants.STATUS_AUTHORIZED);
        }if(getActionType()==ClientConstants.ACTIONTYPE_REJECT){
            objTermLoanSubsidyTO.setAuthorizeStatus(CommonConstants.STATUS_REJECTED);
        }
        return objTermLoanSubsidyTO;
    }
    ...
    public void doAction(String actionType){
        try
        {
            ...
            finalMap.put("ACCT_NUM",getTxtAcctNum());
            finalMap.put("AUCTION_DT",DateUtil.getDateMMDDYYYY(getTdtAuctionDt()));
            finalMap.put(CommonConstants.BRANCH_ID,ProxyParameters.BRANCH_ID);
            finalMap.put("SOURCE_SCREEN","LOAN_AUCTION_DATA");
...
//    }
    ...
    public String getTdtAuctionDt() {
        return tdtAuctionDt;
    }

    public void setTdtAuctionDt(String tdtAuctionDt) {
        this.tdtAuctionDt = tdtAuctionDt;
    }

   

    public String getTxtSubsidyAmount() {
        return txtSubsidyAmount;
    }

    public void setTxtSubsidyAmount(String txtSubsidyAmount) {
        this.txtSubsidyAmount = txtSubsidyAmount;
    }
