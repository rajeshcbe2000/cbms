 ...
 * @author  bala
 */
public class LoanAuctionDetailsUI extends com.see.truetransact.uicomponent.CInternalFrame implements Observer {
    private final LoanSubsidyRB resourceBundle = new LoanSubsidyRB();
    private TableModelListener tableModelListener;
    private LoanAuctionDetailsOB observable;
    ...
    private final static Logger log = Logger.getLogger(LoanAuctionDetailsUI.class);

    /** Creates new form AuthorizeUI */
    public LoanAuctionDetailsUI() {
        setupInit();
        setupScreen();
    }
    
    /** Creates new form AuthorizeUI */
    public LoanAuctionDetailsUI(CInternalFrame parent, HashMap paramMap) {
        this.parent = parent;
    ...
    private void setObservable() {
        try {
            observable = new LoanAuctionDetailsOB();
...
//    }
    ...
    private void initComponents() {
        ...
        tdtAuctionDt = new com.see.truetransact.uicomponent.CDateField();
        ...
        lblToDate.setText("Auction Date");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        gridBagConstraints.insets = new java.awt.Insets(4, 4, 4, 4);
        panToAccount.add(tdtAuctionDt, gridBagConstraints);
...
//        setTableModelListenerUpdate();
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        ...
        if (tblData.getRowCount() > 0) {
            if (tdtAuctionDt.getDateValue().length() == 0) {
                ClientUtil.showMessageWindow("Enter Auction Date !!!");
            } else {
                updateOBFields();
                observable.doAction("");
            ...
            ClientUtil.showMessageWindow("Please find Record then Applied Auction");
            return;
        }        
    ...
    private void btnCancelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCancelActionPerformed
        ...
        tdtAuctionDt.setDateValue(null);
...
//            map.put("ACT_NUM",txtAccountNumber.getText());
            ...
            map.put("AUTHORIZE_STATUS","AUTHORIZED");
              if(tblData.getRowCount()>0){
                  updateOBFields();
                   observable.setTdtAuctionDt(CommonUtil.convertObjToStr(tblData.getValueAt(0,8)));
...
//                heading = null;
    ...
    public void initSubsidyTableData() {
        ...
        setTableData(),
        new String [] {
            "Acct Num","Customer Id","Share No","Name","Loan Amount","Available Bal","Subsidy Date"
        }
        ) {
...
//                        calcTotal();
    ...
    private Object[][] setTableData() {
        ...
        whereMap.put("PROD_ID", CommonUtil.convertObjToStr(observable.getCbmProdId().getKeyForSelected()));
        whereMap.put("ACCT_NUM",txtAcctNo.getText());
        List applnList = ClientUtil.executeQuery("getLoanDetailsForAuctionProvision", whereMap);
        ...
        if (applnList != null && applnList.size() > 0) {
            ...
            for (int j = 0; j < applnList.size(); j++) {                
                ...
                totalList[j][6] = CommonUtil.convertObjToStr(tdtAuctionDt.getDateValue());
...
//        }
    ...
    public void updateOBFields() {
        ...
        observable.setTdtAuctionDt(tdtAuctionDt.getDateValue());
    ...
    private com.see.truetransact.uicomponent.CDateField tdtAuctionDt;
