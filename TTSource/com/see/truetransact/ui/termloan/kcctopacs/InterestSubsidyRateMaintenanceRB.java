...
public class InterestSubsidyRateMaintenanceRB extends ListResourceBundle {

    public InterestSubsidyRateMaintenanceRB() {
    }
    ...
    static final String[][] contents = {
        {"lblInstitution", "Name of the Institution"},
        {"lblRefno", "Ref No."},
        {"lblDateReceived", "Date Received"},
        {"lblSubsidyInt", "Subsidy Interest"},
        {"lblRemarks", "Remarks"},
        ...
        {"btnPrint", ""},
        {"lblRateInterestPer", "%"},
        {"lblCustRateInt", "Interest Charged to Be Customer"},
        {"lblRateInterest", "Total Rate Of interest"},
        {"tblProd1", "Select"},
        {"tblProd2", "Product ID"},
        {"tblProd3", "Product Description"},
        {"lblToDate", "To Date"},
        {"lblMiscellaneousInt", "Miscellaneous Interest"},
        {"tblCategory1", "Select"},
        {"tblCategory2", "Category"},
        {"tblCategory3", "Category Description"},
        {"tblInter1", "Name of Institution"},
        {"tblInter2", "Ref. No"},
        {"tblInter3", "Date Of Received"},
        {"tblInter4", "From Date"},
        {"tblInter5", "To Date"},
        {"tblInter6", "Subsidy Rate Of interest"},
        {"tblInter7", "Int Rate"},
        ...
        {"UNSAVEDATAWARNING", "First Save the Newly Added Record"}
    };
}
