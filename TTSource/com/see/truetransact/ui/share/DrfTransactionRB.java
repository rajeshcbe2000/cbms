...
public class DrfTransactionRB extends ListResourceBundle {
    public DrfTransactionRB(){
    }
    ...
    static final String[][] contents = {
        ...
        {"saveAcctDet", "Save the Share Account Details before saving the Share Account!!!"},
            {"enterResNo","Enter Resolution No!!!"},
            {"enterResDate","Enter Resolution Date!!!"},
            {"transtype", "Select reciept or payment"}
