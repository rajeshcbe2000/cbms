 ...
 * 
 * LoanCalculateInterestWithoutStatic.java
 *
...
//        testing.setMonthOption(InterestCalculationConstants.MONTH_OPTION_ACTUAL);
    ...
    public HashMap getInterest(HashMap parameter)throws Exception{
        ...
        try{
            ...
            if(interestBean.getInterestType().equals("COMPOUND"))
              ic = new InterestCalculation(interestBean,this);
            else
...
//                ic.interestCalcBean=null;
             ...
             System.out.println("### ic after calculateInterest() : "+ic);
...
//            System.out.println("### ic after setAmount() : "+amountRouding(ic.getAmount()));
            ...
            resultMap.put("ROI", new Double(ic.getRateOfInterest()));
            System.out.println("### resultMap after all : "+resultMap);
    ...
    private void populateIC(InterestCalculation ic){
    ...
    private double getDuration(InterestCalculation ic){
        ...
        if (interestBean.isIsDuration_ddmmyy()) {
            ...
            Date fromDate = interestBean.getDuration_FromDt();
            Date toDate = interestBean.getDuration_ToDt();
...
//            }
    ...
    */
    public double getDuration(InterestCalculationBean intCalcBean, InterestCalculation ic){
        ...
        if (intCalcBean.isIsDuration_ddmmyy()) {
            ...
            Date fromDate = intCalcBean.getDuration_FromDt();
            Date toDate = intCalcBean.getDuration_ToDt();
            if(fromDate!=null && toDate!=null) {
...
//                    duration = (double)(((duration * yy)+1)/yy);     //ONE MORE DAY ADDED, SO COMMENTED.
    ...
    public double amountRouding(double amount, InterestCalculationBean interestBean) {
        return amountRouding(amount) ;
    }
    
    public double amountRouding(double amount) {
